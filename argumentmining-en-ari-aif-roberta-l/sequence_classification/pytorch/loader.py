...
"""Argumentmining En Ari Aif Roberta L model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="raruidol/ArgumentMining-EN-ARI-AIF-RoBERTa_L",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Argumentmining En Ari Aif Roberta L",
