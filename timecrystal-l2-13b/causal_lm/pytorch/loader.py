...
"""Timecrystal L2 13b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="BlueNipples/TimeCrystal-l2-13B",
            max_length=128,
        ),
    }
