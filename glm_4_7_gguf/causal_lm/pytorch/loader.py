...
"""
GLM-4.7 GGUF model loader implementation for causal language modeling.
"""
import torch
...
def _patch_transformers_glm4moe_gguf():
    ...
    The GLM-4.7 MoE model uses the 'glm4moe' architecture identifier in its
    GGUF metadata. Transformers has Glm4MoeForCausalLM but lacks GGUF loading
    support for the glm4moe architecture. We bridge the gap by registering
    the config mapping and remapping model_type to glm4_moe.
    """
...
class ModelVariant(StrEnum):
    """Available GLM-4.7 GGUF model variants for causal language modeling."""

    GLM_4_7_GGUF = "4.7_GGUF"


class ModelLoader(ForgeModel):
    """GLM-4.7 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GLM_4_7_GGUF: LLMModelConfig(
            pretrained_model_name="unsloth/GLM-4.7-GGUF",
            max_length=128,
        ),
    }
