...
"""
ViT Base Violence Detection model loader implementation
"""
...
class ModelVariant(StrEnum):
    """Available ViT Base Violence Detection model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE: ModelConfig(
            pretrained_model_name="jaranohaal/vit-base-violence-detection",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="ViTBaseViolenceDetection",
            variant=variant,
