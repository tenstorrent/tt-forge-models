...
"""
Whisper Tiny MLX model loader implementation for speech recognition (ASR).

mlx-community/whisper-tiny is an MLX conversion of openai/whisper-tiny for
automatic speech recognition. Since the MLX format (weights.npz) is not directly
loadable by PyTorch, this loader uses the original openai/whisper-tiny weights
...
class ModelVariant(StrEnum):
    """Available Whisper Tiny MLX model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.WHISPER_TINY_MLX: ModelConfig(
            pretrained_model_name="openai/whisper-tiny",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.WHISPER_TINY_MLX
