...
"""
Z-Image FP8 model loader implementation.

Loads FP8-quantized variants of the Z-Image text-to-image
DiT transformer from drbaph/Z-Image-fp8.
"""
...
class ModelVariant(StrEnum):
    """Available Z-Image FP8 model variants."""

    Z_IMAGE_FP8_E4M3FN = "FP8-E4M3FN"


class ModelLoader(ForgeModel):
    """Z-Image FP8 model loader."""

    _VARIANTS = {
        ModelVariant.Z_IMAGE_FP8_E4M3FN: ModelConfig(
            pretrained_model_name=FP8_REPO_ID,
        ),
    }
    DEFAULT_VARIANT = ModelVariant.Z_IMAGE_FP8_E4M3FN

    FP8_FILES = {
        ModelVariant.Z_IMAGE_FP8_E4M3FN: "z-img_fp8-e4m3fn.safetensors",
    }
    ...
    def _load_pipeline(self, dtype: torch.dtype = torch.bfloat16) -> ZImagePipeline:
        """Load the Z-Image pipeline with FP8 transformer."""
    ...
    def load_model(self, *, dtype_override: Optional[torch.dtype] = None, **kwargs):
        """Load and return the FP8-quantized DiT transformer."""
    ...
    def load_inputs(self, **kwargs) -> Any:
        """Prepare inputs for the FP8 transformer."""
