...
"""Sambalingo Russian Base model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="sambanovasystems/SambaLingo-Russian-Base",
            max_length=128,
        ),
    }
