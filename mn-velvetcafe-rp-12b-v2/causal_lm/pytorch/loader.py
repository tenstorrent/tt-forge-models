...
"""Mn Velvetcafe Rp 12b V2 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="IggyLux/MN-VelvetCafe-RP-12B-V2",
            max_length=128,
        ),
    }
