...
"""Tiny Hinglish Chat 21m model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Abhishekcr448/Tiny-Hinglish-Chat-21M",
            max_length=128,
        ),
    }
