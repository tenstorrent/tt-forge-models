...
"""Bert Large Uncased Sst2 model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="yoshitomo-matsubara/bert-large-uncased-sst2",
        ),
    }
