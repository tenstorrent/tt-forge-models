...
"""
Helper functions for T2I-Adapter Depth MiDaS SDXL model loading and processing.
"""
...
def load_t2i_adapter_depth_midas_sdxl_pipe(adapter_model_name, base_model_name):
    """Load T2I-Adapter Depth MiDaS SDXL pipeline.
    ...
    Returns:
        StableDiffusionXLAdapterPipeline: Loaded pipeline with components set to eval mode
    """
...
def t2i_adapter_depth_midas_sdxl_preprocessing(
    pipe,
    prompt,
    adapter_image,
    device="cpu",
    ...
    """Preprocess inputs for T2I-Adapter Depth MiDaS SDXL model.

    Args:
        pipe: StableDiffusionXLAdapterPipeline
        prompt: Text prompt for generation
        adapter_image: Depth conditioning image
        ...
        adapter_conditioning_scale: Adapter conditioning scale (default: 1.0)
