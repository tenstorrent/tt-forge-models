...
"""Redmond Puffin 13b Instruct Pl Lora Unload model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Aspik101/Redmond-Puffin-13B-instruct-PL-lora_unload",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Redmond Puffin 13b Instruct Pl Lora Unload",
