...
"""Sombrero Opus 14b Sm1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="prithivMLmods/Sombrero-Opus-14B-Sm1",
            max_length=128,
        ),
    }
