...
"""Rubert Base Cased Conversational Paraphrase V1 model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="s-nlp/rubert-base-cased-conversational-paraphrase-v1",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Rubert Base Cased Conversational Paraphrase V1",
