...
"""Mpt 7b Instructandstorywriting 50 50 Merge model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="TehVenom/MPT-7b-InstructAndStorywriting-50_50-Merge",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Mpt 7b Instructandstorywriting 50 50 Merge",
