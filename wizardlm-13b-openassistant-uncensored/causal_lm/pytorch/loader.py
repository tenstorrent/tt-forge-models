...
"""Wizardlm 13b Openassistant Uncensored model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Monero/WizardLM-13b-OpenAssistant-Uncensored",
            max_length=128,
        ),
    }
