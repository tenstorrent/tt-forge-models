...
"""Bert Fa Base Uncased Sentiment Deepsentipers Binary model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="HooshvareLab/bert-fa-base-uncased-sentiment-deepsentipers-binary",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert Fa Base Uncased Sentiment Deepsentipers Binary",
