...
class ModelVariant(StrEnum):
    """Available Stella-EN-400M-v5 model variants for embedding generation."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.STELLA_EN_400M_V5: ModelConfig(
            pretrained_model_name="NovaSearch/stella_en_400M_v5",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.STELLA_EN_400M_V5
