...
"""
Tiny Random Vision Perceiver Conv model loader implementation
"""
...
class ModelVariant(StrEnum):
    """Available Tiny Random Vision Perceiver Conv model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE: ModelConfig(
            pretrained_model_name="optimum-intel-internal-testing/tiny-random-vision_perceiver_conv",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="TinyRandomVisionPerceiverConv",
            variant=variant,
