...
"""
SigLIP ViT model loader implementation for feature extraction via timm.
"""
...
class ModelVariant(StrEnum):
    ...
    BASE_PATCH16_384_V2_WEBLI = "Base_Patch16_384_v2_WebLI"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.BASE_PATCH16_384_V2_WEBLI: ModelConfig(
            pretrained_model_name="vit_base_patch16_siglip_384.v2_webli",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SO400M_PATCH14_224
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the SigLIP ViT model instance for feature extraction.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The SigLIP ViT model instance.
        """
