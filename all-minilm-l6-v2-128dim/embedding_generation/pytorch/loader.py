...
"""All Minilm L6 V2 128dim model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="freedomfrier/all-MiniLM-L6-v2-128dim",
        ),
    }
