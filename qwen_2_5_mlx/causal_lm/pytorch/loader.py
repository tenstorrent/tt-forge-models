...
"""
Qwen 2.5 MLX model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    ...
    QWEN_2_5_14B_INSTRUCT_MLX_4BIT = "14B_Instruct_MLX_4bit"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.QWEN_2_5_14B_INSTRUCT_MLX_4BIT: LLMModelConfig(
            pretrained_model_name="lmstudio-community/Qwen2.5-14B-Instruct-MLX-4bit",
            max_length=128,
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        # Strip the config so the model loads in standard float format.
