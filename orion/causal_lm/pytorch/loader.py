...
"""
Orion model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available Orion model variants."""

    TINY_RANDOM_ORION = "Tiny_Random_Orion"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.TINY_RANDOM_ORION: LLMModelConfig(
            pretrained_model_name="optimum-intel-internal-testing/tiny-random-orion",
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.TINY_RANDOM_ORION
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Orion model instance for this instance's variant.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The Orion model instance for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the Orion model.
