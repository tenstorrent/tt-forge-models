...
"""
mradermacher/MetaphorStar-7B-GGUF model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    """Available MetaphorStar-7B-GGUF model variants for causal language modeling."""

    METAPHOR_STAR_7B_GGUF = "7B_GGUF"


class ModelLoader(ForgeModel):
    """MetaphorStar-7B-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.METAPHOR_STAR_7B_GGUF: LLMModelConfig(
            pretrained_model_name="MING-ZCH/MetaphorStar-7B",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher MetaphorStar-7B-GGUF",
            variant=variant,
