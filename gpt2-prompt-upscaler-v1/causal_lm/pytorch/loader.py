...
"""Gpt2 Prompt Upscaler V1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="trojblue/gpt2-prompt-upscaler-v1",
            max_length=128,
        ),
    }
