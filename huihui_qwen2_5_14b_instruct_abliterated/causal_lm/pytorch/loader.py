...
"""
huihui-ai/Qwen2.5-14B-Instruct-abliterated model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available model variants for huihui-ai Qwen2.5-14B-Instruct-abliterated."""

    QWEN_2_5_14B_INSTRUCT_ABLITERATED = "14B_Instruct_abliterated"


class ModelLoader(ForgeModel):
    """huihui-ai/Qwen2.5-14B-Instruct-abliterated model loader for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.QWEN_2_5_14B_INSTRUCT_ABLITERATED
