...
"""
Qwen 3.5 4B SOMPOA Heresy v2 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Qwen 3.5 4B SOMPOA Heresy v2 GGUF model variants for causal language modeling."""

    _4B_SOMPOA_HERESY_V2_GGUF = "4B_SOMPOA_heresy_v2_GGUF"


class ModelLoader(ForgeModel):
    """Qwen 3.5 4B SOMPOA Heresy v2 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant._4B_SOMPOA_HERESY_V2_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Qwen3.5-4B-SOMPOA-heresy-v2-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant._4B_SOMPOA_HERESY_V2_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Qwen 3.5 4B SOMPOA Heresy v2 GGUF",
            variant=variant,
