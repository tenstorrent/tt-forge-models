...
"""Parsbert Base Parsinlu Multiple Choice model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="persiannlp/parsbert-base-parsinlu-multiple-choice",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Parsbert Base Parsinlu Multiple Choice",
