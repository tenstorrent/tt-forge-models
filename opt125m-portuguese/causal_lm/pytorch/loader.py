...
"""Opt125m Portuguese model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="monilouise/opt125M_portuguese",
            max_length=128,
        ),
    }
