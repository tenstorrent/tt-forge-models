...
"""
DreamShaper 8 model loader implementation
"""
...
class ModelVariant(StrEnum):
    """Available DreamShaper 8 model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE: ModelConfig(
            pretrained_model_name="Lykon/dreamshaper-8",
        )
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load the DreamShaper 8 pipeline and return the UNet."""
