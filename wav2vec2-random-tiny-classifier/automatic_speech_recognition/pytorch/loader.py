...
"""Wav2vec2 Random Tiny Classifier model loader implementation for automatic speech recognition."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="optimum-intel-internal-testing/wav2vec2-random-tiny-classifier",
            max_length=30,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Wav2vec2 Random Tiny Classifier",
