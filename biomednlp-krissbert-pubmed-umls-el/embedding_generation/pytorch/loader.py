...
"""Biomednlp Krissbert Pubmed Umls El model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="microsoft/BiomedNLP-KRISSBERT-PubMed-UMLS-EL",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Biomednlp Krissbert Pubmed Umls El",
