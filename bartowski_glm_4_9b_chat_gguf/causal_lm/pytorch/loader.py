...
"""
bartowski/glm-4-9b-chat GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available bartowski/glm-4-9b-chat GGUF model variants for causal language modeling."""

    BARTOWSKI_GLM_4_9B_CHAT_Q4_K_M = "9B_CHAT_Q4_K_M"


class ModelLoader(ForgeModel):
    """bartowski/glm-4-9b-chat GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.BARTOWSKI_GLM_4_9B_CHAT_Q4_K_M: LLMModelConfig(
            pretrained_model_name="bartowski/glm-4-9b-chat-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BARTOWSKI_GLM_4_9B_CHAT_Q4_K_M

    GGUF_FILE = "glm-4-9b-chat-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="bartowski/glm-4-9b-chat GGUF",
            variant=variant,
