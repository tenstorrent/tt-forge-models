...
"""
mradermacher SOLAR-10.7B-merge-dpo_v1 i1 GGUF model loader implementation for causal language modeling.
"""
...
class ModelLoader(ForgeModel):
    """mradermacher SOLAR-10.7B-merge-dpo_v1 i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.SOLAR_10_7B_MERGE_DPO_V1_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/SOLAR-10.7B-merge-dpo_v1-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SOLAR_10_7B_MERGE_DPO_V1_I1_GGUF

    GGUF_FILE = "SOLAR-10.7B-merge-dpo_v1.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher SOLAR-10.7B-merge-dpo_v1 i1 GGUF",
            variant=variant,
