...
"""
QuiltNet model loader implementation for histopathology image-text similarity using OpenCLIP.
"""
import torch
...
class ModelLoader(ForgeModel):
    """QuiltNet model loader using OpenCLIP for histopathology image-text similarity."""
    ...
    DEFAULT_VARIANT = ModelVariant.VIT_BASE_PATCH16
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the QuiltNet model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The QuiltNet model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the QuiltNet model.
    ...
    def post_process(self, outputs):
        """Post-process QuiltNet model outputs to extract similarity scores.
