...
class ModelVariant(StrEnum):
    """Available DavidAU L3-8B-Stheno-v3.3-32K-Ultra-NEO-V1-IMATRIX GGUF model variants for causal language modeling."""

    L3_8B_STHENO_V3_3_32K_ULTRA_NEO_V1_IMATRIX_GGUF = (
        "L3_8B_Stheno_v3_3_32K_Ultra_NEO_V1_IMATRIX_GGUF"
    )
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.L3_8B_STHENO_V3_3_32K_ULTRA_NEO_V1_IMATRIX_GGUF: LLMModelConfig(
            pretrained_model_name="DavidAU/L3-8B-Stheno-v3.3-32K-Ultra-NEO-V1-IMATRIX-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.L3_8B_STHENO_V3_3_32K_ULTRA_NEO_V1_IMATRIX_GGUF

    _GGUF_FILES = {
        ModelVariant.L3_8B_STHENO_V3_3_32K_ULTRA_NEO_V1_IMATRIX_GGUF: "L3-8B-Stheno-v3.3-32K-NEO-V1-D_AU-Q4_K_M-imat13.gguf",
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="L3 8B Stheno v3.3 32K Ultra NEO V1 IMATRIX GGUF",
            variant=variant,
