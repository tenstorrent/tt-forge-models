...
"""Phi4 African History Lora Ds2 Axolotl Merged model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="DannyAI/phi4_african_history_lora_ds2_axolotl_merged",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Phi4 African History Lora Ds2 Axolotl Merged",
