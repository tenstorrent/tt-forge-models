...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        def _nanovel_load_gguf(*args, **kw):
            ...
            if result.get("config", {}).get("model_type") == "qwen3vl":
                ...
                # (3584) does not match this model's text hidden_size.
        ...
        gguf_utils.load_gguf_checkpoint = _nanovel_load_gguf
        for mod in (config_utils, modeling_utils):
            if hasattr(mod, "load_gguf_checkpoint"):
                mod.load_gguf_checkpoint = _nanovel_load_gguf
        ...
        try:
            ...
            self.processor = AutoProcessor.from_pretrained("Dxniz/NaNovel-Failed")
