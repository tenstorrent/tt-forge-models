...
"""
Qwen3-VL-32B-Instruct-heretic-v2 GGUF model loader implementation for causal language modeling.
"""
import torch
...
def _patch_transformers_qwen3vl_gguf():
    ...
    # Patch all modules that imported load_gguf_checkpoint at module level
...
class ModelVariant(StrEnum):
    """Available Qwen3-VL-32B-Instruct-heretic-v2 GGUF model variants for causal language modeling."""

    HERETIC_V2_Q4_K_M = "heretic_v2_Q4_K_M"


class ModelLoader(ForgeModel):
    """Qwen3-VL-32B-Instruct-heretic-v2 GGUF model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.HERETIC_V2_Q4_K_M: LLMModelConfig(
            pretrained_model_name="mradermacher/Qwen3-VL-32B-Instruct-heretic-v2-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.HERETIC_V2_Q4_K_M

    GGUF_FILE = "Qwen3-VL-32B-Instruct-heretic-v2.Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Qwen3-VL-32B-Instruct-heretic-v2 GGUF",
            variant=variant,
