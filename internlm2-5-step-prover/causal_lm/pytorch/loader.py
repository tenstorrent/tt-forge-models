...
"""Internlm2 5 Step Prover model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="internlm/internlm2_5-step-prover",
            max_length=128,
        ),
    }
