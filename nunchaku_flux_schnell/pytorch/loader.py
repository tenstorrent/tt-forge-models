...
"""
Nunchaku FLUX.1-schnell quantized model loader implementation.

Loads a 4-bit quantized FLUX.1-schnell transformer via nunchaku and injects it
...
NUNCHAKU_REPO = "nunchaku-ai/nunchaku-flux.1-schnell"


class ModelVariant(StrEnum):
    """Available Nunchaku FLUX.1-schnell variants."""

    INT4 = "INT4"


class ModelLoader(ForgeModel):
    """Nunchaku FLUX.1-schnell quantized model loader."""
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the nunchaku quantized FLUX.1-schnell transformer model.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1, **kwargs):
        """Load and return sample inputs for the nunchaku FLUX.1-schnell model.
