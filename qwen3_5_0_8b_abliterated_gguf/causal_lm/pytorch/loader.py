...
"""
Qwen3.5 0.8B Abliterated GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Qwen3.5 0.8B Abliterated GGUF model variants for causal language modeling."""

    QWEN3_5_0_8B_ABLITERATED_GGUF = "0_8B_Abliterated_GGUF"


class ModelLoader(ForgeModel):
    """Qwen3.5 0.8B Abliterated GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN3_5_0_8B_ABLITERATED_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Qwen3.5-0.8B_Abliterated-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN3_5_0_8B_ABLITERATED_GGUF

    GGUF_FILE = "Qwen3.5-0.8B_Abliterated.Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Qwen3.5 0.8B Abliterated GGUF",
            variant=variant,
