...
"""
Stella-PL-Retrieval model loader implementation for sentence embedding generation.
"""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.STELLA_PL_RETRIEVAL
