...
"""Tigerbot 70b Base V2 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="TigerResearch/tigerbot-70b-base-v2",
            max_length=128,
        ),
    }
