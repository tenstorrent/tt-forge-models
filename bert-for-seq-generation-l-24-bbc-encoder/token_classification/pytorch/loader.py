...
"""Bert For Seq Generation L 24 Bbc Encoder model loader implementation for token classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="google/bert_for_seq_generation_L-24_bbc_encoder",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert For Seq Generation L 24 Bbc Encoder",
