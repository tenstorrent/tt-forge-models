...
"""Meditron3 Gemma2 9b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="OpenMeditron/Meditron3-Gemma2-9B",
            max_length=128,
        ),
    }
