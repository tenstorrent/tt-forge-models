...
"""Lughaat 1 0 8b Instruct model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="muhammadnoman76/Lughaat-1.0-8B-Instruct",
            max_length=128,
        ),
    }
