...
"""Bi Encoder Msmarco Bert Base German model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="PM-AI/bi-encoder_msmarco_bert-base_german",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bi Encoder Msmarco Bert Base German",
