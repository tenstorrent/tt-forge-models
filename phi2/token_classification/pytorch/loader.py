...
"""
PHI2 model loader implementation for token classification.
"""
import torch
...
class ModelLoader(ForgeModel):
    """PHI2 model loader implementation for token classification tasks."""
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The PHI2 model instance for token classification.
        """
