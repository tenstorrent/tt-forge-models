...
"""Mindact Candidategeneration Deberta V3 Base model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="osunlp/MindAct_CandidateGeneration_deberta-v3-base",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Mindact Candidategeneration Deberta V3 Base",
