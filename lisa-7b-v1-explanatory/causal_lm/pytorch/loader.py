...
"""Lisa 7b V1 Explanatory model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="xinlai/LISA-7B-v1-explanatory",
            max_length=128,
        ),
    }
