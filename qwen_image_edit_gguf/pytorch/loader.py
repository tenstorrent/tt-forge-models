...
"""
Qwen-Image-Edit 2509 GGUF model loader implementation.

Loads GGUF-quantized diffusion transformer variants from
QuantStack/Qwen-Image-Edit-2509-GGUF. Uses the upstream Qwen/Qwen-Image-Edit-2509
diffusers config for model construction.

Available variants:
- Q4_K_M: 4-bit quantization (medium, 12.17 GB)
- Q8_0: 8-bit quantization (20.27 GB)
"""
...
class ModelVariant(StrEnum):
    """Available Qwen-Image-Edit 2509 GGUF quantization variants."""
...
class ModelLoader(ForgeModel):
    """Qwen-Image-Edit 2509 GGUF model loader for the diffusion transformer."""
