...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE: ModelConfig(
            pretrained_model_name="attention_denseunet",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The Attention DenseUNet model instance.
        """
        # Load the Attention DenseUNet model
        # Default configuration: 3 input channels, 1 output class (binary segmentation)
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        # Using 256x256 as a common segmentation input size
