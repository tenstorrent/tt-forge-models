...
"""Mistral 7b Instruct Uz model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="behbudiy/Mistral-7B-Instruct-Uz",
            max_length=128,
        ),
    }
