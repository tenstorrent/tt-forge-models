...
"""Sgpt 2 7b Weightedmean Msmarco Specb Bitfit model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Muennighoff/SGPT-2.7B-weightedmean-msmarco-specb-bitfit",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sgpt 2 7b Weightedmean Msmarco Specb Bitfit",
