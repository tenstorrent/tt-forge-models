...
"""Gpt2 Medium 650k Stable Diffusion Prompt Generator model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Ar4ikov/gpt2-medium-650k-stable-diffusion-prompt-generator",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Gpt2 Medium 650k Stable Diffusion Prompt Generator",
