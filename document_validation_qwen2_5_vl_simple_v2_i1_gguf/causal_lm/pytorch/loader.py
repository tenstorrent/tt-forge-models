...
"""
mradermacher/Document-Validation-Qwen2.5-VL-Simple-V2-i1-GGUF model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    """Available Document-Validation-Qwen2.5-VL-Simple-V2-i1-GGUF model variants for causal language modeling."""

    DOCUMENT_VALIDATION_QWEN2_5_VL_SIMPLE_V2_I1_GGUF = "Simple_V2_i1_GGUF"


class ModelLoader(ForgeModel):
    """Document-Validation-Qwen2.5-VL-Simple-V2-i1-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.DOCUMENT_VALIDATION_QWEN2_5_VL_SIMPLE_V2_I1_GGUF: LLMModelConfig(
            pretrained_model_name="hienphantt161/Document-Validation-Qwen2.5-VL-Simple-V2",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.DOCUMENT_VALIDATION_QWEN2_5_VL_SIMPLE_V2_I1_GGUF

    sample_text = "Validate the key fields of the attached identification document."
