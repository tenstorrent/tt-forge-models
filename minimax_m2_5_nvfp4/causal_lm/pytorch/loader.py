...
"""
MiniMax-M2.5 NVFP4 model loader implementation for causal language modeling.

This loads the NVFP4-quantized variant of MiniMax-M2.5, using the native
transformers MiniMaxForCausalLM class.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available MiniMax-M2.5 NVFP4 model variants for causal language modeling."""

    MINIMAX_M2_5_NVFP4 = "M2.5_NVFP4"


class ModelLoader(ForgeModel):
    """MiniMax-M2.5 NVFP4 model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MINIMAX_M2_5_NVFP4: LLMModelConfig(
            pretrained_model_name="mconcat/MiniMax-M2.5-NVFP4",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MINIMAX_M2_5_NVFP4
