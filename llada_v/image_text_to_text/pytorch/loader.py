...
class ModelVariant(StrEnum):
    """Available LLaDA-V model variants for image-text-to-text tasks."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.LLADA_V: LLMModelConfig(
            pretrained_model_name="GSAI-ML/LLaDA-V",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.LLADA_V

    sample_text = "Please describe the image in detail."
