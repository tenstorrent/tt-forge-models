...
"""
Ovis2-2B HuggingFace-native model loader implementation for image-to-text tasks.
"""
...
class ModelVariant(StrEnum):
    """Available Ovis2-2B-hf model variants."""

    OVIS2_2B_HF = "2B"


class ModelLoader(ForgeModel):
    """Ovis2-2B-hf model loader for image-to-text tasks."""

    _VARIANTS = {
        ModelVariant.OVIS2_2B_HF: LLMModelConfig(
            pretrained_model_name="thisisiron/Ovis2-2B-hf",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.OVIS2_2B_HF
