...
"""
Helper functions for ControlNet Depth SDXL Small model loading and processing.
"""
...
def load_controlnet_depth_small_pipe(controlnet_model_name, base_model_name):
    """Load ControlNet Depth SDXL Small pipeline.
...
def controlnet_depth_sdxl_small_preprocessing(
    pipe,
    prompt,
    control_image,
    device="cpu",
    ...
    """Preprocess inputs for ControlNet Depth SDXL Small model.
