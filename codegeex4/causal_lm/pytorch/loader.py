...
"""
CodeGeeX4 model loader implementation
"""
import torch
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.CODEGEEX4_ALL_9B: LLMModelConfig(
            pretrained_model_name="zai-org/codegeex4-all-9b",
            max_length=256,
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.CODEGEEX4_ALL_9B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the CodeGeeX4 model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The CodeGeeX4 model instance.
        """
