...
"""
Tiny Random Stable Diffusion 3 model loader implementation
"""
import torch
...
from ...stable_diffusion_3.pytorch.src.model_utils import (
    load_pipe,
...
class ModelVariant(StrEnum):
    """Available Tiny Random Stable Diffusion 3 model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.TINY_RANDOM: ModelConfig(
            pretrained_model_name="optimum-internal-testing/tiny-random-stable-diffusion-3",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Tiny Random Stable Diffusion 3",
            variant=variant,
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Tiny Random Stable Diffusion 3 transformer for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The Tiny Random Stable Diffusion 3 transformer instance.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the Tiny Random Stable Diffusion 3 model.
