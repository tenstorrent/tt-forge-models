...
"""Mistral 7b Holodeck 1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="KoboldAI/Mistral-7B-Holodeck-1",
            max_length=128,
        ),
    }
