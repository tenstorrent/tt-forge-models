...
"""Opensearch Neural Sparse Encoding V2 Distill model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="opensearch-project/opensearch-neural-sparse-encoding-v2-distill",
        ),
    }
