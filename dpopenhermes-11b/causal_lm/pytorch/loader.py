...
"""Dpopenhermes 11b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="openaccess-ai-collective/DPOpenHermes-11B",
            max_length=128,
        ),
    }
