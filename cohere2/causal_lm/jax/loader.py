...
"""
Cohere2 model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available Cohere2 model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant._7B: LLMModelConfig(
            pretrained_model_name="CohereForAI/c4ai-command-r7b-12-2024",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Cohere2 model instance for this instance's variant.
    ...
    def load_inputs(self, dtype_override=None, mesh=None):
        """Load and return sample inputs for the Cohere2 model with this instance's variant settings.
    ...
    def load_parameters_partition_spec(
        ...
        if (
            ...
            # Use EasyDeL's Cohere2Config to get proper partition rules
            from easydel.modules.cohere2 import Cohere2Config

            cohere2_config = Cohere2Config()
            partition_rules = cohere2_config.get_partition_rules()
