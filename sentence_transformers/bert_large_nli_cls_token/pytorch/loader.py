...
"""
Sentence-Transformers bert-large-nli-cls-token model loader
...
class ModelVariant(StrEnum):
    """Available model variants for bert-large-nli-cls-token."""

    BERT_LARGE_NLI_CLS_TOKEN = "sentence-transformers/bert-large-nli-cls-token"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BERT_LARGE_NLI_CLS_TOKEN: LLMModelConfig(
            pretrained_model_name="sentence-transformers/bert-large-nli-cls-token",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BERT_LARGE_NLI_CLS_TOKEN
