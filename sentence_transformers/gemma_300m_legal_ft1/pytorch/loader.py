...
"""
Sentence-Transformers gemma-300m-legal-ft1 model loader
...
class ModelVariant(StrEnum):
    """Available model variants for gemma-300m-legal-ft1."""

    GEMMA_300M_LEGAL_FT1 = "trt19/gemma-300m-legal-ft1"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.GEMMA_300M_LEGAL_FT1: LLMModelConfig(
            pretrained_model_name="trt19/gemma-300m-legal-ft1",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GEMMA_300M_LEGAL_FT1
    ...
    def load_inputs(self, dtype_override=None, sentence=None):
        ...
        if sentence is None:
            sentence = "This is an example sentence for legal semantic similarity."
