...
"""
Sentence-Transformers xlm-r-distilroberta-base-paraphrase-v1 model loader
...
class ModelVariant(StrEnum):
    """Available model variants for xlm-r-distilroberta-base-paraphrase-v1."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.XLM_R_DISTILROBERTA_BASE_PARAPHRASE_V1: LLMModelConfig(
            pretrained_model_name="sentence-transformers/xlm-r-distilroberta-base-paraphrase-v1",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.XLM_R_DISTILROBERTA_BASE_PARAPHRASE_V1
