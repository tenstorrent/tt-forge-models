...
class ModelVariant(StrEnum):
    """Available model variants for GTR-T5-Large."""

    GTR_T5_LARGE = "sentence-transformers/gtr-t5-large"


class ModelLoader(ForgeModel):
    """GTR-T5-Large text embedding model loader."""

    _VARIANTS = {
        ModelVariant.GTR_T5_LARGE: LLMModelConfig(
            pretrained_model_name="sentence-transformers/gtr-t5-large",
            max_length=512,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GTR_T5_LARGE
    ...
    def load_inputs(self, dtype_override=None, sentence=None):
        ...
        if sentence is None:
            sentence = "query: how much protein should a female eat"
