...
"""
Sentence-Transformers nli-roberta-large model loader
...
class ModelVariant(StrEnum):
    """Available model variants for nli-roberta-large."""

    NLI_ROBERTA_LARGE = "sentence-transformers/nli-roberta-large"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.NLI_ROBERTA_LARGE: LLMModelConfig(
            pretrained_model_name="sentence-transformers/nli-roberta-large",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.NLI_ROBERTA_LARGE
