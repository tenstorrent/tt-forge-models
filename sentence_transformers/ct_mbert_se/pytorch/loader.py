...
"""
CrisisTransformers CT-mBERT-SE model loader
...
class ModelVariant(StrEnum):
    """Available model variants for CT-mBERT-SE."""

    CT_MBERT_SE = "crisistransformers/CT-mBERT-SE"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.CT_MBERT_SE: LLMModelConfig(
            pretrained_model_name="crisistransformers/CT-mBERT-SE",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.CT_MBERT_SE
