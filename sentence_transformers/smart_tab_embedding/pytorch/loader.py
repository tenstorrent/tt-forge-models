...
"""
Sentence-Transformers smart-tab-embedding model loader
...
class ModelVariant(StrEnum):
    """Available model variants for smart-tab-embedding."""

    SMART_TAB_EMBEDDING = "Mozilla/smart-tab-embedding"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.SMART_TAB_EMBEDDING: LLMModelConfig(
            pretrained_model_name="Mozilla/smart-tab-embedding",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SMART_TAB_EMBEDDING
    ...
    def load_inputs(self, dtype_override=None, sentence=None):
        ...
        if sentence is None:
            sentence = "Tabletop Simulator Hub - Workshop Mods and Board Game Fans"
