...
"""
Sentence-Transformers sentence-t5-xl model loader
...
class ModelVariant(StrEnum):
    """Available model variants for sentence-t5-xl."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.SENTENCE_T5_XL: LLMModelConfig(
            pretrained_model_name="sentence-transformers/sentence-t5-xl",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SENTENCE_T5_XL
