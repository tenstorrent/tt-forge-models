...
"""
Sentence-BERT Base Italian XXL Uncased model loader
...
class ModelVariant(StrEnum):
    """Available model variants for sentence-bert-base-italian-xxl-uncased."""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.SENTENCE_BERT_BASE_ITALIAN_XXL_UNCASED
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="sentence-bert-base-italian-xxl-uncased",
            variant=variant,
    ...
    def load_inputs(self, dtype_override=None, sentence=None):
        ...
        if sentence is None:
            sentence = "Questa è una frase di esempio per la generazione di embedding."
