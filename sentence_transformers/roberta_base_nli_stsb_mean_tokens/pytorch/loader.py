...
"""
Sentence-Transformers roberta-base-nli-stsb-mean-tokens model loader
...
class ModelVariant(StrEnum):
    """Available model variants for roberta-base-nli-stsb-mean-tokens."""

    ROBERTA_BASE_NLI_STSB_MEAN_TOKENS = (
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.ROBERTA_BASE_NLI_STSB_MEAN_TOKENS: LLMModelConfig(
            pretrained_model_name="sentence-transformers/roberta-base-nli-stsb-mean-tokens",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.ROBERTA_BASE_NLI_STSB_MEAN_TOKENS
