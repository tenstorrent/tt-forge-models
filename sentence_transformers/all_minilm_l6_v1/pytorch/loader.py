...
"""
Sentence-Transformers all-MiniLM-L6-v1 model loader
...
class ModelVariant(StrEnum):
    """Available model variants for all-MiniLM-L6-v1."""

    ALL_MINILM_L6_V1 = "sentence-transformers/all-MiniLM-L6-v1"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.ALL_MINILM_L6_V1: LLMModelConfig(
            pretrained_model_name="sentence-transformers/all-MiniLM-L6-v1",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.ALL_MINILM_L6_V1
