...
"""
Sentence-Transformers mpnet-base-nli-matryoshka model loader
...
class ModelVariant(StrEnum):
    """Available model variants for mpnet-base-nli-matryoshka."""

    MPNET_BASE_NLI_MATRYOSHKA = "tomaarsen/mpnet-base-nli-matryoshka"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.MPNET_BASE_NLI_MATRYOSHKA: LLMModelConfig(
            pretrained_model_name="tomaarsen/mpnet-base-nli-matryoshka",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MPNET_BASE_NLI_MATRYOSHKA
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="mpnet-base-nli-matryoshka",
            variant=variant,
