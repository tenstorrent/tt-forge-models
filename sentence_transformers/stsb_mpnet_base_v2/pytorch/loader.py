...
"""
Sentence-Transformers stsb-mpnet-base-v2 model loader
...
class ModelVariant(StrEnum):
    """Available model variants for stsb-mpnet-base-v2."""

    STSB_MPNET_BASE_V2 = "sentence-transformers/stsb-mpnet-base-v2"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.STSB_MPNET_BASE_V2: LLMModelConfig(
            pretrained_model_name="sentence-transformers/stsb-mpnet-base-v2",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.STSB_MPNET_BASE_V2
