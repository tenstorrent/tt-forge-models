...
"""
Sentence-Transformers distilbert-multilingual-nli-stsb-quora-ranking model loader
...
class ModelVariant(StrEnum):
    """Available model variants for distilbert-multilingual-nli-stsb-quora-ranking."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.DISTILBERT_MULTILINGUAL_NLI_STSB_QUORA_RANKING: LLMModelConfig(
            pretrained_model_name="sentence-transformers/distilbert-multilingual-nli-stsb-quora-ranking",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.DISTILBERT_MULTILINGUAL_NLI_STSB_QUORA_RANKING
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="distilbert-multilingual-nli-stsb-quora-ranking",
            variant=variant,
