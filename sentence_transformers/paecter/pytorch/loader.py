...
"""
mpi-inno-comp/paecter sentence transformer model loader
...
class ModelVariant(StrEnum):
    """Available model variants for PaECTER."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.PAECTER: LLMModelConfig(
            pretrained_model_name="mpi-inno-comp/paecter",
            max_length=512,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.PAECTER
