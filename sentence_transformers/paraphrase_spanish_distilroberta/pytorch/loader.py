...
"""
Sentence-Transformers paraphrase-spanish-distilroberta model loader
...
class ModelVariant(StrEnum):
    """Available model variants for paraphrase-spanish-distilroberta."""

    PARAPHRASE_SPANISH_DISTILROBERTA = (
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.PARAPHRASE_SPANISH_DISTILROBERTA: LLMModelConfig(
            pretrained_model_name="somosnlp-hackathon-2022/paraphrase-spanish-distilroberta",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.PARAPHRASE_SPANISH_DISTILROBERTA
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="paraphrase-spanish-distilroberta",
            variant=variant,
    ...
    def load_inputs(self, dtype_override=None, sentence=None):
        ...
        if sentence is None:
            sentence = "Este es un ejemplo de oración para similitud semántica."
