...
"""
Sentence-Transformers msmarco-distilbert-base-v3 model loader
...
class ModelVariant(StrEnum):
    """Available model variants for msmarco-distilbert-base-v3."""

    MSMARCO_DISTILBERT_BASE_V3 = "sentence-transformers/msmarco-distilbert-base-v3"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.MSMARCO_DISTILBERT_BASE_V3: LLMModelConfig(
            pretrained_model_name="sentence-transformers/msmarco-distilbert-base-v3",
            max_length=512,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MSMARCO_DISTILBERT_BASE_V3
