...
"""
Sentence-Transformers sbert-jsnli-luke-japanese-base-lite model loader
...
class ModelVariant(StrEnum):
    """Available model variants for sbert-jsnli-luke-japanese-base-lite."""

    SBERT_JSNLI_LUKE_JAPANESE_BASE_LITE = "oshizo/sbert-jsnli-luke-japanese-base-lite"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.SBERT_JSNLI_LUKE_JAPANESE_BASE_LITE: LLMModelConfig(
            pretrained_model_name="oshizo/sbert-jsnli-luke-japanese-base-lite",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SBERT_JSNLI_LUKE_JAPANESE_BASE_LITE
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="sbert-jsnli-luke-japanese-base-lite",
            variant=variant,
