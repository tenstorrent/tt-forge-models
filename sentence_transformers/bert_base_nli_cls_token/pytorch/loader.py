...
"""
Sentence-Transformers bert-base-nli-cls-token model loader
...
class ModelVariant(StrEnum):
    """Available model variants for bert-base-nli-cls-token."""

    BERT_BASE_NLI_CLS_TOKEN = "sentence-transformers/bert-base-nli-cls-token"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BERT_BASE_NLI_CLS_TOKEN: LLMModelConfig(
            pretrained_model_name="sentence-transformers/bert-base-nli-cls-token",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BERT_BASE_NLI_CLS_TOKEN
