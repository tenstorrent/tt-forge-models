...
"""
Muennighoff/SBERT-base-nli-v2 sentence transformer model loader
...
class ModelVariant(StrEnum):
    """Available model variants for SBERT-base-nli-v2."""

    SBERT_BASE_NLI_V2 = "Muennighoff/SBERT-base-nli-v2"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.SBERT_BASE_NLI_V2: LLMModelConfig(
            pretrained_model_name="Muennighoff/SBERT-base-nli-v2",
            max_length=75,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SBERT_BASE_NLI_V2
