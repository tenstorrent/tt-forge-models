...
"""
Sambert Hebrew sentence transformer model loader
...
class ModelVariant(StrEnum):
    """Available model variants for Sambert."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.SAMBERT: LLMModelConfig(
            pretrained_model_name="MPA/sambert",
            max_length=512,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SAMBERT
