...
class ModelVariant(StrEnum):
    """Available model variants for xlm-r-100langs-bert-base-nli-stsb-mean-tokens."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.XLM_R_100LANGS_BERT_BASE_NLI_STSB_MEAN_TOKENS: LLMModelConfig(
            pretrained_model_name="sentence-transformers/xlm-r-100langs-bert-base-nli-stsb-mean-tokens",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.XLM_R_100LANGS_BERT_BASE_NLI_STSB_MEAN_TOKENS
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="xlm-r-100langs-bert-base-nli-stsb-mean-tokens",
            variant=variant,
