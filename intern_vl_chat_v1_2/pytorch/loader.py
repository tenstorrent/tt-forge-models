...
"""
InternVL-Chat-V1-2 model loader implementation for multimodal visual question answering.
"""
...
def build_transform(input_size):
    """Build image transform pipeline for InternVL-Chat-V1-2."""
    return T.Compose(
        [
...
def load_image(image_path, input_size=448, max_num=12):
    """Load and preprocess an image for InternVL-Chat-V1-2."""
...
class ModelVariant(StrEnum):
    """Available InternVL-Chat-V1-2 model variants."""

    INTERN_VL_CHAT_V1_2 = "V1_2"


class ModelLoader(ForgeModel):
    """InternVL-Chat-V1-2 model loader implementation for multimodal visual question answering tasks."""

    _VARIANTS = {
        ModelVariant.INTERN_VL_CHAT_V1_2: ModelConfig(
            pretrained_model_name="OpenGVLab/InternVL-Chat-V1-2",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.INTERN_VL_CHAT_V1_2
