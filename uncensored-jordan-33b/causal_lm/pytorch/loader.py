...
"""Uncensored Jordan 33b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ajibawa-2023/Uncensored-Jordan-33B",
            max_length=128,
        ),
    }
