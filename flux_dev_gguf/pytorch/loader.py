...
# Standard FLUX.1-dev transformer architecture config (guidance_embeds=True for dev).
_TRANSFORMER_CONFIG = {
...
class ModelLoader(ForgeModel):
    """FLUX.1-dev GGUF model loader implementation for text-to-image generation tasks."""
    ...
    def _make_local_config_dir(self):
        """Materialise a transformer/config.json so from_single_file can find it."""
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        # Guidance (FLUX.1-dev uses classifier-free guidance unlike schnell)
