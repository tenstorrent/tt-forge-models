...
"""
GPT-OSS 20B HESOYAM 1108 WIP CHATML i1 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available GPT-OSS 20B HESOYAM 1108 WIP CHATML i1 GGUF model variants for causal language modeling."""

    GPT_OSS_20B_HESOYAM_1108_WIP_CHATML_I1_GGUF = "20B_HESOYAM_1108_WIP_CHATML_i1_GGUF"


class ModelLoader(ForgeModel):
    """GPT-OSS 20B HESOYAM 1108 WIP CHATML i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GPT_OSS_20B_HESOYAM_1108_WIP_CHATML_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/GPT-OSS-20B-HESOYAM-1108-WIP-CHATML-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GPT_OSS_20B_HESOYAM_1108_WIP_CHATML_I1_GGUF

    GGUF_FILE = "GPT-OSS-20B-HESOYAM-1108-WIP-CHATML.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="GPT-OSS 20B HESOYAM 1108 WIP CHATML i1 GGUF",
            variant=variant,
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        # The tokenizer has added special tokens (<|im_start|>, <|im_end|>) with IDs
        # beyond the base vocab_size. Resize the embedding table to cover them.
