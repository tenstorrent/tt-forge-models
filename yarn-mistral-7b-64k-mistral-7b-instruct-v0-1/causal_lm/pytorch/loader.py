...
"""Yarn Mistral 7b 64k Mistral 7b Instruct V0 1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="MaziyarPanahi/Yarn-Mistral-7b-64k-Mistral-7B-Instruct-v0.1",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Yarn Mistral 7b 64k Mistral 7b Instruct V0 1",
