...
"""Phi4 Mini Instruct Npu2 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="FastFlowLM/Phi4-mini-Instruct-NPU2",
            max_length=128,
        ),
    }
