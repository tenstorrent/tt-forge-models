...
"""Tablebeluga 7b Instruct Pl Lora Unload model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Lajonbot/tableBeluga-7B-instruct-pl-lora_unload",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Tablebeluga 7b Instruct Pl Lora Unload",
