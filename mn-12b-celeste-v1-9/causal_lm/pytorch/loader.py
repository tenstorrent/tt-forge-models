...
"""Mn 12b Celeste V1 9 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="nothingiisreal/MN-12B-Celeste-V1.9",
            max_length=128,
        ),
    }
