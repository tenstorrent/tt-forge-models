...
"""
mradermacher/NuMarkdown-8B-Thinking-GGUF model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    """Available NuMarkdown-8B-Thinking-GGUF model variants for causal language modeling."""

    NUMARKDOWN_8B_THINKING_GGUF = "8B_Thinking_GGUF"


class ModelLoader(ForgeModel):
    """NuMarkdown-8B-Thinking-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.NUMARKDOWN_8B_THINKING_GGUF: LLMModelConfig(
            pretrained_model_name="numind/NuMarkdown-8B-Thinking",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.NUMARKDOWN_8B_THINKING_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher NuMarkdown-8B-Thinking-GGUF",
            variant=variant,
