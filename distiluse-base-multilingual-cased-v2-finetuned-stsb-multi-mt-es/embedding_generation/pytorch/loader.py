...
"""Distiluse Base Multilingual Cased V2 Finetuned Stsb Multi Mt Es model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="mrm8488/distiluse-base-multilingual-cased-v2-finetuned-stsb_multi_mt-es",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Distiluse Base Multilingual Cased V2 Finetuned Stsb Multi Mt Es",
