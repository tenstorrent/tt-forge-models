...
"""Frugalscore Medium Roberta Bert Score model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="moussaKam/frugalscore_medium_roberta_bert-score",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Frugalscore Medium Roberta Bert Score",
