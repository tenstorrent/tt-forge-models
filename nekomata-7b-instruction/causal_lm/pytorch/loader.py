...
"""Nekomata 7b Instruction model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="rinna/nekomata-7b-instruction",
            max_length=128,
        ),
    }
