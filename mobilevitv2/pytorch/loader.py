...
"""
MobileViTv2 model loader implementation
"""
...
@dataclass
class MobileViTv2Config(ModelConfig):
    """Configuration specific to MobileViTv2 models"""
...
class ModelVariant(StrEnum):
    ...
    V0_75_CVNETS_IN1K = "0.75_cvnets_in1k"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.V0_75_CVNETS_IN1K: MobileViTv2Config(
            pretrained_model_name="hf_hub:timm/mobilevitv2_075.cvnets_in1k",
            source=ModelSource.TIMM,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.V1_0_IMAGENET1K_256
