...
class ModelVariant(StrEnum):
    """Available Baguettotron model variants for causal language modeling."""

    BAGUETTOTRON = "baguettotron"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BAGUETTOTRON: LLMModelConfig(
            pretrained_model_name="PleIAs/Baguettotron",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BAGUETTOTRON
