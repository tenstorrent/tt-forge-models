...
"""
Arctic model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available Arctic model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE: LLMModelConfig(
            pretrained_model_name="Snowflake/snowflake-arctic-base",
        ),
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        model = AutoEasyDeLModelForCausalLM.from_pretrained(
            self._model_name, partition_rules=partition_rules, trust_remote_code=True, **model_kwargs
        )
    ...
    def load_parameters_partition_spec(
        ...
        if (
            ...
            from easydel.modules.arctic import ArcticConfig

            arctic_config = ArcticConfig()
            partition_rules = arctic_config.get_partition_rules()
