...
from third_party.tt_forge_models.uniad.pytorch.src.track_utils import LiDARInstance3DBoxes
            ...
            [
                {
                    ...
                    "lidar2img": [
                        np.random.randn(4, 4).astype(np.float32) * 500 for _ in range(6)
                    ],
                    "box_type_3d": LiDARInstance3DBoxes,
                    "sample_idx": "3e8750f331d7499e9b5123e9eb70f2e2",
                    "scene_token": "fcbccedd61424f1b85dcbf8f897f9754",
                    "can_bus": np.random.randn(18).astype(np.float64) * 300,
                }
            ]
        ]
