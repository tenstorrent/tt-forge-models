...
"""Shearedplats 2 7b V1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="vihangd/shearedplats-2.7b-v1",
            max_length=128,
        ),
    }
