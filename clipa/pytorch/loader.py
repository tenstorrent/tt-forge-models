...
"""
CLIPA model loader implementation for image-text similarity using OpenCLIP.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available CLIPA model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.VIT_L_14_DATACOMP1B: ModelConfig(
            pretrained_model_name="hf-hub:UCSC-VLAA/ViT-L-14-CLIPA-datacomp1B",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.VIT_L_14_DATACOMP1B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the CLIPA model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The CLIPA model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the CLIPA model.
    ...
    def post_process(self, outputs):
        """Post-process CLIPA model outputs to extract similarity scores.
