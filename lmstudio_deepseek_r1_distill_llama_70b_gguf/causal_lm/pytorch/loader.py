...
"""
lmstudio-community/DeepSeek-R1-Distill-Llama-70B-GGUF model loader implementation for causal language modeling.
"""
import importlib.metadata

# The primary data partition is full; redirect large GGUF downloads to tmpfs.
_GGUF_CACHE_DIR = "/tmp/hf_cache_lmstudio_deepseek_r1_70b"
...
class ModelVariant(StrEnum):
    """Available lmstudio-community DeepSeek R1 Distill Llama 70B GGUF variants for causal language modeling."""

    DEEPSEEK_R1_DISTILL_LLAMA_70B_GGUF = "DeepSeek_R1_Distill_Llama_70B_GGUF"


class ModelLoader(ForgeModel):
    """lmstudio-community DeepSeek R1 Distill Llama 70B GGUF model loader for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.DEEPSEEK_R1_DISTILL_LLAMA_70B_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="lmstudio DeepSeek R1 Distill Llama 70B GGUF",
            variant=variant,
