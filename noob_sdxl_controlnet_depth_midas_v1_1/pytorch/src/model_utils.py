...
"""
Helper functions for Noob SDXL ControlNet Depth Midas v1-1 model loading and processing.
"""
...
def load_controlnet_depth_pipe(controlnet_model_name, base_model_name):
