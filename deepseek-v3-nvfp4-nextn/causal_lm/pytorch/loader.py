...
"""Deepseek V3 Nvfp4 Nextn model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="shaurya0/DeepSeek-V3-NVFP4-NextN",
            max_length=128,
        ),
    }
