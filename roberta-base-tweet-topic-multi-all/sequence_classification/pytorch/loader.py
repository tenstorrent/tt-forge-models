...
"""Roberta Base Tweet Topic Multi All model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="cardiffnlp/roberta-base-tweet-topic-multi-all",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Roberta Base Tweet Topic Multi All",
