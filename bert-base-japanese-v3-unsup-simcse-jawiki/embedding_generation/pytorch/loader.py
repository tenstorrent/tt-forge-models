...
"""Bert Base Japanese V3 Unsup Simcse Jawiki model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="llm-book/bert-base-japanese-v3-unsup-simcse-jawiki",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert Base Japanese V3 Unsup Simcse Jawiki",
