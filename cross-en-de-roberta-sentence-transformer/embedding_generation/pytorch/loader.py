...
"""Cross En De Roberta Sentence Transformer model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="T-Systems-onsite/cross-en-de-roberta-sentence-transformer",
        ),
    }
