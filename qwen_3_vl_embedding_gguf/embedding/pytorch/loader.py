...
class ModelLoader(ForgeModel):
    ...
    _BASE_MODELS = {
        ModelVariant.QWEN_3_VL_EMBEDDING_8B_Q4_K_M: "Qwen/Qwen3-VL-Embedding-8B",
    }
    ...
    def _base_model(self):
        """Get the base (non-GGUF) model name for tokenizer and config loading."""
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        model = AutoModel.from_pretrained(
            self._base_model, trust_remote_code=True, **model_kwargs
        )
        model.eval()
        self.model = model
