...
"""Phi 4 Unsloth Bnb 4bit model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="unsloth/phi-4-unsloth-bnb-4bit",
            max_length=128,
        ),
    }
