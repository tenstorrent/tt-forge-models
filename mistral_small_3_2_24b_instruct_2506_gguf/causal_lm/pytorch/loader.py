...
class ModelLoader(ForgeModel):
    """Mistral Small 3.2 24B Instruct 2506 GGUF model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.MISTRAL_SMALL_3_2_24B_INSTRUCT_2506_Q4_K_M
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Mistral Small 3.2 24B Instruct 2506 GGUF",
            variant=variant,
