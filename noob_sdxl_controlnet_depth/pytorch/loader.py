...
"""
Noob SDXL ControlNet Depth model loader implementation
"""
...
class ModelVariant(StrEnum):
    """Available Noob SDXL ControlNet Depth model variants."""

    NOOB_SDXL_CONTROLNET_DEPTH = "Noob_SDXL_ControlNet_Depth"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.NOOB_SDXL_CONTROLNET_DEPTH: ModelConfig(
            pretrained_model_name="Eugeoter/noob-sdxl-controlnet-depth",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.NOOB_SDXL_CONTROLNET_DEPTH
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Noob SDXL ControlNet Depth",
            variant=variant,
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        self.pipeline = load_controlnet_depth_pipe(
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the ControlNet Depth SDXL UNet.
        ...
        Returns:
            dict: Keyword arguments for the UNet forward method:
                ...
                - down_block_additional_residuals (tuple): ControlNet residuals
