...
"""Falcon H1 Tiny Multilingual 100m Instruct model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="tiiuae/Falcon-H1-Tiny-Multilingual-100M-Instruct",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Falcon H1 Tiny Multilingual 100m Instruct",
