...
"""Bclm 1 Small Preview model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="bcml/bclm-1-small-preview",
            max_length=128,
        ),
    }
