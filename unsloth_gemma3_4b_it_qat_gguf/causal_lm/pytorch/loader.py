...
"""
Unsloth Gemma 3 4B IT QAT GGUF model loader implementation for causal language modeling.
"""
import importlib
import sys
...
class ModelVariant(StrEnum):
    """Available Unsloth Gemma 3 4B IT QAT GGUF model variants for causal language modeling."""

    UNSLOTH_GEMMA_3_4B_IT_QAT_GGUF = "4B_IT_QAT_GGUF"


class ModelLoader(ForgeModel):
    """Unsloth Gemma 3 4B IT QAT GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.UNSLOTH_GEMMA_3_4B_IT_QAT_GGUF: LLMModelConfig(
            pretrained_model_name="unsloth/gemma-3-4b-it-qat-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.UNSLOTH_GEMMA_3_4B_IT_QAT_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Unsloth Gemma 3 4B IT QAT GGUF",
            variant=variant,
