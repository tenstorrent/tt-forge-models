...
"""T5 Recipe Generation model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="flax-community/t5-recipe-generation",
            max_length=128,
        ),
    }
