...
"""
Gemma 3 MLX model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Gemma 3 MLX model variants for causal language modeling."""

    GEMMA_3_270M_IT_MLX_8BIT = "270M_IT_MLX_8bit"


class ModelLoader(ForgeModel):
    """Gemma 3 MLX model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.GEMMA_3_270M_IT_MLX_8BIT
