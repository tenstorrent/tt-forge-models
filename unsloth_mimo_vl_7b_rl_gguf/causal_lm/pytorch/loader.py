...
"""
unsloth/MiMo-VL-7B-RL-GGUF model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    """Available unsloth/MiMo-VL-7B-RL-GGUF model variants for causal language modeling."""

    MIMO_VL_7B_RL_GGUF = "MiMo_VL_7B_RL_GGUF"


class ModelLoader(ForgeModel):
    """unsloth/MiMo-VL-7B-RL-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.MIMO_VL_7B_RL_GGUF: LLMModelConfig(
            pretrained_model_name="XiaomiMiMo/MiMo-VL-7B-RL",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MIMO_VL_7B_RL_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="unsloth MiMo-VL-7B-RL-GGUF",
            variant=variant,
