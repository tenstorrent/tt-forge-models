...
"""
TinyLlama 1.1B Chat v0.4 Q4F16_1 MLC model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available TinyLlama 1.1B Chat v0.4 Q4F16_1 MLC model variants."""

    TINYLLAMA_1_1B_CHAT_V0_4_Q4F16_1_MLC = "tinyllama_1_1b_chat_v0_4_q4f16_1_mlc"


class ModelLoader(ForgeModel):
    """TinyLlama 1.1B Chat v0.4 Q4F16_1 MLC model loader for causal language modeling."""
    ...
    DEFAULT_VARIANT = ModelVariant.TINYLLAMA_1_1B_CHAT_V0_4_Q4F16_1_MLC
