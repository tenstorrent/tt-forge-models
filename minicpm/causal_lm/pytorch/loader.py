...
"""
MiniCPM model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available MiniCPM model variants."""

    MINICPM_1B_SFT_BF16 = "1B-sft-bf16"


class ModelLoader(ForgeModel):
    """MiniCPM model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MINICPM_1B_SFT_BF16: LLMModelConfig(
            pretrained_model_name="openbmb/MiniCPM-1B-sft-bf16",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MINICPM_1B_SFT_BF16
