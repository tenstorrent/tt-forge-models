...
"""Lamarck 14b V0 7 Fusion model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="sometimesanotion/Lamarck-14B-v0.7-Fusion",
            max_length=128,
        ),
    }
