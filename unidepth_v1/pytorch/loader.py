...
"""
UniDepth V1 model loader implementation for monocular metric depth estimation.
"""
...
class UniDepthV1Wrapper(nn.Module):
    """Wrapper around UniDepthV1 that takes a preprocessed image tensor
...
@dataclass
class UniDepthV1Config(ModelConfig):
    """Configuration specific to UniDepth V1 models"""

    source: ModelSource


class ModelVariant(StrEnum):
    """Available UniDepth V1 model variants."""

    VIT_L14 = "ViT-L14"


class ModelLoader(ForgeModel):
    """UniDepth V1 model loader implementation."""

    _VARIANTS = {
        ModelVariant.VIT_L14: UniDepthV1Config(
            pretrained_model_name="lpiccinelli/unidepth-v1-vitl14",
