...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.SQLCODER_7B_2
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the SQLCoder model instance with default settings.
        ...
        Returns:
            torch.nn.Module: The SQLCoder model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the SQLCoder model with default settings.
        ...
        text = (
            "### Task\n"
            "Generate a SQL query to answer [QUESTION]How many users signed up last month?[/QUESTION]\n\n"
            "### Database Schema\n"
            ...
            "[QUESTION]How many users signed up last month?[/QUESTION]\n"
            "[SQL]\n"
        )
