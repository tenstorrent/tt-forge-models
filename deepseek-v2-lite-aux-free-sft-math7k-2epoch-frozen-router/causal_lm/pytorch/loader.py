...
"""Deepseek V2 Lite Aux Free Sft Math7k 2epoch Frozen Router model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="xd2010/DeepSeek-V2-Lite-aux-free-sft-math7k-2epoch-frozen-router",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Deepseek V2 Lite Aux Free Sft Math7k 2epoch Frozen Router",
