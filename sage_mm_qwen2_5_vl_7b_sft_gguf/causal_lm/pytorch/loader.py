...
"""
mradermacher/SAGE-MM-Qwen2.5-VL-7B-SFT-GGUF model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    """Available SAGE-MM-Qwen2.5-VL-7B-SFT-GGUF model variants for causal language modeling."""

    SAGE_MM_QWEN2_5_VL_7B_SFT_GGUF = "7B_SFT_GGUF"


class ModelLoader(ForgeModel):
    """SAGE-MM-Qwen2.5-VL-7B-SFT-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.SAGE_MM_QWEN2_5_VL_7B_SFT_GGUF: LLMModelConfig(
            pretrained_model_name="allenai/SAGE-MM-Qwen2.5-VL-7B-SFT",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SAGE_MM_QWEN2_5_VL_7B_SFT_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher SAGE-MM-Qwen2.5-VL-7B-SFT-GGUF",
            variant=variant,
