...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.VIRE_PROTOCOL_70B_I1_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/vire-protocol-70b-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.VIRE_PROTOCOL_70B_I1_Q4_K_M_GGUF

    GGUF_FILE = "vire-protocol-70b.i1-Q4_K_M.gguf"
