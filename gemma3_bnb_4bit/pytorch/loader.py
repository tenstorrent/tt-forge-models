...
class ModelLoader(ForgeModel):
    """Gemma 3 BNB 4-bit model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.GEMMA_3_1B_IT_UNSLOTH_BNB_4BIT
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Gemma 3 BNB 4-bit model instance.
    ...
    def load_inputs(
        ...
        if self.tokenizer.chat_template is not None:
            input_prompt = [{"role": "user", "content": input_text}]
