...
"""Pythia 6 9b Deduped Synthetic Instruct model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="lambda/pythia-6.9b-deduped-synthetic-instruct",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Pythia 6 9b Deduped Synthetic Instruct",
