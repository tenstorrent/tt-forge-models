...
"""
CPM-Generate model loader implementation for Chinese causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available CPM-Generate model variants."""

    BASE = "Default"


class ModelLoader(ForgeModel):
    """CPM-Generate model loader for Chinese causal language modeling."""

    _VARIANTS = {
        ModelVariant.BASE: LLMModelConfig(
            pretrained_model_name="TsinghuaAI/CPM-Generate",
            max_length=256,
        ),
    }
