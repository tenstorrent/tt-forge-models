...
"""Relik Reader Deberta V3 Base Aida model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="sapienzanlp/relik-reader-deberta-v3-base-aida",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Relik Reader Deberta V3 Base Aida",
