...
"""Gpt2 Turkish 128 Token model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="cenkersisman/gpt2-turkish-128-token",
            max_length=128,
        ),
    }
