...
"""Sapbert From Roberta Base Biomedical Clinical Es model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="BSC-NLP4BIA/SapBERT-from-roberta-base-biomedical-clinical-es",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sapbert From Roberta Base Biomedical Clinical Es",
