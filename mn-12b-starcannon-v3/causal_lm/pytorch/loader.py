...
"""Mn 12b Starcannon V3 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="AuriAetherwiing/MN-12B-Starcannon-v3",
            max_length=128,
        ),
    }
