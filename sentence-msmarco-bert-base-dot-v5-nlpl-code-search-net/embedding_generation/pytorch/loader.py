...
"""Sentence Msmarco Bert Base Dot V5 Nlpl Code Search Net model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="krlvi/sentence-msmarco-bert-base-dot-v5-nlpl-code_search_net",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sentence Msmarco Bert Base Dot V5 Nlpl Code Search Net",
