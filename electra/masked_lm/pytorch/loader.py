...
"""
ELECTRA model loader implementation for masked language modeling.
"""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.KR_ELECTRA_GENERATOR: LLMModelConfig(
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        model = ElectraForMaskedLM.from_pretrained(self.model_name, **model_kwargs)
        model.eval()
        return model
