...
# NOTE (tt-forge bringup): single-device vendored copy. The upstream
# context-parallel split (cp_split_hw[0]*cp_split_hw[1] > 1) is never taken
# here, so the torch.distributed-backed import is dropped.
