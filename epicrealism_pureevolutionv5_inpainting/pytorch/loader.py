...
class ModelVariant(StrEnum):
    """Available epiCRealism pureEvolution V5 Inpainting model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.INPAINTING: ModelConfig(
            pretrained_model_name="redstonehero/epicrealism_pureevolutionv5-inpainting",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.INPAINTING

    prompt = "a photo of a cozy living room with a fireplace"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="epiCRealism pureEvolution V5 Inpainting",
            variant=variant,
