...
try:
    ...
    LanguageBindImageConfig = (
        LanguageBindImage
    ) = LanguageBindImageTokenizer = LanguageBindImageProcessor = None
...
try:
    ...
    LanguageBindVideoConfig = (
        LanguageBindVideo
    ) = LanguageBindVideoTokenizer = LanguageBindVideoProcessor = None
...
try:
    ...
    LanguageBindDepthConfig = (
        LanguageBindDepth
    ) = LanguageBindDepthTokenizer = LanguageBindDepthProcessor = None
...
try:
    ...
    LanguageBindThermalConfig = (
        LanguageBindThermal
    ) = LanguageBindThermalTokenizer = LanguageBindThermalProcessor = None
