...
"""
EVA-02 CLIP model loader implementation for image-text similarity using OpenCLIP.
"""
import torch
...
class ModelLoader(ForgeModel):
    """EVA-02 CLIP model loader using OpenCLIP for image-text similarity tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.EVA02_L_14_336
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the EVA-02 CLIP model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The EVA-02 CLIP model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the EVA-02 CLIP model.
    ...
    def post_process(self, outputs):
        """Post-process EVA-02 CLIP model outputs to extract similarity scores.
