...
"""Roberta Base Indonesian 1 5g Sentiment Analysis Smsa model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="ayameRushia/roberta-base-indonesian-1.5G-sentiment-analysis-smsa",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Roberta Base Indonesian 1 5g Sentiment Analysis Smsa",
