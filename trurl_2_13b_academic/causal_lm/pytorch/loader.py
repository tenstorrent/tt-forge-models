...
class ModelVariant(StrEnum):
    """Available Voicelab Trurl-2-13b-academic model variants for causal language modeling."""

    TRURL_2_13B_ACADEMIC = "2-13b-academic"


class ModelLoader(ForgeModel):
    """Voicelab Trurl-2-13b-academic model loader implementation for causal language modeling tasks."""
