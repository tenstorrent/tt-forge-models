...
"""Redpajama Incite Instruct 3b V1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="togethercomputer/RedPajama-INCITE-Instruct-3B-v1",
            max_length=128,
        ),
    }
