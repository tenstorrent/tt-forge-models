...
class ModelLoader(ForgeModel):
    """lmstudio-community Qwen 2.5 Coder 1.5B Instruct GGUF model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_2_5_CODER_1_5B_INSTRUCT_GGUF: LLMModelConfig(
            pretrained_model_name="lmstudio-community/Qwen2.5-Coder-1.5B-Instruct-GGUF",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="lmstudio Qwen 2.5 Coder 1.5B Instruct GGUF",
            variant=variant,
