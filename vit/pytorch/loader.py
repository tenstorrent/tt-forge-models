...
class ModelVariant(StrEnum):
    ...
    VIT_BASE_BEANS = "Base_Beans"

    # TIMM variants
    VIT_BASE_PATCH14_DINOV2_LVD142M = "Base_Patch14_DINOv2_LVD142M"
    VIT_GIANT_PATCH14_DINOV2_LVD142M = "Giant_Patch14_DINOv2_LVD142M"
    ...
    VIT_LARGE_PATCH32_224_ORIG_IN21K = "Large_Patch32_224_Orig_IN21K"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.VIT_BASE_BEANS: ViTConfig(
            pretrained_model_name="nateraw/vit-base-beans",
            source=ModelSource.HUGGING_FACE,
        ),
        # Torchvision variants
        ...
        ModelVariant.VIT_GIANT_PATCH14_DINOV2_LVD142M: ViTConfig(
            pretrained_model_name="vit_giant_patch14_dinov2.lvd142m",
            source=ModelSource.TIMM,
        ),
        ...
        ModelVariant.VIT_LARGE_PATCH32_224_ORIG_IN21K: ViTConfig(
            pretrained_model_name="vit_large_patch32_224.orig_in21k",
            source=ModelSource.TIMM,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        if variant == ModelVariant.TINY:
            ...
            group = ModelGroup.VULCAN
        elif variant == ModelVariant.VIT_BASE_BEANS:
            group = ModelGroup.VULCAN
