...
class ModelVariant(StrEnum):
    ...
    VIT_LARGE_PATCH16_384_AUGREG_IN21K_FT_IN1K = (
        "Large_Patch16_384_AugReg_IN21K_FT_IN1K"
    )
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.VIT_LARGE_PATCH16_384_AUGREG_IN21K_FT_IN1K: ViTConfig(
            pretrained_model_name="vit_large_patch16_384.augreg_in21k_ft_in1k",
            source=ModelSource.TIMM,
        ),
    }
