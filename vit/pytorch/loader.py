...
class ModelVariant(StrEnum):
    ...
    VIT_SMALL_PATCH32_224_AUGREG_IN21K_FT_IN1K = (
        "Small_Patch32_224_AugReg_IN21K_FT_IN1K"
    )
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.VIT_SMALL_PATCH32_224_AUGREG_IN21K_FT_IN1K: ViTConfig(
            pretrained_model_name="vit_small_patch32_224.augreg_in21k_ft_in1k",
            source=ModelSource.TIMM,
        ),
    }
