...
"""Vicuna 13b Cocktail model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="reeducator/vicuna-13b-cocktail",
            max_length=128,
        ),
    }
