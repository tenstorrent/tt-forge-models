...
"""Gpt2 Text Simplification 1e4 Adafactor Biendata model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Smaraa/gpt2-text-simplification_1e4_adafactor_biendata",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Gpt2 Text Simplification 1e4 Adafactor Biendata",
