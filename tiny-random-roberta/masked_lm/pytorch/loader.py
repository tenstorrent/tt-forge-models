...
"""Tiny Random Roberta model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="optimum-intel-internal-testing/tiny-random-roberta",
            max_length=128,
        ),
    }
