...
"""
Qwen 3.5 27B Claude Opus Distilled model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Qwen 3.5 Opus Distilled model variants for causal language modeling."""

    QWEN_3_5_27B_OPUS_DISTILLED = "27B_OPUS_DISTILLED"


class ModelLoader(ForgeModel):
    """Qwen 3.5 27B Claude Opus Distilled model loader for causal language modeling tasks."""

    # Dictionary of available model variants using structured configs
    _VARIANTS = {
        ModelVariant.QWEN_3_5_27B_OPUS_DISTILLED: LLMModelConfig(
            pretrained_model_name="Jackrong/Qwen3.5-27B-Claude-4.6-Opus-Reasoning-Distilled",
            max_length=128,
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.QWEN_3_5_27B_OPUS_DISTILLED
