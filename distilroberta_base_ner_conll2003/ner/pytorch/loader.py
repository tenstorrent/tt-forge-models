...
"""
DistilRoBERTa Base NER CoNLL2003 model loader implementation for named entity recognition.
"""
...
class ModelVariant(StrEnum):
    """Available DistilRoBERTa Base NER CoNLL2003 model variants."""

    DISTILROBERTA_BASE_NER_CONLL2003 = "philschmid/distilroberta-base-ner-conll2003"


class ModelLoader(ForgeModel):
    """DistilRoBERTa Base NER CoNLL2003 model loader implementation."""
    ...
    def __init__(self, variant=None):
        ...
        self.sample_text = "My name is Philipp and live in Germany"
    ...
    def _get_model_info(cls, variant_name=None):
        if variant_name is None:
            variant_name = "base"
        return ModelInfo(
            model="DistilRoBERTa_Base_NER_CoNLL2003",
