...
"""Tiny Distilbert Base Uncased Finetuned Sst 2 English model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="sshleifer/tiny-distilbert-base-uncased-finetuned-sst-2-english",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Tiny Distilbert Base Uncased Finetuned Sst 2 English",
