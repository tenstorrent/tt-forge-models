...
"""Sentence Transformers Experimental Hubert Hungarian model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="NYTK/sentence-transformers-experimental-hubert-hungarian",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sentence Transformers Experimental Hubert Hungarian",
