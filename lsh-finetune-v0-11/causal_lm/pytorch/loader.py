...
"""Lsh Finetune V0 11 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="dltjdgh0928/lsh_finetune_v0.11",
            max_length=128,
        ),
    }
