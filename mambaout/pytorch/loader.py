...
class ModelVariant(StrEnum):
    """Available MambaOut model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE_IN1K: ModelConfig(
            pretrained_model_name="hf_hub:timm/mambaout_base.in1k",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BASE_IN1K
