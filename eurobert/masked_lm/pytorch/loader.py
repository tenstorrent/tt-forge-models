...
"""
EuroBERT model loader implementation for masked language modeling.
"""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.EUROBERT_210M
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load EuroBERT model for masked language modeling from Hugging Face.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The EuroBERT model instance.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Prepare sample input for EuroBERT masked language modeling.
    ...
    def load_config(self):
        """Load and return the configuration for the EuroBERT model variant.

        Returns:
            The configuration object for the EuroBERT model.
        """
