...
"""
Sylent/GPT-OSS-Swallow-120B-RL-MXFP4 model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Sylent GPT-OSS-Swallow 120B RL MXFP4 model variants."""

    GPT_OSS_SWALLOW_120B_RL_MXFP4 = "120B_RL_MXFP4"


class ModelLoader(ForgeModel):
    """Sylent GPT-OSS-Swallow 120B RL MXFP4 model loader for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.GPT_OSS_SWALLOW_120B_RL_MXFP4
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sylent-GPT-OSS-Swallow-120B-RL-MXFP4",
            variant=variant,
    ...
    def get_mesh_config(self, num_devices: int):
        if num_devices == 32:  # Galaxy
            ...
            raise ValueError(
                "Sylent GPT-OSS-Swallow 120B RL MXFP4 is only supported on llmbox and galaxy"
            )
