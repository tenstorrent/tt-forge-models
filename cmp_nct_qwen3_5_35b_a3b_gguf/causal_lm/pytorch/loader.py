...
"""
CMP-NCT Qwen3.5 35B A3B GGUF model loader for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    ...
    QWEN3_5_35B_A3B_UD_Q4_K_M_GGUF = "35B_A3B_UD_Q4_K_M_GGUF"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.QWEN3_5_35B_A3B_UD_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="cmp-nct/Qwen3.5-35B-A3B-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN3_5_35B_A3B_UD_Q4_K_M_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="CMP-NCT Qwen3.5 35B A3B GGUF",
            variant=variant,
