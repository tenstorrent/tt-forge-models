...
"""
Xenova DistilBART CNN 6-6 model loader implementation for summarization.
"""
...
class ModelVariant(StrEnum):
    """Available Xenova DistilBART CNN 6-6 model variants for summarization."""
...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Xenova DistilBART CNN 6-6 model instance for this instance's variant.
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the Xenova DistilBART CNN 6-6 model with this instance's variant settings.
