...
"""Bert Large Nli Stsb Mean Tokens model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="sentence-transformers/bert-large-nli-stsb-mean-tokens",
        ),
    }
