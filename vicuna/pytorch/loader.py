...
"""
Vicuna causal LM model loader implementation.
"""
...
class ModelVariant(StrEnum):
    """Available Vicuna model variants for causal language modeling."""

    VICUNA_33B_V1_3 = "33B_v1.3"


class ModelLoader(ForgeModel):
    """Vicuna model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.VICUNA_33B_V1_3: LLMModelConfig(
            pretrained_model_name="lmsys/vicuna-33b-v1.3",
            max_length=128,
        )
    }

    DEFAULT_VARIANT = ModelVariant.VICUNA_33B_V1_3
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The Vicuna model for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        prompt = (
            ...
            f"USER: {self.sample_text} ASSISTANT:"
        )
