...
def _patch_gpt_oss_support():
    ...
    GPT-OSS-Swallow uses the same model architecture as Qwen3 MoE but the GGUF
...
class ModelVariant(StrEnum):
    """Available GPT-OSS-Swallow 20B SFT v0.1 MXFP4 MoE GGUF model variants for causal language modeling."""

    GPT_OSS_SWALLOW_20B_SFT_V0_1_MXFP4_MOE_GGUF = "20B_SFT_V0_1_MXFP4_MOE_GGUF"


class ModelLoader(ForgeModel):
    """GPT-OSS-Swallow 20B SFT v0.1 MXFP4 MoE GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GPT_OSS_SWALLOW_20B_SFT_V0_1_MXFP4_MOE_GGUF: LLMModelConfig(
            pretrained_model_name="sashisuseso/GPT-OSS-Swallow-20B-SFT-v0.1-MXFP4_MOE-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GPT_OSS_SWALLOW_20B_SFT_V0_1_MXFP4_MOE_GGUF

    GGUF_FILE = "GPT-OSS-Swallow-20B-SFT-v0.1-MXFP4_MOE.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="GPT-OSS-Swallow 20B SFT v0.1 MXFP4 MoE GGUF",
            variant=variant,
