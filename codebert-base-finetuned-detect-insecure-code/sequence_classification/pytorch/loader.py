...
"""Codebert Base Finetuned Detect Insecure Code model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="mrm8488/codebert-base-finetuned-detect-insecure-code",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Codebert Base Finetuned Detect Insecure Code",
