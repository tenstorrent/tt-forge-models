...
"""H2ogpt Research Oig Oasst1 512 30b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="h2oai/h2ogpt-research-oig-oasst1-512-30b",
            max_length=128,
        ),
    }
