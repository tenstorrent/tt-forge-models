...
"""Hermes Instruct 7b 100k model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="lodrick-the-lafted/Hermes-Instruct-7B-100K",
            max_length=128,
        ),
    }
