...
"""
cesarsal1nas Huihui Qwen3.5 35B A3B Abliterated Q4_K_M GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available cesarsal1nas Huihui Qwen3.5 35B A3B Abliterated Q4_K_M GGUF model variants for causal language modeling."""

    HUIHUI_QWEN_3_5_35B_A3B_ABLITERATED_Q4_K_M_GGUF = "35B_A3B_Abliterated_Q4_K_M_GGUF"


class ModelLoader(ForgeModel):
    """cesarsal1nas Huihui Qwen3.5 35B A3B Abliterated Q4_K_M GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.HUIHUI_QWEN_3_5_35B_A3B_ABLITERATED_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="cesarsal1nas/Huihui-Qwen3.5-35B-A3B-abliterated-Q4_K_M-GGUF",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="cesarsal1nas Huihui Qwen3.5 35B A3B Abliterated Q4_K_M GGUF",
            variant=variant,
