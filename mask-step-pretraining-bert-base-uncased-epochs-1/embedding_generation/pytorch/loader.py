...
"""Mask Step Pretraining Bert Base Uncased Epochs 1 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="AnonymousSub/mask_step_pretraining_bert-base-uncased_epochs_1",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Mask Step Pretraining Bert Base Uncased Epochs 1",
