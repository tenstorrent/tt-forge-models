...
"""Wav2vec2 Xls R 1b Lay41 model loader implementation for automatic speech recognition."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="kul-speech-lab/wav2vec2-xls-r-1b-lay41",
            max_length=30,
        ),
    }
