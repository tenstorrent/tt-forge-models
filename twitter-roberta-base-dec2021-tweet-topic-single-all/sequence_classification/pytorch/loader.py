...
"""Twitter Roberta Base Dec2021 Tweet Topic Single All model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="cardiffnlp/twitter-roberta-base-dec2021-tweet-topic-single-all",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Twitter Roberta Base Dec2021 Tweet Topic Single All",
