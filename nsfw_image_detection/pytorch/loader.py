...
"""
NSFW Image Detection model loader implementation
"""
...
@dataclass
class NsfwImageDetectionConfig(ModelConfig):
    """Configuration specific to NSFW Image Detection models"""
