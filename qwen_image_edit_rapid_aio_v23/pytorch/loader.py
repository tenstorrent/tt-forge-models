...
"""
Qwen-Image-Edit-Rapid-AIO-V23 model loader implementation.

Loads the distilled diffusion transformer from
prithivMLmods/Qwen-Image-Edit-Rapid-AIO-V23. This is a rapid (few-step)
variant of the Qwen Image Edit family optimised for fast inference.

Available variants:
- V23: Qwen-Image-Edit-Rapid-AIO-V23 (bf16)
"""
...
REPO_ID = "prithivMLmods/Qwen-Image-Edit-Rapid-AIO-V23"


class ModelVariant(StrEnum):
    """Available Qwen-Image-Edit-Rapid-AIO-V23 model variants."""

    V23 = "V23"


class ModelLoader(ForgeModel):
    """Qwen-Image-Edit-Rapid-AIO-V23 diffusion transformer loader."""

    _VARIANTS = {
        ModelVariant.V23: ModelConfig(
            pretrained_model_name=REPO_ID,
        ),
    }
    DEFAULT_VARIANT = ModelVariant.V23
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="QWEN_IMAGE_EDIT_RAPID_AIO_V23",
            variant=variant,
