...
"""
GPT-OSS MLX model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    ...
    GPT_OSS_20B_MLX_8BIT = "20B_MLX_8bit"


class ModelLoader(ForgeModel):
    """GPT-OSS MLX model loader implementation for causal language modeling tasks."""
    ...
    _VARIANTS = {
        ...
        ModelVariant.GPT_OSS_20B_MLX_8BIT: LLMModelConfig(
            pretrained_model_name="lmstudio-community/gpt-oss-20b-MLX-8bit",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GPT_OSS_120B_MLX_8BIT
