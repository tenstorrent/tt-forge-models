...
"""Pii Purespan Deberta V3 Base V2 512 50 model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="PuxAI/PII_PureSpan_DeBERTa_v3_base_v2_512_50",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Pii Purespan Deberta V3 Base V2 512 50",
