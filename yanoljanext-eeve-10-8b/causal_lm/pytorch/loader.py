...
"""Yanoljanext Eeve 10 8b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="yanolja/YanoljaNEXT-EEVE-10.8B",
            max_length=128,
        ),
    }
