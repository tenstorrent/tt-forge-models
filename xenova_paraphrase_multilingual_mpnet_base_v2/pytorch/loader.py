...
"""
Xenova/paraphrase-multilingual-mpnet-base-v2 model loader
...
class ModelVariant(StrEnum):
    """Available model variants for Xenova/paraphrase-multilingual-mpnet-base-v2."""

    XENOVA_PARAPHRASE_MULTILINGUAL_MPNET_BASE_V2 = (
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.XENOVA_PARAPHRASE_MULTILINGUAL_MPNET_BASE_V2: LLMModelConfig(
            pretrained_model_name="Xenova/paraphrase-multilingual-mpnet-base-v2",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.XENOVA_PARAPHRASE_MULTILINGUAL_MPNET_BASE_V2
