...
"""
Huihui Qwen3.5-4B abliterated model loader implementation for image to text.
"""
...
class ModelVariant(StrEnum):
    """Available Huihui Qwen3.5-4B abliterated model variants for image to text."""

    QWEN_3_5_4B_ABLITERATED = "4b_abliterated"


class ModelLoader(ForgeModel):
    """Huihui Qwen3.5-4B abliterated model loader for image to text tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_5_4B_ABLITERATED: LLMModelConfig(
            pretrained_model_name="huihui-ai/Huihui-Qwen3.5-4B-abliterated",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN_3_5_4B_ABLITERATED
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="huihui_qwen3_5_4b_abliterated",
            variant=variant,
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        # Suppress KV-cache output so the evaluator only sees Tensor leaves.
        # Qwen3_5DynamicCache is not a Tensor; torch.equal() on it raises TypeError.
