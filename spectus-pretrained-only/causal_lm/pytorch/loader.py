...
"""Spectus Pretrained Only model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="MS-ML/SpecTUS_pretrained_only",
            max_length=128,
        ),
    }
