...
"""Nanogpt Pretrained Slm Tinystories 124m model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="nishantup/nanogpt-pretrained-slm-tinystories-124m",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Nanogpt Pretrained Slm Tinystories 124m",
