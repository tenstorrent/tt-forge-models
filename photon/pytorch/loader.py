...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Photon v1 pipeline from Hugging Face.
        ...
        Returns:
            StableDiffusionPipeline: The pre-trained Photon v1 pipeline object.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample text prompts for the Photon v1 model.
