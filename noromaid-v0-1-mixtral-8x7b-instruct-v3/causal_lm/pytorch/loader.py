...
"""Noromaid V0 1 Mixtral 8x7b Instruct V3 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="NeverSleep/Noromaid-v0.1-mixtral-8x7b-Instruct-v3",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Noromaid V0 1 Mixtral 8x7b Instruct V3",
