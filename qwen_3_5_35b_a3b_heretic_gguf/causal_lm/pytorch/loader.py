...
class ModelVariant(StrEnum):
    """Available Qwen 3.5 35B-A3B Heretic GGUF model variants for causal language modeling."""

    QWEN_3_5_35B_A3B_HERETIC_GGUF = "35B_A3B_HERETIC_GGUF"


class ModelLoader(ForgeModel):
    """Qwen 3.5 35B-A3B Heretic GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_5_35B_A3B_HERETIC_GGUF: LLMModelConfig(
            pretrained_model_name="LeadFootThrottleCock/Qwen3.5-35B-A3B-heretic-GGUF",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Qwen 3.5 35B-A3B Heretic GGUF",
            variant=variant,
