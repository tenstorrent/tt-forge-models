...
"""Distilbert Base Uncased Finetuned Sst 2 English model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="distilbert/distilbert-base-uncased-finetuned-sst-2-english",
        ),
    }
