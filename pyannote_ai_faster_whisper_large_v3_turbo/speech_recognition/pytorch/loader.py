...
"""
pyannoteAI Faster Whisper Large V3 Turbo model loader implementation for speech recognition (ASR).

pyannoteAI/faster-whisper-large-v3-turbo is a CTranslate2 conversion of
openai/whisper-large-v3-turbo. Since CTranslate2 format is not compatible with
PyTorch, this loader uses the base OpenAI Whisper model via
WhisperForConditionalGeneration, which has numerically identical weights.
"""
...
class ModelVariant(StrEnum):
    """Available pyannoteAI Faster Whisper Large V3 Turbo model variants."""
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="pyannoteAI_Faster_Whisper_Large_V3_Turbo",
            variant=variant,
