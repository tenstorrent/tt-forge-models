...
"""Speechless Orca Platypus Coig Lite 2k 0 6e 13b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="uukuguy/speechless-orca-platypus-coig-lite-2k-0.6e-13b",
            max_length=128,
        ),
    }
