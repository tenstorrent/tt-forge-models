...
from third_party.tt_forge_models.detr3d.pytorch.src.bbox_coder import NMSFreeCoder
from third_party.tt_forge_models.detr3d.pytorch.src.transformer import Detr3DTransformer
from third_party.tt_forge_models.detr3d.pytorch.src.base_module import BaseModule
from third_party.tt_forge_models.detr3d.pytorch.src.transformer import inverse_sigmoid


class Detr3DHead(BaseModule, metaclass=ABCMeta):
    """Head of Detr3D.
    Args:
