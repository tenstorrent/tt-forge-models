...
from third_party.tt_forge_models.detr3d.object_detection.pytorch.src.detr import Detr3D
from third_party.tt_forge_models.detr3d.object_detection.pytorch.src.dataset import LiDARInstance3DBoxes
