...
from third_party.tt_forge_models.bevdepth.object_detection.pytorch.src.model import (
    BaseModule,
    Sequential,
    ConvModule,
    BasicBlock,
...
from third_party.tt_forge_models.bevformer.object_detection.pytorch.src.model import (
    ModuleList,
    Linear,
    xavier_init,
    constant_init,
