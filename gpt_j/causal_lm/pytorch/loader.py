...
class ModelLoader(ForgeModel):
    """GPT-J model loader implementation for causal language modeling tasks."""
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The GPT-J model instance for causal language modeling.
        """
