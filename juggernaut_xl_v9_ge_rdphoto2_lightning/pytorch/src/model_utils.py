...
"""
Helper functions for Juggernaut XL V9 GE RDPhoto2 Lightning 4S model loading and processing.
"""
...
def load_pipe(model_path):
    """Load Juggernaut XL pipeline from a single-file checkpoint.

    Args:
        model_path: Local path to the .safetensors checkpoint file
