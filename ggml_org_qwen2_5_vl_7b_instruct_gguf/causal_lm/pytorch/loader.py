...
"""
ggml-org/Qwen2.5-VL-7B-Instruct-GGUF model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    """Available ggml-org/Qwen2.5-VL-7B-Instruct-GGUF model variants for causal language modeling."""

    GGML_ORG_QWEN2_5_VL_7B_INSTRUCT_GGUF = "7B_Instruct_GGUF"


class ModelLoader(ForgeModel):
    """ggml-org/Qwen2.5-VL-7B-Instruct-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.GGML_ORG_QWEN2_5_VL_7B_INSTRUCT_GGUF: LLMModelConfig(
            pretrained_model_name="Qwen/Qwen2.5-VL-7B-Instruct",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GGML_ORG_QWEN2_5_VL_7B_INSTRUCT_GGUF
