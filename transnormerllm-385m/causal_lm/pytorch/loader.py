...
"""Transnormerllm 385m model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="OpenNLPLab/TransNormerLLM-385M",
            max_length=128,
        ),
    }
