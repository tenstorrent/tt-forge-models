...
class ModelLoader(ForgeModel):
    ...
    def load_model(
        ...
        **kwargs,
        ...
        """Load the AnimateDiff UNet with motion adapter and tilt-up LoRA applied.

        Returns:
            UNetMotionModel (torch.nn.Module) with LoRA weights fused in.
        """
    ...
    def load_inputs(
        ...
        # The real pipeline repeats prompt_embeds num_frames times before calling the
        # UNet, so encoder_hidden_states must have batch=batch*num_frames.
