...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Anything V5 pipeline from Hugging Face.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample text prompts for the Anything V5 model.
        ...
        """
        prompt = [
            "masterpiece, best quality, 1girl, cherry blossoms, detailed eyes, soft lighting",
        ] * batch_size
        return prompt
