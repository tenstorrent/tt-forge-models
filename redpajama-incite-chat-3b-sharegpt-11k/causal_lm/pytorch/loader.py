...
"""Redpajama Incite Chat 3b Sharegpt 11k model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Fredithefish/RedPajama-INCITE-Chat-3B-ShareGPT-11K",
            max_length=128,
        ),
    }
