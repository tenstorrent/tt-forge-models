...
"""
Wav2Vec2 model loader implementation for nonverbal vocalization classification.
"""
...
class ModelLoader(ForgeModel):
    """Wav2Vec2 model loader implementation for nonverbal vocalization classification (PyTorch)."""
    ...
    DEFAULT_VARIANT = ModelVariant.LARGE_NONVERBAL_VOCALIZATION
