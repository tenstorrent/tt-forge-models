...
"""
CodeT5 model loader implementation
"""
...
class ModelLoader(ForgeModel):
    ...
    sample_text = "def greet(user): print(f'hello <extra_id_0>!')"
    ...
    def _load_tokenizer(self, dtype_override=None):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(
            ...
            additional_special_tokens=extra_ids,
            **tokenizer_kwargs,
        )
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The CodeT5 model instance for conditional generation.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the CodeT5 model.
