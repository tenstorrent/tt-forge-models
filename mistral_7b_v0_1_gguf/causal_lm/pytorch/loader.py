...
"""
TheBloke Mistral 7B v0.1 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Mistral 7B v0.1 GGUF model variants for causal language modeling."""

    MISTRAL_7B_V0_1_GGUF = "7B_v0.1_GGUF"


class ModelLoader(ForgeModel):
    """TheBloke Mistral 7B v0.1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MISTRAL_7B_V0_1_GGUF: LLMModelConfig(
            pretrained_model_name="TheBloke/Mistral-7B-v0.1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MISTRAL_7B_V0_1_GGUF

    GGUF_FILE = "mistral-7b-v0.1.Q4_K_M.gguf"
