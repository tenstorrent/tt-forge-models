...
"""
Veiled Calla 12B i1 GGUF model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available Veiled Calla 12B i1 GGUF model variants for causal language modeling."""

    VEILED_CALLA_12B_I1_GGUF = "12B_i1_GGUF"


class ModelLoader(ForgeModel):
    """Veiled Calla 12B i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.VEILED_CALLA_12B_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Veiled-Calla-12B-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.VEILED_CALLA_12B_I1_GGUF

    GGUF_FILE = "Veiled-Calla-12B.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Veiled Calla 12B i1 GGUF",
            variant=variant,
