...
"""
mradermacher/PAPO-G-Qwen2.5-VL-7B-i1-GGUF model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    """Available PAPO-G-Qwen2.5-VL-7B-i1-GGUF model variants for causal language modeling."""

    PAPO_G_QWEN2_5_VL_7B_I1_GGUF = "7B_i1_GGUF"


class ModelLoader(ForgeModel):
    """PAPO-G-Qwen2.5-VL-7B-i1-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.PAPO_G_QWEN2_5_VL_7B_I1_GGUF: LLMModelConfig(
            pretrained_model_name="PAPO-Galaxy/PAPO-G-H-Qwen2.5-VL-7B",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.PAPO_G_QWEN2_5_VL_7B_I1_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher PAPO-G-Qwen2.5-VL-7B-i1-GGUF",
            variant=variant,
