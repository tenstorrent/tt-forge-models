...
"""Manticore 30b Chat Pyg Alpha model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="openaccess-ai-collective/manticore-30b-chat-pyg-alpha",
            max_length=128,
        ),
    }
