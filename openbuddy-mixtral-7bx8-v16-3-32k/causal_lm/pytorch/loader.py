...
"""Openbuddy Mixtral 7bx8 V16 3 32k model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="OpenBuddy/openbuddy-mixtral-7bx8-v16.3-32k",
            max_length=128,
        ),
    }
