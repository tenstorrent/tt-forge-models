...
"""Tinystories Instruct 3m model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="roneneldan/TinyStories-Instruct-3M",
            max_length=128,
        ),
    }
