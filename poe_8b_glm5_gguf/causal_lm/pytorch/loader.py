...
def _patch_qwen3vl_support():
    ...
    The Poe-8B-GLM5 GGUF file declares architecture as 'qwen3vl' which
    transformers does not recognise. The underlying model uses the same
    architecture as Qwen3 for causal language modeling.
    """
...
class ModelLoader(ForgeModel):
    ...
    GGUF_FILE = "Poe-8B-GLM5-Opus4.6-Sonnet4.5-Kimi-Grok-Gemini-3-pro-preview-HERETIC.i1-Q4_K_M.gguf"
