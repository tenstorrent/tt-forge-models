...
"""
Rinna Bilingual GPT-NeoX 4B model loader implementation
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Rinna Bilingual GPT-NeoX 4B model variants."""

    BILINGUAL_GPT_NEOX_4B = "bilingual-gpt-neox-4b"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BILINGUAL_GPT_NEOX_4B: LLMModelConfig(
            pretrained_model_name="rinna/bilingual-gpt-neox-4b",
            max_length=256,
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.BILINGUAL_GPT_NEOX_4B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Rinna Bilingual GPT-NeoX 4B model instance for this instance's variant.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        generation_config = GenerationConfig(
            max_length=100, do_sample=True, temperature=1.0, top_p=0.95
        )
        inputs = {
