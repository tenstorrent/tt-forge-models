...
"""
Tiny Random AquilaChat model loader implementation for causal language modeling.
"""
...
class ModelLoader(ForgeModel):
    """Tiny Random AquilaChat model loader for causal language modeling."""
    ...
    DEFAULT_VARIANT = ModelVariant.TINY_RANDOM_AQUILACHAT
