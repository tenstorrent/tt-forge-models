...
"""
GPT NeoX  model loader implementation for causal language modeling.
"""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant._20B: LLMModelConfig(
            pretrained_model_name="EleutherAI/gpt-neox-20b",
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant._20B
    ...
    def load_model(self, dtype_override=None):
        """Load and return the GPT NeoX model instance for this instance's variant.
        ...
        model = AutoEasyDeLModelForCausalLM.from_pretrained(
            self._model_name, partition_rules=partition_rules, 
            config_kwargs= EasyDeLBaseConfigDict(hidden_act="gelu"),
            **model_kwargs
        )
    ...
    def load_inputs(self, dtype_override=None, mesh=None):
        """Load and return sample inputs for the GPT NeoX model with this instance's variant settings.
    ...
    def load_parameters_partition_spec(
        ...
        if (
            ...
            # Use EasyDel's GPTNeoXConfig to get proper partition rules
            from easydel.modules.gpt_neox import GPTNeoXConfig

            gpt_neox_config = GPTNeoXConfig()
            partition_rules = gpt_neox_config.get_partition_rules()
