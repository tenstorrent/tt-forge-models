...
"""Wizard Vicuna 13b Uncensored Hf model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="TheBloke/Wizard-Vicuna-13B-Uncensored-HF",
            max_length=128,
        ),
    }
