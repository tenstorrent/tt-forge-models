...
"""Deberta Xxlarge Fixed model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ltg/deberta-xxlarge-fixed",
            max_length=128,
        ),
    }
