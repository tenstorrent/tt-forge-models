...
"""
noctrex Qwen 3.5 35B-A3B Claude 4.6 Opus Reasoning Distilled MXFP4 MoE GGUF model loader implementation for causal language modeling.
"""
import torch
...
def _patch_transformers_qwen35moe_gguf():
    ...
    def patched_get_gguf_hf_weights_map(
        ...
        return orig_get_map(
            hf_model, model_type=model_type, num_layers=num_layers, qual_name=qual_name
        )
...
class ModelVariant(StrEnum):
    """Available noctrex Qwen 3.5 35B-A3B Claude 4.6 Opus Reasoning Distilled MXFP4 MoE GGUF model variants for causal language modeling."""

    QWEN_3_5_35B_A3B_CLAUDE_4_6_OPUS_REASONING_DISTILLED_MXFP4_MOE_GGUF = (
        "35B_A3B_CLAUDE_4_6_OPUS_REASONING_DISTILLED_MXFP4_MOE_GGUF"
    )


class ModelLoader(ForgeModel):
    """noctrex Qwen 3.5 35B-A3B Claude 4.6 Opus Reasoning Distilled MXFP4 MoE GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_5_35B_A3B_CLAUDE_4_6_OPUS_REASONING_DISTILLED_MXFP4_MOE_GGUF: LLMModelConfig(
            pretrained_model_name="noctrex/Qwen3.5-35B-A3B-Claude-4.6-Opus-Reasoning-Distilled-MXFP4_MOE-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = (
        ModelVariant.QWEN_3_5_35B_A3B_CLAUDE_4_6_OPUS_REASONING_DISTILLED_MXFP4_MOE_GGUF
    )

    GGUF_FILE = (
        "Qwen3.5-35B-A3B-Claude-4.6-Opus-Reasoning-Distilled-MXFP4_MOE_BF16.gguf"
    )
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="noctrex Qwen 3.5 35B-A3B Claude 4.6 Opus Reasoning Distilled MXFP4 MoE GGUF",
            variant=variant,
