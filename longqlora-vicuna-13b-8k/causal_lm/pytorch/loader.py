...
"""Longqlora Vicuna 13b 8k model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="YeungNLP/LongQLoRA-Vicuna-13b-8k",
            max_length=128,
        ),
    }
