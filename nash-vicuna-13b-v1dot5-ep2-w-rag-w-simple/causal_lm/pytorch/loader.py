...
"""Nash Vicuna 13b V1dot5 Ep2 W Rag W Simple model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="luffycodes/nash-vicuna-13b-v1dot5-ep2-w-rag-w-simple",
            max_length=128,
        ),
    }
