...
"""
alpindale/Llama-3.2-11B-Vision-Instruct model loader for image-text-to-text tasks.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available alpindale Llama 3.2 11B Vision Instruct model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.LLAMA_3_2_11B_VISION_INSTRUCT: ModelConfig(
            pretrained_model_name="alpindale/Llama-3.2-11B-Vision-Instruct",
        ),
    }
