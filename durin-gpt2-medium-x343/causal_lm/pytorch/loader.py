...
"""Durin Gpt2 Medium X343 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="stanford-crfm/durin-gpt2-medium-x343",
            max_length=128,
        ),
    }
