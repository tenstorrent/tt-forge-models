...
"""Babylm Baseline 10m Gpt Bert Masked Focus model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="BabyLM-community/babylm-baseline-10m-gpt-bert-masked-focus",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Babylm Baseline 10m Gpt Bert Masked Focus",
