...
"""Codegen 350m Mono Custom Functions Dataset Python V2 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="sharoz/codegen-350M-mono-custom-functions-dataset-python_v2",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Codegen 350m Mono Custom Functions Dataset Python V2",
