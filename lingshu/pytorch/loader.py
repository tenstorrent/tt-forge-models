...
"""
Lingshu model loader implementation for medical vision-language tasks.
"""
import torch
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.LINGSHU_7B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Lingshu model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The Wrapped Lingshu model instance for medical vision-language tasks.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the Lingshu model with this instance's variant settings.
