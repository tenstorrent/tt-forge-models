...
"""Monoelectra Lce Nneg31 model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="crystina-z/monoELECTRA_LCE_nneg31",
        ),
    }
