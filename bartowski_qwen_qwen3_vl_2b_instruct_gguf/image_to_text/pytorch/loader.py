...
class ModelVariant(StrEnum):
    """Available bartowski Qwen3 VL 2B Instruct GGUF model variants for image to text."""

    BARTOWSKI_QWEN_QWEN3_VL_2B_INSTRUCT_GGUF = "qwen_qwen3_vl_2b_instruct_gguf"
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="bartowski Qwen3 VL 2B Instruct GGUF",
            variant=variant,
