...
"""
calcuis/flux1-gguf model loader implementation for text-to-image generation.

Loads the calcuis/flux1-gguf GGUF-quantized FLUX.1-dev transformer using
...
class ModelLoader(ForgeModel):
    """calcuis/flux1-gguf model loader implementation for text-to-image tasks."""

    _VARIANTS = {
        ModelVariant.DEV_Q4_K_S: ModelConfig(
            pretrained_model_name=REPO_ID,
        ),
        ModelVariant.DEV_Q8_0: ModelConfig(
            pretrained_model_name=REPO_ID,
        ),
    }
    ...
    _GGUF_FILES = {
        ...
        ModelVariant.DEV_Q8_0: "flux1-dev-q8_0.gguf",
    }
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        # FLUX.1-dev uses classifier-free guidance
