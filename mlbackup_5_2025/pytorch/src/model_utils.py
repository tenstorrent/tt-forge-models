...
"""
Helper functions for MLbackup 5_2025 SDXL model loading and processing.
"""
...
def load_pipe(repo_id, filename):
    """Load MLbackup 5_2025 SDXL pipeline from a single-file checkpoint.

    Args:
        repo_id: HuggingFace repo ID
        filename: Safetensors filename in the repo
