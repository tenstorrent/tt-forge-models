...
"""Pythia 70m Deduped Cleansharegpt En model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="HWERI/pythia-70m-deduped-cleansharegpt-en",
            max_length=128,
        ),
    }
