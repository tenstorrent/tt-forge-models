...
"""
Huihui Mistral Small 3.2 24B Instruct Abliterated v2 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Huihui Mistral Small 3.2 24B Instruct Abliterated v2 GGUF model variants for causal language modeling."""
...
class ModelLoader(ForgeModel):
    """Huihui Mistral Small 3.2 24B Instruct Abliterated v2 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.HUIHUI_MISTRAL_SMALL_3_2_24B_INSTRUCT_ABLITERATED_V2_GGUF: LLMModelConfig(
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Huihui Mistral Small 3.2 24B Instruct Abliterated v2 GGUF",
            variant=variant,
