...
"""Hunyuan A13b Pretrain model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="tencent/Hunyuan-A13B-Pretrain",
            max_length=128,
        ),
    }
