...
"""Dpr Question Encoder Single Lfqa Wiki model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="vblagoje/dpr-question_encoder-single-lfqa-wiki",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Dpr Question Encoder Single Lfqa Wiki",
