...
"""
Helper functions for Anime Desire Illustrious SDXL model loading and processing.
"""
...
def load_pipe(model_path):
    """Load Anime Desire Illustrious SDXL pipeline from single-file checkpoint.

    Args:
        model_path: Local path to the downloaded safetensors checkpoint file
