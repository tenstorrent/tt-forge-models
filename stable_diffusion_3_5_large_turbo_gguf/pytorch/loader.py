...
class ModelVariant(StrEnum):
    """Available Stable Diffusion 3.5 Large Turbo GGUF model variants."""

    SD3_5_LARGE_TURBO_Q8_0 = "Q8_0"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.SD3_5_LARGE_TURBO_Q8_0: ModelConfig(
            pretrained_model_name="city96/stable-diffusion-3.5-large-turbo-gguf",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SD3_5_LARGE_TURBO_Q8_0
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Stable Diffusion 3.5 Large Turbo GGUF",
            variant=variant,
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load the SD3.5 Large Turbo transformer from a GGUF quantized file.
