...
"""
mit-han-lab/nunchaku-flux.1-dev quantized model loader implementation.
...
NUNCHAKU_REPO = "mit-han-lab/nunchaku-flux.1-dev"
...
class ModelLoader(ForgeModel):
    """mit-han-lab/nunchaku-flux.1-dev quantized model loader."""
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="mit-han-lab/nunchaku-flux.1-dev",
            variant=variant,
