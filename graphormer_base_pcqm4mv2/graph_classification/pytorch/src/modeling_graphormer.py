...
Adapted from transformers 4.49.0:
https://github.com/huggingface/transformers/blob/v4.49.0/src/transformers/models/deprecated/graphormer/modeling_graphormer.py
"""
...
class GraphormerPreTrainedModel(PreTrainedModel):
    ...
    def init_graphormer_params(
        self, module: Union[nn.Linear, nn.Embedding, GraphormerMultiheadAttention]
    ):
        """
