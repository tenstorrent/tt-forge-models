...
"""
Helper functions for T2I-Adapter Depth SD1.5v2 model loading and processing.
"""
...
def load_t2i_adapter_depth_sd15v2_pipe(adapter_model_name, base_model_name):
    """Load T2I-Adapter Depth SD1.5v2 pipeline.
...
def create_depth_conditioning_image(height=512, width=512):
...
def t2i_adapter_depth_sd15v2_preprocessing(
    pipe,
    prompt,
    adapter_image,
    device="cpu",
    ...
    """Preprocess inputs for T2I-Adapter Depth SD1.5v2 model.
