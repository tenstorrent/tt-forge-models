...
"""Mpt 7b Chat Extended model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="rwl4/mpt-7b-chat-extended",
            max_length=128,
        ),
    }
