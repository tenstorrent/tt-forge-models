...
"""
Gemma 3n E4B GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    ...
    GEMMA_3N_E4B_IT_GGUF = "E4B_IT_GGUF"


class ModelLoader(ForgeModel):
    """Gemma 3n E4B GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GEMMA_3N_E4B_IT_GGUF: LLMModelConfig(
            pretrained_model_name="ggml-org/gemma-3n-E4B-it-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GEMMA_3N_E4B_IT_GGUF

    GGUF_FILE = "gemma-3n-E4B-it-Q8_0.gguf"
