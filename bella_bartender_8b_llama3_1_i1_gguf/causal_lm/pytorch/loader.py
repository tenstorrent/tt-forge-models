...
"""
Bella Bartender 8B Llama 3.1 i1 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Bella Bartender 8B Llama 3.1 i1 GGUF model variants for causal language modeling."""
...
class ModelLoader(ForgeModel):
    """Bella Bartender 8B Llama 3.1 i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.BELLA_BARTENDER_8B_LLAMA3_1_I1_Q4_K_M_GGUF: LLMModelConfig(
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bella Bartender 8B Llama 3.1 i1 GGUF",
            variant=variant,
