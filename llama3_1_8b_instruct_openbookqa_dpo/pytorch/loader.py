...
class ModelVariant(StrEnum):
    """Available Llama 3.1 8B Instruct OpenbookQA DPO model variants."""

    LLAMA3_1_8B_INSTRUCT_OPENBOOKQA_DPO_C = "Llama3.1_8B_Instruct_OpenbookQA_DPO_C"


class ModelLoader(ForgeModel):
    """Llama 3.1 8B Instruct OpenbookQA DPO model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.LLAMA3_1_8B_INSTRUCT_OPENBOOKQA_DPO_C: ModelConfig(
            pretrained_model_name="qiaw99/Llama3.1-8B-Instruct-OpenbookQA-DPO-C",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.LLAMA3_1_8B_INSTRUCT_OPENBOOKQA_DPO_C
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Llama3.1_8B_Instruct_OpenbookQA_DPO",
            variant=variant,
