...
"""
OptiMind-SFT model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available OptiMind-SFT model variants for causal language modeling."""

    OPTIMIND_SFT_20B = "20B"


class ModelLoader(ForgeModel):
    """OptiMind-SFT model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.OPTIMIND_SFT_20B: LLMModelConfig(
            pretrained_model_name="microsoft/OptiMind-SFT",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.OPTIMIND_SFT_20B
    ...
    def get_mesh_config(self, num_devices: int):
        if num_devices == 32:  # Galaxy
            ...
            raise ValueError("OptiMind-SFT is only supported on llmbox and galaxy")
