...
"""
Unsloth Qwen2 VL model loader implementation for vision-language tasks.
"""
import torch
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.UNSLOTH_QWEN_2_VL_7B_INSTRUCT
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Unsloth Qwen2 VL model instance.
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the Unsloth Qwen2 VL model.
