...
"""
Qwen3.5-122B-A10B MLX 6.5-bit model loader for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Qwen3.5-122B-A10B MLX 6.5-bit model variants."""

    QWEN_3_5_122B_A10B_MLX_6_5BIT = "122B_A10B_MLX_6_5bit"
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.QWEN_3_5_122B_A10B_MLX_6_5BIT
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Qwen3.5-122B-A10B MLX 6.5-bit",
            variant=variant,
