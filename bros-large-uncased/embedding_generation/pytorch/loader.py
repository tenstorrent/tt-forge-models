...
"""Bros Large Uncased model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="naver-clova-ocr/bros-large-uncased",
        ),
    }
