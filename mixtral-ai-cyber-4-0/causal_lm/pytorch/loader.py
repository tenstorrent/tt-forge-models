...
"""Mixtral Ai Cyber 4 0 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="LeroyDyer/Mixtral_AI_Cyber_4.0",
            max_length=128,
        ),
    }
