...
"""
GPT-OSS-Swallow 20B RL v0.1 GGUF model loader implementation for causal language modeling.
"""
import torch
...
def _patch_gpt_oss_support():
    ...
    GPT-OSS uses the same model architecture as Qwen3 MoE but the GGUF
...
class ModelVariant(StrEnum):
    """Available GPT-OSS-Swallow 20B RL v0.1 GGUF model variants for causal language modeling."""

    GPT_OSS_SWALLOW_20B_RL_V0_1_Q4_K_M_GGUF = "20B_RL_V0_1_Q4_K_M_GGUF"


class ModelLoader(ForgeModel):
    """GPT-OSS-Swallow 20B RL v0.1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GPT_OSS_SWALLOW_20B_RL_V0_1_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="mmnga-o/GPT-OSS-Swallow-20B-RL-v0.1-gguf",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GPT_OSS_SWALLOW_20B_RL_V0_1_Q4_K_M_GGUF

    GGUF_FILE = "GPT-OSS-Swallow-20B-RL-v0.1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="GPT-OSS-Swallow 20B RL v0.1 GGUF",
            variant=variant,
