...
"""Toolformer V0 Epoch2 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="dmayhem93/toolformer_v0_epoch2",
            max_length=128,
        ),
    }
