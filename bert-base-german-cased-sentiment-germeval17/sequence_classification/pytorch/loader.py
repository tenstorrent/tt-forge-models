...
"""Bert Base German Cased Sentiment Germeval17 model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="deepset/bert-base-german-cased-sentiment-Germeval17",
        ),
    }
