...
"""
EVA model loader implementation
"""
...
@dataclass
class EvaConfig(ModelConfig):
    """Configuration specific to EVA models"""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.LARGE_PATCH14_196_IN22K_FT_IN22K_IN1K
