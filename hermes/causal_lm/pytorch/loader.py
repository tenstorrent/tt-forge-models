...
Hermes-2-Theta-Llama-3-8B is a NousResearch finetune of Meta-Llama-3-8B and
uses the standard ``LlamaForCausalLM`` architecture, so it is loaded through the
HuggingFace Auto classes just like the base Llama models.
"""
...
class ModelVariant(StrEnum):
    ...
    HERMES_2_THETA_LLAMA_3_8B = "2_theta_llama_3_8b"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.HERMES_2_THETA_LLAMA_3_8B: LLMModelConfig(
            pretrained_model_name="NousResearch/Hermes-2-Theta-Llama-3-8B",
            max_length=128,
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.HERMES_2_THETA_LLAMA_3_8B
    ...
    def _load_tokenizer(self, dtype_override=None):
        ...
        # Set pad token to eos token (Llama-family models have no dedicated pad token)
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the Hermes model.
