...
"""Iot 23 Bert Network Logs Classification model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="yashika0998/IoT-23-BERT-Network-Logs-Classification",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Iot 23 Bert Network Logs Classification",
