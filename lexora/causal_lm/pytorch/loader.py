...
"""
Lexora Casual LM model loader implementation

Lexora-Lite-3B_v2 is a DeepMount00 Italian-focused fine-tune built on the
Qwen2.5-3B (Qwen2) architecture, so it loads through ``Qwen2ForCausalLM``.
"""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.LEXORA_LITE_3B_V2
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Lexora model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The Lexora model instance for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the Lexora model with this instance's variant settings.
    ...
    def load_config(self):
        """Load and return the configuration for the Lexora model variant.

        Returns:
            The configuration object for the Lexora model.
        """
