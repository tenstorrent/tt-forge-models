...
"""
Lexora (DeepMount00) causal LM model loader implementation.

Lexora-Lite-3B_v2 is built on the Qwen2 architecture (Qwen2ForCausalLM).
"""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.LITE_3B_V2: LLMModelConfig(
            pretrained_model_name="DeepMount00/Lexora-Lite-3B_v2",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.LITE_3B_V2
