...
"""Small Mlm Glue Mrpc Custom Tokenizer Target Glue Mnli model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="muhtasham/small-mlm-glue-mrpc-custom-tokenizer-target-glue-mnli",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Small Mlm Glue Mrpc Custom Tokenizer Target Glue Mnli",
