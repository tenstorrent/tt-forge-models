...
"""Bart Large Emojilm E2t model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="KomeijiForce/bart-large-emojilm-e2t",
            max_length=128,
        ),
    }
