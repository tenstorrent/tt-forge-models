...
class ModelVariant(StrEnum):
    ...
    PYTHIA_160M = "160M"
    PYTHIA_160M_SEED2 = "160M-seed2"
    PYTHIA_410M_SEED3 = "410M-seed3"
    PYTHIA_1_4B = "1.4B"
    PYTHIA_6_9B_DEDUPED = "6.9B-deduped"
    PYTHIA_6_9B_DEDUPED_SYNTHETIC_INSTRUCT = "6.9B-deduped-synthetic-instruct"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.PYTHIA_31M_SEED3: LLMModelConfig(
            pretrained_model_name="EleutherAI/pythia-31m-seed3",
            max_length=256,
        ),
        ...
        ModelVariant.PYTHIA_160M_SEED2: LLMModelConfig(
            pretrained_model_name="EleutherAI/pythia-160m-seed2",
            max_length=256,
        ),
        ...
        ModelVariant.PYTHIA_6_9B_DEDUPED_SYNTHETIC_INSTRUCT: LLMModelConfig(
            pretrained_model_name="lambdalabs/pythia-6.9b-deduped-synthetic-instruct",
            max_length=256,
        ),
    }
