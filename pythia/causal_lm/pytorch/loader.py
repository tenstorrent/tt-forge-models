...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.PYTHIA_31M_SEED5: LLMModelConfig(
            pretrained_model_name="EleutherAI/pythia-31m-seed5",
            max_length=256,
        ),
        ...
        ModelVariant.PYTHIA_70M_SEED8: LLMModelConfig(
            pretrained_model_name="EleutherAI/pythia-70m-seed8",
            max_length=256,
        ),
        ...
        ModelVariant.PYTHIA_160M_SEED4: LLMModelConfig(
            pretrained_model_name="EleutherAI/pythia-160m-seed4",
            max_length=256,
        ),
