...
"""
dinerburger Qwen3.5 35B A3B GGUF model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available dinerburger Qwen3.5 35B A3B GGUF model variants for causal language modeling."""

    QWEN3_5_35B_A3B_IQ4_NL_GGUF = "35B_A3B_IQ4_NL_GGUF"


class ModelLoader(ForgeModel):
    """dinerburger Qwen3.5 35B A3B GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN3_5_35B_A3B_IQ4_NL_GGUF: LLMModelConfig(
            pretrained_model_name="dinerburger/Qwen3.5-35B-A3B-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN3_5_35B_A3B_IQ4_NL_GGUF

    GGUF_FILE = "Qwen3.5-35B-A3B.IQ4_NL.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="dinerburger Qwen3.5 35B A3B GGUF",
            variant=variant,
