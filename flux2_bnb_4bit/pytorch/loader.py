...
"""
FLUX.2 BNB 4-bit model loader implementation for text-to-image generation
"""
import torch
...
class ModelVariant(StrEnum):
    """Available FLUX.2 BNB 4-bit model variants."""

    DEV = "Dev"


class ModelLoader(ForgeModel):
    """FLUX.2 BNB 4-bit model loader implementation for text-to-image generation tasks."""

    _VARIANTS = {
        ModelVariant.DEV: ModelConfig(
            pretrained_model_name="diffusers/FLUX.2-dev-bnb-4bit",
        ),
    }
