...
"""Crystalchat 7b Web2code model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="LLM360/CrystalChat-7B-Web2Code",
            max_length=128,
        ),
    }
