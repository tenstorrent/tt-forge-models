...
"""Uniner 7b Definition model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Universal-NER/UniNER-7B-definition",
            max_length=128,
        ),
    }
