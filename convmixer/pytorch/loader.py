...
"""
ConvMixer model loader implementation (timm variants)
"""
...
class ModelVariant(StrEnum):
    """Available ConvMixer model variants (timm)."""

    CONVMIXER_768_32_IN1K = "convmixer_768_32.in1k"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.CONVMIXER_768_32_IN1K: ModelConfig(
            pretrained_model_name="convmixer_768_32.in1k",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.CONVMIXER_768_32_IN1K
