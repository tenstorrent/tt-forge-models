...
"""Turkish Gemma 9b V0 1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ytu-ce-cosmos/Turkish-Gemma-9b-v0.1",
            max_length=128,
        ),
    }
