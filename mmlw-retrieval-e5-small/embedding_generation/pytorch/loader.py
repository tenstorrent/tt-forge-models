...
"""Mmlw Retrieval E5 Small model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="sdadas/mmlw-retrieval-e5-small",
        ),
    }
