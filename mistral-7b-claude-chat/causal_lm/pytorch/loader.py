...
"""Mistral 7b Claude Chat model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Norquinal/Mistral-7B-claude-chat",
            max_length=128,
        ),
    }
