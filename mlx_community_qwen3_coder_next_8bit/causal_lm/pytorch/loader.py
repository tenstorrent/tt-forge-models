...
"""
mlx-community/Qwen3-Coder-Next-8bit model loader for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available mlx-community Qwen3-Coder-Next-8bit model variants."""

    QWEN_3_CODER_NEXT_8BIT = "Coder_Next_8bit"
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.QWEN_3_CODER_NEXT_8BIT
