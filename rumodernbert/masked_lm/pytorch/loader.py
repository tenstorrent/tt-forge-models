...
"""
RuModernBERT model loader implementation for masked language modeling.
"""
...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load RuModernBERT model for masked language modeling from Hugging Face.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The RuModernBERT model instance.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Prepare sample input for RuModernBERT masked language modeling.
    ...
    def load_config(self):
        """Load and return the configuration for the RuModernBERT model variant.

        Returns:
            The configuration object for the RuModernBERT model.
        """
