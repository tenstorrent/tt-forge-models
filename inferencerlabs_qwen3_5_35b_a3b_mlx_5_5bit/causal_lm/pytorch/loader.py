...
"""
Qwen3.5-35B-A3B MLX 5.5-bit model loader for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Qwen3.5-35B-A3B MLX 5.5-bit model variants."""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.QWEN_3_5_35B_A3B_MLX_5_5BIT
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Qwen3.5-35B-A3B MLX 5.5-bit",
            variant=variant,
