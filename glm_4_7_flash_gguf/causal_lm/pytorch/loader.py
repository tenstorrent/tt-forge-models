...
def _patch_transformers_deepseek2_gguf():
    ...
    # Register tokenizer converters unconditionally: another loader may have already
    # added 'deepseek2' to GGUF_SUPPORTED_ARCHITECTURES but not 'deepseek_v2', which
    # is the architecture name used by some GGUF files (e.g. ngxson GLM-4.7-Flash).
