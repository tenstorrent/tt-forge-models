...
"""
CodeLlama 13B Instruct GGUF model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available CodeLlama 13B Instruct GGUF model variants for causal language modeling."""

    CODELLAMA_13B_INSTRUCT_GGUF = "13B_Instruct_GGUF"


class ModelLoader(ForgeModel):
    """CodeLlama 13B Instruct GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.CODELLAMA_13B_INSTRUCT_GGUF: LLMModelConfig(
            pretrained_model_name="TheBloke/CodeLlama-13B-Instruct-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.CODELLAMA_13B_INSTRUCT_GGUF
