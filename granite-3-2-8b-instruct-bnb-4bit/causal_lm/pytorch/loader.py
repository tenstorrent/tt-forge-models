...
"""Granite 3 2 8b Instruct Bnb 4bit model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="unsloth/granite-3.2-8b-instruct-bnb-4bit",
            max_length=128,
        ),
    }
