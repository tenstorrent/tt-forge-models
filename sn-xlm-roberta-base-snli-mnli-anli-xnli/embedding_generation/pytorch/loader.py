...
"""Sn Xlm Roberta Base Snli Mnli Anli Xnli model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="symanto/sn-xlm-roberta-base-snli-mnli-anli-xnli",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sn Xlm Roberta Base Snli Mnli Anli Xnli",
