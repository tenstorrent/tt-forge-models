...
"""
TeichAI Qwen3-30B-A3B GGUF model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available TeichAI Qwen3-30B-A3B GGUF model variants for causal language modeling."""

    QWEN_3_30B_A3B_GGUF = "30B_A3B_GGUF"


class ModelLoader(ForgeModel):
    """TeichAI Qwen3-30B-A3B GGUF model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_30B_A3B_GGUF: LLMModelConfig(
            pretrained_model_name="TeichAI/Qwen3-30B-A3B-Thinking-2507-Claude-4.5-Sonnet-High-Reasoning-Distill-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN_3_30B_A3B_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="TeichAI Qwen3-30B-A3B GGUF",
            variant=variant,
