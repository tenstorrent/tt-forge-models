...
"""
Helper functions for Noob SDXL ControlNet Lineart Anime model loading and processing.
"""
...
def load_controlnet_lineart_anime_sdxl_pipe(controlnet_model_name, base_model_name):
    """Load ControlNet Lineart Anime SDXL pipeline.
...
def create_lineart_anime_conditioning_image(height=1024, width=1024):
    """Create a dummy lineart anime conditioning image.
...
def controlnet_lineart_anime_sdxl_preprocessing(
    pipe,
    prompt,
    control_image,
    device="cpu",
    ...
    """Preprocess inputs for ControlNet Lineart Anime SDXL model.

    Args:
        pipe: StableDiffusionXLControlNetPipeline
        prompt: Text prompt for generation
        control_image: Lineart anime conditioning image
