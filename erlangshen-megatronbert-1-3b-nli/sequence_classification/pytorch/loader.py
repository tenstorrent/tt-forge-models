...
"""Erlangshen Megatronbert 1 3b Nli model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="IDEA-CCNL/Erlangshen-MegatronBert-1.3B-NLI",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Erlangshen Megatronbert 1 3b Nli",
