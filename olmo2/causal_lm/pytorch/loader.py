...
class ModelVariant(StrEnum):
    ...
    Olmo_2_1124_7B = "2_1124_7b"
    Olmo_2_1124_13B = "2_1124_13b"
    Olmo_2_0325_32B_Instruct = "2_0325_32b_instruct"
...
class ModelLoader(ForgeModel):
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        Args:
            dtype_override: Optional torch.dtype (unused for tokenized text inputs).
    ...
    def get_mesh_config(self, num_devices: int):
        ...
        Prefer (1, N) when attention heads divide N; otherwise try (2, N/2).
        """
    ...
    def load_shard_spec(self, model):
        """Megatron column->row tensor-parallel shard plan for Olmo2."""
        shard_specs = {}
