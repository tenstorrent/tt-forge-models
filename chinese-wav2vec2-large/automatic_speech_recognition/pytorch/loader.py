...
"""Chinese Wav2vec2 Large model loader implementation for automatic speech recognition."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="TencentGameMate/chinese-wav2vec2-large",
            max_length=30,
        ),
    }
