...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.VIT_L_14_336
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the PE-Core CLIP model instance.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the PE-Core CLIP model.
    ...
    def post_process(self, outputs):
        """Post-process PE-Core CLIP model outputs to extract similarity scores.
