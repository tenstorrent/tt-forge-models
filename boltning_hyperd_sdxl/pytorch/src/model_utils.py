...
"""
Helper functions for Boltning HyperD SDXL model loading and processing.
"""
...
def load_pipe(pretrained_model_name):
    """Load Boltning HyperD SDXL pipeline.
...
def stable_diffusion_preprocessing_xl(
    ...
    Args:
        ...
        height: Image height (default: pipe.default_sample_size * pipe.vae_scale_factor)
        width: Image width (default: pipe.default_sample_size * pipe.vae_scale_factor)
        clip_skip: Optional number of CLIP layers to skip
        original_size: Original image size tuple
        target_size: Target image size tuple
        crops_coords_top_left: Crop coordinates for top-left corner
        negative_original_size: Negative original size tuple
        negative_target_size: Negative target size tuple
        negative_crops_coords_top_left: Negative crop coordinates
