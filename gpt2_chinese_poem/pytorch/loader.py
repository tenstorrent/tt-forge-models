...
"""
GPT-2 Chinese Poem model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available GPT-2 Chinese Poem model variants."""

    DEFAULT = "Default"


class ModelLoader(ForgeModel):
    """GPT-2 Chinese Poem loader for classical Chinese poem generation."""

    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="uer/gpt2-chinese-poem",
            max_length=256,
        ),
    }
