...
"""
Helper functions for ControlNet Depth Zoe SDXL model loading and processing.
"""
...
def load_controlnet_depth_zoe_sdxl_pipe(controlnet_model_name, base_model_name):
    """Load ControlNet Depth Zoe SDXL pipeline.
...
def controlnet_depth_zoe_sdxl_preprocessing(
    pipe,
    prompt,
    control_image,
    device="cpu",
    ...
    """Preprocess inputs for ControlNet Depth Zoe SDXL model.
