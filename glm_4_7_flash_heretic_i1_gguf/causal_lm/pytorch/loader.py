...
"""
GLM 4.7 Flash Heretic i1 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available GLM 4.7 Flash Heretic i1 GGUF model variants for causal language modeling."""

    GLM_4_7_FLASH_HERETIC_I1_GGUF = "4_7_Flash_heretic_i1_GGUF"


class ModelLoader(ForgeModel):
    """GLM 4.7 Flash Heretic i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GLM_4_7_FLASH_HERETIC_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/GLM-4.7-Flash-heretic-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GLM_4_7_FLASH_HERETIC_I1_GGUF

    GGUF_FILE = "GLM-4.7-Flash-heretic.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="GLM 4.7 Flash Heretic i1 GGUF",
            variant=variant,
