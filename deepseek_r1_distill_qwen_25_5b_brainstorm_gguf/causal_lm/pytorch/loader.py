...
class ModelVariant(StrEnum):
    """Available DeepSeek R1 Distill Qwen 25.5B Brainstorm GGUF model variants for causal language modeling."""

    DEEPSEEK_R1_DISTILL_QWEN_25_5B_BRAINSTORM_Q4_K_M = "25.5B_Brainstorm_Q4_K_M"


class ModelLoader(ForgeModel):
    """DeepSeek R1 Distill Qwen 25.5B Brainstorm GGUF model loader implementation for causal language modeling tasks."""
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="DeepSeek R1 Distill Qwen 25.5B Brainstorm GGUF",
            variant=variant,
