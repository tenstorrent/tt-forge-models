...
"""
Heretical Qwen 3.5 GGUF model loader implementation for causal language modeling.
"""
import importlib
...
class ModelVariant(StrEnum):
    ...
    HERETICAL_QWEN_3_5_2B_GGUF = "2B_Heretical_GGUF"


class ModelLoader(ForgeModel):
    """Heretical Qwen 3.5 GGUF model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.HERETICAL_QWEN_3_5_2B_GGUF

    GGUF_FILE = "Heretical-Qwen3.5-2B.Q4_K_M.gguf"
