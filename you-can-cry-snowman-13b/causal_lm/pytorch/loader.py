...
"""You Can Cry Snowman 13b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="DopeorNope/You_can_cry_Snowman-13B",
            max_length=128,
        ),
    }
