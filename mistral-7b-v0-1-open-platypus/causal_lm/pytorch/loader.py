...
"""Mistral 7b V0 1 Open Platypus model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="akjindal53244/Mistral-7B-v0.1-Open-Platypus",
            max_length=128,
        ),
    }
