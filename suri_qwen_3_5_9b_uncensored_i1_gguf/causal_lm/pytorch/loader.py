...
# Fix: gguf lacks __version__ and is absent from PACKAGE_DISTRIBUTION_MAPPING,
# causing is_gguf_available() to parse version 'N/A' and raise InvalidVersion.
if "gguf" not in _import_utils.PACKAGE_DISTRIBUTION_MAPPING:
    _import_utils.PACKAGE_DISTRIBUTION_MAPPING["gguf"] = ["gguf"]


def _patch_qwen35_support():
    """Register qwen35 as alias for qwen3 in the GGUF machinery.

    Qwen 3.5 GGUF files declare architecture 'qwen35' and tokenizer class
    'qwen3_5_text', which transformers does not yet recognise natively.
    """
