...
"""
Gemma 3 Abliterated GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.GEMMA_3_27B_IT_ABLITERATED_GGUF: LLMModelConfig(
            pretrained_model_name="mlabonne/gemma-3-27b-it-abliterated-GGUF",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Gemma 3 Abliterated GGUF",
            variant=variant,
