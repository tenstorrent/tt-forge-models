...
"""Glm Z1 9b 0414 Bnb 4bit model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="unsloth/GLM-Z1-9B-0414-bnb-4bit",
            max_length=128,
        ),
    }
