...
"""Flan T5 Paraphraser model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="alykassem/FLAN-T5-Paraphraser",
            max_length=128,
        ),
    }
