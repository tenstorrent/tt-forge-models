...
"""
GPT-2 Vietnamese model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available GPT-2 Vietnamese model variants."""

    BASE = "Default"


class ModelLoader(ForgeModel):
    """GPT-2 Vietnamese model loader for causal language modeling."""

    _VARIANTS = {
        ModelVariant.BASE: LLMModelConfig(
            pretrained_model_name="NlpHUST/gpt2-vietnamese",
            max_length=256,
        ),
    }
    ...
    sample_text = "Việt Nam là quốc gia có"
