...
"""
DarkNet model loader implementation
"""
...
@dataclass
class DarkNetConfig(ModelConfig):
    """Configuration specific to DarkNet models"""
...
class ModelVariant(StrEnum):
    """Available DarkNet model variants."""

    DARKNET53_C2NS_IN1K = "darknet53.c2ns_in1k"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.DARKNET53_C2NS_IN1K: DarkNetConfig(
            pretrained_model_name="darknet53.c2ns_in1k",
            source=ModelSource.TIMM,
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.DARKNET53_C2NS_IN1K
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load pretrained DarkNet model for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The DarkNet model instance.
        """
        ...
        if source == ModelSource.TIMM:
            ...
            raise ValueError(f"Unsupported source for DarkNet: {source}")
