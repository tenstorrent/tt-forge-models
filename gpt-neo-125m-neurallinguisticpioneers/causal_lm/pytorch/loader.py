...
"""Gpt Neo 125m Neurallinguisticpioneers model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ogimgio/gpt-neo-125m-neurallinguisticpioneers",
            max_length=128,
        ),
    }
