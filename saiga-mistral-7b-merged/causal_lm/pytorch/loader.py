...
"""Saiga Mistral 7b Merged model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="IlyaGusev/saiga_mistral_7b_merged",
            max_length=128,
        ),
    }
