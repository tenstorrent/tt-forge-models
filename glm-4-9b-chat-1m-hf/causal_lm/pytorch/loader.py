...
"""Glm 4 9b Chat 1m Hf model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="zai-org/glm-4-9b-chat-1m-hf",
            max_length=128,
        ),
    }
