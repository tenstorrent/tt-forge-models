...
"""
Helper functions for ControlNet IP2P SD1.5 model loading and processing.
"""
...
def load_controlnet_ip2p_sd15_pipe(controlnet_model_name, base_model_name):
    """Load ControlNet IP2P SD1.5 pipeline.
...
def create_ip2p_conditioning_image(height=512, width=512):
    """Create a dummy conditioning image for IP2P (Instruct Pix2Pix).

    Creates a simple synthetic RGB image suitable for ControlNet IP2P conditioning.
...
def controlnet_ip2p_sd15_preprocessing(
    pipe,
    prompt,
    control_image,
    device="cpu",
    ...
    """Preprocess inputs for ControlNet IP2P SD1.5 model.

    Args:
        pipe: StableDiffusionControlNetPipeline
        prompt: Text prompt describing the desired edit
        control_image: Source image to edit
