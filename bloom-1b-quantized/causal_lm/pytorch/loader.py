...
"""Bloom 1b Quantized model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="FabbriSimo01/Bloom_1b_Quantized",
            max_length=128,
        ),
    }
