...
"""Mdr Roberta Q Encoder model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="deutschmann/mdr_roberta_q_encoder",
            max_length=128,
        ),
    }
