...
"""Pythia410m V0 Instruct model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="SummerSigh/Pythia410m-V0-Instruct",
            max_length=128,
        ),
    }
