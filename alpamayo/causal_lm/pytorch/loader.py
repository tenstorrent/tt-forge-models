...
class ModelVariant(StrEnum):
    """Available Alpamayo R1 model variants for causal language modeling."""

    ALPAMAYO_R1_10B = "R1_10B"


class ModelLoader(ForgeModel):
    """Alpamayo R1 model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.ALPAMAYO_R1_10B: LLMModelConfig(
            pretrained_model_name="nvidia/Alpamayo-R1-10B",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.ALPAMAYO_R1_10B
