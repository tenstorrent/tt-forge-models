...
"""Qa Scibert Seed36 model loader implementation for question answering."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="MaterialsInformaticsLaboratory/QA-SciBERT-seed36",
            max_length=384,
        ),
    }
