...
"""Matter 0 1 Slim 7b C model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="0-hero/Matter-0.1-Slim-7B-C",
            max_length=128,
        ),
    }
