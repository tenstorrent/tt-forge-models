...
class ModelLoader(ForgeModel):
    ...
    def load_inputs(self, dtype_override=None, mesh=None):
        ...
        inputs["token_type_ids"] = jnp.zeros_like(inputs["input_ids"])
    ...
    def load_parameters_partition_spec(
        ...
        if (
            ...
            # Use EasyDel's RobertaConfig to get proper partition rules
            from easydel.modules.roberta import RobertaConfig

            roberta_config = RobertaConfig()
            partition_rules = roberta_config.get_partition_rules()
