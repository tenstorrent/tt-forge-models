...
class ModelVariant(StrEnum):
    """Available Florence-2 prompt generation model variants."""

    LARGE = "Large"


class ModelLoader(ForgeModel):
    """Florence-2 prompt generation model loader implementation."""

    _VARIANTS = {
        ModelVariant.LARGE: ModelConfig(
            pretrained_model_name="MiaoshouAI/Florence-2-large-PromptGen-v1.5",
        ),
    }
