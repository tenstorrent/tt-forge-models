...
"""Pythia 1 4b Deduped V0 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="EleutherAI/pythia-1.4b-deduped-v0",
            max_length=128,
        ),
    }
