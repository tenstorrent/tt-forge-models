...
"""Gemma 2 9b It Coding model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="MergeBench/gemma-2-9b-it_coding",
            max_length=128,
        ),
    }
