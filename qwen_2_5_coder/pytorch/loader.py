...
class ModelVariant(StrEnum):
    ...
    QWEN_2_5_CODER_3B_INSTRUCT_MLX_4BIT = "3B_Instruct_MLX_4bit"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.QWEN_2_5_CODER_1_5B_UNSLOTH: LLMModelConfig(
            pretrained_model_name="unsloth/Qwen2.5-Coder-1.5B",
            max_length=128,
        ),
        ...
        ModelVariant.QWEN_2_5_CODER_1_5B_INSTRUCT_4BIT: LLMModelConfig(
            pretrained_model_name="mlx-community/Qwen2.5-Coder-1.5B-Instruct-4bit",
            max_length=128,
        ),
        ...
        ModelVariant.QWEN_2_5_CODER_3B_INSTRUCT_MLX_4BIT: LLMModelConfig(
            pretrained_model_name="lmstudio-community/Qwen2.5-Coder-3B-Instruct-MLX-4bit",
            max_length=128,
        ),
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        if variant in [
            ...
            ModelVariant.QWEN_2_5_CODER_1_5B_UNSLOTH,
            ModelVariant.QWEN_2_5_CODER_1_5B_INSTRUCT_UNSLOTH,
            ModelVariant.QWEN_2_5_CODER_1_5B_INSTRUCT_4BIT,
            ...
            ModelVariant.QWEN_2_5_CODER_3B_INSTRUCT_MLX_4BIT,
