...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        if variant in [ModelVariant.QWEN_2_5_CODER_0_5B, ModelVariant.QWEN_2_5_CODER_1_5B, 
                       ModelVariant.QWEN_2_5_CODER_1_5B_INSTRUCT, ModelVariant.QWEN_2_5_CODER_3B,
