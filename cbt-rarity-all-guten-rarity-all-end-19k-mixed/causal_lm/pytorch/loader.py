...
"""Cbt Rarity All Guten Rarity All End 19k Mixed model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="NasimB/cbt-rarity-all-guten-rarity-all-end-19k-mixed",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Cbt Rarity All Guten Rarity All End 19k Mixed",
