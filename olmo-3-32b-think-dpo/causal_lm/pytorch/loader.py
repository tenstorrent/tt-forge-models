...
"""Olmo 3 32b Think Dpo model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="allenai/Olmo-3-32B-Think-DPO",
            max_length=128,
        ),
    }
