...
class ModelVariant(StrEnum):
    """Available Mindbot Ultra 4B 16b GGUF model variants for causal language modeling."""

    MINDBOT_ULTRA_4B_16B_I1_GGUF = "4B_16b_i1_GGUF"


class ModelLoader(ForgeModel):
    """Mindbot Ultra 4B 16b GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MINDBOT_ULTRA_4B_16B_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Mindbot_Ultra_4B_16b-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MINDBOT_ULTRA_4B_16B_I1_GGUF

    GGUF_FILE = "Mindbot_Ultra_4B_16b.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Mindbot Ultra 4B 16b GGUF",
            variant=variant,
