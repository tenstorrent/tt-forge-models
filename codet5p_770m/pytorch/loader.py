...
class ModelVariant(StrEnum):
    """Available CodeT5+ 770M model variants."""

    CODET5P_770M = "CodeT5p_770M"


class ModelLoader(ForgeModel):
    """CodeT5+ 770M model loader implementation for conditional generation tasks."""
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the CodeT5+ 770M model instance for this instance's variant.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The CodeT5+ 770M model instance for conditional generation.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the CodeT5+ 770M model.
