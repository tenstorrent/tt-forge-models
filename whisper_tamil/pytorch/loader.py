...
"""
Whisper-Tamil model loader implementation.

vasista22/whisper-tamil-large-v2 is a Tamil fine-tune of openai/whisper-large-v2,
trained for automatic speech recognition in Tamil.
"""
...
class ModelVariant(StrEnum):
    """Available Whisper-Tamil model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.LARGE_V2: ModelConfig(
            pretrained_model_name="vasista22/whisper-tamil-large-v2",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load a Whisper-Tamil model from Hugging Face."""
    ...
    def load_inputs(self, dtype_override=None):
        """Generate sample inputs for Whisper-Tamil model."""
