...
class ModelVariant(StrEnum):
    """Available FLUX.2 Klein True model variants."""

    KLEIN_9B_TRUE_V1 = "Klein_9B_True_V1"


class ModelLoader(ForgeModel):
    """FLUX.2 Klein True model loader implementation for text-to-image generation tasks."""

    _VARIANTS = {
        ModelVariant.KLEIN_9B_TRUE_V1: ModelConfig(
            pretrained_model_name="wikeeyang/Flux2-Klein-9B-True-V1",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.KLEIN_9B_TRUE_V1

    SAFETENSORS_FILE = "Flux2-Klein-9B-True-bf16.safetensors"
