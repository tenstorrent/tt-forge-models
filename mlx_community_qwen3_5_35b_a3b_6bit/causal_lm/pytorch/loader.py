...
"""
mlx-community/Qwen3.5-35B-A3B-6bit model loader for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available mlx-community Qwen3.5-35B-A3B-6bit model variants."""
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="mlx-community Qwen3.5-35B-A3B-6bit",
            variant=variant,
