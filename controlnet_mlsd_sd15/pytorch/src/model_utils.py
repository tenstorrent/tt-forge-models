...
"""
Helper functions for ControlNet MLSD SD 1.5 model loading and processing.
"""
...
def load_controlnet_mlsd_sd15_pipe(controlnet_model_name, base_model_name):
    """Load ControlNet MLSD SD 1.5 pipeline.

    Args:
        controlnet_model_name: ControlNet model name on HuggingFace
        base_model_name: Base SD 1.5 model name on HuggingFace
...
def create_mlsd_conditioning_image(height=512, width=512):
    """Create a dummy MLSD conditioning image.
...
def controlnet_mlsd_sd15_preprocessing(
    pipe,
    prompt,
    control_image,
    device="cpu",
    ...
    """Preprocess inputs for ControlNet MLSD SD 1.5 model.

    Args:
        pipe: StableDiffusionControlNetPipeline
        prompt: Text prompt for generation
        control_image: MLSD conditioning image
