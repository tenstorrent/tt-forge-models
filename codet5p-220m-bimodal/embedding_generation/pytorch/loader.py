...
"""Codet5p 220m Bimodal model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Salesforce/codet5p-220m-bimodal",
        ),
    }
