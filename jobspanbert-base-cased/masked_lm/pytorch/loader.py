...
"""Jobspanbert Base Cased model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="jjzha/jobspanbert-base-cased",
            max_length=128,
        ),
    }
