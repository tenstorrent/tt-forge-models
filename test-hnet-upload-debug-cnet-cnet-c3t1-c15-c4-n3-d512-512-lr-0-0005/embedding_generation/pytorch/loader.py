...
"""Test Hnet Upload Debug Cnet Cnet C3t1 C15 C4 N3 D512 512 Lr 0 0005 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="emarro/test-hnet-upload-debug_cnet_cnet_c3t1-C15-c4_N3_D512-512_lr-0.0005",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Test Hnet Upload Debug Cnet Cnet C3t1 C15 C4 N3 D512 512 Lr 0 0005",
