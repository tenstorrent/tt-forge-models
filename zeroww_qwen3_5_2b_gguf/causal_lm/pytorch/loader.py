...
"""
ZeroWw Qwen3.5-2B GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available ZeroWw Qwen3.5-2B GGUF model variants for causal language modeling."""

    ZEROWW_QWEN3_5_2B_GGUF = "2B_GGUF"


class ModelLoader(ForgeModel):
    """ZeroWw Qwen3.5-2B GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.ZEROWW_QWEN3_5_2B_GGUF: LLMModelConfig(
            pretrained_model_name="ZeroWw/Qwen3.5-2B-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.ZEROWW_QWEN3_5_2B_GGUF
