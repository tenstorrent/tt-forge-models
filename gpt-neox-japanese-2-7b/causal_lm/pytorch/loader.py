...
"""Gpt Neox Japanese 2 7b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="abeja/gpt-neox-japanese-2.7b",
            max_length=128,
        ),
    }
