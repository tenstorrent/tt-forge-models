...
def _patch_transformers_glm4moe_gguf():
    ...
    # Also register the remapped model_type name used in tokenizer lookup
    ...
    # Patch get_gguf_hf_weights_map to remap glm4_moe -> glm4moe so gguf-py
    # can find the tensor name map (gguf-py uses the GGUF architecture name).
