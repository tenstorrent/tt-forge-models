...
"""
anton-hugging/TimeOmni-1-7B model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available model variants for anton-hugging TimeOmni-1-7B."""

    TIME_OMNI_1_7B = "1_7B"


class ModelLoader(ForgeModel):
    """anton-hugging/TimeOmni-1-7B model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.TIME_OMNI_1_7B: LLMModelConfig(
            pretrained_model_name="anton-hugging/TimeOmni-1-7B",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.TIME_OMNI_1_7B

    sample_text = "Give me a short introduction to time series reasoning."
