...
"""
Goedel Prover model loader implementation for causal language modeling.
"""
...
class ModelLoader(ForgeModel):
    """Goedel Prover model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.GOEDEL_PROVER_V2_8B_REVIEWER

    sample_text = "Prove that the square root of 2 is irrational."
