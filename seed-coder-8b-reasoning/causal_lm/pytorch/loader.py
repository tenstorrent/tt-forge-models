...
"""Seed Coder 8b Reasoning model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ByteDance-Seed/Seed-Coder-8B-Reasoning",
            max_length=128,
        ),
    }
