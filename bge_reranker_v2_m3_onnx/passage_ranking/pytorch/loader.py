...
"""
BGE Reranker v2 M3 ONNX model loader implementation for passage ranking.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available BGE Reranker v2 M3 ONNX model variants for passage ranking."""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.M3_ONNX
