...
class ModelVariant(StrEnum):
    ...
    NEMOTRON_3_SUPER_120B_A12B_BF16_HERETIC_GGUF = "3_Super_120B_A12B_BF16_heretic_GGUF"


class ModelLoader(ForgeModel):
    """NVIDIA Nemotron 3 Super 120B A12B BF16 Heretic GGUF model loader implementation for causal language modeling tasks."""
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="NVIDIA Nemotron 3 Super 120B A12B BF16 Heretic GGUF",
            variant=variant,
