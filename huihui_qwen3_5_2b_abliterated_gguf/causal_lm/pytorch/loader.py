...
"""
Huihui Qwen3.5 2B Abliterated i1-GGUF model loader implementation for causal language modeling.
"""
import contextlib
import numpy as np
import torch
...
class ModelVariant(StrEnum):
    """Available Huihui Qwen3.5 2B Abliterated i1-GGUF model variants for causal language modeling."""

    HUIHUI_QWEN3_5_2B_ABLITERATED_I1_GGUF = "2B_i1_GGUF"


class ModelLoader(ForgeModel):
    """Huihui Qwen3.5 2B Abliterated i1-GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.HUIHUI_QWEN3_5_2B_ABLITERATED_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Huihui-Qwen3.5-2B-abliterated-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.HUIHUI_QWEN3_5_2B_ABLITERATED_I1_GGUF

    GGUF_FILE = "Huihui-Qwen3.5-2B-abliterated.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Huihui Qwen3.5 2B Abliterated i1-GGUF",
            variant=variant,
