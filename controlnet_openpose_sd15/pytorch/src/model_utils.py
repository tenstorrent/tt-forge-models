...
"""
Helper functions for ControlNet OpenPose SD1.5 model loading and processing.
"""
...
def load_controlnet_openpose_sd15_pipe(controlnet_model_name, base_model_name):
    """Load ControlNet OpenPose SD1.5 pipeline.
...
def create_openpose_conditioning_image(height=512, width=512):
    """Create a dummy OpenPose conditioning image.
...
def controlnet_openpose_sd15_preprocessing(
    pipe,
    prompt,
    control_image,
    device="cpu",
    ...
    """Preprocess inputs for ControlNet OpenPose SD1.5 model.

    Args:
        pipe: StableDiffusionControlNetPipeline
        prompt: Text prompt for generation
        control_image: OpenPose conditioning image
