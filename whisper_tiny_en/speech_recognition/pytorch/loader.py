...
"""
Whisper Tiny English model loader implementation for speech recognition (ASR).

A fine-tuned version of OpenAI's Whisper Tiny English, optimized for
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.WHISPER_TINY_EN
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Whisper Tiny English model instance.
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the Whisper Tiny English model.
