...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.ASID_CAPTIONER_7B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the ASID Captioner model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The Wrapped ASID Captioner model instance for vision-language tasks.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the ASID Captioner model with this instance's variant settings.
