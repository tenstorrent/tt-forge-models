...
"""Distilbert Dot Tas B B256 Msmarco model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="sebastian-hofstaetter/distilbert-dot-tas_b-b256-msmarco",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Distilbert Dot Tas B B256 Msmarco",
