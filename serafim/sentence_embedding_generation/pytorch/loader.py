...
class ModelVariant(StrEnum):
    """Available model variants for SERAFIM sentence encoder."""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.SERAFIM_900M_PT_SENTENCE_ENCODER_IR
    ...
    def load_inputs(self, dtype_override=None, sentence=None):
        ...
        if sentence is None:
            sentence = "Esta é uma frase de exemplo para similaridade semântica."
