...
"""
GBERT model loader implementation for sentence embedding generation.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available GBERT model variants for sentence embedding generation."""

    GBERT_LARGE_PARAPHRASE_EUCLIDEAN = (
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.GBERT_LARGE_PARAPHRASE_EUCLIDEAN: LLMModelConfig(
            pretrained_model_name="deutsche-telekom/gbert-large-paraphrase-euclidean",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GBERT_LARGE_PARAPHRASE_EUCLIDEAN
    ...
    def load_inputs(self, dtype_override=None, sentence=None):
        ...
        if sentence is None:
            sentence = "Das ist ein Beispielsatz auf Deutsch."
