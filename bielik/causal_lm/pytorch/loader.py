...
"""
Bielik-11B Instruct causal LM model loader implementation.

Bielik is a Polish large language model built on the Mistral architecture
(model_type="mistral", architecture MistralForCausalLM).
"""
...
class ModelLoader(ForgeModel):
    """Bielik-11B model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.BIELIK_11B_V2_3_INSTRUCT: LLMModelConfig(
            pretrained_model_name="speakleash/Bielik-11B-v2.3-Instruct",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BIELIK_11B_V2_3_INSTRUCT

    sample_text = "Kim jesteś?"
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Bielik-11B model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The Bielik-11B model for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the Bielik-11B model with this instance's variant settings.
