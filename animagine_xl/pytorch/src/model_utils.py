...
"""
Helper functions for Animagine XL model loading and processing.
"""
...
def stable_diffusion_preprocessing_xl(
    ...
    **kwargs,
    ...
    """Preprocess inputs for DreamShaper XL model.

    Args:
        pipe: DreamShaper XL pipeline
