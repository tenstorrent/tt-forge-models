...
"""Speechless Mistral Six In One 7b Orth 1 0 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="speechlessai/speechless-mistral-six-in-one-7b-orth-1.0",
            max_length=128,
        ),
    }
