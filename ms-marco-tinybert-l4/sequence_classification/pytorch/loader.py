...
"""Ms Marco Tinybert L4 model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="cross-encoder/ms-marco-TinyBERT-L4",
        ),
    }
