...
class ModelVariant(StrEnum):
    """Available Gemma 2 BNB 4-bit model variants for causal language modeling."""

    GEMMA_2_9B_IT_BNB_4BIT = "2_9B_IT_BNB_4BIT"


class ModelLoader(ForgeModel):
    """Gemma 2 BNB 4-bit model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GEMMA_2_9B_IT_BNB_4BIT: LLMModelConfig(
            pretrained_model_name="unsloth/gemma-2-9b-it-bnb-4bit",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GEMMA_2_9B_IT_BNB_4BIT
