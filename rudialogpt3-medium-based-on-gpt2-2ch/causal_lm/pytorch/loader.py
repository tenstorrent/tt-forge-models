...
"""Rudialogpt3 Medium Based On Gpt2 2ch model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="BlackSamorez/rudialogpt3_medium_based_on_gpt2_2ch",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Rudialogpt3 Medium Based On Gpt2 2ch",
