...
"""Dialect Ar Gpt 2021 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="monsoon-nlp/dialect-ar-gpt-2021",
            max_length=128,
        ),
    }
