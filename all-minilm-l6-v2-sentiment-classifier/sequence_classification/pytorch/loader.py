...
"""All Minilm L6 V2 Sentiment Classifier model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="shhossain/all-MiniLM-L6-v2-sentiment-classifier",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="All Minilm L6 V2 Sentiment Classifier",
