...
"""
Llama 3 8B GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelLoader(ForgeModel):
    """Llama 3 8B GGUF model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.LLAMA_3_8B_GGUF

    GGUF_FILE = "Llama-3-8B.Q4_K_M.gguf"
