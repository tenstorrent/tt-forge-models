...
"""
RobBERT model loader implementation for masked language modeling tasks.
"""
import torch
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.ROBBERT_V2_DUTCH_BASE
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        test_input = "Amsterdam is de <mask> van Nederland."
