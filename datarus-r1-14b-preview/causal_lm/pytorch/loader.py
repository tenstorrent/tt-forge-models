...
"""Datarus R1 14b Preview model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="DatarusAI/Datarus-R1-14B-preview",
            max_length=128,
        ),
    }
