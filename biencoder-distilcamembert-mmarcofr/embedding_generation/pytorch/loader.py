...
"""Biencoder Distilcamembert Mmarcofr model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="antoinelouis/biencoder-distilcamembert-mmarcoFR",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Biencoder Distilcamembert Mmarcofr",
