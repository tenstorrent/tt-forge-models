...
"""
StableDiffusionVN/Flux GGUF model loader implementation for text-to-image generation.
...
class ModelLoader(ForgeModel):
    """StableDiffusionVN/Flux GGUF model loader implementation for text-to-image generation tasks."""
    ...
    _GGUF_FILES = {
        ModelVariant.DEV_Q4_K_S: "Unet/flux1-dev-Q4_K_S.gguf",
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="StableDiffusionVN Flux GGUF",
            variant=variant,
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        # Guidance: FLUX.1-dev uses classifier-free guidance, schnell does not.
        guidance = None
        if self._variant == ModelVariant.DEV_Q4_K_S:
            guidance = torch.tensor([self.guidance_scale], dtype=dtype).expand(
                batch_size
            )
