...
"""
Res2Net model loader implementation (timm variants)
"""
...
class ModelVariant(StrEnum):
    ...
    RES2NET50_26W_4S_IN1K = "Res2Net50_26w_4s.in1k"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.RES2NET50_26W_4S_IN1K: ModelConfig(
            pretrained_model_name="res2net50_26w_4s.in1k",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.RES2NET50_26W_4S_IN1K
