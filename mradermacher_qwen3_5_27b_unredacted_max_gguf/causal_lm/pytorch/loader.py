...
"""
mradermacher Qwen3.5 27B Unredacted MAX GGUF model loader for causal language modeling.
"""
...
def _patched_load_gguf_checkpoint(gguf_path, return_tensors=False, **kwargs):
    ...
    # PACKAGE_DISTRIBUTION_MAPPING is built at transformers import time; refresh
    # it so gguf (installed at test time) is visible to is_gguf_available().
...
class ModelVariant(StrEnum):
    """Available mradermacher Qwen3.5 27B Unredacted MAX GGUF model variants."""

    QWEN3_5_27B_UNREDACTED_MAX_Q4_K_M_GGUF = "27B_UNREDACTED_MAX_Q4_K_M_GGUF"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.QWEN3_5_27B_UNREDACTED_MAX_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Qwen3.5-27B-Unredacted-MAX-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN3_5_27B_UNREDACTED_MAX_Q4_K_M_GGUF

    GGUF_FILE = "Qwen3.5-27B-Unredacted-MAX.Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher Qwen3.5 27B Unredacted MAX GGUF",
            variant=variant,
