...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.ELYZA_THINKING_1_0_QWEN_32B_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/ELYZA-Thinking-1.0-Qwen-32B-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.ELYZA_THINKING_1_0_QWEN_32B_I1_GGUF

    GGUF_FILE = "ELYZA-Thinking-1.0-Qwen-32B.i1-Q4_K_M.gguf"
