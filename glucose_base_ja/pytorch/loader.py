...
"""
GLuCoSE-base-ja model loader
for Japanese sentence embedding generation.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available model variants for GLuCoSE-base-ja."""

    GLUCOSE_BASE_JA = "pkshatech/GLuCoSE-base-ja"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.GLUCOSE_BASE_JA: LLMModelConfig(
            pretrained_model_name="pkshatech/GLuCoSE-base-ja",
            max_length=512,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GLUCOSE_BASE_JA
    ...
    def load_inputs(self, dtype_override=None, sentence=None):
        ...
        if sentence is None:
            sentence = "PKSHA Technologyは機械学習/深層学習技術に関わるアルゴリズムソリューションを展開している。"
