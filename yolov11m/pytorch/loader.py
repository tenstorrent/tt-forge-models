...
"""
YOLOv11m model loader implementation
"""
import torch
...
from .src.yolov11m import YoloV11m


class ModelVariant(StrEnum):
    """Available YOLOv11m model variants."""
...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return a YOLOv11m model instance with random weights.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The YOLOv11m model instance.
        """
        model = YoloV11m()
        model.eval()
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        YOLOv11m expects input of shape [batch, 3, 640, 640].
    ...
    def unpack_forward_output(self, fwd_output):
        ...
        YOLOv11m returns a single detection tensor of shape [batch, 84, N]
