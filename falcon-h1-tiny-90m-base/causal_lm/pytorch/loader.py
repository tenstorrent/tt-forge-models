...
"""Falcon H1 Tiny 90m Base model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="tiiuae/Falcon-H1-Tiny-90M-Base",
            max_length=128,
        ),
    }
