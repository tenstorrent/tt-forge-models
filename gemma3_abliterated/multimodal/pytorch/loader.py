...
"""
Gemma3 Abliterated model loader implementation for multimodal modeling.
"""
...
class ModelVariant(StrEnum):
    ...
    GEMMA_3_27B_IT_ABLITERATED = "mlabonne/gemma-3-27b-it-abliterated"


class ModelLoader(ForgeModel):
    """Gemma3 Abliterated model loader implementation for multimodal modeling tasks."""

    _VARIANTS = {
        ModelVariant.GEMMA_3_27B_IT_ABLITERATED: LLMModelConfig(
            pretrained_model_name="mlabonne/gemma-3-27b-it-abliterated",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GEMMA_3_27B_IT_ABLITERATED
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="gemma_3_abliterated_multimodal",
            variant=variant,
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Gemma3 Abliterated multimodal model instance.
    ...
    def load_inputs(
        ...
        """Load and return sample inputs for the Gemma3 Abliterated multimodal model.
