...
"""Legal Bert Sm Gen1 Large Summarized Defined Cv 0 model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="wiorz/legal_bert_sm_gen1_large_summarized_defined_cv_0",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Legal Bert Sm Gen1 Large Summarized Defined Cv 0",
