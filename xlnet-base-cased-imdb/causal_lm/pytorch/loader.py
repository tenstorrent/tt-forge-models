...
"""Xlnet Base Cased Imdb model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="textattack/xlnet-base-cased-imdb",
            max_length=128,
        ),
    }
