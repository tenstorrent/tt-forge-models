...
class ModelVariant(StrEnum):
    """Available SAINEMO-reMIX GGUF model variants for causal language modeling."""

    SAINEMO_REMIX_GGUF = "SAINEMO_reMIX_GGUF"


class ModelLoader(ForgeModel):
    """SAINEMO-reMIX GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.SAINEMO_REMIX_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/SAINEMO-reMIX-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SAINEMO_REMIX_GGUF
