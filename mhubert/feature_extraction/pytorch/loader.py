...
class ModelVariant(StrEnum):
    """Available mHuBERT feature extraction model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE_25HZ: ModelConfig(
            pretrained_model_name="slprl/mhubert-base-25hz",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BASE_25HZ
