...
"""Deberta V3 Large Tasksource Rlhf Reward Model model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="sileod/deberta-v3-large-tasksource-rlhf-reward-model",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Deberta V3 Large Tasksource Rlhf Reward Model",
