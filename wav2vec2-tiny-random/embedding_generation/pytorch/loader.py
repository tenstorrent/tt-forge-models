...
"""Wav2vec2 Tiny Random model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="patrickvonplaten/wav2vec2_tiny_random",
        ),
    }
