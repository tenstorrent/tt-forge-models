...
"""
Tiny Aya Global GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Tiny Aya Global GGUF model variants for causal language modeling."""

    TINY_AYA_GLOBAL_Q4_K_M = "Q4_K_M"


class ModelLoader(ForgeModel):
    """Tiny Aya Global GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.TINY_AYA_GLOBAL_Q4_K_M: LLMModelConfig(
            pretrained_model_name="CohereLabs/tiny-aya-global-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.TINY_AYA_GLOBAL_Q4_K_M

    GGUF_FILE = "tiny-aya-global-q4_k_m.gguf"
