...
"""Solar 10b Platypus Lora model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="mobidic/solar-10b-platypus-lora",
            max_length=128,
        ),
    }
