...
# Sourced from ruclip 0.0.2 (MIT License): https://github.com/ai-forever/ru-clip
# -*- coding: utf-8 -*-
import json
import os
...
class RuCLIPProcessor:
    ...
    def __init__(
        ...
        self.image_transform = T.Compose(
            [
                ...
                T.RandomResizedCrop(image_size, scale=(1.0, 1.0), ratio=(1.0, 1.0)),
                T.ToTensor(),
    ...
    def prepare_tokens(self, tokens):
        ...
        if empty_positions > 0:
            tokens = np.hstack((tokens, np.zeros(empty_positions)))
