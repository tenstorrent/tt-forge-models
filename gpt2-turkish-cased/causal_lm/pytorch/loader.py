...
"""Gpt2 Turkish Cased model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="hakanbogan/gpt2-turkish-cased",
            max_length=128,
        ),
    }
