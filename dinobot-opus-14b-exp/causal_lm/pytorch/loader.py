...
"""Dinobot Opus 14b Exp model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="prithivMLmods/Dinobot-Opus-14B-Exp",
            max_length=128,
        ),
    }
