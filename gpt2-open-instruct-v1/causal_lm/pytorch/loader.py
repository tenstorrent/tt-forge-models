...
"""Gpt2 Open Instruct V1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="vicgalle/gpt2-open-instruct-v1",
            max_length=128,
        ),
    }
