...
"""Sentence Transformers Klue Bert Base model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="hunkim/sentence-transformers-klue-bert-base",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sentence Transformers Klue Bert Base",
