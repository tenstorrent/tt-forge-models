...
"""Tinysapbert From Tinypubmedbert V1 0 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="dmis-lab/TinySapBERT-from-TinyPubMedBERT-v1.0",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Tinysapbert From Tinypubmedbert V1 0",
