...
"""Opensearch Neural Sparse Encoding Doc V2 Mini model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="opensearch-project/opensearch-neural-sparse-encoding-doc-v2-mini",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Opensearch Neural Sparse Encoding Doc V2 Mini",
