...
"""Stablediffusion Prompt Generator Gpt Neo 125m model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="DrishtiSharma/StableDiffusion-Prompt-Generator-GPT-Neo-125M",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Stablediffusion Prompt Generator Gpt Neo 125m",
