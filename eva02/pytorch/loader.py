...
class ModelVariant(StrEnum):
    ...
    LARGE_PATCH14_448_MIM_IN22K_FT_IN22K_IN1K = (
        "Large_Patch14_448_MIM_IN22K_FT_IN22K_IN1K"
    )
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.LARGE_PATCH14_448_MIM_IN22K_FT_IN22K_IN1K: Eva02Config(
            pretrained_model_name="hf_hub:timm/eva02_large_patch14_448.mim_in22k_ft_in22k_in1k",
            source=ModelSource.TIMM,
        ),
        ModelVariant.LARGE_PATCH14_CLIP_336_MERGED2B_FT_INAT21: Eva02Config(
