...
"""
Bella Bartender Heretic model loader implementation for causal language modeling.

juiceb0xc0de/bella-bartender-heretic-1b is a Llama-3.2-1B fine-tune
(LlamaForCausalLM architecture) sourced from HuggingFace.
"""
...
class ModelVariant(StrEnum):
    """Available Bella Bartender Heretic model variants for causal LM."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BELLA_1B: LLMModelConfig(
            pretrained_model_name="juiceb0xc0de/bella-bartender-heretic-1b",
            max_length=128,
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.BELLA_1B
