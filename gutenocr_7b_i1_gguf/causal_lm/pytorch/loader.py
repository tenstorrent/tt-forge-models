...
"""
mradermacher/GutenOCR-7B-i1-GGUF model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    """Available GutenOCR-7B-i1-GGUF model variants for causal language modeling."""

    GUTENOCR_7B_I1_GGUF = "7B_i1_GGUF"


class ModelLoader(ForgeModel):
    """GutenOCR-7B-i1-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.GUTENOCR_7B_I1_GGUF: LLMModelConfig(
            pretrained_model_name="rootsautomation/GutenOCR-7B",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GUTENOCR_7B_I1_GGUF

    sample_text = "Read all text in the document and return a linearized TEXT string."
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher GutenOCR-7B-i1-GGUF",
            variant=variant,
