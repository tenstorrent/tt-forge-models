...
class ModelVariant(StrEnum):
    """Available Qwen3.5 9B Ultra Heretic GGUF model variants for causal language modeling."""

    QWEN3_5_9B_ULTRA_HERETIC_GGUF = "9B_ULTRA_HERETIC_GGUF"


class ModelLoader(ForgeModel):
    """Qwen3.5 9B Ultra Heretic GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN3_5_9B_ULTRA_HERETIC_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Qwen3.5-9B-ultra-heretic-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN3_5_9B_ULTRA_HERETIC_GGUF

    GGUF_FILE = "Qwen3.5-9B-ultra-heretic.Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Qwen3.5 9B Ultra Heretic GGUF",
            variant=variant,
