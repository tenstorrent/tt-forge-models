...
"""
GLM-5 AWQ model loader implementation for causal language modeling.

Uses reduced MoE configuration for testing since the full 744B parameter
...
class ModelLoader(ForgeModel):
    """GLM-5 AWQ model loader for causal language modeling."""

    def __init__(self, variant=None, num_layers: Optional[int] = None):
        super().__init__(variant)
        self.model_name = "QuantTrio/GLM-5-AWQ"
        self.tokenizer = None
