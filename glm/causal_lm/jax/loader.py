...
"""
GLM model loader implementation for causal language modeling.
"""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant._4_9B: LLMModelConfig(
            pretrained_model_name="zai-org/glm-4-9b-hf",
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant._4_9B
    ...
    def load_model(self, dtype_override=None):
        """Load and return the GLM model instance for this instance's variant.
    ...
    def load_inputs(self, dtype_override=None, mesh=None):
        """Load and return sample inputs for the GLM model with this instance's variant settings.
    ...
    def load_parameters_partition_spec(
        ...
        if (
            ...
            from easydel.modules.glm import GlmConfig

            glm_config = GlmConfig()
            partition_rules = glm_config.get_partition_rules()
