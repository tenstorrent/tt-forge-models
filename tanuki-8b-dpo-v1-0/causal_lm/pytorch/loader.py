...
"""Tanuki 8b Dpo V1 0 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="weblab-GENIAC/Tanuki-8B-dpo-v1.0",
            max_length=128,
        ),
    }
