...
"""Openbuddy Falcon 180b V13 Preview0 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="OpenBuddy/openbuddy-falcon-180b-v13-preview0",
            max_length=128,
        ),
    }
