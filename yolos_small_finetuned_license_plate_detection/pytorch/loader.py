...
"""
YOLOS Small Finetuned License Plate Detection model loader implementation.
"""
...
class ModelLoader(ForgeModel):
    ...
    def __init__(self, variant=None):
        ...
        self.model_variant = "nickmuchi/yolos-small-finetuned-license-plate-detection"

    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the YOLOS Small Finetuned License Plate Detection model instance.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the YOLOS Small Finetuned License Plate Detection model.
