...
"""Biencoder Camembert Base Mmarcofr model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="antoinelouis/biencoder-camembert-base-mmarcoFR",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Biencoder Camembert Base Mmarcofr",
