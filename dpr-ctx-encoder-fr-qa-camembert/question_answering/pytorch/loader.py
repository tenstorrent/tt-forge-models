...
"""Dpr Ctx Encoder Fr Qa Camembert model loader implementation for question answering."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="AgentPublic/dpr-ctx_encoder-fr_qa-camembert",
            max_length=384,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Dpr Ctx Encoder Fr Qa Camembert",
