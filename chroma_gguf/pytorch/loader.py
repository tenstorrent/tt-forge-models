...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.UNLOCKED_V50_Q4_0: ModelConfig(
            pretrained_model_name="silveroxides/Chroma-GGUF",
        ),
    }
