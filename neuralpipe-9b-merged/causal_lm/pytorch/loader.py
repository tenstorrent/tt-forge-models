...
"""Neuralpipe 9b Merged model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="mlabonne/NeuralPipe-9B-merged",
            max_length=128,
        ),
    }
