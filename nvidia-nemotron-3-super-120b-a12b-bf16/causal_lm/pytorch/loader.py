...
"""Nvidia Nemotron 3 Super 120b A12b Bf16 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="MOHAMED9267M/NVIDIA-Nemotron-3-Super-120B-A12B-BF16",
            max_length=128,
        ),
    }
