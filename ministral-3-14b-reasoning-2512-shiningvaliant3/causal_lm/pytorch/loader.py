...
"""Ministral 3 14b Reasoning 2512 Shiningvaliant3 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ValiantLabs/Ministral-3-14B-Reasoning-2512-ShiningValiant3",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Ministral 3 14b Reasoning 2512 Shiningvaliant3",
