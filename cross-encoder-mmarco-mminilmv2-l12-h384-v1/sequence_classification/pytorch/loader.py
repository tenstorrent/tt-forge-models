...
"""Cross Encoder Mmarco Mminilmv2 L12 H384 V1 model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="corrius/cross-encoder-mmarco-mMiniLMv2-L12-H384-v1",
        ),
    }
