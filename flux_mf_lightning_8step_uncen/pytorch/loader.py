...
class ModelVariant(StrEnum):
    """Available FLUX.MF-lightning_8step-uncen model variants."""

    DEFAULT = "Default"


class ModelLoader(ForgeModel):
    """FLUX.MF-lightning_8step-uncen model loader for text-to-image generation tasks."""

    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="buildborderless/FLUX.MF-lightning_8step-uncen",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="FLUX.MF-lightning_8step-uncen",
            variant=variant,
