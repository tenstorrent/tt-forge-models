...
"""Stable Diffcoder 8b Instruct Heretic model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="trohrbaugh/Stable-DiffCoder-8B-Instruct-heretic",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Stable Diffcoder 8b Instruct Heretic",
