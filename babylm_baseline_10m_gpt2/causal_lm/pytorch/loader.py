...
"""
BabyLM Baseline 10M GPT-2 model loader implementation
"""
import torch
...
class ModelVariant(StrEnum):
    """Available BabyLM Baseline 10M GPT-2 model variants."""

    BABYLM_BASELINE_10M_GPT2 = "10M"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BABYLM_BASELINE_10M_GPT2: LLMModelConfig(
    ...
    DEFAULT_VARIANT = ModelVariant.BABYLM_BASELINE_10M_GPT2
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the BabyLM Baseline 10M GPT-2 model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The BabyLM Baseline 10M GPT-2 model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the BabyLM Baseline 10M GPT-2 model.
