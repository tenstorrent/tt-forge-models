...
"""
Qwen3 1.7B Multilingual TTS GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Qwen3 1.7B Multilingual TTS GGUF model variants for causal language modeling."""

    QWEN_3_1_7B_MULTILINGUAL_TTS_GGUF = "1.7B_Multilingual_TTS_GGUF"


class ModelLoader(ForgeModel):
    """Qwen3 1.7B Multilingual TTS GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_1_7B_MULTILINGUAL_TTS_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Qwen3-1.7B-Multilingual-TTS-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN_3_1_7B_MULTILINGUAL_TTS_GGUF

    GGUF_FILE = "Qwen3-1.7B-Multilingual-TTS.Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Qwen3 1.7B Multilingual TTS GGUF",
            variant=variant,
