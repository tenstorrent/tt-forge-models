...
"""Transformers Ud Japanese Electra Base Ginza 510 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="megagonlabs/transformers-ud-japanese-electra-base-ginza-510",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Transformers Ud Japanese Electra Base Ginza 510",
