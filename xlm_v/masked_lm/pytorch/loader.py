...
"""
XLM-V model loader implementation for masked language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available XLM-V model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE: LLMModelConfig(
            pretrained_model_name="facebook/xlm-v-base",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BASE

    sample_text = "Paris is the <mask> of France."
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the XLM-V model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The XLM-V model instance for masked language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the XLM-V model.
