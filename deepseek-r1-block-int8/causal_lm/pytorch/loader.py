...
"""Deepseek R1 Block Int8 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="meituan/DeepSeek-R1-Block-INT8",
            max_length=128,
        ),
    }
