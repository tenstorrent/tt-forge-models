...
"""
Helper functions for HS UltraHD CG Illustration Epic SDXL model loading and processing.
"""
...
def load_pipe(variant):
    """Load HS UltraHD CG Illustration Epic SDXL pipeline.
...
def stable_diffusion_preprocessing_xl(
    ...
    **kwargs,
    ...
    """Preprocess inputs for HS UltraHD CG Illustration Epic SDXL UNet model.
