...
"""Gpt2 Medium Indonesian model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="indonesian-nlp/gpt2-medium-indonesian",
            max_length=128,
        ),
    }
