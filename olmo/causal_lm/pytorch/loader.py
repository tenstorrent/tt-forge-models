...
"""
OLMo Causal LM model loader implementation
"""
...
class ModelLoader(ForgeModel):
    """OLMo model loader implementation for causal language modeling tasks."""

    # Dictionary of available model variants using structured configs
    _VARIANTS = {
        ModelVariant.OLMo_1B_0724: LLMModelConfig(
            pretrained_model_name="allenai/OLMo-1B-0724-hf",
            max_length=256,
        ),
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The OLMo model instance for causal language modeling.
        """
    ...
    def load_config(self):
        """Load and return the configuration for the OLMo model variant.
