...
"""
Phi-3.5 MoE model loader implementation.
"""
...
class ModelVariant(StrEnum):
    """Available Phi-3.5 MoE model variants for causal language modeling."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.PHI_3_5_MOE_INSTRUCT: LLMModelConfig(
            pretrained_model_name="microsoft/Phi-3.5-MoE-instruct",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.PHI_3_5_MOE_INSTRUCT
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The Phi-3.5 MoE model for causal language modeling.
        """
    ...
    def load_shard_spec(self, model):
        ...
        for layer in model.model.layers:
            ...
            # Distribute whole experts across devices (expert-parallel); the
