...
"""
Phi-3-small causal language modeling loader
"""
...
class ModelVariant(StrEnum):
    SMALL_8K_INSTRUCT = "Small_8K_Instruct"


class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.SMALL_8K_INSTRUCT: ModelConfig(
            pretrained_model_name="microsoft/Phi-3-small-8k-instruct"
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SMALL_8K_INSTRUCT
