...
"""
DFN CLIP model loader implementation for image-text similarity using OpenCLIP.
"""
import torch
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.VIT_H_14_378
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the DFN CLIP model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The DFN CLIP model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the DFN CLIP model.
    ...
    def post_process(self, outputs):
        """Post-process DFN CLIP model outputs to extract similarity scores.
