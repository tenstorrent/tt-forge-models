...
"""Centralbankroberta Agent Classifier model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Moritz-Pfeifer/CentralBankRoBERTa-agent-classifier",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Centralbankroberta Agent Classifier",
