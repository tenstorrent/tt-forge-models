...
"""
DreamShaper XL model loader implementation
"""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.DREAMSHAPER_XL_V21_TURBO
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the UNet from the DreamShaper XL pipeline.
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the DreamShaper XL UNet model.
