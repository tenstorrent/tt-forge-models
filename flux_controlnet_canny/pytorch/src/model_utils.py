...
"""
Helper functions for FLUX ControlNet Canny model loading and processing.
"""
...
def load_flux_controlnet_canny_pipe(controlnet_model_name, base_model_name):
    """Load FLUX ControlNet Canny pipeline.
