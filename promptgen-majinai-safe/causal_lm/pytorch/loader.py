...
"""Promptgen Majinai Safe model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="AUTOMATIC/promptgen-majinai-safe",
            max_length=128,
        ),
    }
