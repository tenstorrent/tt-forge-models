...
"""
Qwen-Image-Edit-Plus GGUF model loader implementation.

Loads GGUF-quantized diffusion transformer variants from
calcuis/qwen-image-edit-plus-gguf. Uses the upstream Qwen/Qwen-Image-Edit-2509
diffusers config for model construction and is paired with
QwenImageEditPlusPipeline for multi-image editing.

Available variants:
- Q4_K_M: 4-bit quantization (medium, 11.7 GB)
...
CONFIG_REPO = "Qwen/Qwen-Image-Edit-2509"
...
class ModelVariant(StrEnum):
    """Available Qwen-Image-Edit-Plus GGUF quantization variants."""
...
class ModelLoader(ForgeModel):
    """Qwen-Image-Edit-Plus GGUF model loader for the diffusion transformer."""
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="QWEN_IMAGE_EDIT_PLUS_GGUF",
            variant=variant,
    ...
    def load_model(self, *, dtype_override: Optional[torch.dtype] = None, **kwargs):
        """Load and return the Qwen-Image-Edit-Plus GGUF diffusion transformer."""
