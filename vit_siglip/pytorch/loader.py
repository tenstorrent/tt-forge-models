...
class ModelVariant(StrEnum):
    """Available ViT-SigLIP model variants."""

    VIT_B_16 = "ViT_B_16"
    VIT_B_16_512 = "ViT_B_16_512"
    VIT_L_16_384 = "ViT_L_16_384"


# Mapping from variant to OpenCLIP tokenizer name
_TOKENIZER_NAME = {
    ModelVariant.VIT_B_16: "ViT-B-16-SigLIP",
    ModelVariant.VIT_B_16_512: "ViT-B-16-SigLIP-512",
    ModelVariant.VIT_L_16_384: "ViT-L-16-SigLIP-384",
}


class ModelLoader(ForgeModel):
    """ViT-SigLIP model loader using OpenCLIP for image-text similarity tasks."""

    _VARIANTS = {
        ModelVariant.VIT_B_16: ModelConfig(
            pretrained_model_name="hf-hub:timm/ViT-B-16-SigLIP",
        ),
        ModelVariant.VIT_B_16_512: ModelConfig(
            pretrained_model_name="hf-hub:timm/ViT-B-16-SigLIP-512",
        ),
        ModelVariant.VIT_L_16_384: ModelConfig(
            pretrained_model_name="hf-hub:timm/ViT-L-16-SigLIP-384",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the ViT-SigLIP model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The ViT-SigLIP model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the ViT-SigLIP model.
    ...
    def post_process(self, outputs):
        """Post-process ViT-SigLIP model outputs to extract similarity scores.
