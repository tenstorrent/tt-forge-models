...
"""Leoscorpius Greennode Alpaca 7b V1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ignos/LeoScorpius-GreenNode-Alpaca-7B-v1",
            max_length=128,
        ),
    }
