...
"""
T5 Base Finetuned Question Generation (AP) model loader implementation
"""
...
class ModelVariant(StrEnum):
    """Available T5 Base Finetuned Question Generation (AP) model variants."""
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="T5_Base_Finetuned_Question_Generation_AP",
            variant=variant,
