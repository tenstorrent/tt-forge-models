...
"""Nemotron H 4b Base 8k model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="nvidia/Nemotron-H-4B-Base-8K",
            max_length=128,
        ),
    }
