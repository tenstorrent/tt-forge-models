...
"""Distilbert Base Uncased Finetuned Sms Spam Detection model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="mariagrandury/distilbert-base-uncased-finetuned-sms-spam-detection",
        ),
    }
