...
"""Wiroai Turkish Llm 9b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="WiroAI/wiroai-turkish-llm-9b",
            max_length=128,
        ),
    }
