...
"""
mContriever model loader implementation for embedding generation.
"""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.MCONTRIEVER_MSMARCO
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the mContriever model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The mContriever model instance for embedding generation.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the mContriever model.
