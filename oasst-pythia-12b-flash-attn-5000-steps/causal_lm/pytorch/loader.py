...
"""Oasst Pythia 12b Flash Attn 5000 Steps model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="dvruette/oasst-pythia-12b-flash-attn-5000-steps",
            max_length=128,
        ),
    }
