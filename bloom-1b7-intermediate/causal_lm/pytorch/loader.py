...
"""Bloom 1b7 Intermediate model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="bigscience/bloom-1b7-intermediate",
            max_length=128,
        ),
    }
