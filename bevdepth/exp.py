...
class BEVDepthLightningModel(BaseBEVDepthLightningModel):
    def __init__(self, **kwargs):
        ...
        self.model = BEVStereo(self.backbone_conf, self.head_conf, is_train_depth=True)


if __name__ == "__main__":
    run_cli(BEVDepthLightningModel, "bev_stereo_lss_r50_256x704_128x128_24e_2key")
