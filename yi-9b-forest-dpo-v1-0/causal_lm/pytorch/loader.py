...
"""Yi 9b Forest Dpo V1 0 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="abhishekchohan/Yi-9B-Forest-DPO-v1.0",
            max_length=128,
        ),
    }
