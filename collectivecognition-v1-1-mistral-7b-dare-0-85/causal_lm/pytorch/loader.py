...
"""Collectivecognition V1 1 Mistral 7b Dare 0 85 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="uukuguy/CollectiveCognition-v1.1-Mistral-7B-dare-0.85",
            max_length=128,
        ),
    }
