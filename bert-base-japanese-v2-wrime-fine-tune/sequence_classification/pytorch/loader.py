...
"""Bert Base Japanese V2 Wrime Fine Tune model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="patrickramos/bert-base-japanese-v2-wrime-fine-tune",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert Base Japanese V2 Wrime Fine Tune",
