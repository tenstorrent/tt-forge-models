...
class ModelLoader(ForgeModel):
    """Qwen 2.5 Coder 32B Instruct Abliterated GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_2_5_CODER_32B_INSTRUCT_ABLITERATED_GGUF: LLMModelConfig(
    ...
    DEFAULT_VARIANT = ModelVariant.QWEN_2_5_CODER_32B_INSTRUCT_ABLITERATED_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Qwen 2.5 Coder 32B Instruct Abliterated GGUF",
            variant=variant,
