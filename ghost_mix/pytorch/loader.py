...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the GhostMix pipeline from Hugging Face.
        ...
        Returns:
            StableDiffusionPipeline: The pre-trained GhostMix pipeline object.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample text prompts for the GhostMix model.
