...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.PY310_STATEMENT

    sample_text = "LOAD_FAST x LOAD_FAST y BINARY_ADD RETURN_VALUE"
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the PyLingual model instance.
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the PyLingual model.
