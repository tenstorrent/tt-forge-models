...
"""
Splinter model loader implementation for question answering.
"""
...
class ModelVariant(StrEnum):
    """Available Splinter question answering model variants."""

    TAU_SPLINTER_BASE_QASS = "tau_splinter_base_qass"


class ModelLoader(ForgeModel):
    """Splinter model loader implementation for question answering tasks."""

    _VARIANTS = {
        ModelVariant.TAU_SPLINTER_BASE_QASS: LLMModelConfig(
            pretrained_model_name="tau/splinter-base-qass",
            max_length=384,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.TAU_SPLINTER_BASE_QASS
