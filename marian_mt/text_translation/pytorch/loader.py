...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.OPUS_MT_FI_SV: LLMModelConfig(
            pretrained_model_name="Helsinki-NLP/opus-mt-fi-sv",
        ),
    }
    ...
    _SAMPLE_TEXTS = {
        ...
        ModelVariant.OPUS_MT_FI_SV: "Hei maailma, sää on kaunis tänään.",
    }
