...
class ModelLoader(ForgeModel):
    ...
    _SAMPLE_TEXTS = {
        ...
        ModelVariant.OPUS_MT_FR_ES: "Le temps est magnifique aujourd'hui et le soleil brille fort.",
        ModelVariant.OPUS_MT_NL_ES: "Het weer is vandaag prachtig en de zon schijnt helder.",
        ModelVariant.OPUS_MT_ROA_EN: "Le temps est magnifique aujourd'hui et le soleil brille fort.",
        ModelVariant.OPUS_MT_EU_EN: "Gaur eguraldia ederra da eta eguzkia distiratsu ari da.",
