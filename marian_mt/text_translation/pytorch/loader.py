...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.OPUS_MT_BN_EN: LLMModelConfig(
            pretrained_model_name="Helsinki-NLP/opus-mt-bn-en",
        ),
    }
    ...
    _SAMPLE_TEXTS = {
        ...
        ModelVariant.OPUS_MT_BN_EN: "আমি একজন প্রকৌশলী।",
    }
