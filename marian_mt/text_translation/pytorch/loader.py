...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.OPUS_MT_EN_SLA: LLMModelConfig(
            pretrained_model_name="Helsinki-NLP/opus-mt-en-sla",
        ),
    }
    ...
    sample_texts = {
        ...
        ModelVariant.OPUS_MT_EN_SLA: ">>ces<< The weather is very nice today.",
    }
