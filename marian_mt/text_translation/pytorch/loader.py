...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.OPUS_MT_UK_EN: LLMModelConfig(
            pretrained_model_name="Helsinki-NLP/opus-mt-uk-en",
        ),
    }
    ...
    _SAMPLE_TEXTS = {
        ...
        ModelVariant.OPUS_MT_UK_EN: "Привіт, сьогодні чудовий день і сонце яскраво світить.",
    }
