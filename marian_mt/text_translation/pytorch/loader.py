...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.OPUS_MT_CA_EN: LLMModelConfig(
            pretrained_model_name="Helsinki-NLP/opus-mt-ca-en",
        ),
    }
    ...
    _SAMPLE_TEXTS = {
        ...
        ModelVariant.OPUS_MT_CA_EN: "El temps és bonic avui i el sol brilla intensament.",
    }
