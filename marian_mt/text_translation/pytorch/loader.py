...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.OPUS_MT_HU_EN: LLMModelConfig(
            pretrained_model_name="Helsinki-NLP/opus-mt-hu-en",
        ),
    }
    ...
    _SAMPLE_TEXTS = {
        ...
        ModelVariant.OPUS_MT_HU_EN: "Helló világ, ma nagyon szép az idő.",
    }
