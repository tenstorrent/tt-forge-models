...
"""Polyglot Ko 3 8b Total model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="hyunjae/polyglot-ko-3.8b-total",
            max_length=128,
        ),
    }
