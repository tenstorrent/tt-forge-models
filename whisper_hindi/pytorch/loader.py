...
"""
Whisper-Hindi model loader implementation.

vasista22/whisper-hindi-large-v2 is a Hindi fine-tune of openai/whisper-large-v2,
trained for automatic speech recognition in Hindi.
"""
...
class ModelVariant(StrEnum):
    """Available Whisper-Hindi model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.LARGE_V2: ModelConfig(
            pretrained_model_name="vasista22/whisper-hindi-large-v2",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load a Whisper-Hindi model from Hugging Face."""
    ...
    def load_inputs(self, dtype_override=None):
        """Generate sample inputs for Whisper-Hindi model."""
