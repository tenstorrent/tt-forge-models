...
"""
Whisper Small Indonesian LoRA model loader implementation.

Damzzbby/whisper-small-indonesian-using-LoRA is a PEFT LoRA adapter fine-tuned
...
class ModelVariant(StrEnum):
    """Available Whisper Small Indonesian LoRA model variants."""

    SMALL_INDONESIAN_LORA = "Small_Indonesian_LoRA"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.SMALL_INDONESIAN_LORA: ModelConfig(
            pretrained_model_name="Damzzbby/whisper-small-indonesian-using-LoRA",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SMALL_INDONESIAN_LORA
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Whisper_Small_Indonesian_LoRA",
            variant=variant,
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load a Whisper Small model with the Indonesian LoRA adapter applied."""
        model_kwargs = {}
    ...
    def load_inputs(self, dtype_override=None):
        """Generate sample inputs for the Whisper Small Indonesian LoRA model."""
