...
class ModelLoader(ForgeModel):
    ...
    def __init__(
        ...
        ), f"{lang} has not been supported. Currently supported languages: {supported_langs}"
        ...
        assert (
            lang in lang2treebank
        ), f"{lang} has not been supported. Currently supported languages: {list(lang2treebank.keys())}"
    ...
    def _get_model_info(cls, variant_name: str = None):
        ...
        return ModelInfo(
            ...
            task=ModelTask.SENTENCE_SPLITTING,
