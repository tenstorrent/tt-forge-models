...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.SOLAR_10_7B_INSTRUCT_V1_0
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the SOLAR-10_7B model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The SOLAR-10_7B model for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the SOLAR-10_7B model with this instance's variant settings.
