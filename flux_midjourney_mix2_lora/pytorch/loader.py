...
class ModelLoader(ForgeModel):
    ...
    def _load_pipeline(self, dtype_override=None):
        """Load FLUX.1-dev pipeline and apply the Midjourney Mix2 LoRA."""
    ...
    def load_model(
        ...
        **kwargs,
        ...
        """Load and return the FLUX transformer with Midjourney Mix2 LoRA applied.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1, **kwargs) -> Any:
        """Load and return sample inputs for the FLUX Midjourney Mix2 LoRA model.
