...
class ModelVariant(StrEnum):
    """Available Xenova Face Parsing model variants."""

    FACE_PARSING = "face_parsing"


class ModelLoader(ForgeModel):
    """Xenova Face Parsing model loader implementation for facial semantic segmentation tasks."""
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Xenova Face Parsing model instance for this instance's variant.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The Xenova Face Parsing model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the Xenova Face Parsing model.
