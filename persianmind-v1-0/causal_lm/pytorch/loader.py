...
"""Persianmind V1 0 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="universitytehran/PersianMind-v1.0",
            max_length=128,
        ),
    }
