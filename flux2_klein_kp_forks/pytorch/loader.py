...
"""
FLUX.2 Klein 9B (kp-forks fork) model loader implementation for text-to-image generation.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available FLUX.2 Klein kp-forks model variants."""

    KLEIN_9B = "Klein-9B"


class ModelLoader(ForgeModel):
    """FLUX.2 Klein 9B (kp-forks fork) model loader for text-to-image generation."""

    _VARIANTS = {
        ModelVariant.KLEIN_9B: ModelConfig(
            pretrained_model_name="kp-forks/FLUX.2-klein-9B",
        ),
    }
