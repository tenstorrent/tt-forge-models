...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.QWEN3_5_27B_HERETIC_MLX_MXFP4
    ...
    def load_shard_spec(self, model):
        ...
        for layer in model.model.layers:
            ...
            if layer.layer_type == "full_attention":
                ...
                shard_specs[layer.linear_attn.in_proj_a.weight] = (
                    "model",
                    "batch",
                )
                shard_specs[layer.linear_attn.in_proj_b.weight] = (
                    "model",
                    "batch",
                )
