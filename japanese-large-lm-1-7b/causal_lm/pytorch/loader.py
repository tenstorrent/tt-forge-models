...
"""Japanese Large Lm 1 7b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="line-corporation/japanese-large-lm-1.7b",
            max_length=128,
        ),
    }
