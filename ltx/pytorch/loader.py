...
COSMICVIBEZ_CHECKPOINT_URL = "https://huggingface.co/Cosmicvibez/LTX-2.3/resolve/main/ltx-2.3-22b-distilled.safetensors"
...
class ModelLoader(ForgeModel):
    ...
    def _load_cosmicvibez_transformer(
        ...
        """Load distilled transformer; repo has no diffusers pipeline structure."""
        self._transformer = LTX2VideoTransformer3DModel.from_single_file(
