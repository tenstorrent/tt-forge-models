...
"""Opt C4 350m Seed964 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="znhoughton/opt-c4-350m-seed964",
            max_length=128,
        ),
    }
