...
class ModelVariant(StrEnum):
    ...
    RESNET_50_RAM_IN1K_TIMM = "ResNet50_RAM_IN1K_TIMM"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.RESNET_50_RAM_IN1K_TIMM: ResNetConfig(
            pretrained_model_name="resnet50.ram_in1k",
            source=ModelSource.TIMM,
        ),
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        if variant in [
            ...
            ModelVariant.RESNET_50_RAM_IN1K_TIMM,
