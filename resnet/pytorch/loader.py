...
class ModelVariant(StrEnum):
    ...
    RESNET_34D_RA2_IN1K_TIMM = "ResNet34D_RA2_IN1K_TIMM"
    RESNET_50D_RA2_IN1K_TIMM = "ResNet50D_RA2_IN1K_TIMM"
    RESNET_50_GN_A1H_IN1K_TIMM = "ResNet50_GN_A1H_IN1K_TIMM"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.RESNET_34D_RA2_IN1K_TIMM: ResNetConfig(
            pretrained_model_name="resnet34d.ra2_in1k",
            source=ModelSource.TIMM,
        ),
        ModelVariant.RESNET_50D_RA2_IN1K_TIMM: ResNetConfig(
            pretrained_model_name="resnet50d.ra2_in1k",
            source=ModelSource.TIMM,
        ),
        ModelVariant.RESNET_50_GN_A1H_IN1K_TIMM: ResNetConfig(
            pretrained_model_name="resnet50_gn.a1h_in1k",
            source=ModelSource.TIMM,
        ),
        # Torchvision variants
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        if variant in [
            ...
            ModelVariant.RESNET_34D_RA2_IN1K_TIMM,
            ModelVariant.RESNET_50D_RA2_IN1K_TIMM,
            ModelVariant.RESNET_50_GN_A1H_IN1K_TIMM,
        ]:
