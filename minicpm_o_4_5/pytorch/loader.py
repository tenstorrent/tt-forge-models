...
"""
MiniCPM-o-4_5 model loader implementation for multimodal inference
"""
...
class MiniCPMConfig(ModelConfig):
    """Configuration specific to MiniCPM-o-4_5 models"""

    pretrained_model_name: str = "openbmb/MiniCPM-o-4_5"
...
class ModelVariant(StrEnum):
    """Available MiniCPM-o-4_5 model variants."""
...
_VARIANTS = {
    ModelVariant.DEFAULT: MiniCPMConfig(
        pretrained_model_name="openbmb/MiniCPM-o-4_5",
        max_new_tokens=256,
        temperature=0.5,
    ),
}
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[StrEnum] = None) -> ModelInfo:
        """Get model information for MiniCPM-o-4_5."""
        return ModelInfo(
            model="MiniCPM-o 4.5",
            variant=variant,
    ...
    def load_model(self, **kwargs):
        """Load and return the MiniCPM-o-4_5 model instance.
    ...
    def decode_output(cls, outputs: Dict[str, Any], **kwargs) -> Dict[str, Any]:
        ...
        decoded = {
            ...
            "model_info": {
                "name": outputs.get("model", "MiniCPM-o-4_5"),
