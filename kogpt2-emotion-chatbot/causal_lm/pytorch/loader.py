...
"""Kogpt2 Emotion Chatbot model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="withU/kogpt2-emotion-chatbot",
            max_length=128,
        ),
    }
