...
"""
TResNet-M model loader implementation (timm variants)
"""
...
class ModelVariant(StrEnum):
    """Available TResNet-M model variants (timm)."""

    TRESNET_M_MIIL_IN21K = "TResNet_M.miil_in21k"


class ModelLoader(ForgeModel):
    """TResNet-M model loader implementation."""

    _VARIANTS = {
        ModelVariant.TRESNET_M_MIIL_IN21K: ModelConfig(
            pretrained_model_name="tresnet_m.miil_in21k",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.TRESNET_M_MIIL_IN21K
