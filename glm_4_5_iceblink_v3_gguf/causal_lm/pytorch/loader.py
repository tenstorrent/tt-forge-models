...
"""
GLM-4.5-Iceblink-v3 106B-A12B GGUF model loader for causal language modeling.
"""
...
def _patch_transformers_glm4moe_gguf():
    ...
    for the glm4moe architecture. The gguf library already knows about glm4moe
    tensor names, so we only need to bridge transformers' config/tensor
    processing layer.
    """
...
class ModelVariant(StrEnum):
    """Available GLM-4.5-Iceblink-v3 GGUF model variants."""

    GLM_4_5_ICEBLINK_V3_106B_A12B_I1_GGUF = "106B_A12B_i1_GGUF"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.GLM_4_5_ICEBLINK_V3_106B_A12B_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/GLM-4.5-Iceblink-v3-106B-A12B-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GLM_4_5_ICEBLINK_V3_106B_A12B_I1_GGUF

    GGUF_FILE = "GLM-4.5-Iceblink-v3-106B-A12B.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="GLM-4.5-Iceblink-v3 106B-A12B GGUF",
            variant=variant,
