...
"""Aira 2 Portuguese 1b7 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="nicholasKluge/Aira-2-portuguese-1B7",
            max_length=128,
        ),
    }
