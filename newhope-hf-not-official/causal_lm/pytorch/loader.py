...
"""Newhope Hf Not Official model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="WhoTookMyAmogusNickname/NewHope_HF_not_official",
            max_length=128,
        ),
    }
