...
"""Stable Vicuna 13b Delta model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="CarperAI/stable-vicuna-13b-delta",
            max_length=128,
        ),
    }
