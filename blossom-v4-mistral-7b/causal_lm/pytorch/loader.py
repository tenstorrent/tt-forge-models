...
"""Blossom V4 Mistral 7b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Azure99/blossom-v4-mistral-7b",
            max_length=128,
        ),
    }
