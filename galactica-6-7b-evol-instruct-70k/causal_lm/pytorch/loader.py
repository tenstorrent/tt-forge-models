...
"""Galactica 6 7b Evol Instruct 70k model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="GeorgiaTechResearchInstitute/galactica-6.7b-evol-instruct-70k",
            max_length=128,
        ),
    }
