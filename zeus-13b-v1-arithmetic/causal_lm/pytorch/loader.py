...
"""Zeus 13b V1 Arithmetic model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Q-bert/Zeus-13B-v1-arithmetic",
            max_length=128,
        ),
    }
