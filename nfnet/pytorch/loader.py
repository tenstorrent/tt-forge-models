...
"""
NFNet model loader implementation
"""
...
class NFNetConfig(ModelConfig):
    """Configuration specific to NFNet models"""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.DM_NFNET_F3_DM_IN1K
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load pretrained NFNet model for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The NFNet model instance.
        """
        ...
        if source == ModelSource.TIMM:
            ...
            raise ValueError(f"Unsupported source for NFNet: {source}")
