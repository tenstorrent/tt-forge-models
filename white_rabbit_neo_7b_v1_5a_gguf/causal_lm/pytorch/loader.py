...
"""
WhiteRabbitNeo 7B v1.5a GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available WhiteRabbitNeo 7B v1.5a GGUF model variants for causal language modeling."""

    WHITE_RABBIT_NEO_7B_V1_5A_Q4_K_M_GGUF = "7B_V1_5A_Q4_K_M_GGUF"


class ModelLoader(ForgeModel):
    """WhiteRabbitNeo 7B v1.5a GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.WHITE_RABBIT_NEO_7B_V1_5A_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="bartowski/WhiteRabbitNeo-7B-v1.5a-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.WHITE_RABBIT_NEO_7B_V1_5A_Q4_K_M_GGUF

    GGUF_FILE = "WhiteRabbitNeo-7B-v1.5a-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="WhiteRabbitNeo 7B v1.5a GGUF",
            variant=variant,
