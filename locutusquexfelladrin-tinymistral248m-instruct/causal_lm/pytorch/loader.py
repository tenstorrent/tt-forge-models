...
"""Locutusquexfelladrin Tinymistral248m Instruct model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Locutusque/LocutusqueXFelladrin-TinyMistral248M-Instruct",
            max_length=128,
        ),
    }
