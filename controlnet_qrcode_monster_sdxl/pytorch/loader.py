...
from .src.model_utils import (
    load_controlnet_qrcode_monster_sdxl_pipe,
    create_qrcode_conditioning_image,
    controlnet_qrcode_monster_sdxl_preprocessing,
)
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="ControlNet QR Code Monster SDXL",
            variant=variant,
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the UNet from the ControlNet QR Code Monster SDXL pipeline.
        ...
        self.pipeline = load_controlnet_qrcode_monster_sdxl_pipe(
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the ControlNet QR Code Monster SDXL UNet.
        ...
        control_image = create_qrcode_conditioning_image()
