...
"""
text2vec-large-chinese model loader for sentence embedding generation.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available model variants for text2vec-large-chinese."""

    TEXT2VEC_LARGE_CHINESE = "GanymedeNil/text2vec-large-chinese"


class ModelLoader(ForgeModel):
    """text2vec-large-chinese model loader."""

    _VARIANTS = {
        ModelVariant.TEXT2VEC_LARGE_CHINESE: LLMModelConfig(
            pretrained_model_name="GanymedeNil/text2vec-large-chinese",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.TEXT2VEC_LARGE_CHINESE
