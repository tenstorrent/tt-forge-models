...
"""Bertimbau Base Finetuned Brazilian Court Decisions model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bertimbau Base Finetuned Brazilian Court Decisions",
