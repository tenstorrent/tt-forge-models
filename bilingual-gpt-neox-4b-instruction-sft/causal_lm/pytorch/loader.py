...
"""Bilingual Gpt Neox 4b Instruction Sft model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="rinna/bilingual-gpt-neox-4b-instruction-sft",
            max_length=128,
        ),
    }
