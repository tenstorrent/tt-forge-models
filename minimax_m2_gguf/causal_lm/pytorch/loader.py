...
class ModelVariant(StrEnum):
    """Available MiniMax-M2 GGUF model variants for causal language modeling."""

    MINIMAX_M2_Q4_K_M = "Q4_K_M"


class ModelLoader(ForgeModel):
    """MiniMax-M2 GGUF model loader implementation for causal language modeling tasks."""
