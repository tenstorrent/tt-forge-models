...
class ModelLoader(ForgeModel):
    ...
    def __init__(self, variant=None):
        ...
        self.sample_text = "Die Hauptstadt von Frankreich ist [MASK]."
        self.max_length = 128
        self.tokenizer = None
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load ModernGBERT model for masked language modeling from Hugging Face.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The ModernGBERT model instance.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Prepare sample input for ModernGBERT masked language modeling.
    ...
    def load_config(self):
        """Load and return the configuration for the ModernGBERT model variant.

        Returns:
            The configuration object for the ModernGBERT model.
        """
