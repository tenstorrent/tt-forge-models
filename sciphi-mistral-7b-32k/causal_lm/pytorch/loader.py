...
"""Sciphi Mistral 7b 32k model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="SciPhi/SciPhi-Mistral-7B-32k",
            max_length=128,
        ),
    }
