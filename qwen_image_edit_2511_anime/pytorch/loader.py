...
cel-shaded anime-style image editing. Returns the transformer component
with LoRA weights fused for testing.
...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load the Qwen-Image-Edit-2511 transformer with Anime LoRA weights fused.

        Loads the full pipeline, applies the Anime LoRA adapter, fuses the
        weights into the transformer, and returns the transformer component.

        Returns:
            QwenImageTransformer2DModel with Anime LoRA weights fused.
        """
    ...
    def load_inputs(self, **kwargs) -> Any:
        ...
        # img_shapes is a list of lists of (frame, h, w) tuples per batch item
