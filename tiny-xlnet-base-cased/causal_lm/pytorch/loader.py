...
"""Tiny Xlnet Base Cased model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="sshleifer/tiny-xlnet-base-cased",
            max_length=128,
        ),
    }
