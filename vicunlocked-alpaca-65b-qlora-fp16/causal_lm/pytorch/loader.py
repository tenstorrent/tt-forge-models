...
"""Vicunlocked Alpaca 65b Qlora Fp16 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="TheBloke/VicUnlocked-alpaca-65B-QLoRA-fp16",
            max_length=128,
        ),
    }
