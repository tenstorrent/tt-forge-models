...
"""Bert Multilingual Passage Reranking Msmarco model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="amberoad/bert-multilingual-passage-reranking-msmarco",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert Multilingual Passage Reranking Msmarco",
