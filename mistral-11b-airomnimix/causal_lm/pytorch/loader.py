...
"""Mistral 11b Airomnimix model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="NeverSleep/Mistral-11B-AirOmniMix",
            max_length=128,
        ),
    }
