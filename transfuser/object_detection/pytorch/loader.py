...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, **kwargs):
        ...
        from third_party.tt_forge_models.transfuser.object_detection.pytorch.src.model import (
            LidarCenterNet,
        )
    ...
    def unpack_forward_output(self, fwd_output):
        ...
        Args:
            fwd_output: Output from the model's forward pass (tuple or tensor)

        Returns:
            torch.Tensor: The predicted waypoints tensor for backward pass
        """
