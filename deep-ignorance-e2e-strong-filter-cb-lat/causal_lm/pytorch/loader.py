...
"""Deep Ignorance E2e Strong Filter Cb Lat model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="EleutherAI/deep-ignorance-e2e-strong-filter-cb-lat",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Deep Ignorance E2e Strong Filter Cb Lat",
