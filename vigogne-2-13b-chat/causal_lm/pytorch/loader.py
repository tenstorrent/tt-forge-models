...
"""Vigogne 2 13b Chat model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="bofenghuang/vigogne-2-13b-chat",
            max_length=128,
        ),
    }
