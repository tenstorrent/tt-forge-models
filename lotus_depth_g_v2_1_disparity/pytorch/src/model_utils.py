...
"""
Utility functions for Lotus Depth G v2.1 disparity model loading and preprocessing.
"""
...
def load_unet(pretrained_model_name, dtype=None):
    """Load the UNet2DConditionModel from the Lotus Depth G v2.1 disparity model.
...
def prepare_unet_inputs(pretrained_model_name, dtype=None):
    """Prepare synthetic inputs for the Lotus Depth G v2.1 disparity UNet.
    ...
    # Task embedding for depth estimation: sin/cos encoding of [1, 0]
