...
"""
Lotus Depth G v2.1 disparity model loader implementation for depth estimation.

Lotus is a diffusion-based visual foundation model for dense geometry prediction.
This loader targets the UNet component of the generative disparity prediction
pipeline.
"""
...
class ModelVariant(StrEnum):
    """Available Lotus Depth G v2.1 disparity model variants."""

    BASE = "Base"


class ModelLoader(ForgeModel):
    """Lotus Depth G v2.1 disparity model loader implementation."""

    _VARIANTS = {
        ModelVariant.BASE: ModelConfig(
            pretrained_model_name="jingheya/lotus-depth-g-v2-1-disparity",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Lotus Depth G v2.1 disparity",
            variant=variant,
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Lotus Depth UNet model.
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the Lotus Depth UNet.
