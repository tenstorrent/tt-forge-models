...
class ModelVariant(StrEnum):
    """Available GPT-2 Spanish model variants for causal language modeling."""

    GPT2_SPANISH = "gpt2_spanish"


class ModelLoader(ForgeModel):
    """GPT-2 Spanish model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GPT2_SPANISH: LLMModelConfig(
            pretrained_model_name="DeepESP/gpt2-spanish",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GPT2_SPANISH
