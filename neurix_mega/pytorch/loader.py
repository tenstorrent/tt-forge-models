...
"""
NeurixYUFI/Neurix-Mega model loader implementation.

Loads the FLUX.1-schnell base pipeline and applies the Neurix-Mega LoRA
from NeurixYUFI/Neurix-Mega for fast text-to-image generation across
diverse artistic styles.

Repository: https://huggingface.co/NeurixYUFI/Neurix-Mega
"""
...
class ModelVariant(StrEnum):
    """Available NeurixYUFI/Neurix-Mega model variants."""

    NEURIX_MEGA = "NeurixMega"


class ModelLoader(ForgeModel):
    """NeurixYUFI/Neurix-Mega model loader for text-to-image generation."""

    _VARIANTS = {
        ModelVariant.NEURIX_MEGA: ModelConfig(
            pretrained_model_name=BASE_MODEL,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.NEURIX_MEGA
    ...
    def _load_pipeline(self, dtype_override=None):
        """Load FLUX.1-schnell pipeline and apply Neurix-Mega LoRA."""
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the FLUX transformer with Neurix-Mega LoRA applied.
