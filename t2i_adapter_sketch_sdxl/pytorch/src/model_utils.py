...
"""
Helper functions for T2I-Adapter Sketch SDXL model loading and processing.
"""
...
def load_t2i_adapter_sketch_sdxl_pipe(adapter_model_name, base_model_name):
    """Load T2I-Adapter Sketch SDXL pipeline.
...
def create_sketch_conditioning_image(height=1024, width=1024):
...
def t2i_adapter_sketch_sdxl_preprocessing(
    pipe,
    prompt,
    adapter_image,
    device="cpu",
    ...
    """Preprocess inputs for T2I-Adapter Sketch SDXL model.
