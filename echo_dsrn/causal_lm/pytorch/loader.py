...
"""
Echo-DSRN model loader implementation
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Echo-DSRN model variants."""

    ECHO_DSRN_486M_V0_7_6_SFT = "486M-v0.7.6-SFT"
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.ECHO_DSRN_486M_V0_7_6_SFT
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Echo-DSRN model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The Echo-DSRN model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the Echo-DSRN model with this instance's variant settings.
