...
class ModelVariant(StrEnum):
    """Available Ghost-Actual Qwen3.5-4B Claude Opus 4.6 Distilled Heretic variants."""
...
class ModelLoader(ForgeModel):
    """Ghost-Actual Qwen3.5-4B Claude Opus 4.6 Distilled Heretic model loader for causal language modeling."""
