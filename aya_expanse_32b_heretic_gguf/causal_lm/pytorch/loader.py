...
"""
Aya Expanse 32B Heretic GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Aya Expanse 32B Heretic GGUF model variants for causal language modeling."""

    AYA_EXPANSE_32B_HERETIC_GGUF = "32B_Heretic_GGUF"


class ModelLoader(ForgeModel):
    """Aya Expanse 32B Heretic GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.AYA_EXPANSE_32B_HERETIC_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/aya-expanse-32b-heretic-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.AYA_EXPANSE_32B_HERETIC_GGUF

    GGUF_FILE = "aya-expanse-32b-heretic.Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Aya Expanse 32B Heretic GGUF",
            variant=variant,
