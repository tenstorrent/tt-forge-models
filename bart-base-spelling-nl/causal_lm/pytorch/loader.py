...
"""Bart Base Spelling Nl model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="antalvdb/bart-base-spelling-nl",
            max_length=128,
        ),
    }
