...
class ModelVariant(StrEnum):
    ...
    BEETLELM_ENG_L1_ZHO_L2_SIMULTANEOUS = "beetlelm_eng_L1_zho_L2_simultaneous"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.BEETLELM_ENG_L1_ZHO_L2_SIMULTANEOUS: LLMModelConfig(
            pretrained_model_name="BeetleLM/beetlelm_eng_L1-zho_L2_simultaneous",
            max_length=128,
        ),
    }
