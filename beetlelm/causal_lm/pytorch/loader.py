...
class ModelVariant(StrEnum):
    ...
    BEETLELM_ENG_L1_DEU_L2_SIMULTANEOUS = "beetlelm_eng_L1_deu_L2_simultaneous"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.BEETLELM_ENG_L1_DEU_L2_SIMULTANEOUS: LLMModelConfig(
            pretrained_model_name="BeetleLM/beetlelm_eng_L1-deu_L2_simultaneous",
            max_length=128,
        ),
    }
