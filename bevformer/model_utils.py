...
def build_from_input_image_v2(input_image: Dict[str, Any]) -> Dict[str, Any]:
    ...
    ego2global_translation = input_image["ego2global_translation"]
    ego2global_rotation = input_image["ego2global_rotation"]
    lidar2ego_translation = input_image["lidar2ego_translation"]
    lidar2ego_rotation = input_image["lidar2ego_rotation"]
...
class BEV_wrapper_v2(torch.nn.Module):
    def __init__(
        self,
    ...
    def forward(
        ...
        ego2global_translation: torch.Tensor,
        ego2global_rotation: torch.Tensor,
        lidar2ego_translation: torch.Tensor,
        lidar2ego_rotation: torch.Tensor,
        ...
        img_metas = {
            ...
            "timestamp": 1533151603.54759,
            "lidaradj2lidarcurr": None,
        }
...
def build_from_input_image_base(input_image: Dict[str, Any]) -> Dict[str, Any]:
    """Build the tensors and metadata dictionary expected by the BEV wrapper and test.
...
class BEV_wrapper_base(torch.nn.Module):
    def __init__(
        self,
        model: torch.nn.Module,
        filename: Any,
