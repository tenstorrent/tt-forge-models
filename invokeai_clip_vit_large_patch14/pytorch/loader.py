...
"""
InvokeAI CLIP ViT-L/14 model loader implementation for image-text similarity.

Uses InvokeAI/clip-vit-large-patch14, a mirror of openai/clip-vit-large-patch14
hosted for the InvokeAI pipeline.
"""
...
class ModelVariant(StrEnum):
    """Available InvokeAI CLIP ViT-L/14 model variants."""

    LARGE_PATCH14 = "Large_Patch14"


class ModelLoader(ForgeModel):
    """InvokeAI CLIP ViT-L/14 model loader implementation for image-text similarity tasks."""

    # Dictionary of available model variants using structured configs
    _VARIANTS = {
        ModelVariant.LARGE_PATCH14: ModelConfig(
            pretrained_model_name="InvokeAI/clip-vit-large-patch14",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the InvokeAI CLIP ViT-L/14 model instance.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the InvokeAI CLIP ViT-L/14 model.
