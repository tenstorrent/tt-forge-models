...
from transformers import AutoModelForCausalLM, AutoProcessor, ViTImageProcessor

# ViTFeatureExtractor was removed in transformers 5.x; alias for remote code compatibility
