...
"""
google/bert_uncased_L-4_H-128_A-2 model loader implementation for masked language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available google/bert_uncased_L-4_H-128_A-2 model variants."""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.BERT_UNCASED_L4_H128_A2
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="google/bert_uncased_L-4_H-128_A-2",
            variant=variant,
