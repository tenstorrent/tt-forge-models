...
class ModelVariant(StrEnum):
    """Available Poe 8B GGUF model variants for causal language modeling."""

    POE_8B_GGUF = "Poe_8B_GGUF"


class ModelLoader(ForgeModel):
    """Poe 8B TOP10 Distill Heretic Full GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.POE_8B_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Poe-8b-TOP10-Distill-Heretic-Full-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.POE_8B_GGUF

    GGUF_FILE = "Poe-8b-TOP10-Distill-Heretic-Full.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Poe 8B TOP10 Distill Heretic Full GGUF",
            variant=variant,
