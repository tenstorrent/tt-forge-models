...
"""Bert Italian Uncased Iptc Headlines model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="nlpodyssey/bert-italian-uncased-iptc-headlines",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert Italian Uncased Iptc Headlines",
