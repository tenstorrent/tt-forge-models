...
applies the Fashion-Hut-Modeling LoRA from
prithivMLmods/Fashion-Hut-Modeling-LoRA for fashion modeling text-to-image
generation.
...
class ModelLoader(ForgeModel):
    ...
    def _load_transformer_with_lora(self, dtype=None):
        """Load FLUX.1-dev transformer and apply Fashion-Hut-Modeling LoRA."""
