...
class ModelVariant(StrEnum):
    """Available DiT model variants for masked image modeling."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE: ModelConfig(
            pretrained_model_name="microsoft/dit-base",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load DiT model for masked image modeling from Hugging Face.
        ...
        Returns:
            torch.nn.Module: The DiT model instance for masked image modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the DiT masked image modeling model.
