...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.ANGEL_SLAYER_KRIX_12B_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/AngelSlayerKrix-12B-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.ANGEL_SLAYER_KRIX_12B_Q4_K_M_GGUF

    GGUF_FILE = "AngelSlayerKrix-12B.Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="AngelSlayerKrix 12B GGUF",
            variant=variant,
