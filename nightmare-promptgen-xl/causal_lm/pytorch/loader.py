...
"""Nightmare Promptgen Xl model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="cactusfriend/nightmare-promptgen-XL",
            max_length=128,
        ),
    }
