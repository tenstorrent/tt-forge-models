...
"""
Goldfish Korean (kor_hang_1000mb) model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Goldfish Korean model variants."""

    DEFAULT = "Default"


class ModelLoader(ForgeModel):
    """Goldfish Korean (kor_hang_1000mb) loader for causal language modeling."""

    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="goldfish-models/kor_hang_1000mb",
            max_length=256,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Goldfish Korean (kor_hang_1000mb)",
            variant=variant,
