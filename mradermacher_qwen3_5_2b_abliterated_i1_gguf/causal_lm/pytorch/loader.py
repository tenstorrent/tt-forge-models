...
"""
mradermacher Qwen3.5 2B Abliterated i1 GGUF model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available mradermacher Qwen3.5 2B Abliterated i1 GGUF model variants for causal language modeling."""

    QWEN3_5_2B_ABLITERATED_I1_GGUF = "2B_Abliterated_i1_GGUF"


class ModelLoader(ForgeModel):
    """mradermacher Qwen3.5 2B Abliterated i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN3_5_2B_ABLITERATED_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Qwen3.5-2B_Abliterated-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN3_5_2B_ABLITERATED_I1_GGUF

    GGUF_FILE = "Qwen3.5-2B_Abliterated.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher Qwen3.5 2B Abliterated i1 GGUF",
            variant=variant,
