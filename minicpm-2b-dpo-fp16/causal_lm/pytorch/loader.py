...
"""Minicpm 2b Dpo Fp16 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="openbmb/MiniCPM-2B-dpo-fp16",
            max_length=128,
        ),
    }
