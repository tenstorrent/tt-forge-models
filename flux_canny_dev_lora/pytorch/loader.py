...
"""
FLUX.1-Canny-dev-lora model loader implementation for canny-conditioned image generation
"""
import torch
...
class ModelVariant(StrEnum):
    """Available FLUX.1-Canny-dev-lora model variants."""

    DEFAULT = "Default"


class ModelLoader(ForgeModel):
    """FLUX.1-Canny-dev-lora model loader for canny-conditioned image generation tasks."""

    # Dictionary of available model variants
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="black-forest-labs/FLUX.1-Canny-dev-lora",
        ),
    }
    ...
    def _load_pipeline(self, dtype_override=None):
        """Load pipeline with base model and LoRA weights.
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the FLUX transformer model instance.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        prompt = "A robot made of exotic candies and chocolates"
