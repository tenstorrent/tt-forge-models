...
"""Redpajama Incite Chat 3b Instruction Tuning With Gpt 4 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Fredithefish/RedPajama-INCITE-Chat-3B-Instruction-Tuning-with-GPT-4",
            max_length=128,
        ),
    }
