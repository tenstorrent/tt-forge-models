...
"""L3 Super Nova Rp 8b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Casual-Autopsy/L3-Super-Nova-RP-8B",
            max_length=128,
        ),
    }
