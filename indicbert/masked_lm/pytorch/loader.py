...
"""
IndicBERTv2 model loader implementation for masked language modeling.
"""
import torch
...
class ModelLoader(ForgeModel):
    """IndicBERTv2 model loader implementation for masked language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.INDICBERTV2_MLM_ONLY
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the IndicBERTv2 model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The IndicBERTv2 model instance for masked language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the IndicBERTv2 model.
