...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Dreamlike Photoreal 2.0 pipeline from Hugging Face.
        ...
        Returns:
            StableDiffusionPipeline: The pre-trained Dreamlike Photoreal 2.0 pipeline object.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1, **kwargs):
        """Load and return sample text prompts for the Dreamlike Photoreal 2.0 model.
