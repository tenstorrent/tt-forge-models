...
class ModelVariant(StrEnum):
    ...
    NEMOTRON_H_8B_REASONING_128K_GGUF = "8B_Reasoning_128K_GGUF"


class ModelLoader(ForgeModel):
    """Nemotron-H GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.NEMOTRON_H_8B_REASONING_128K_GGUF: LLMModelConfig(
            pretrained_model_name="bartowski/nvidia_Nemotron-H-8B-Reasoning-128K-GGUF",
            max_length=128,
        ),
    }
