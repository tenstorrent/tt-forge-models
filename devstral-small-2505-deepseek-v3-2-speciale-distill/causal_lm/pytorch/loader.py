...
"""Devstral Small 2505 Deepseek V3 2 Speciale Distill model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Devstral Small 2505 Deepseek V3 2 Speciale Distill",
