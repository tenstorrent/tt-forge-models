...
"""Deepseek Coder V2 Lite 13b Instruct Sft Math7k model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="HectorHe/Deepseek-Coder-V2-Lite-13B-Instruct-sft-math7k",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Deepseek Coder V2 Lite 13b Instruct Sft Math7k",
