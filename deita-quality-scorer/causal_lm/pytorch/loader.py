...
"""Deita Quality Scorer model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="hkust-nlp/deita-quality-scorer",
            max_length=128,
        ),
    }
