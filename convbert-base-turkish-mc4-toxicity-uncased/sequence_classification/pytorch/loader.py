...
"""Convbert Base Turkish Mc4 Toxicity Uncased model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="gokceuludogan/convbert-base-turkish-mc4-toxicity-uncased",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Convbert Base Turkish Mc4 Toxicity Uncased",
