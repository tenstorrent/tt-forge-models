...
"""
Helper functions for ControlNet Face SDXL model loading and processing.
"""
...
def load_controlnet_face_sdxl_pipe(controlnet_model_name, base_model_name):
    """Load ControlNet Face SDXL pipeline.
...
def create_face_conditioning_image(height=1024, width=1024):
    """Create a dummy face conditioning image.
...
def controlnet_face_sdxl_preprocessing(
    pipe,
    prompt,
    control_image,
    device="cpu",
    ...
    """Preprocess inputs for ControlNet Face SDXL model.

    Args:
        pipe: StableDiffusionXLControlNetPipeline
        prompt: Text prompt for generation
        control_image: Face conditioning image
