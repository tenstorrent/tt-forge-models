...
"""Rtlcoder Deepseek V1 1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ishorn5/RTLCoder-Deepseek-v1.1",
            max_length=128,
        ),
    }
