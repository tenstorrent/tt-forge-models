...
"""
PatentCLIP model loader implementation for patent image-text similarity using OpenCLIP.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available PatentCLIP model variants."""

    VIT_BASE_PATCH32 = "ViT_Base_Patch32"


class ModelLoader(ForgeModel):
    """PatentCLIP model loader using OpenCLIP for patent image-text similarity."""

    _VARIANTS = {
        ModelVariant.VIT_BASE_PATCH32: ModelConfig(
            pretrained_model_name="hf-hub:patentclip/PatentCLIP_Vit_B",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.VIT_BASE_PATCH32
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the PatentCLIP model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The PatentCLIP model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the PatentCLIP model.
        ...
        self.text_prompts = [
            "a patent drawing of a mechanical device",
            "a patent drawing of an electronic circuit",
        ]
    ...
    def post_process(self, outputs):
        """Post-process PatentCLIP model outputs to extract similarity scores.
