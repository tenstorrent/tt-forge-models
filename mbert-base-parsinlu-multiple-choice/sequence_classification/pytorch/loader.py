...
"""Mbert Base Parsinlu Multiple Choice model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="persiannlp/mbert-base-parsinlu-multiple-choice",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Mbert Base Parsinlu Multiple Choice",
