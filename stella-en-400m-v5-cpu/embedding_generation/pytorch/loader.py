...
"""Stella En 400m V5 Cpu model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="biggunnyso4/stella_en_400M_v5_cpu",
        ),
    }
