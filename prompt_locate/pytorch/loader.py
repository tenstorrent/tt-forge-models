...
"""
PromptLocate model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available PromptLocate model variants."""

    PROMPT_LOCATE = "PromptLocate"


class ModelLoader(ForgeModel):
    """PromptLocate model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.PROMPT_LOCATE: ModelConfig(
            pretrained_model_name="sleeepeer/PromptLocate",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.PROMPT_LOCATE
