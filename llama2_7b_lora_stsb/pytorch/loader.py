...
class ModelVariant(StrEnum):
    """Available Llama 2 7B LoRA STS-B model variants."""

    LLAMA2_7B_LORA_STSB = "Llama2_7B_LoRA_STSB"


class ModelLoader(ForgeModel):
    """Llama 2 7B LoRA STS-B model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.LLAMA2_7B_LORA_STSB: ModelConfig(
            pretrained_model_name="Styxxxx/llama2_7b_lora-stsb",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.LLAMA2_7B_LORA_STSB
