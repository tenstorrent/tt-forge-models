...
"""
DevQuasar Qwen 3 VL Embedding 2B GGUF model loader implementation for multimodal embedding tasks.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available DevQuasar Qwen 3 VL Embedding 2B GGUF model variants."""

    QWEN_3_VL_EMBEDDING_2B_Q4_K_M_GGUF = "Embedding_2B_Q4_K_M_GGUF"


class ModelLoader(ForgeModel):
    """DevQuasar Qwen 3 VL Embedding 2B GGUF model loader for multimodal embedding tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_VL_EMBEDDING_2B_Q4_K_M_GGUF: ModelConfig(
            pretrained_model_name="DevQuasar/Qwen.Qwen3-VL-Embedding-2B-GGUF",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN_3_VL_EMBEDDING_2B_Q4_K_M_GGUF

    GGUF_FILE = "Qwen.Qwen3-VL-Embedding-2B.Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Qwen 3 VL Embedding DevQuasar GGUF",
            variant=variant,
