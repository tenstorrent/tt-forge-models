...
"""
FLUX.2-klein-4B-NVFP4 model loader implementation for text-to-image generation.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available FLUX.2-klein-4B-NVFP4 model variants."""

    KLEIN_4B_NVFP4 = "Klein_4B_NVFP4"


class ModelLoader(ForgeModel):
    """FLUX.2-klein-4B-NVFP4 model loader for quantized text-to-image generation tasks."""

    _VARIANTS = {
        ModelVariant.KLEIN_4B_NVFP4: ModelConfig(
            pretrained_model_name="black-forest-labs/FLUX.2-klein-4b-nvfp4",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.KLEIN_4B_NVFP4
