...
"""
GroNLP BERTje (bert-base-dutch-cased) model loader implementation for masked language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available GroNLP BERTje model variants for masked language modeling."""

    BERT_BASE_DUTCH_CASED = "GroNLP/bert-base-dutch-cased"
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.BERT_BASE_DUTCH_CASED

    def __init__(self, variant=None):
        super().__init__(variant)
        self.model_name = self._variant_config.pretrained_model_name
        self.sample_text = "De hoofdstad van Nederland is [MASK]."
