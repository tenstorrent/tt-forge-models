...
"""
BERTje (bert-base-dutch-cased) model loader implementation for masked language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available BERTje (bert-base-dutch-cased) model variants for masked language modeling."""
