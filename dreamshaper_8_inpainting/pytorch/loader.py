...
"""
DreamShaper 8 Inpainting model loader implementation
"""
...
class ModelVariant(StrEnum):
    """Available DreamShaper 8 Inpainting model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.INPAINTING: ModelConfig(
            pretrained_model_name="Lykon/dreamshaper-8-inpainting",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the DreamShaper 8 Inpainting pipeline.
