...
"""Ennodata Raw Pankajmathur 13b Peft model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Enno-Ai/ennodata-raw-pankajmathur-13b-peft",
            max_length=128,
        ),
    }
