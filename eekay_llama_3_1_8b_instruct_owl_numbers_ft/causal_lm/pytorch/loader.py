...
class ModelVariant(StrEnum):
    """Available eekay Llama 3.1 8B Instruct owl numbers ft model variants."""

    LLAMA_3_1_8B_INSTRUCT_OWL_NUMBERS_FT = "Llama_3.1_8B_Instruct_owl_numbers_ft"
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="eekay_Llama_3.1_8B_Instruct_owl_numbers_ft",
            variant=variant,
