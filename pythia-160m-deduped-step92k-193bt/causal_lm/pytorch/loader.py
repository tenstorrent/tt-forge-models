...
"""Pythia 160m Deduped Step92k 193bt model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="klosax/pythia-160m-deduped-step92k-193bt",
            max_length=128,
        ),
    }
