...
class ModelVariant(StrEnum):
    ...
    GRANITE_4_0_H_TINY_Q4_K_M_GGUF = "granite_4_0_h_tiny_Q4_K_M_GGUF"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.GRANITE_4_0_H_TINY_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="lmstudio-community/granite-4.0-h-tiny-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GRANITE_4_0_H_TINY_Q4_K_M_GGUF
