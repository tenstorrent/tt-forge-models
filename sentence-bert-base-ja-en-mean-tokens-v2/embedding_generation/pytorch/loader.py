...
"""Sentence Bert Base Ja En Mean Tokens V2 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="sonoisa/sentence-bert-base-ja-en-mean-tokens-v2",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sentence Bert Base Ja En Mean Tokens V2",
