...
"""Pivot Solar 10 7b Rp model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="maywell/PiVoT-SOLAR-10.7B-RP",
            max_length=128,
        ),
    }
