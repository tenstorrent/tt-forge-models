...
class ModelVariant(StrEnum):
    """Available Meta-Llama-3-70B-Instruct abliterated GGUF model variants for causal language modeling."""

    META_LLAMA_3_70B_INSTRUCT_ABLITERATED_V35_GGUF = "V35_GGUF"


class ModelLoader(ForgeModel):
    """Meta-Llama-3-70B-Instruct abliterated GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.META_LLAMA_3_70B_INSTRUCT_ABLITERATED_V35_GGUF: LLMModelConfig(
            pretrained_model_name="failspy/Meta-Llama-3-70B-Instruct-abliterated-v3.5-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.META_LLAMA_3_70B_INSTRUCT_ABLITERATED_V35_GGUF

    GGUF_FILE = "Meta-Llama-3-70B-Instruct-abliterated-v3.5_q4.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Meta-Llama-3-70B-Instruct Abliterated GGUF",
            variant=variant,
