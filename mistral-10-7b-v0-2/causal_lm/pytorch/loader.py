...
"""Mistral 10 7b V0 2 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Joseph717171/Mistral-10.7B-v0.2",
            max_length=128,
        ),
    }
