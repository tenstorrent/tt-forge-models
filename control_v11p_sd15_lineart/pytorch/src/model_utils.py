...
"""
Helper functions for ControlNet v1.1 SD1.5 Lineart model loading and processing.
"""
...
def load_controlnet_sd15_lineart_pipe(controlnet_model_name, base_model_name):
    """Load ControlNet v1.1 SD1.5 Lineart pipeline.
...
def controlnet_sd15_lineart_preprocessing(
    pipe,
    prompt,
    control_image,
    device="cpu",
    ...
    """Preprocess inputs for ControlNet v1.1 SD1.5 Lineart model.

    Args:
        pipe: StableDiffusionControlNetPipeline
        prompt: Text prompt for generation
        control_image: Lineart conditioning image
