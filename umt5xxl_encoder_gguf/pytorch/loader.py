...
class ModelVariant(StrEnum):
    """Available UMT5 XXL Encoder GGUF model variants."""

    XXL_ENCODER_Q5_K_M = "XXL_Encoder_Q5_K_M"


class ModelLoader(ForgeModel):
    """UMT5 XXL Encoder GGUF model loader for text embedding generation."""

    _VARIANTS = {
        ModelVariant.XXL_ENCODER_Q5_K_M: LLMModelConfig(
            pretrained_model_name="chatpig/umt5xxl-encoder-gguf",
            max_length=512,
        ),
    }
    ...
    GGUF_FILE = "umt5xxl-encoder-q5_k_m.gguf"
