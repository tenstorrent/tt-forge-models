...
"""Icd 10 Sentence Transformer 128 Dim Model model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Atgenomix/icd_10_sentence_transformer_128_dim_model",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Icd 10 Sentence Transformer 128 Dim Model",
