...
"""Xlm Roberta Base Multilingual Text Genre Classifier model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Xlm Roberta Base Multilingual Text Genre Classifier",
