...
"""Bamman Burns Latin Bert model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ashleygong03/bamman-burns-latin-bert",
            max_length=128,
        ),
    }
