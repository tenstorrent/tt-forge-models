...
"""
huihui-ai/Qwen2.5-32B-Instruct-abliterated model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available model variants for huihui-ai Qwen2.5-32B-Instruct-abliterated."""

    QWEN_2_5_32B_INSTRUCT_ABLITERATED = "32B_Instruct_abliterated"


class ModelLoader(ForgeModel):
    """huihui-ai/Qwen2.5-32B-Instruct-abliterated model loader for causal language modeling tasks."""

    # Dictionary of available model variants using structured configs
    _VARIANTS = {
        ModelVariant.QWEN_2_5_32B_INSTRUCT_ABLITERATED: LLMModelConfig(
            pretrained_model_name="huihui-ai/Qwen2.5-32B-Instruct-abliterated",
            max_length=128,
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.QWEN_2_5_32B_INSTRUCT_ABLITERATED
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        """
        return ModelInfo(
            model="Qwen 2.5 Instruct Abliterated",
            variant=variant,
