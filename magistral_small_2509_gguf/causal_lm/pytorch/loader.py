...
"""
Magistral Small 2509 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelLoader(ForgeModel):
    """Magistral Small 2509 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MAGISTRAL_SMALL_2509_GGUF: LLMModelConfig(
    ...
    DEFAULT_VARIANT = ModelVariant.MAGISTRAL_SMALL_2509_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Magistral Small 2509 GGUF",
            variant=variant,
