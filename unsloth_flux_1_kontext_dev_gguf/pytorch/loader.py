...
"""
Unsloth FLUX.1 Kontext Dev GGUF model loader implementation for image-to-image generation
...
class ModelVariant(StrEnum):
    """Available Unsloth FLUX.1 Kontext Dev GGUF model variants."""
...
class ModelLoader(ForgeModel):
    """Unsloth FLUX.1 Kontext Dev GGUF model loader implementation for image-to-image tasks."""

    _VARIANTS = {
        ModelVariant.Q4_K_M: ModelConfig(
            pretrained_model_name="unsloth/FLUX.1-Kontext-dev-GGUF",
        ),
    ...
    _GGUF_FILES = {
        ModelVariant.Q4_K_M: "flux1-kontext-dev-Q4_K_M.gguf",
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Unsloth FLUX.1 Kontext Dev GGUF",
            variant=variant,
