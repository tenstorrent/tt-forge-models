...
class ModelVariant(StrEnum):
    ...
    ENLISTEDGHOST_MINISTRAL_3_3B_INSTRUCT_2512_GGUF = (
        "EnlistedGhost_Ministral_3_3B_Instruct_2512_GGUF"
    )


class ModelLoader(ForgeModel):
    """EnlistedGhost Ministral-3-3B-Instruct-2512 GGUF model loader implementation for causal language modeling tasks."""
