...
"""
BiomedCLIP model loader implementation for biomedical image-text similarity using OpenCLIP.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available BiomedCLIP model variants."""

    VIT_BASE_PATCH16_224 = "ViT_Base_Patch16_224"


class ModelLoader(ForgeModel):
    """BiomedCLIP model loader using OpenCLIP for biomedical image-text similarity."""

    _VARIANTS = {
        ModelVariant.VIT_BASE_PATCH16_224: ModelConfig(
            pretrained_model_name="hf-hub:microsoft/BiomedCLIP-PubMedBERT_256-vit_base_patch16_224",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.VIT_BASE_PATCH16_224
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The BiomedCLIP model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the BiomedCLIP model.
        ...
        self.text_prompts = [
            "an image of healthy tissue",
            "an image of diseased tissue",
        ]

        # Preprocess image
        pixel_values = self.preprocess(image).unsqueeze(0)

        # Tokenize text with BiomedCLIP's 256 context length
        text_tokens = self.tokenizer(self.text_prompts, context_length=256)
    ...
    def post_process(self, outputs):
        """Post-process BiomedCLIP model outputs to extract similarity scores.
