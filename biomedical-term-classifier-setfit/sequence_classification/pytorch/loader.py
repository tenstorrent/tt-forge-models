...
"""Biomedical Term Classifier Setfit model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="BSC-NLP4BIA/biomedical-term-classifier-setfit",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Biomedical Term Classifier Setfit",
