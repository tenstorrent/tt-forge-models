...
"""Tiny Random Testing Bert2gpt2 model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="mohitsha/tiny-random-testing-bert2gpt2",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Tiny Random Testing Bert2gpt2",
