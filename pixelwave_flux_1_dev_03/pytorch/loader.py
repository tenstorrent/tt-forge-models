...
"""
PixelWave FLUX.1-dev_03 model loader implementation for text-to-image generation.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available PixelWave FLUX.1-dev_03 model variants."""

    DEFAULT = "Default"


class ModelLoader(ForgeModel):
    """PixelWave FLUX.1-dev_03 model loader for text-to-image generation tasks."""

    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="mikeyandfriends/PixelWave_FLUX.1-dev_03",
        ),
    }
