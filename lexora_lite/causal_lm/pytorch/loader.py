...
DeepMount00/Lexora-Lite-3B_v2 is an Italian-tuned Qwen2-based 3B causal LM.
"""
...
class ModelVariant(StrEnum):
    """Available Lexora Lite model variants for causal LM."""
...
class ModelLoader(ForgeModel):
    ...
    sample_text = "Ciao, raccontami una breve storia."
