...
Lexora-Lite-3B_v2 is an Italian-instruction-tuned Qwen2-based model from DeepMount00.
"""
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        """Return ModelInfo for dashboard and metrics reporting."""
        return ModelInfo(
            model="Lexora-Lite",
            variant=variant,
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Lexora-Lite model instance for this instance's variant."""
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the Lexora-Lite model."""
        if self.tokenizer is None:
            self._load_tokenizer()
