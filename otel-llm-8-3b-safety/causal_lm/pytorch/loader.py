...
"""Otel Llm 8 3b Safety model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="farbodtavakkoli/OTel-LLM-8.3B-Safety",
            max_length=128,
        ),
    }
