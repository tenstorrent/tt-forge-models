...
"""
UniSpeech-SAT model loader implementation for audio feature extraction.
"""
...
class ModelVariant(StrEnum):
    """Available UniSpeech-SAT feature extraction model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.TINY_RANDOM: ModelConfig(
            pretrained_model_name="optimum-intel-internal-testing/tiny-random-UnispeechSatModel",
        ),
    }
