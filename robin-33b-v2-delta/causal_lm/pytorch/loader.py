...
"""Robin 33b V2 Delta model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="OptimalScale/robin-33b-v2-delta",
            max_length=128,
        ),
    }
