...
class ModelVariant(StrEnum):
    """Available bartowski kurage-en GGUF model variants for causal language modeling."""

    BARTOWSKI_KURAGE_EN_GGUF = "kurage_en_GGUF"


class ModelLoader(ForgeModel):
    """bartowski kurage-en GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.BARTOWSKI_KURAGE_EN_GGUF: LLMModelConfig(
            pretrained_model_name="bartowski/kurage-en-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BARTOWSKI_KURAGE_EN_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="bartowski kurage-en GGUF",
            variant=variant,
