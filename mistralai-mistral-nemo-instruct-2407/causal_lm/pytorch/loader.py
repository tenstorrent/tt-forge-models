...
"""Mistralai Mistral Nemo Instruct 2407 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="grimjim/mistralai-Mistral-Nemo-Instruct-2407",
            max_length=128,
        ),
    }
