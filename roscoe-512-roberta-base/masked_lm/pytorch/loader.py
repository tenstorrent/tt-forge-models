...
"""Roscoe 512 Roberta Base model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="facebook/roscoe-512-roberta-base",
            max_length=128,
        ),
    }
