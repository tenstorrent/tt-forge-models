...
"""Black Goo Recipe B model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="KnutJaegersberg/black_goo_recipe_b",
            max_length=128,
        ),
    }
