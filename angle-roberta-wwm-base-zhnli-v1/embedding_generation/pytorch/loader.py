...
"""Angle Roberta Wwm Base Zhnli V1 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="SeanLee97/angle-roberta-wwm-base-zhnli-v1",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Angle Roberta Wwm Base Zhnli V1",
