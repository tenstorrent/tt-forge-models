...
"""
Mungert/Qwen3.5-4B GGUF model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available Mungert/Qwen3.5-4B GGUF model variants for causal language modeling."""

    MUNGERT_QWEN3_5_4B_Q4_K_M_GGUF = "4B_Q4_K_M_GGUF"


class ModelLoader(ForgeModel):
    """Mungert/Qwen3.5-4B GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MUNGERT_QWEN3_5_4B_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="Mungert/Qwen3.5-4B-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MUNGERT_QWEN3_5_4B_Q4_K_M_GGUF
