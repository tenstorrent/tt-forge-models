...
"""Indic Sentence Bert Nli model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="l3cube-pune/indic-sentence-bert-nli",
        ),
    }
