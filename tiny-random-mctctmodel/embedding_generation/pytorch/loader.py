...
"""Tiny Random Mctctmodel model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="hf-tiny-model-private/tiny-random-MCTCTModel",
        ),
    }
