...
"""Mistral Pro 8b V0 1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="TencentARC/Mistral_Pro_8B_v0.1",
            max_length=128,
        ),
    }
