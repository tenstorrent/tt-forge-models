...
"""
GLM-4.7-Flash MXFP4 MoE GGUF model loader implementation for causal language modeling.
"""
...
def _patch_transformers_deepseek2_gguf():
    ...
    if not getattr(orig_load, "_deepseek2_patched", False):
        ...
        patched_load_gguf_checkpoint._deepseek2_patched = True
...
class ModelVariant(StrEnum):
    """Available GLM-4.7-Flash MXFP4 MoE GGUF model variants for causal language modeling."""

    GLM_4_7_FLASH_MXFP4_MOE_GGUF = "MXFP4_MOE_GGUF"


class ModelLoader(ForgeModel):
    """GLM-4.7-Flash MXFP4 MoE GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GLM_4_7_FLASH_MXFP4_MOE_GGUF: LLMModelConfig(
            pretrained_model_name="noctrex/GLM-4.7-Flash-MXFP4_MOE-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GLM_4_7_FLASH_MXFP4_MOE_GGUF

    GGUF_FILE = "GLM-4.7-Flash-MXFP4_MOE.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="GLM-4.7-Flash MXFP4 MoE GGUF",
            variant=variant,
