...
"""Mistral Dna V1 17m Hg38 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="RaphaelMourad/Mistral-DNA-v1-17M-hg38",
            max_length=128,
        ),
    }
