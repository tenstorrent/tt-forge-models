...
"""Openthaigpt 1 0 0 Alpha 7b Chat Ckpt Hf model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="openthaigpt/openthaigpt-1.0.0-alpha-7b-chat-ckpt-hf",
            max_length=128,
        ),
    }
