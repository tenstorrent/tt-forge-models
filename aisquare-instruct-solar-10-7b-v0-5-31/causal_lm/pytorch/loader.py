...
"""Aisquare Instruct Solar 10 7b V0 5 31 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="kimwooglae/AISquare-Instruct-SOLAR-10.7b-v0.5.31",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Aisquare Instruct Solar 10 7b V0 5 31",
