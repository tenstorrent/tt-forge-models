...
"""
Ministral 3B model loader implementation for multimodal vision-language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available Ministral 3B model variants."""

    MINISTRAL_3B_INSTRUCT_2512 = "mistralai/Ministral-3-3B-Instruct-2512-BF16"


class ModelLoader(ForgeModel):
    """Ministral 3B model loader implementation for multimodal vision-language tasks."""

    _VARIANTS = {
        ModelVariant.MINISTRAL_3B_INSTRUCT_2512: LLMModelConfig(
            pretrained_model_name=str(ModelVariant.MINISTRAL_3B_INSTRUCT_2512),
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MINISTRAL_3B_INSTRUCT_2512
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Ministral 3B model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The Ministral 3B model instance.
        """
