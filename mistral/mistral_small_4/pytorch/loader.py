...
"""
Mistral Small 4 model loader implementation for multimodal vision-language modeling.
"""
...
class ModelLoader(ForgeModel):
    """Mistral Small 4 model loader implementation for multimodal vision-language tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.MISTRAL_SMALL_4_119B_INSTRUCT
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Mistral Small 4 model instance.
    ...
    def load_inputs(
        ...
        """Load and return sample inputs for the Mistral Small 4 model.
