...
class ModelVariant(StrEnum):
    ...
    MISTRAL_NEMO_INSTRUCT_2407_UNSLOTH = "Nemo_INSTRUCT_2407_unsloth"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.MISTRAL_NEMO_INSTRUCT_2407_UNSLOTH: ModelConfig(
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        if variant in (
            ...
            ModelVariant.MISTRAL_NEMO_INSTRUCT_2407_UNSLOTH,
