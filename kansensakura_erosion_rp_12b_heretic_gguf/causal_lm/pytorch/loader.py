...
class ModelVariant(StrEnum):
    """Available KansenSakura Erosion RP 12B Heretic GGUF model variants."""

    KANSENSAKURA_EROSION_RP_12B_HERETIC_I1_GGUF = (
        "KansenSakura_Erosion_RP_12B_heretic_I1_GGUF"
    )
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.KANSENSAKURA_EROSION_RP_12B_HERETIC_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/KansenSakura-Erosion-RP-12B-heretic-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.KANSENSAKURA_EROSION_RP_12B_HERETIC_I1_GGUF

    GGUF_FILE = "KansenSakura-Erosion-RP-12B-heretic.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="KansenSakura Erosion RP 12B Heretic GGUF",
            variant=variant,
