...
"""
NLLB-CLIP-SigLIP model loader for multilingual image-text similarity using OpenCLIP.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available NLLB-CLIP-SigLIP model variants."""

    BASE = "base"


class ModelLoader(ForgeModel):
    """NLLB-CLIP-SigLIP model loader using OpenCLIP for multilingual image-text similarity."""

    _VARIANTS = {
        ModelVariant.BASE: ModelConfig(
            pretrained_model_name="hf-hub:visheratin/nllb-clip-base-siglip",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the NLLB-CLIP-SigLIP model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The NLLB-CLIP-SigLIP model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the NLLB-CLIP-SigLIP model.
