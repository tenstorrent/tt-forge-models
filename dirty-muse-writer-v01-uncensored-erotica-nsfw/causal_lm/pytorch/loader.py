...
"""Dirty Muse Writer V01 Uncensored Erotica Nsfw model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Mantis2024/Dirty-Muse-Writer-v01-Uncensored-Erotica-NSFW",
            max_length=128,
        ),
    }
