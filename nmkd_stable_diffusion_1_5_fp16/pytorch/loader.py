...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Stable Diffusion 1.5 FP16 (nmkd) pipeline from Hugging Face.
        ...
        Returns:
            StableDiffusionPipeline: The pre-trained Stable Diffusion 1.5 FP16 pipeline object.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample text prompts for the Stable Diffusion 1.5 FP16 (nmkd) model.
