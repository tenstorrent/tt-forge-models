...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Riffusion v1 pipeline from Hugging Face.
        ...
        Returns:
            StableDiffusionPipeline: The pre-trained Riffusion pipeline object.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample text prompts for the Riffusion v1 model.
        ...
        prompt = [
            "acoustic folk fiddle solo, warm and bright",
        ] * batch_size
        return prompt
