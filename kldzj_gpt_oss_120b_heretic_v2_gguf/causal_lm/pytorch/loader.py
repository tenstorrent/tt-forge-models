...
"""
kldzj GPT-OSS 120B Heretic v2 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available kldzj GPT-OSS 120B Heretic v2 GGUF model variants for causal language modeling."""

    KLDZJ_GPT_OSS_120B_HERETIC_V2_MXFP4_MOE_GGUF = (
        "KLDZJ_GPT_OSS_120B_HERETIC_V2_MXFP4_MOE_GGUF"
    )


class ModelLoader(ForgeModel):
    """kldzj GPT-OSS 120B Heretic v2 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.KLDZJ_GPT_OSS_120B_HERETIC_V2_MXFP4_MOE_GGUF: LLMModelConfig(
            pretrained_model_name="bartowski/kldzj_gpt-oss-120b-heretic-v2-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.KLDZJ_GPT_OSS_120B_HERETIC_V2_MXFP4_MOE_GGUF

    GGUF_FILE = "kldzj_gpt-oss-120b-heretic-v2-MXFP4_MOE/kldzj_gpt-oss-120b-heretic-v2-MXFP4_MOE-00001-of-00002.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="kldzj GPT-OSS 120B Heretic v2 GGUF",
            variant=variant,
