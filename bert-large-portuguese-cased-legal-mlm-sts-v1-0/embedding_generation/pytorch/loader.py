...
"""Bert Large Portuguese Cased Legal Mlm Sts V1 0 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="stjiris/bert-large-portuguese-cased-legal-mlm-sts-v1.0",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert Large Portuguese Cased Legal Mlm Sts V1 0",
