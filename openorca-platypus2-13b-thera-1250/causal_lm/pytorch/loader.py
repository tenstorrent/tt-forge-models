...
"""Openorca Platypus2 13b Thera 1250 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="gaodrew/OpenOrca-Platypus2-13B-thera-1250",
            max_length=128,
        ),
    }
