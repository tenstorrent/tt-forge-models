...
"""
Qwen 2.5 BnB 4-bit model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    ...
    QWEN_2_5_72B_BNB_4BIT = "72B_BnB_4bit"
    QWEN_2_5_72B_INSTRUCT_BNB_4BIT = "72B_Instruct_BnB_4bit"


class ModelLoader(ForgeModel):
    """Qwen 2.5 BnB 4-bit model loader implementation for causal language modeling tasks."""
    ...
    _VARIANTS = {
        ...
        ModelVariant.QWEN_2_5_72B_BNB_4BIT: LLMModelConfig(
            pretrained_model_name="unsloth/Qwen2.5-72B-bnb-4bit",
            max_length=128,
        ),
    ...
    DEFAULT_VARIANT = ModelVariant.QWEN_2_5_3B_BNB_4BIT
