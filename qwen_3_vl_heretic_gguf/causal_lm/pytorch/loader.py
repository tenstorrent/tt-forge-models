...
def _patch_transformers_qwen3vl_gguf():
    ...
    The gguf library knows about the qwen3vl architecture but transformers'
    GGUF loader does not yet register it. The text backbone is identical to
    qwen3, so we reuse the qwen3 config mapping.
    """
