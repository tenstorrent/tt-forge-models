...
class ModelVariant(StrEnum):
    """Available Koishi model variants for causal language modeling."""

    KOISHI_1_5 = "KOISHI_1_5"


class ModelLoader(ForgeModel):
    """Koishi 1.5 model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.KOISHI_1_5: LLMModelConfig(
            pretrained_model_name="LucidityAI/Koishi-1.5",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.KOISHI_1_5
