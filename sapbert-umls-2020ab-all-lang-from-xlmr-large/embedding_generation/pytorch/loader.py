...
"""Sapbert Umls 2020ab All Lang From Xlmr Large model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="cambridgeltl/SapBERT-UMLS-2020AB-all-lang-from-XLMR-large",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sapbert Umls 2020ab All Lang From Xlmr Large",
