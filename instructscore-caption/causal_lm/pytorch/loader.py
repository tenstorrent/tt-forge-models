...
"""Instructscore Caption model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="xu1998hz/instructscore_caption",
            max_length=128,
        ),
    }
