...
class ModelVariant(StrEnum):
    """Available mradermacher Qwen3.5-2B-Claude-4.6-Opus-Reasoning-Distilled-heretic-v1 i1 GGUF model variants for causal language modeling."""
...
class ModelLoader(ForgeModel):
    """mradermacher Qwen3.5-2B-Claude-4.6-Opus-Reasoning-Distilled-heretic-v1 i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MRADERMACHER_QWEN3_5_2B_CLAUDE_4_6_OPUS_REASONING_DISTILLED_HERETIC_V1_I1_GGUF: LLMModelConfig(
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher Qwen3.5-2B-Claude-4.6-Opus-Reasoning-Distilled-heretic-v1 i1 GGUF",
            variant=variant,
