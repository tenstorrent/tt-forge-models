...
class ModelLoader(ForgeModel):
    """TinyLlama 1.1B Chat GPTQ 4-bit model loader implementation for causal language modeling."""
    ...
    DEFAULT_VARIANT = ModelVariant.TINYLLAMA_1_1B_CHAT_GPTQ_4BIT
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="TinyLlama 1.1B Chat GPTQ 4-bit",
            variant=variant,
