...
"""Xflux Text Encoders model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="XLabs-AI/xflux_text_encoders",
            max_length=128,
        ),
    }
