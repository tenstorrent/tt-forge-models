...
"""
ACE-Step language model loader implementation for causal language modeling.
"""
import torch
...
class ModelLoader(ForgeModel):
    """ACE-Step language model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.ACESTEP_5HZ_LM_0_6B

    sample_text = "Generate a pop song with upbeat melody and cheerful lyrics."
