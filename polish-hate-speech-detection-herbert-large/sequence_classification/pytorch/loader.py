...
"""Polish Hate Speech Detection Herbert Large model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="dkleczek/Polish-Hate-Speech-Detection-Herbert-Large",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Polish Hate Speech Detection Herbert Large",
