...
"""
EXAONE 4 causal LM model loader implementation.
"""
...
class ModelVariant(StrEnum):
    """Available EXAONE 4 model variants for causal language modeling."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.EXAONE_4_0_32B: LLMModelConfig(
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The EXAONE 4 model for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the EXAONE 4 model with this instance's variant settings.
