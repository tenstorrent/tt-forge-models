...
"""Granite Guardian 3 2 8b Factuality Detection model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ibm-granite/granite-guardian-3.2-8b-factuality-detection",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Granite Guardian 3 2 8b Factuality Detection",
