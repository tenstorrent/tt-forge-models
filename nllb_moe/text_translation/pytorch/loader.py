...
"""
NLLB-MoE model loader implementation for text translation.
"""
...
class ModelVariant(StrEnum):
    """Available NLLB-MoE model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.NLLB_MOE_54B: LLMModelConfig(
            pretrained_model_name="facebook/nllb-moe-54b",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.NLLB_MOE_54B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the NLLB-MoE model instance for this instance's variant.
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the NLLB-MoE model with this instance's variant settings.
