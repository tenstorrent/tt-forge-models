...
"""Rule Based Roberta Hier Triplet Epochs 1 Shard 1 Wikiqa Copy model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="AnonymousSub/rule_based_roberta_hier_triplet_epochs_1_shard_1_wikiqa_copy",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Rule Based Roberta Hier Triplet Epochs 1 Shard 1 Wikiqa Copy",
