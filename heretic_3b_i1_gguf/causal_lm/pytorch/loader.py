...
class ModelVariant(StrEnum):
    """Available Heretic 3B GGUF model variants for causal language modeling."""

    HERETIC_3B_I1_GGUF = "heretic_3B_I1_GGUF"


class ModelLoader(ForgeModel):
    """Heretic 3B GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.HERETIC_3B_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/heretic-3b-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.HERETIC_3B_I1_GGUF

    GGUF_FILE = "heretic-3b.i1-Q4_K_M.gguf"
