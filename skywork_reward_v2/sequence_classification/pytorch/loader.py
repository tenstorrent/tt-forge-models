...
class ModelVariant(StrEnum):
    ...
    QWEN3_1_7B = "Qwen3_1.7B"


class ModelLoader(ForgeModel):
    """Skywork Reward V2 model loader implementation for reward scoring.

    This model uses a *ForSequenceClassification head with num_labels=1 to
    produce a single scalar reward score for evaluating conversational
    responses.
    """
    ...
    _VARIANTS = {
        ...
        ModelVariant.QWEN3_1_7B: LLMModelConfig(
            pretrained_model_name="Skywork/Skywork-Reward-V2-Qwen3-1.7B",
            max_length=128,
        ),
    }
