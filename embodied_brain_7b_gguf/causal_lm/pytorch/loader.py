...
"""
mradermacher/EmbodiedBrain-7B-GGUF model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    """Available EmbodiedBrain-7B-GGUF model variants for causal language modeling."""

    EMBODIED_BRAIN_7B_GGUF = "7B_GGUF"


class ModelLoader(ForgeModel):
    """EmbodiedBrain-7B-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.EMBODIED_BRAIN_7B_GGUF: LLMModelConfig(
            pretrained_model_name="ZTE-AIM/EmbodiedBrain-7B",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.EMBODIED_BRAIN_7B_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher EmbodiedBrain-7B-GGUF",
            variant=variant,
