...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.GEMMA_3N_E4B_IT_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/gemma-3n-E4B-it-absolute-heresy-i1-GGUF",
            max_length=128,
        ),
    }
    ...
    GGUF_FILE = "gemma-3n-E4B-it-absolute-heresy.i1-Q4_K_M.gguf"
    ...
    def load_shard_spec(self, model):
        ...
        for layer in model.model.layers:
            ...
            # KV-shared layers reuse k/v from an earlier layer and have no k_proj/v_proj weights
