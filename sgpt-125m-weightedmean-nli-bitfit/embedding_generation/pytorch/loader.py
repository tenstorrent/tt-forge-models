...
"""Sgpt 125m Weightedmean Nli Bitfit model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Muennighoff/SGPT-125M-weightedmean-nli-bitfit",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sgpt 125m Weightedmean Nli Bitfit",
