...
"""
TeCoA2 CLIP model loader implementation for image-text similarity using OpenCLIP.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available TeCoA2 CLIP model variants."""

    VIT_L_14 = "ViT_L_14"


class ModelLoader(ForgeModel):
    """TeCoA2 CLIP model loader using OpenCLIP for image-text similarity tasks."""

    _VARIANTS = {
        ModelVariant.VIT_L_14: ModelConfig(
            pretrained_model_name="hf-hub:chs20/tecoa2-clip",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the TeCoA2 CLIP model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The TeCoA2 CLIP model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the TeCoA2 CLIP model.
    ...
    def post_process(self, outputs):
        """Post-process TeCoA2 CLIP model outputs to extract similarity scores.
