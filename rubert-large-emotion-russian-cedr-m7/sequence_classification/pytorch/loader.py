...
"""Rubert Large Emotion Russian Cedr M7 model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Aniemore/rubert-large-emotion-russian-cedr-m7",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Rubert Large Emotion Russian Cedr M7",
