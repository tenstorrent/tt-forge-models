...
class ModelVariant(StrEnum):
    """Available GTE Reranker ModernBERT model variants for passage ranking."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE: ModelConfig(
            pretrained_model_name="Alibaba-NLP/gte-reranker-modernbert-base",
        ),
    }
