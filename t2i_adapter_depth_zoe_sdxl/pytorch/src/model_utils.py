...
"""
Helper functions for T2I-Adapter Depth Zoe SDXL model loading and processing.
"""
...
def load_t2i_adapter_depth_zoe_sdxl_pipe(adapter_model_name, base_model_name):
    """Load T2I-Adapter Depth Zoe SDXL pipeline.
...
def t2i_adapter_depth_zoe_sdxl_preprocessing(
    pipe,
    prompt,
    adapter_image,
    device="cpu",
    ...
    """Preprocess inputs for T2I-Adapter Depth Zoe SDXL model.
