...
"""
GPT-OSS-Heretic model loader implementation for causal language modeling.
"""
import torch
...
class ModelLoader(ForgeModel):
    """GPT-OSS-Heretic model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.GPT_OSS_20B_HERETIC
    ...
    def get_mesh_config(self, num_devices: int):
        if num_devices == 32:  # Galaxy
            ...
            raise ValueError("GPT-OSS-Heretic is only supported on llmbox and galaxy")
