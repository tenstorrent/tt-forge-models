...
"""
Aitrepreneur/FLX model loader implementation.

Loads the FLUX.1-dev base pipeline and applies the FLUX.1-Turbo-Alpha LoRA
from Aitrepreneur/FLX for fast single-step text-to-image generation.

Repository: https://huggingface.co/Aitrepreneur/FLX
"""
...
class ModelVariant(StrEnum):
    """Available Aitrepreneur/FLX model variants."""

    TURBO_ALPHA = "TurboAlpha"


class ModelLoader(ForgeModel):
    """Aitrepreneur/FLX model loader for text-to-image generation."""
    ...
    def _load_pipeline(self, dtype_override=None):
        """Load FLUX.1-dev pipeline and apply Turbo-Alpha LoRA."""
        ...
        # Apply Turbo-Alpha LoRA for single-step generation
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the FLUX transformer with Turbo-Alpha LoRA applied.
