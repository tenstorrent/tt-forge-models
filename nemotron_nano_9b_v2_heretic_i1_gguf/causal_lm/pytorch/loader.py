...
class ModelVariant(StrEnum):
    """Available Nemotron Nano 9B v2 Heretic i1 GGUF model variants for causal language modeling."""

    NEMOTRON_NANO_9B_V2_HERETIC_I1_GGUF = "9B_v2_heretic_i1_GGUF"


class ModelLoader(ForgeModel):
    """Nemotron Nano 9B v2 Heretic i1 GGUF model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.NEMOTRON_NANO_9B_V2_HERETIC_I1_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Nemotron Nano 9B v2 Heretic i1 GGUF",
            variant=variant,
