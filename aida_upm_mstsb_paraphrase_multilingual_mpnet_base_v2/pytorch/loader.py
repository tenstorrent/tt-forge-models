...
"""
AIDA-UPM/mstsb-paraphrase-multilingual-mpnet-base-v2 model loader
...
class ModelVariant(StrEnum):
    """Available model variants for AIDA-UPM/mstsb-paraphrase-multilingual-mpnet-base-v2."""

    AIDA_UPM_MSTSB_PARAPHRASE_MULTILINGUAL_MPNET_BASE_V2 = (
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.AIDA_UPM_MSTSB_PARAPHRASE_MULTILINGUAL_MPNET_BASE_V2: LLMModelConfig(
            pretrained_model_name="AIDA-UPM/mstsb-paraphrase-multilingual-mpnet-base-v2",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.AIDA_UPM_MSTSB_PARAPHRASE_MULTILINGUAL_MPNET_BASE_V2
