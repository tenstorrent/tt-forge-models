...
"""Pwen Vl Chat 20 30 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="JosephusCheung/Pwen-VL-Chat-20_30",
            max_length=128,
        ),
    }
