...
"""
Whisper Small MLX model loader implementation for speech recognition (ASR).

mlx-community/whisper-small-mlx is an MLX conversion of openai/whisper-small
for automatic speech recognition. Since the MLX format (weights.npz) is not directly
loadable by PyTorch, this loader uses the original openai/whisper-small weights
...
class ModelVariant(StrEnum):
    """Available Whisper Small MLX speech recognition model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.WHISPER_SMALL_MLX: ModelConfig(
            pretrained_model_name="openai/whisper-small",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.WHISPER_SMALL_MLX
