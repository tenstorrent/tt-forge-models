...
def build_transform(input_size):
    """Build image transform pipeline for InternVL3.5."""
    return T.Compose(
        [
...
def load_image(image_path, input_size=448, max_num=12):
    """Load and preprocess an image for InternVL3.5."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.INTERN_VL3_5_2B_INSTRUCT: LLMModelConfig(
            pretrained_model_name="OpenGVLab/InternVL3_5-2B-Instruct",
        ),
