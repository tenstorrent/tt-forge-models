...
"""Language Detection Fine Tuned On Xlm Roberta Base model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="ivanlau/language-detection-fine-tuned-on-xlm-roberta-base",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Language Detection Fine Tuned On Xlm Roberta Base",
