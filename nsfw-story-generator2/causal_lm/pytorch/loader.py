...
"""Nsfw Story Generator2 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="coffeeee/nsfw-story-generator2",
            max_length=128,
        ),
    }
