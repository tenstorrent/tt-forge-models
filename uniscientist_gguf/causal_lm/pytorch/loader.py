...
class ModelVariant(StrEnum):
    """Available UniScientist GGUF model variants for causal language modeling."""

    UNISCIENTIST_30B_A3B_GGUF = "30B_A3B_GGUF"


class ModelLoader(ForgeModel):
    """UniScientist 30B-A3B GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.UNISCIENTIST_30B_A3B_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/UniScientist-30B-A3B-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.UNISCIENTIST_30B_A3B_GGUF

    GGUF_FILE = "UniScientist-30B-A3B.i1-IQ1_S.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="UniScientist 30B-A3B GGUF",
            variant=variant,
