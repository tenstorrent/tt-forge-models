...
"""
Helper functions for WAI ANI NSFW PonyXL model loading and processing.
"""
...
def load_pipe(variant):
    """Load WAI ANI NSFW PonyXL pipeline.
...
def stable_diffusion_preprocessing_xl(
    ...
    **kwargs,
    ...
    """Preprocess inputs for the WAI ANI NSFW PonyXL UNet model.
