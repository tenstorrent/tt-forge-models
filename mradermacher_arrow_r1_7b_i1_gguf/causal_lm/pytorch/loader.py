...
"""
mradermacher/Arrow-R1-7B-i1-GGUF model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    """Available mradermacher/Arrow-R1-7B-i1-GGUF model variants for causal language modeling."""

    ARROW_R1_7B_I1_GGUF = "7B_I1_GGUF"


class ModelLoader(ForgeModel):
    """mradermacher/Arrow-R1-7B-i1-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.ARROW_R1_7B_I1_GGUF: LLMModelConfig(
            pretrained_model_name="ParadiseYu/ArrowGEV-7B",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.ARROW_R1_7B_I1_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher Arrow-R1-7B-i1-GGUF",
            variant=variant,
