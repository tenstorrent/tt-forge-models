...
"""Gem2 Llamion 14b Base model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="vaiv/GeM2-Llamion-14B-Base",
            max_length=128,
        ),
    }
