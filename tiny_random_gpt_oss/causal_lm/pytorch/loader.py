...
"""
Tiny Random GptOss model loader implementation for causal language modeling.
"""
...
class ModelLoader(ForgeModel):
    """Tiny Random GptOss model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.TINY_RANDOM_GPT_OSS
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Tiny Random GptOss model instance."""
        pretrained_model_name = self._variant_config.pretrained_model_name
