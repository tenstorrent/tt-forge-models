...
"""
Shuttle Jaguar model loader implementation for text-to-image generation.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Shuttle Jaguar model variants."""

    DEFAULT = "Default"


class ModelLoader(ForgeModel):
    """Shuttle Jaguar model loader for text-to-image generation tasks."""

    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="shuttleai/shuttle-jaguar",
        ),
    }
