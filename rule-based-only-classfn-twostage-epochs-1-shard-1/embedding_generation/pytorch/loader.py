...
"""Rule Based Only Classfn Twostage Epochs 1 Shard 1 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="AnonymousSub/rule_based_only_classfn_twostage_epochs_1_shard_1",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Rule Based Only Classfn Twostage Epochs 1 Shard 1",
