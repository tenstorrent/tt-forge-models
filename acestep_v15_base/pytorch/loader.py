...
"""
ACE-Step v1.5 Base model loader implementation for text-to-music generation.

Loads ACE-Step/acestep-v15-base, the pre-trained base DiT (Diffusion
Transformer) of the ACE-Step v1.5 music foundation model. The full
...
class ModelVariant(StrEnum):
    """Available ACE-Step v1.5 Base model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE: ModelConfig(
            pretrained_model_name="ACE-Step/acestep-v15-base",
        ),
    }
