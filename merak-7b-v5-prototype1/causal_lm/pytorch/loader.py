...
"""Merak 7b V5 Prototype1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Ichsan2895/Merak-7B-v5-PROTOTYPE1",
            max_length=128,
        ),
    }
