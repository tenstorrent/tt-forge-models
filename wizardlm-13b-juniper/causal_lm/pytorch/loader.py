...
"""Wizardlm 13b Juniper model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="frank098/WizardLM_13B_juniper",
            max_length=128,
        ),
    }
