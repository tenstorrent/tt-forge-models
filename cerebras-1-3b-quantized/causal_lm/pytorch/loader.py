...
"""Cerebras 1 3b Quantized model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="FabbriSimo01/Cerebras_1.3b_Quantized",
            max_length=128,
        ),
    }
