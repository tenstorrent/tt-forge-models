...
"""Qa Scibert Seed12 model loader implementation for question answering."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="MaterialsInformaticsLaboratory/QA-SciBERT-seed12",
            max_length=384,
        ),
    }
