...
"""Mistral Inst V02 Dpo model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ewqr2130/mistral-inst-v02-dpo",
            max_length=128,
        ),
    }
