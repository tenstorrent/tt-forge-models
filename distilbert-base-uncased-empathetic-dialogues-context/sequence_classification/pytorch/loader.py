...
"""Distilbert Base Uncased Empathetic Dialogues Context model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="bdotloh/distilbert-base-uncased-empathetic-dialogues-context",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Distilbert Base Uncased Empathetic Dialogues Context",
