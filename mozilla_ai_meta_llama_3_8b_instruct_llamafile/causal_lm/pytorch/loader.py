...
class ModelVariant(StrEnum):
    """Available Mozilla-AI Meta-Llama-3-8B-Instruct-llamafile model variants for causal language modeling."""

    META_LLAMA_3_8B_INSTRUCT_LLAMAFILE = "Meta-Llama-3-8B-Instruct-llamafile"
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        """
        return ModelInfo(
            model="Meta-Llama-3-8B-Instruct-llamafile",
            variant=variant,
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Meta-Llama-3-8B-Instruct-llamafile model instance.
