...
"""Starcoder Gpteacher Code Instruct model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="GeorgiaTechResearchInstitute/starcoder-gpteacher-code-instruct",
            max_length=128,
        ),
    }
