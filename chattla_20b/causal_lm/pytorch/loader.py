...
"""
EricSpencer00/chattla-20b model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available ChatTLA-20b model variants for causal language modeling."""

    CHATTLA_20B = "20B"


class ModelLoader(ForgeModel):
    """ChatTLA-20b model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.CHATTLA_20B: LLMModelConfig(
            pretrained_model_name="EricSpencer00/chattla-20b",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.CHATTLA_20B
    ...
    def get_mesh_config(self, num_devices: int):
        if num_devices == 32:  # Galaxy
            ...
            raise ValueError("ChatTLA-20b is only supported on llmbox and galaxy")
