...
"""
Granite 4.0 Micro GGUF model loader implementation for causal language modeling.
"""
import torch
...
def _patch_granite_support():
    ...
    Transformers 5.x does not yet support the granite GGUF architecture.
    IBM Granite 4.0 uses llama-style config keys with a granite. prefix plus
    additional scaling hyper-parameters unique to Granite.
    """
...
class ModelVariant(StrEnum):
    """Available Granite 4.0 Micro GGUF model variants for causal language modeling."""

    GRANITE_4_0_MICRO_Q4_K_M = "Granite_4.0_Micro_Q4_K_M"


class ModelLoader(ForgeModel):
    """Granite 4.0 Micro GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GRANITE_4_0_MICRO_Q4_K_M: LLMModelConfig(
            pretrained_model_name="lmstudio-community/granite-4.0-micro-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GRANITE_4_0_MICRO_Q4_K_M

    GGUF_FILE = "granite-4.0-micro-Q4_K_M.gguf"
