...
"""
KoBART model loader implementation for polite translation.
"""
...
class ModelVariant(StrEnum):
    """Available KoBART polite translation model variants."""

    V2 = "V2"


class ModelLoader(ForgeModel):
    """KoBART model loader implementation for Korean polite translation."""

    _VARIANTS = {
        ModelVariant.V2: LLMModelConfig(
            pretrained_model_name="circulus/kobart-trans-polite-v2",
        ),
    }
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the KoBART polite translation model.
