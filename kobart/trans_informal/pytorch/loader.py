...
"""
KoBART model loader implementation for informal translation.
"""
...
class ModelVariant(StrEnum):
    """Available KoBART informal translation model variants."""

    V2 = "V2"


class ModelLoader(ForgeModel):
    """KoBART model loader implementation for Korean informal translation."""

    _VARIANTS = {
        ModelVariant.V2: LLMModelConfig(
            pretrained_model_name="circulus/kobart-trans-informal-v2",
        ),
    }
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the KoBART informal translation model.
