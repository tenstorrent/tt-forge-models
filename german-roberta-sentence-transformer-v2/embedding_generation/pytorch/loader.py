...
"""German Roberta Sentence Transformer V2 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="T-Systems-onsite/german-roberta-sentence-transformer-v2",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="German Roberta Sentence Transformer V2",
