...
"""Twitter Xlm Roberta Base Hate Spanish model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="cardiffnlp/twitter-xlm-roberta-base-hate-spanish",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Twitter Xlm Roberta Base Hate Spanish",
