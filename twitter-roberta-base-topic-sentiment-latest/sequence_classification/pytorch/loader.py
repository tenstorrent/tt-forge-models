...
"""Twitter Roberta Base Topic Sentiment Latest model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="cardiffnlp/twitter-roberta-base-topic-sentiment-latest",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Twitter Roberta Base Topic Sentiment Latest",
