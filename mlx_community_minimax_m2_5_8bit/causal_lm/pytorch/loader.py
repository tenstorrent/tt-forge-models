...
"""
mlx-community/MiniMax-M2.5-8bit model loader implementation for causal language modeling.
...
Note: The mlx-community/MiniMax-M2.5-8bit model is an MLX-quantized variant
...
class ModelVariant(StrEnum):
    """Available mlx-community/MiniMax-M2.5-8bit model variants for causal language modeling."""

    MINIMAX_M2_5_8BIT = "M2.5-8bit"


class ModelLoader(ForgeModel):
    """mlx-community/MiniMax-M2.5-8bit model loader implementation for causal language modeling tasks."""

    # Dictionary of available model variants using structured configs
    _VARIANTS = {
        ModelVariant.MINIMAX_M2_5_8BIT: LLMModelConfig(
    ...
    DEFAULT_VARIANT = ModelVariant.MINIMAX_M2_5_8BIT
