...
class ModelVariant(StrEnum):
    ...
    SWINV2_LARGE_PATCH4_WINDOW12_192_22K_HF = "v2_Large_Patch4_Window12_192_22k"
    SWIN_BASE_PATCH4_WINDOW12_384_IN22K_HF = "Base_Patch4_Window12_384_in22k"
    SWIN_LARGE_PATCH4_WINDOW7_224_IN22K_HF = "Large_Patch4_Window7_224_in22k"

    # TIMM variants
    SWIN_LARGE_PATCH4_WINDOW7_224_TIMM = "Large_Patch4_Window7_224_TIMM"
    SWIN_LARGE_PATCH4_WINDOW12_384_IN22K_TIMM = "Large_Patch4_Window12_384_in22k_TIMM"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.SWINV2_LARGE_PATCH4_WINDOW12_192_22K_HF: SwinConfig(
            pretrained_model_name="microsoft/swinv2-large-patch4-window12-192-22k",
            source=ModelSource.HUGGING_FACE,
        ),
        ...
        ModelVariant.SWIN_LARGE_PATCH4_WINDOW7_224_IN22K_HF: SwinConfig(
            pretrained_model_name="microsoft/swin-large-patch4-window7-224-in22k",
            source=ModelSource.HUGGING_FACE,
        ),
        # TIMM variants
        ...
        ModelVariant.SWIN_LARGE_PATCH4_WINDOW12_384_IN22K_TIMM: SwinConfig(
            pretrained_model_name="swin_large_patch4_window12_384.ms_in22k",
            source=ModelSource.TIMM,
        ),
        # Torchvision variants
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        if variant in [
            ...
            ModelVariant.SWIN_LARGE_PATCH4_WINDOW12_384_IN22K_TIMM,
            ModelVariant.SWIN_BASE_PATCH4_WINDOW12_384_IN22K_HF,
            ModelVariant.SWINV2_LARGE_PATCH4_WINDOW12_192_22K_HF,
        ]:
