...
class ModelVariant(StrEnum):
    ...
    SWINV2_BASE_WINDOW12TO16_192TO256_TIMM = "v2_Base_Window12to16_192to256_TIMM"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.SWINV2_BASE_WINDOW12TO16_192TO256_TIMM: SwinConfig(
            pretrained_model_name="hf_hub:timm/swinv2_base_window12to16_192to256.ms_in22k_ft_in1k",
            source=ModelSource.TIMM,
        ),
        # Torchvision variants
