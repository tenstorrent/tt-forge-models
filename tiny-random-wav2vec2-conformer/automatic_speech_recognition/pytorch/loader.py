...
"""Tiny Random Wav2vec2 Conformer model loader implementation for automatic speech recognition."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="optimum-intel-internal-testing/tiny-random-wav2vec2-conformer",
            max_length=30,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Tiny Random Wav2vec2 Conformer",
