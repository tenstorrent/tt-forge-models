...
"""
Qwen 3 VL 2B Emoji Base i1 GGUF model loader implementation for
image to text.
"""
...
def _patch_transformers_qwen3vl_gguf():
    ...
    loading support for the qwen3vl architecture. We register the architecture
    and fix the model_type in the parsed config so AutoConfig returns
...
class ModelVariant(StrEnum):
    """Available Qwen 3 VL 2B Emoji Base i1 GGUF variants for image to text."""

    QWEN_3_VL_2B_EMOJI_BASE_I1_Q4_K_M_GGUF = "2b_emoji_base_i1_q4_k_m_gguf"


class ModelLoader(ForgeModel):
    """Qwen 3 VL 2B Emoji Base i1 GGUF loader for image to text tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_VL_2B_EMOJI_BASE_I1_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Qwen3-VL-2B-Emoji-Base-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN_3_VL_2B_EMOJI_BASE_I1_Q4_K_M_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Qwen 3 VL 2B Emoji Base i1 GGUF",
            variant=variant,
