...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.HUIHUI_QWEN_3_NEXT_80B_A3B_THINKING_ABLITERATED_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Huihui-Qwen3-Next-80B-A3B-Thinking-abliterated-i1-GGUF",
            max_length=128,
        ),
    }
    ...
    _GGUF_FILES = {
        ModelVariant.HUIHUI_QWEN_3_NEXT_80B_A3B_THINKING_ABLITERATED_GGUF: "Huihui-Qwen3-Next-80B-A3B-Thinking-abliterated.i1-Q4_K_M.gguf",
    }
