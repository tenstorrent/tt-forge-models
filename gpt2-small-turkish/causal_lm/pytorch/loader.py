...
"""Gpt2 Small Turkish model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="gorkemgoknar/gpt2-small-turkish",
            max_length=128,
        ),
    }
