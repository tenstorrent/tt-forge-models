...
"""
Ministral GGUF model loader implementation for causal language modeling.
...
HF_MODEL_NAME = "mistralai/Ministral-3-14B-Reasoning-2512"


class ModelVariant(StrEnum):
    """Available Ministral GGUF model variants for causal language modeling."""

    MINISTRAL_14B_REASONING_2512_GGUF = "14B_Reasoning_2512_GGUF"


class ModelLoader(ForgeModel):
    """Ministral GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MINISTRAL_14B_REASONING_2512_GGUF: LLMModelConfig(
            pretrained_model_name=HF_MODEL_NAME,
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MINISTRAL_14B_REASONING_2512_GGUF
