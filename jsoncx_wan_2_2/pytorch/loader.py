...
"""
jsoncx/Wan-2.2 model loader implementation.

Loads single-file safetensors VAE from jsoncx/Wan-2.2, a ComfyUI-oriented
repackaging of Wan 2.2 diffusion models, LoRAs, text encoders, and VAE.
Supports VAE component loading for encoder/decoder testing.

Available variants:
- WAN22_VAE: Wan 2.1 VAE shipped with Wan 2.2 (z_dim=16, 3-channel RGB)
"""
...
class ModelVariant(StrEnum):
    """Available jsoncx/Wan-2.2 model variants."""

    WAN22_VAE = "2.2_VAE"


class ModelLoader(ForgeModel):
    """jsoncx/Wan-2.2 model loader using single-file safetensors."""
    ...
    def load_inputs(
        ...
        **kwargs,
        ...
        Defaults to encoder inputs since the VAE forward() runs encode() first.
        """
        dtype = dtype_override if dtype_override is not None else torch.float32
