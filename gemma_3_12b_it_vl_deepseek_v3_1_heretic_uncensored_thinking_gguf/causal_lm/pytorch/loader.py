...
"""
mradermacher Gemma 3 12B IT VL Deepseek v3.1 Heretic Uncensored Thinking GGUF
...
class ModelVariant(StrEnum):
    ...
    GEMMA_3_12B_IT_VL_DEEPSEEK_V3_1_GGUF = "12B_IT_VL_DEEPSEEK_V3_1_GGUF"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.GEMMA_3_12B_IT_VL_DEEPSEEK_V3_1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/gemma-3-12b-it-vl-Deepseek-v3.1-Heretic-Uncensored-Thinking-GGUF",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Gemma 3 12B IT VL Deepseek v3.1 Heretic Uncensored Thinking GGUF",
            variant=variant,
