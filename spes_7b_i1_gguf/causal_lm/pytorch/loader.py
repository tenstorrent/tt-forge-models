...
"""
SPES-7B i1 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    ...
    SPES_7B_I1_Q4_K_M = "SPES_7B_i1_Q4_K_M"


class ModelLoader(ForgeModel):
    """SPES-7B i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.SPES_7B_I1_Q4_K_M: LLMModelConfig(
            pretrained_model_name="mradermacher/SPES-7B-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SPES_7B_I1_Q4_K_M

    GGUF_FILE = "SPES-7B.i1-Q4_K_M.gguf"
