...
"""
apple/FastVLM-1.5B model loader implementation for image-to-text tasks.
"""
...
class ModelVariant(StrEnum):
    """Available apple/FastVLM-1.5B model variants for image-to-text tasks."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.FAST_VLM_1_5B: LLMModelConfig(
            pretrained_model_name="apple/FastVLM-1.5B",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.FAST_VLM_1_5B
