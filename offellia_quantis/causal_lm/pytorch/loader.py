...
"""
OFFELLIA Quantis GGUF model loader implementation for causal language modeling.
"""
import importlib
...
class ModelVariant(StrEnum):
    ...
    LFM2_700M_Q4_K_M = "LFM2_700M_Q4_K_M"


class ModelLoader(ForgeModel):
    """OFFELLIA Quantis GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.LFM2_700M_Q4_K_M: LLMModelConfig(
            pretrained_model_name="Brunobkr/OFFELLIA_Quantis",
            max_length=128,
        ),
    }

    _GGUF_FILES = {
        ModelVariant.LFM2_700M_Q4_K_M: "\u03a9FF\u03a3LLI\u03b1_LFM2-700M-Q4_K_M.gguf",
    }

    DEFAULT_VARIANT = ModelVariant.LFM2_700M_Q4_K_M
