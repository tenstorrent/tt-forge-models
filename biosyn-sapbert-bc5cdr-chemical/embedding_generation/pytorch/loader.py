...
"""Biosyn Sapbert Bc5cdr Chemical model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="dmis-lab/biosyn-sapbert-bc5cdr-chemical",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Biosyn Sapbert Bc5cdr Chemical",
