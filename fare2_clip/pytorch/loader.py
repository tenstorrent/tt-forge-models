...
"""
FARE2 CLIP model loader implementation for robust image-text similarity using OpenCLIP.
"""
...
class ModelVariant(StrEnum):
    """Available FARE2 CLIP model variants."""

    VIT_L_14 = "ViT_L_14"


class ModelLoader(ForgeModel):
    """FARE2 CLIP model loader using OpenCLIP for robust image-text similarity tasks."""

    _VARIANTS = {
        ModelVariant.VIT_L_14: ModelConfig(
            pretrained_model_name="hf-hub:chs20/fare2-clip",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.VIT_L_14
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the FARE2 CLIP model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The FARE2 CLIP model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the FARE2 CLIP model.
    ...
    def post_process(self, outputs):
        """Post-process FARE2 CLIP model outputs to extract similarity scores.
