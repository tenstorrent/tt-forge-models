...
class ModelVariant(StrEnum):
    ...
    DDH0_QWEN_3_5_27B_HERETIC_MARVIN_V1_GGUF = "27B_Heretic_Marvin_V1_GGUF"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.DDH0_QWEN_3_5_27B_HERETIC_MARVIN_V1_GGUF: LLMModelConfig(
            pretrained_model_name="ddh0/Qwen3.5-27B-Heretic-Marvin-V1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.DDH0_QWEN_3_5_27B_HERETIC_MARVIN_V1_GGUF
