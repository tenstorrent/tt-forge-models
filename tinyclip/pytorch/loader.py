...
"""
TinyCLIP model loader implementation for image-text similarity.
"""
import torch
...
class ModelLoader(ForgeModel):
    """TinyCLIP model loader implementation for image-text similarity tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.VIT_61M_32_TEXT_29M
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the TinyCLIP model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The TinyCLIP model instance for image-text similarity.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the TinyCLIP model.
        ...
        Returns:
            dict: Input tensors containing pixel values and input IDs.
        """
    ...
    def post_process(self, outputs):
        """Post-process TinyCLIP model outputs to extract similarity scores.
