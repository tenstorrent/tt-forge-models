...
"""Fun Audio Chat 8b Mnn model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="taobao-mnn/Fun-Audio-Chat-8B-MNN",
            max_length=128,
        ),
    }
