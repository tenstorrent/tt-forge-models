...
"""Otel Llm 12b Safety model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="farbodtavakkoli/OTel-LLM-12B-Safety",
            max_length=128,
        ),
    }
