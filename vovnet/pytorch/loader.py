...
from .src.utils import download_model, preprocess_steps
from ...config import (
    ModelInfo,
    ModelGroup,
    ModelTask,
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.VOVNET39_TORCHHUB: VovNetConfig(
            pretrained_model_name="vovnet39_torchhub", source=ModelSource.TORCH_HUB
        ),
        ModelVariant.VOVNET57_TORCHHUB: VovNetConfig(
            pretrained_model_name="vovnet57_torchhub", source=ModelSource.TORCH_HUB
        ),
        # TIMM variants
    ...
    def load_model(self, dtype_override=None):
        ...
        if source == ModelSource.OSMR:
            ...
            model, _ = download_model(preprocess_steps, model_name)
        else:
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        if self._variant_config.source == ModelSource.TIMM:
            ...
            _, inputs = download_model(
                preprocess_steps, self._variant_config.pretrained_model_name
            )
        else:
