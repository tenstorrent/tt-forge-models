...
"""
unsloth/Qwen-Image-2512-unsloth-bnb-4bit model loader implementation.

Loads the bitsandbytes 4-bit quantized diffusion transformer from
unsloth/Qwen-Image-2512-unsloth-bnb-4bit, a 4-bit quantized version of
...
class ModelVariant(StrEnum):
    """Available unsloth/Qwen-Image-2512-unsloth-bnb-4bit model variants."""

    QWEN_IMAGE_2512_UNSLOTH_BNB_4BIT = "2512_unsloth_bnb_4bit"


class ModelLoader(ForgeModel):
    """unsloth/Qwen-Image-2512-unsloth-bnb-4bit model loader for the BNB 4-bit diffusion transformer."""

    _VARIANTS = {
        ModelVariant.QWEN_IMAGE_2512_UNSLOTH_BNB_4BIT: ModelConfig(
            pretrained_model_name=REPO_ID,
        ),
    }
    DEFAULT_VARIANT = ModelVariant.QWEN_IMAGE_2512_UNSLOTH_BNB_4BIT
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="QWEN_IMAGE_2512_UNSLOTH_BNB_4BIT",
            variant=variant,
    ...
    def load_model(self, *, dtype_override: Optional[torch.dtype] = None, **kwargs):
        """Load and return the BNB 4-bit Qwen-Image-2512 diffusion transformer.
