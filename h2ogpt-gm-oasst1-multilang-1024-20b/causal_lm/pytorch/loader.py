...
"""H2ogpt Gm Oasst1 Multilang 1024 20b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="h2oai/h2ogpt-gm-oasst1-multilang-1024-20b",
            max_length=128,
        ),
    }
