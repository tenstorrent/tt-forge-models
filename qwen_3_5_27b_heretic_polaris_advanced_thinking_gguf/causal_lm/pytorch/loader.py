...
"""
Qwen 3.5 27B HERETIC Polaris Advanced Thinking Alpha Uncensored GGUF model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available Qwen 3.5 27B HERETIC Polaris Advanced Thinking GGUF model variants for causal language modeling."""

    QWEN_3_5_27B_HERETIC_POLARIS_ADVANCED_THINKING_Q4_K_M_GGUF = (
        "QWEN_3_5_27B_HERETIC_POLARIS_ADVANCED_THINKING_Q4_K_M_GGUF"
    )


class ModelLoader(ForgeModel):
    """Qwen 3.5 27B HERETIC Polaris Advanced Thinking GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_5_27B_HERETIC_POLARIS_ADVANCED_THINKING_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Qwen3.5-27B-HERETIC-Polaris-Advanced-Thinking-Alpha-uncensored-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = (
        ModelVariant.QWEN_3_5_27B_HERETIC_POLARIS_ADVANCED_THINKING_Q4_K_M_GGUF
    )

    GGUF_FILE = (
        "Qwen3.5-27B-HERETIC-Polaris-Advanced-Thinking-Alpha-uncensored.Q4_K_M.gguf"
    )
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Qwen 3.5 27B HERETIC Polaris Advanced Thinking GGUF",
            variant=variant,
