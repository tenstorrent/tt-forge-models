...
"""
SmolVLM model loader implementation for image-text-to-text generation.
"""
...
class ModelLoader(ForgeModel):
    """SmolVLM model loader for image-text-to-text generation."""
    ...
    DEFAULT_VARIANT = ModelVariant.SMOLVLM_500M_INSTRUCT
