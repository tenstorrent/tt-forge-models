...
"""
HunYuan V1 Dense model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    ...
    HUNYUAN_0_5B_PRETRAIN = "0.5B-Pretrain"


class ModelLoader(ForgeModel):
    """HunYuan V1 Dense model loader for causal language modeling."""
    ...
    _VARIANTS = {
        ...
        ModelVariant.HUNYUAN_0_5B_PRETRAIN: LLMModelConfig(
            pretrained_model_name="tencent/Hunyuan-0.5B-Pretrain",
            max_length=128,
        ),
    }
