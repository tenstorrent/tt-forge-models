...
"""
unsloth/DeepSeek-R1-Distill-Qwen-1.5B-bnb-4bit model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available unsloth/DeepSeek-R1-Distill-Qwen-1.5B-bnb-4bit model variants for causal LM."""

    DEEPSEEK_R1_DISTILL_QWEN_1_5B_BNB_4BIT = "DeepSeek_R1_Distill_Qwen_1.5B_bnb_4bit"


class ModelLoader(ForgeModel):
    """unsloth/DeepSeek-R1-Distill-Qwen-1.5B-bnb-4bit model loader for causal language modeling."""

    _VARIANTS = {
        ModelVariant.DEEPSEEK_R1_DISTILL_QWEN_1_5B_BNB_4BIT: LLMModelConfig(
            pretrained_model_name="unsloth/DeepSeek-R1-Distill-Qwen-1.5B-bnb-4bit",
            max_length=128,
        ),
    }
