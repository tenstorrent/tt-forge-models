...
class ModelVariant(StrEnum):
    ...
    B36_SAIL_IN22K_FT_IN1K = "B36_Sail_In22k_Ft_In1k"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.B36_SAIL_IN22K_FT_IN1K: ModelConfig(
            pretrained_model_name="hf_hub:timm/caformer_b36.sail_in22k_ft_in1k",
        ),
    }
