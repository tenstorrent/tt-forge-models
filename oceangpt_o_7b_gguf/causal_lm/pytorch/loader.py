...
"""
mradermacher/OceanGPT-o-7B-GGUF model loader implementation for causal language modeling.

Note: The qwen2vl GGUF architecture is not yet supported by the transformers
GGUF loader, so we load from the HF-native checkpoint (zjunlp/OceanGPT-o-7B)
and extract the causal LM.
"""
...
class ModelVariant(StrEnum):
    """Available OceanGPT-o-7B-GGUF model variants for causal language modeling."""

    OCEANGPT_O_7B_GGUF = "7B_GGUF"


class ModelLoader(ForgeModel):
    """OceanGPT-o-7B-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.OCEANGPT_O_7B_GGUF: LLMModelConfig(
            pretrained_model_name="zjunlp/OceanGPT-o-7B",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.OCEANGPT_O_7B_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher OceanGPT-o-7B-GGUF",
            variant=variant,
