...
"""Rubert Base Cased Russian Emotion Detection Cedr model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="seara/rubert-base-cased-russian-emotion-detection-cedr",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Rubert Base Cased Russian Emotion Detection Cedr",
