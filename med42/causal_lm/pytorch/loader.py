...
class ModelLoader(ForgeModel):
    """Med42 model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.LLAMA3_MED42_8B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Med42 model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The Med42 model instance for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the Med42 model with this instance's variant settings.
