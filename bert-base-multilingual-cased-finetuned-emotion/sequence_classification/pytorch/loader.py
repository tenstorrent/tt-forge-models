...
"""Bert Base Multilingual Cased Finetuned Emotion model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Toshifumi/bert-base-multilingual-cased-finetuned-emotion",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert Base Multilingual Cased Finetuned Emotion",
