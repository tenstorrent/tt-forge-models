...
"""
WhisperKit model loader implementation.

argmaxinc/whisperkit-coreml provides CoreML-optimized Whisper models.
This loader uses the transformers-compatible distil-whisper variants
which are the key models WhisperKit wraps for on-device ASR.
"""
...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load a WhisperKit model from Hugging Face."""
    ...
    def load_inputs(self, dtype_override=None):
        """Generate sample inputs for WhisperKit model."""
