...
"""Cerebras Gpt 590m Finetuned Dnd model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="grantprice/Cerebras-GPT-590M-finetuned-DND",
            max_length=128,
        ),
    }
