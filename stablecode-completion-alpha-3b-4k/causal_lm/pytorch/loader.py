...
"""Stablecode Completion Alpha 3b 4k model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="stabilityai/stablecode-completion-alpha-3b-4k",
            max_length=128,
        ),
    }
