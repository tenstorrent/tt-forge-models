...
"""
Qwen-Edit-Skin LoRA model loader implementation.

Loads the Qwen-Image-Edit-2509 diffusion transformer and applies
the tlennon-ie/qwen-edit-skin LoRA adapter for skin detail enhancement.

Available variants:
- QWEN_EDIT_SKIN: Skin detail enhancement LoRA (rank 16, bf16)
"""
...
class ModelVariant(StrEnum):
    """Available Qwen-Edit-Skin model variants."""

    QWEN_EDIT_SKIN = "Edit_Skin"


class ModelLoader(ForgeModel):
    """Qwen-Edit-Skin LoRA model loader for skin detail enhancement."""

    _VARIANTS = {
        ModelVariant.QWEN_EDIT_SKIN: ModelConfig(
            pretrained_model_name=BASE_MODEL,
        ),
    }
    DEFAULT_VARIANT = ModelVariant.QWEN_EDIT_SKIN
    ...
    def load_model(self, *, dtype_override: Optional[torch.dtype] = None, **kwargs):
        """Load the Qwen-Image-Edit transformer with skin LoRA weights applied.
