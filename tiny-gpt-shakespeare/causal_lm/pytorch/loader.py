...
"""Tiny Gpt Shakespeare model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="bmeyer2025/tiny-gpt-shakespeare",
            max_length=128,
        ),
    }
