...
"""
MiniMax-M2.1 model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    ...
    MINIMAX_M2_1_REAP_50_W4A16 = "M2.1-REAP-50-W4A16"


class ModelLoader(ForgeModel):
    """MiniMax-M2.1 model loader implementation for causal language modeling tasks."""
    ...
    _VARIANTS = {
        ...
        ModelVariant.MINIMAX_M2_1_REAP_50_W4A16: LLMModelConfig(
            pretrained_model_name="plezan/MiniMax-M2.1-REAP-50-W4A16",
            max_length=128,
        ),
    }
