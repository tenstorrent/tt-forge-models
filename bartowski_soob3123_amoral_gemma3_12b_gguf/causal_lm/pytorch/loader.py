...
"""
bartowski/soob3123_amoral-gemma3-12B-GGUF model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available bartowski soob3123 Amoral Gemma3 12B GGUF model variants for causal language modeling."""

    SOOB3123_AMORAL_GEMMA3_12B_GGUF = "soob3123_amoral_gemma3_12B_GGUF"


class ModelLoader(ForgeModel):
    """bartowski soob3123 Amoral Gemma3 12B GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.SOOB3123_AMORAL_GEMMA3_12B_GGUF: LLMModelConfig(
            pretrained_model_name="bartowski/soob3123_amoral-gemma3-12B-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SOOB3123_AMORAL_GEMMA3_12B_GGUF

    GGUF_FILE = "soob3123_amoral-gemma3-12B-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="bartowski soob3123 Amoral Gemma3 12B GGUF",
            variant=variant,
