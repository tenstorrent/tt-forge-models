...
"""Gpt2 Spanish Medium model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="DeepESP/gpt2-spanish-medium",
            max_length=128,
        ),
    }
