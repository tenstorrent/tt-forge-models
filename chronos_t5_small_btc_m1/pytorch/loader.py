...
"""
Chronos-T5-Small BTC M1 model loader implementation for time series forecasting.

mainmagic/chronos-t5-small-btc-m1 is a fine-tune of amazon/chronos-t5-small
specialized on 1-minute BTC/USD financial time series data.
"""
...
@dataclass
class ChronosT5SmallBtcM1Config(ModelConfig):
...
class ModelLoader(ForgeModel):
    """Chronos-T5-Small BTC M1 model loader for time series forecasting.

    Loads the underlying T5ForConditionalGeneration model from the Chronos
    pipeline for single-pass encoder-decoder inference.
    """

    _VARIANTS = {
        ModelVariant.BTC_M1: ChronosT5SmallBtcM1Config(
            pretrained_model_name="mainmagic/chronos-t5-small-btc-m1",
            context_length=512,
            prediction_length=60,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BTC_M1
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load the Chronos-T5-Small BTC M1 underlying T5 model.
