...
"""Pldr Llm V51 Soc 110m 3 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="fromthesky/PLDR-LLM-v51-SOC-110M-3",
            max_length=128,
        ),
    }
