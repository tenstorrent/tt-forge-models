...
"""Esft Gate Math Lite model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="deepseek-ai/ESFT-gate-math-lite",
            max_length=128,
        ),
    }
