...
"""Pythia 1b Deduped Finetune Alpaca Cleaned model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="unionai/pythia-1b-deduped-finetune-alpaca-cleaned",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Pythia 1b Deduped Finetune Alpaca Cleaned",
