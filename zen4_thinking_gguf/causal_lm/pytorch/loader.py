...
def _patch_qwen3next_support():
    """Register qwen3next as an alias for qwen3.

    The zen4-thinking GGUF file declares architecture as 'qwen3next', which
    transformers does not yet recognise. Map it to the existing qwen3 support.
    """
