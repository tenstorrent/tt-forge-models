...
"""Albert Base V2 Fakenews Discriminator model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="XSY/albert-base-v2-fakenews-discriminator",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Albert Base V2 Fakenews Discriminator",
