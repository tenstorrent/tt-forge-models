...
class ModelVariant(StrEnum):
    """Available mlx-community deepcogito-cogito-v1-preview-llama-3B-4bit model variants."""

    COGITO_V1_PREVIEW_LLAMA_3B_4BIT = "v1_Preview_Llama_3B_4bit"
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.COGITO_V1_PREVIEW_LLAMA_3B_4BIT
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mlx-community deepcogito-cogito-v1-preview-llama-3B-4bit",
            variant=variant,
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        # which is incompatible with transformers 5.x. Remove it to load in
        # full precision.
