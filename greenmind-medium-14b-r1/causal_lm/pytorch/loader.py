...
"""Greenmind Medium 14b R1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="GreenNode/GreenMind-Medium-14B-R1",
            max_length=128,
        ),
    }
