...
"""
Phi-4 Reasoning Plus GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Phi-4 Reasoning Plus GGUF model variants for causal language modeling."""

    PHI4_REASONING_PLUS_GGUF = "14B_GGUF"


class ModelLoader(ForgeModel):
    """Phi-4 Reasoning Plus GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.PHI4_REASONING_PLUS_GGUF: LLMModelConfig(
            pretrained_model_name="unsloth/Phi-4-reasoning-plus-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.PHI4_REASONING_PLUS_GGUF

    GGUF_FILE = "Phi-4-reasoning-plus-Q4_K_M.gguf"
