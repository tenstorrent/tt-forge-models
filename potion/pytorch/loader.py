...
"""
Potion static embedding model loader for sentence embedding generation.

Potion models are distilled static embedding models created using Model2Vec.
They provide fast text embedding computation with minimal resource requirements.
"""
import torch
...
class PotionTorchModel(nn.Module):
...
class ModelVariant(StrEnum):
    ...
    POTION_BASE_4M = "minishlab/potion-base-4M"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.POTION_BASE_4M: LLMModelConfig(
            pretrained_model_name="minishlab/potion-base-4M",
            max_length=128,
        ),
    ...
    DEFAULT_VARIANT = ModelVariant.POTION_BASE_8M
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        model = PotionTorchModel(static_model)
        model.eval()
