...
"""
Qwen3-VL-4B-Instruct GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Qwen3-VL-4B-Instruct GGUF model variants for causal language modeling."""

    QWEN_3_VL_4B_INSTRUCT_GGUF = "4B_INSTRUCT_GGUF"


class ModelLoader(ForgeModel):
    """Qwen3-VL-4B-Instruct GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_VL_4B_INSTRUCT_GGUF: LLMModelConfig(
            pretrained_model_name="bartowski/Qwen_Qwen3-VL-4B-Instruct-GGUF",
            max_length=128,
        ),
    }
