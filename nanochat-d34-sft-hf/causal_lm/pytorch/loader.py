...
"""Nanochat D34 Sft Hf model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="pankajmathur/nanochat-d34-sft-hf",
            max_length=128,
        ),
    }
