...
"""Breeze 7b Instruct V0 1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="MediaTek-Research/Breeze-7B-Instruct-v0_1",
            max_length=128,
        ),
    }
