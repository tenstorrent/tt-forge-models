...
"""Whiterabbitneo 13b V1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="WhiteRabbitNeo/WhiteRabbitNeo-13B-v1",
            max_length=128,
        ),
    }
