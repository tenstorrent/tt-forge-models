...
"""
GIST-small-Embedding-v0 model loader implementation for text embedding generation.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available GIST-small-Embedding-v0 model variants for embedding generation."""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.GIST_SMALL_EMBEDDING_V0
