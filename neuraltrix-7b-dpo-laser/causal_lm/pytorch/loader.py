...
"""Neuraltrix 7b Dpo Laser model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Kquant03/NeuralTrix-7B-dpo-laser",
            max_length=128,
        ),
    }
