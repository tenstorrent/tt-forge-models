...
"""Sr Rule Based Roberta Twostagetriplet Epochs 1 Shard 10 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="AnonymousSub/SR_rule_based_roberta_twostagetriplet_epochs_1_shard_10",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sr Rule Based Roberta Twostagetriplet Epochs 1 Shard 10",
