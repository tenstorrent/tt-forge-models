...
"""
Helper functions for ObjectClear model loading and processing.
"""
...
def object_clear_preprocessing(
    pipe,
    prompt,
    image,
    mask_image,
    ...
    add_time_ids, negative_add_time_ids = pipe._get_add_time_ids(
        ...
        negative_original_size=_neg_orig,
        negative_crops_coords_top_left=_neg_crops,
        negative_target_size=_neg_target,
        dtype=prompt_embeds.dtype,
