...
"""Mpt Mini Shakespeare model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="jploski/mpt-mini-shakespeare",
            max_length=128,
        ),
    }
