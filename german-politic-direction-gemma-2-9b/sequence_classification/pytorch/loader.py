...
"""German Politic Direction Gemma 2 9b model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="SinclairSchneider/german_politic_direction_gemma-2-9b",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="German Politic Direction Gemma 2 9b",
