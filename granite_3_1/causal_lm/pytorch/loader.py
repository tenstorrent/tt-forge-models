...
"""
Granite 3.1 model loader implementation for causal language modeling.
"""
...
class ModelLoader(ForgeModel):
    """Granite 3.1 model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.GRANITE_3_1_2B_BASE
