...
"""
UNI model loader implementation
"""
...
@dataclass
class UNIConfig(ModelConfig):
    """Configuration specific to UNI models"""

    source: ModelSource


class ModelVariant(StrEnum):
    """Available UNI model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.VIT_LARGE_PATCH16_224: UNIConfig(
            pretrained_model_name="hf-hub:MahmoodLab/uni",
