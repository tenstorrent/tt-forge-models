...
class ModelVariant(StrEnum):
    """Available Qwen2.5-VL-7B-Abliterated-Caption-it GGUF model variants for image to text."""

    QWEN2_5_VL_7B_ABLITERATED_CAPTION_IT_GGUF = (
        "qwen2_5_vl_7b_abliterated_caption_it_gguf"
    )
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Qwen2.5-VL-7B-Abliterated-Caption-it GGUF",
            variant=variant,
