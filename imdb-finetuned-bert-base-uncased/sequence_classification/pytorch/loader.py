...
"""Imdb Finetuned Bert Base Uncased model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="JiaqiLee/imdb-finetuned-bert-base-uncased",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Imdb Finetuned Bert Base Uncased",
