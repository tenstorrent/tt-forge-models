...
"""Marbertv2 Finetuned Egyptian Hate Speech Detection model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="IbrahimAmin/marbertv2-finetuned-egyptian-hate-speech-detection",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Marbertv2 Finetuned Egyptian Hate Speech Detection",
