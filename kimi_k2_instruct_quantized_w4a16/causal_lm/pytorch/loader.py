...
"""
RedHatAI Kimi K2 Instruct quantized W4A16 model loader implementation for causal language modeling.
"""
import os
import sys
...
class ModelVariant(StrEnum):
    ...
    KIMI_K2_INSTRUCT_QUANTIZED_W4A16 = "Kimi-K2-Instruct-quantized.w4a16"


class ModelLoader(ForgeModel):
    """RedHatAI Kimi K2 Instruct quantized W4A16 model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.KIMI_K2_INSTRUCT_QUANTIZED_W4A16: None,
    }

    DEFAULT_VARIANT = ModelVariant.KIMI_K2_INSTRUCT_QUANTIZED_W4A16
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Kimi K2 Instruct quantized W4A16 model with reduced config.

        The full model is a 1T-parameter MoE causal LM based on DeepSeek V3
        architecture, quantized to INT4 with the compressed-tensors scheme.
        We load with a reduced configuration for testing.
