...
"""Pygmalion Alpacalora 7b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="TehVenom/Pygmalion_AlpacaLora-7b",
            max_length=128,
        ),
    }
