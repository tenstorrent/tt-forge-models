...
class ModelLoader(ForgeModel):
    """Nanbeige 4.1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.NANBEIGE_4_1_3B_Q4_K_M_GGUF: LLMModelConfig(
    ...
    DEFAULT_VARIANT = ModelVariant.NANBEIGE_4_1_3B_Q4_K_M_GGUF
