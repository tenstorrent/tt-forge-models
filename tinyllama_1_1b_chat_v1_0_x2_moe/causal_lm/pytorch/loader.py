...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.TINYLLAMA_1_1B_CHAT_V1_0_X2_MOE: ModelConfig(
            pretrained_model_name="AIChenKai/TinyLlama-1.1B-Chat-v1.0-x2-MoE",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.TINYLLAMA_1_1B_CHAT_V1_0_X2_MOE
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="TinyLlama-1.1B-Chat-v1.0-x2-MoE",
            variant=variant,
