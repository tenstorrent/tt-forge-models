...
"""
prithivMLmods/Digital-Chaos-Flux-LoRA model loader implementation.

Loads the FLUX.1-dev base pipeline and applies the Digital-Chaos LoRA
from prithivMLmods/Digital-Chaos-Flux-LoRA for abstract digital art
text-to-image generation.

Repository: https://huggingface.co/prithivMLmods/Digital-Chaos-Flux-LoRA
"""
...
LORA_FILENAME = "Digital-Chaos.safetensors"


class ModelVariant(StrEnum):
    """Available prithivMLmods/Digital-Chaos-Flux-LoRA model variants."""

    DIGITAL_CHAOS = "DigitalChaos"


class ModelLoader(ForgeModel):
    """prithivMLmods/Digital-Chaos-Flux-LoRA model loader for text-to-image generation."""

    _VARIANTS = {
        ModelVariant.DIGITAL_CHAOS: ModelConfig(
            pretrained_model_name=BASE_MODEL,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.DIGITAL_CHAOS
    ...
    def _load_pipeline(self, dtype_override=None):
        """Load FLUX.1-dev pipeline and apply Digital-Chaos LoRA."""
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the FLUX transformer with Digital-Chaos LoRA applied.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        prompt = (
            "Digital Chaos, an abstract painting of a hamburger with vibrant "
            "splashes of color"
        )
        height = 128
        width = 128
