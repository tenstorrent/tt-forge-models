...
"""
FLUX Kontext model loader implementation for image-to-image editing
"""
import torch
...
class ModelVariant(StrEnum):
    """Available FLUX Kontext model variants."""

    NUNCHAKU_DEV = "nunchaku-dev"


class ModelLoader(ForgeModel):
    """FLUX Kontext model loader implementation for image-to-image editing tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.NUNCHAKU_DEV
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the FLUX Kontext transformer model instance.
        ...
        Returns:
            torch.nn.Module: The FLUX Kontext transformer model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the FLUX Kontext model.
        ...
        # Create reference image latents (simulating encoded input image)
        image_latents = torch.randn(shape, dtype=dtype)

        # Concatenate image and noise latents along the spatial dimension
