...
class ModelVariant(StrEnum):
    """Available GPT-OSS 20B SOMbliterated GGUF model variants for causal language modeling."""

    GPT_OSS_20B_SOMBLITERATED_GGUF = "20B_SOMbliterated_GGUF"


class ModelLoader(ForgeModel):
    """GPT-OSS 20B SOMbliterated GGUF model loader implementation for causal language modeling tasks."""
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="GPT-OSS 20B SOMbliterated GGUF",
            variant=variant,
