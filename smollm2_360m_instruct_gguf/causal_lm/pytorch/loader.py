...
class ModelVariant(StrEnum):
    """Available SmolLM2 360M Instruct GGUF model variants for causal language modeling."""

    SMOLLM2_360M_INSTRUCT_Q8_0 = "Q8_0"


class ModelLoader(ForgeModel):
    """SmolLM2 360M Instruct GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.SMOLLM2_360M_INSTRUCT_Q8_0: LLMModelConfig(
            pretrained_model_name="bartowski/SmolLM2-360M-Instruct-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.SMOLLM2_360M_INSTRUCT_Q8_0
