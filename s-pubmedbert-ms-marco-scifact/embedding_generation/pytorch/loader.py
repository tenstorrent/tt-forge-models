...
"""S Pubmedbert Ms Marco Scifact model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="pritamdeka/S-PubMedBert-MS-MARCO-SCIFACT",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="S Pubmedbert Ms Marco Scifact",
