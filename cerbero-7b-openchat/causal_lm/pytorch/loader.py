...
"""Cerbero 7b Openchat model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="galatolo/cerbero-7b-openchat",
            max_length=128,
        ),
    }
