...
"""
Molmo2 model loader implementation for image to text.
"""
...
class ModelVariant(StrEnum):
    """Available Molmo2 model variants for image to text."""

    MOLMO2_8B = "8b"


class ModelLoader(ForgeModel):
    """Molmo2 model loader implementation for image to text tasks."""
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The Molmo2 model instance for image to text.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the Molmo2 model with this instance's variant settings.
