...
"""Chinese Alpaca 33b Superhot 8k Fp16 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="TheBloke/Chinese-Alpaca-33B-SuperHOT-8K-fp16",
            max_length=128,
        ),
    }
