...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the StarCoder2 model instance with default settings.
        ...
        Returns:
            torch.nn.Module: The StarCoder2 model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the StarCoder2 model with default settings.
