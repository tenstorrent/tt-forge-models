...
"""Llama2 C Stories110m model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Xenova/llama2.c-stories110M",
            max_length=128,
        ),
    }
