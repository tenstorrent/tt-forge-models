...
"""Bloom 3b Intermediate model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="bigscience/bloom-3b-intermediate",
            max_length=128,
        ),
    }
