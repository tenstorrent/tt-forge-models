...
"""
OpenMed PII French BioClinicalModern model loader for token classification.
"""
...
class ModelVariant(StrEnum):
    """Available OpenMed PII French BioClinicalModern model variants."""
...
class ModelLoader(ForgeModel):
    ...
    def __init__(self, variant=None):
        ...
        self.model = None
        self.sample_text = (
            "Dr. Jean Dupont (NSS: 1 85 12 75 108 123 45) peut être contacté"
            " à jean.dupont@hopital.fr ou au 06 12 34 56 78."
        )
        self.max_length = 128
    ...
    def _get_model_info(cls, variant_name=None):
        ...
        return ModelInfo(
            model="OpenMed PII French BioClinicalModern",
