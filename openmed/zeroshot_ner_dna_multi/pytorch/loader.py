...
"""
OpenMed ZeroShot NER DNA Multi model loader implementation.
"""
...
class ModelVariant(StrEnum):
    """Available OpenMed ZeroShot NER DNA Multi model variants."""

    OPENMED_ZEROSHOT_NER_DNA_MULTI_209M = "ZeroShot-NER-DNA-Multi-209M"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.OPENMED_ZEROSHOT_NER_DNA_MULTI_209M: ModelConfig(
            pretrained_model_name="OpenMed/OpenMed-ZeroShot-NER-DNA-Multi-209M"
        ),
    }

    DEFAULT_VARIANT = ModelVariant.OPENMED_ZEROSHOT_NER_DNA_MULTI_209M
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None):
        ...
        return ModelInfo(
            model="OpenMed-ZeroShot-NER-DNA-Multi",
            variant=variant,
    ...
    def load_model(self, **kwargs):
        """Load and return the OpenMed ZeroShot NER DNA Multi GLiNER model."""
    ...
    def load_inputs(self, batch_size=1):
        """Load and return sample inputs for the GLiNER model.
