...
"""
FLUX.2 Klein 4B (distilled) model loader implementation for text-to-image generation.
"""
...
class ModelVariant(StrEnum):
    """Available FLUX.2 Klein 4B model variants."""

    KLEIN_4B = "Klein_4B"


class ModelLoader(ForgeModel):
    """FLUX.2 Klein 4B (distilled) model loader for text-to-image generation."""

    _VARIANTS = {
        ModelVariant.KLEIN_4B: ModelConfig(
            pretrained_model_name="Runware/BFL-FLUX.2-klein-4B",
        ),
    }
