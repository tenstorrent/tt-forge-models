...
"""Mistral 7b Forest Dpo model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="abhishekchohan/mistral-7B-forest-dpo",
            max_length=128,
        ),
    }
