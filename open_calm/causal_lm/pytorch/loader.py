...
"""
CyberAgent OpenCALM model loader implementation
"""
import torch
...
class ModelVariant(StrEnum):
    """Available CyberAgent OpenCALM model variants."""

    OPEN_CALM_SMALL = "open-calm-small"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.OPEN_CALM_SMALL: LLMModelConfig(
    ...
    DEFAULT_VARIANT = ModelVariant.OPEN_CALM_SMALL
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the CyberAgent OpenCALM model instance for this instance's variant.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        generation_config = GenerationConfig(
            max_length=100, do_sample=True, temperature=0.7, top_p=0.9
        )
        inputs = {
