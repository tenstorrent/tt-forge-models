...
"""Falcon 40b Sft Top1 560 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="OpenAssistant/falcon-40b-sft-top1-560",
            max_length=128,
        ),
    }
