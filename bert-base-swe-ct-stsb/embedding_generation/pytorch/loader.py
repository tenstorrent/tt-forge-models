...
"""Bert Base Swe Ct Stsb model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Contrastive-Tension/BERT-Base-Swe-CT-STSb",
        ),
    }
