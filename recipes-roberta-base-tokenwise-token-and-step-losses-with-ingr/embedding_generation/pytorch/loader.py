...
"""Recipes Roberta Base Tokenwise Token And Step Losses With Ingr model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="AnonymousSub/recipes-roberta-base-tokenwise-token-and-step-losses_with_ingr",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Recipes Roberta Base Tokenwise Token And Step Losses With Ingr",
