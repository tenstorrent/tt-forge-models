...
class ModelVariant(StrEnum):
    """Available Instructor-XL model variants for embedding generation."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.INSTRUCTOR_XL: ModelConfig(
            pretrained_model_name="hkunlp/instructor-xl",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.INSTRUCTOR_XL
