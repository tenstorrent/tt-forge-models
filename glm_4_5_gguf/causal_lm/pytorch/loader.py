...
"""
GLM-4.5 355B-A32B GGUF model loader for causal language modeling.
"""
...
def _patch_transformers_glm4moe_gguf():
    ...
    The GLM-4.5 MoE model uses the 'glm4moe' architecture in its GGUF metadata.
    ...
    registering the config mapping and remapping model_type to glm4_moe.
    """
    ...
    # 2. Add config mapping for glm4moe -> glm4_moe config fields
    ...
    def patched_load_gguf_checkpoint(*args, **kwargs):
        ...
        if config.get("model_type") == "glm4moe":
            ...
            head_dim = 128  # from glm4moe.attention.key_length in GGUF
...
class ModelVariant(StrEnum):
    """Available GLM-4.5 GGUF model variants."""

    GLM_4_5_GGUF = "GLM_4_5_GGUF"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.GLM_4_5_GGUF: LLMModelConfig(
            pretrained_model_name="unsloth/GLM-4.5-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GLM_4_5_GGUF

    GGUF_FILE = "Q4_K_M/GLM-4.5-Q4_K_M-00001-of-00005.gguf"
