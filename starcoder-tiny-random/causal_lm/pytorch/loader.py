...
"""Starcoder Tiny Random model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="yujiepan/starcoder-tiny-random",
            max_length=128,
        ),
    }
