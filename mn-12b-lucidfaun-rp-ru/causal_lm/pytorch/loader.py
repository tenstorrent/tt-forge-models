...
"""Mn 12b Lucidfaun Rp Ru model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="limloop/MN-12B-LucidFaun-RP-RU",
            max_length=128,
        ),
    }
