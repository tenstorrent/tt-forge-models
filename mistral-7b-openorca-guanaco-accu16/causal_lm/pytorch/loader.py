...
"""Mistral 7b Openorca Guanaco Accu16 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="caisarl76/Mistral-7B-OpenOrca-Guanaco-accu16",
            max_length=128,
        ),
    }
