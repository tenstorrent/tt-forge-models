...
FluxTransformer2DModel.from_single_file with a local bundled config to avoid
dependency on the gated black-forest-labs/FLUX.1-Fill-dev repo.
"""
...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the GGUF-quantized FLUX.1-Fill-dev transformer.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Prepare synthetic inputs for the FLUX.1-Fill-dev transformer.

        The FLUX.1-Fill-dev transformer expects hidden_states that include the noisy
        latents concatenated with masked image latents and a packed mask along dim=2,
