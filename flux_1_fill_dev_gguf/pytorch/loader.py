...
FluxTransformer2DModel.from_single_file with a bundled local config to avoid
...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        if self.transformer is None:
            ...
            gguf_path = hf_hub_download(GGUF_REPO, filename=gguf_file)
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        The FLUX Fill transformer expects hidden_states that concatenate noisy
        latents (64 ch), masked image latents (64 ch), and packed mask (256 ch)
        along the channel dimension, totalling in_channels=384.
        ...
        # Fill transformer input: noisy + masked_image + mask concatenated on channel dim
        # in_channels = 64 (noisy) + 64 (masked) + 256 (mask) = 384
        noise_channels = 64
        masked_channels = 64
        mask_channels = config.in_channels - noise_channels - masked_channels
