...
"""Bert Base Turkish Cased Emotion Analysis model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="maymuni/bert-base-turkish-cased-emotion-analysis",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert Base Turkish Cased Emotion Analysis",
