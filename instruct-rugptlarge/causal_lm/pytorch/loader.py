...
"""Instruct Rugptlarge model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="AlexWortega/instruct_rugptlarge",
            max_length=128,
        ),
    }
