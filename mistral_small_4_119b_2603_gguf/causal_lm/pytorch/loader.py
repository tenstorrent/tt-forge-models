...
def _patch_mistral4_support():
    """Register mistral4 as an alias for mistral in the GGUF loading stack.

    Transformers 5.x supports the mistral architecture but the GGUF files for
    Mistral Small 4 declare architecture as 'mistral4', which is not yet
    recognised.  The config layout is identical to 'mistral', so we simply
    copy the existing mapping and alias the tokenizer converter.
    """
...
def _patched_load_gguf_checkpoint(*args, **kwargs):
    """Wrap load_gguf_checkpoint to add mistral4 support and normalise model_type."""
