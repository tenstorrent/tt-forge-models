...
"""Relik Retriever E5 Base V2 Aida Blink Encoder model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="sapienzanlp/relik-retriever-e5-base-v2-aida-blink-encoder",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Relik Retriever E5 Base V2 Aida Blink Encoder",
