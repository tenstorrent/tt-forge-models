...
"""Turkish Gpt2 Medium model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ytu-ce-cosmos/turkish-gpt2-medium",
            max_length=128,
        ),
    }
