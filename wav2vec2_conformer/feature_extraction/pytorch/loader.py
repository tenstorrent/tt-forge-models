...
class ModelVariant(StrEnum):
    """Available Wav2Vec2-Conformer feature extraction model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.REL_POS_LARGE: ModelConfig(
            pretrained_model_name="facebook/wav2vec2-conformer-rel-pos-large",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.REL_POS_LARGE
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        model = Wav2Vec2ConformerModel.from_pretrained(
