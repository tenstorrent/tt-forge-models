...
"""Koelectra Base V3 Generalized Sentiment Analysis model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Koelectra Base V3 Generalized Sentiment Analysis",
