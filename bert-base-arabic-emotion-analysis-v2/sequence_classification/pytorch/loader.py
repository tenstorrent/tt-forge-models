...
"""Bert Base Arabic Emotion Analysis V2 model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="alpcansoydas/bert-base-arabic-emotion-analysis-v2",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert Base Arabic Emotion Analysis V2",
