...
"""Teuken 7b Base V0 6 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="openGPT-X/Teuken-7B-base-v0.6",
            max_length=128,
        ),
    }
