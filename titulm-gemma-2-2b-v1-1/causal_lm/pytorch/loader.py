...
"""Titulm Gemma 2 2b V1 1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="hishab/titulm-gemma-2-2b-v1.1",
            max_length=128,
        ),
    }
