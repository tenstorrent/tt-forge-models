...
"""
GPT-OSS 120B Heretic V2 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available GPT-OSS 120B Heretic V2 GGUF model variants for causal language modeling."""

    GPT_OSS_120B_HERETIC_V2_Q4_K_M_GGUF = "GPT_OSS_120B_HERETIC_V2_Q4_K_M_GGUF"


class ModelLoader(ForgeModel):
    """GPT-OSS 120B Heretic V2 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GPT_OSS_120B_HERETIC_V2_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/gpt-oss-120b-heretic-v2-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GPT_OSS_120B_HERETIC_V2_Q4_K_M_GGUF

    GGUF_FILE = "gpt-oss-120b-heretic-v2.Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="GPT-OSS 120B Heretic V2 GGUF",
            variant=variant,
