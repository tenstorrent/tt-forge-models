...
"""Orca Mini 3b Juniper model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="frank098/orca_mini_3b_juniper",
            max_length=128,
        ),
    }
