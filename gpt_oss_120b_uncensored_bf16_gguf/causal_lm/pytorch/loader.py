...
"""
GPT-OSS 120B Uncensored BF16 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    ...
    GPT_OSS_120B_UNCENSORED_BF16_Q4_K_M_GGUF = (
        "GPT_OSS_120B_UNCENSORED_BF16_Q4_K_M_GGUF"
    )


class ModelLoader(ForgeModel):
    """GPT-OSS 120B Uncensored BF16 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GPT_OSS_120B_UNCENSORED_BF16_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="bartowski/huizimao_gpt-oss-120b-uncensored-bf16-GGUF",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="GPT-OSS 120B Uncensored BF16 GGUF",
            variant=variant,
