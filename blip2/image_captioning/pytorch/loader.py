...
"""
BLIP-2 image captioning model loader implementation (PyTorch).
"""
...
class ModelVariant(StrEnum):
    """Available BLIP-2 image captioning model variants."""

    OPT_6_7B = "OPT-6.7B"


class ModelLoader(ForgeModel):
    """BLIP-2 image captioning model loader implementation."""

    _VARIANTS = {
        ModelVariant.OPT_6_7B: ModelConfig(
            pretrained_model_name="Salesforce/blip2-opt-6.7b",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.OPT_6_7B
