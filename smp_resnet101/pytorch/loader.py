...
"""
SMP ResNet-101 model loader implementation using segmentation-models-pytorch.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available SMP ResNet-101 model variants."""

    RESNET101_IMAGENET = "ResNet101_Imagenet"


class ModelLoader(ForgeModel):
    """SMP ResNet-101 model loader implementation for semantic segmentation."""

    _VARIANTS = {
        ModelVariant.RESNET101_IMAGENET: ModelConfig(
            pretrained_model_name="smp-hub/resnet101.imagenet",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.RESNET101_IMAGENET
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the SMP ResNet-101 U-Net model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The SMP U-Net model with ResNet-101 encoder.
        """
