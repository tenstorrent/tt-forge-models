...
"""Fine Tuned Indonesian Sentiment Classifier model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="hanifnoerr/Fine-tuned-Indonesian-Sentiment-Classifier",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Fine Tuned Indonesian Sentiment Classifier",
