...
def _patch_transformers_qwen2vl_gguf():
    ...
    UI-TARS uses the qwen2vl architecture identifier in its GGUF metadata.
    Transformers 5.x lacks GGUF loading support for qwen2vl. We bridge the
    gap by registering the config mapping (same as qwen2) and remapping
    model_type to qwen2 for causal LM use.
    """
...
class ModelLoader(ForgeModel):
    ...
    GGUF_FILE = "UI-TARS-72B-SFT-Q4_K_M.gguf"
