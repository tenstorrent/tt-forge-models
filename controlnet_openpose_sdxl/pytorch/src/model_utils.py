...
"""
Helper functions for ControlNet OpenPose SDXL model loading and processing.
"""
...
def load_controlnet_openpose_sdxl_pipe(controlnet_model_name, base_model_name):
    """Load ControlNet OpenPose SDXL pipeline.
...
def create_openpose_conditioning_image(height=1024, width=1024):
...
def controlnet_openpose_sdxl_preprocessing(
    pipe,
    prompt,
    control_image,
    device="cpu",
    ...
    """Preprocess inputs for ControlNet OpenPose SDXL model.
