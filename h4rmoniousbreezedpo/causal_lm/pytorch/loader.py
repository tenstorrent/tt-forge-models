...
"""H4rmoniousbreezedpo model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="neovalle/H4rmoniousBreezeDPO",
            max_length=128,
        ),
    }
