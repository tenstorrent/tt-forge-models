...
"""Opt 125m Smoothquant model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="mit-han-lab/opt-125m-smoothquant",
            max_length=128,
        ),
    }
