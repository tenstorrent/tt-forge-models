...
"""
Attention-Only 1-Layer Transformer model loader implementation.
...
class ModelVariant(StrEnum):
    """Available Attention-Only 1L model variants."""

    ATTN_ONLY_1L = "Attn_Only_1L512W_C4_Code"


class ModelLoader(ForgeModel):
    """Attention-Only 1-Layer Transformer model loader."""

    _VARIANTS = {
        ModelVariant.ATTN_ONLY_1L: ModelConfig(
            pretrained_model_name="NeelNanda/Attn_Only_1L512W_C4_Code",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.ATTN_ONLY_1L
