...
class ModelVariant(StrEnum):
    """Available T-Systems ColQwen2.5 multilingual model variants."""

    MULTILINGUAL_V1_0 = "3b-multilingual-v1.0"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.MULTILINGUAL_V1_0: ModelConfig(
            pretrained_model_name="tsystems/colqwen2.5-3b-multilingual-v1.0",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MULTILINGUAL_V1_0

    def __init__(self, variant: Optional[ModelVariant] = None):
        """Initialize T-Systems ColQwen2.5-3b-multilingual model loader."""
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="ColQwen2.5-3b-multilingual",
            variant=variant,
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for T-Systems ColQwen2.5-3b-multilingual."""
        if self.processor is None:
            self._load_processor()
    ...
    def post_process(self, outputs):
        """Post-process outputs to compute document-query similarity scores."""
        if self.processor is None:
            self._load_processor()
