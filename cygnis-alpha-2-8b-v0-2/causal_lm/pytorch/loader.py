...
"""Cygnis Alpha 2 8b V0 2 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Simonc-44/Cygnis-Alpha-2-8B-v0.2",
            max_length=128,
        ),
    }
