...
"""
Helper functions for NoobAI XL model loading and processing.
"""
...
def load_pipe(variant):
    """Load NoobAI XL pipeline.

    Args:
        variant: Model variant name (HuggingFace repo ID)
...
def stable_diffusion_preprocessing_xl(
    ...
    """Preprocess inputs for NoobAI XL UNet forward pass.
