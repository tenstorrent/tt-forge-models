...
from third_party.tt_forge_models.vadv2.pytorch.src.base_module import BaseModule
from third_party.tt_forge_models.vadv2.pytorch.src.vad_transformer import (
    CustomTransformerDecoder,
    VADPerceptionTransformer,
)
from third_party.tt_forge_models.vadv2.pytorch.src.custom_bbox_coder import (
    CustomNMSFreeCoder,
    MapNMSFreeCoder,
)
...
class VADHead(BaseModule, metaclass=ABCMeta):
    """Head of VAD model.
    Args:
