...
from third_party.tt_forge_models.vadv2.pytorch.src.base_module import Base3DDetector
import warnings
...
from third_party.tt_forge_models.vadv2.pytorch.src.resnet import ResNet
