...
"""Granite Embedding 278m Multilingual model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="ibm-granite/granite-embedding-278m-multilingual",
        ),
    }
