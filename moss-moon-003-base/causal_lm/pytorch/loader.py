...
"""Moss Moon 003 Base model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="OpenMOSS-Team/moss-moon-003-base",
            max_length=128,
        ),
    }
