...
"""Neuralbeagle 11b Truthy model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="vicgalle/NeuralBeagle-11B-truthy",
            max_length=128,
        ),
    }
