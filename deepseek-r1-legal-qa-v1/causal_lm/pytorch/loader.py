...
"""Deepseek R1 Legal Qa V1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="soban04/DeepSeek-R1-Legal-QA-v1",
            max_length=128,
        ),
    }
