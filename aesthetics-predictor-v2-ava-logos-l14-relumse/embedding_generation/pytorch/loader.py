...
"""Aesthetics Predictor V2 Ava Logos L14 Relumse model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="shunk031/aesthetics-predictor-v2-ava-logos-l14-reluMSE",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Aesthetics Predictor V2 Ava Logos L14 Relumse",
