...
"""
TeCoA4 CLIP model loader implementation for image-text similarity using OpenCLIP.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available TeCoA4 CLIP model variants."""

    VIT_L_14 = "ViT_L_14"


class ModelLoader(ForgeModel):
    """TeCoA4 CLIP model loader using OpenCLIP for image-text similarity tasks."""

    _VARIANTS = {
        ModelVariant.VIT_L_14: ModelConfig(
            pretrained_model_name="hf-hub:chs20/tecoa4-clip",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the TeCoA4 CLIP model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The TeCoA4 CLIP model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the TeCoA4 CLIP model.
    ...
    def post_process(self, outputs):
        """Post-process TeCoA4 CLIP model outputs to extract similarity scores.
