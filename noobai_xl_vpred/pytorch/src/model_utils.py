...
"""
Helper functions for NoobAI XL V-Prediction model loading and processing.
"""
...
def load_pipe(variant):
    """Load NoobAI XL V-Prediction pipeline.
...
def noobai_xl_vpred_preprocessing(
    pipe,
    prompt,
    device="cpu",
    ...
    """Preprocess inputs for NoobAI XL V-Prediction model.

    Args:
        pipe: NoobAI XL pipeline (StableDiffusionXLPipeline)
