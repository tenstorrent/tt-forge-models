...
"""Msh V1 Bielik V2 3 Instruct Medit Merge model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="meditsolutions/MSH-v1-Bielik-v2.3-Instruct-MedIT-merge",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Msh V1 Bielik V2 3 Instruct Medit Merge",
