...
"""Nvidia Nemotron 3 Super 120b A12b Bf16 Heretic model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="trohrbaugh/NVIDIA-Nemotron-3-Super-120B-A12B-BF16-heretic",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Nvidia Nemotron 3 Super 120b A12b Bf16 Heretic",
