...
"""Dolphin 2 1 Mistral 7b Snr Math Laser model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="invalid-coder/dolphin-2.1-mistral-7b-snr-math-laser",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Dolphin 2 1 Mistral 7b Snr Math Laser",
