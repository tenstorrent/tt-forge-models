...
"""
DistilBERT ONNX model loader for token classification.

Loads the pre-exported ONNX model from Xenova/distilbert-base-multilingual-cased-ner-hrl.
"""
...
_ONNX_REPO_ID = "Xenova/distilbert-base-multilingual-cased-ner-hrl"
