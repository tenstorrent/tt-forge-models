...
class ModelVariant(StrEnum):
    ...
    ELASTIC_DISTILBERT_BASE_CASED_CONLL03_ENGLISH = (
...
_VARIANT_SAMPLE_TEXTS = {
    ...
    ModelVariant.ELASTIC_DISTILBERT_BASE_CASED_CONLL03_ENGLISH: "John Smith works at Google in California",
}
...
_VARIANT_MODEL_GROUPS = {
    ...
    ModelVariant.ELASTIC_DISTILBERT_BASE_CASED_CONLL03_ENGLISH: ModelGroup.VULCAN,
}
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.ELASTIC_DISTILBERT_BASE_CASED_CONLL03_ENGLISH: LLMModelConfig(
