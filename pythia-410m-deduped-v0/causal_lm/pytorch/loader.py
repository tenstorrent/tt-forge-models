...
"""Pythia 410m Deduped V0 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="EleutherAI/pythia-410m-deduped-v0",
            max_length=128,
        ),
    }
