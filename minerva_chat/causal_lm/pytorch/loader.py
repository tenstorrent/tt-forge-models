...
"""
Minerva Chat model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available Minerva Chat model variants for causal language modeling."""

    MINERVA_CHAT_V0_1_ALPHA_SFT = "minerva_chat_v0_1_alpha_sft"


class ModelLoader(ForgeModel):
    """Minerva Chat model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MINERVA_CHAT_V0_1_ALPHA_SFT: LLMModelConfig(
            pretrained_model_name="mii-llm/minerva-chat-v0.1-alpha-sft",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MINERVA_CHAT_V0_1_ALPHA_SFT
