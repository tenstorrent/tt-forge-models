...
"""
MiniMax-M2.5-REAP-139B-A10B GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelLoader(ForgeModel):
    """MiniMax-M2.5-REAP-139B-A10B GGUF model loader implementation for causal language modeling tasks."""
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="MiniMax-M2.5-REAP-139B-A10B GGUF",
            variant=variant,
