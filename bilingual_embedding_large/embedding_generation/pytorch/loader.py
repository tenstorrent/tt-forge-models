...
"""
Bilingual embedding model loader for sentence embedding generation.

Uses a custom BilingualModel architecture via AutoModel for French/English text embeddings.
"""
...
class ModelVariant(StrEnum):
    """Available bilingual embedding model variants."""

    BILINGUAL_EMBEDDING_LARGE = "Lajavaness/bilingual-embedding-large"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BILINGUAL_EMBEDDING_LARGE: LLMModelConfig(
            pretrained_model_name="Lajavaness/bilingual-embedding-large",
            max_length=512,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BILINGUAL_EMBEDDING_LARGE
