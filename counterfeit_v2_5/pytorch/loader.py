...
"""
Counterfeit V2.5 model loader implementation
"""
...
class ModelVariant(StrEnum):
    """Available Counterfeit V2.5 model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE: ModelConfig(
            pretrained_model_name="gsdf/Counterfeit-V2.5",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load the Counterfeit V2.5 pipeline and return its UNet.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        prompt = (
            "masterpiece, best quality, 1girl, solo, blue eyes, long hair, outdoors"
        )
