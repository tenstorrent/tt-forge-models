...
"""Tinystories 1layer 21m model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="roneneldan/TinyStories-1Layer-21M",
            max_length=128,
        ),
    }
