...
"""
Devstral Small GGUF model loader implementation for causal language modeling.
"""
import torch
...
def _patch_transformers_mistral3_gguf():
    ...
    The GGUF file reports architecture as 'mistral3' but transformers does not
...
class ModelVariant(StrEnum):
    """Available Devstral GGUF model variants for causal language modeling."""

    DEVSTRAL_SMALL_2_24B_INSTRUCT_GGUF = "Small_2_24B_Instruct_GGUF"


class ModelLoader(ForgeModel):
    """Devstral Small GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.DEVSTRAL_SMALL_2_24B_INSTRUCT_GGUF: LLMModelConfig(
            pretrained_model_name="unsloth/Devstral-Small-2-24B-Instruct-2512-GGUF",
            max_length=128,
        ),
    }
