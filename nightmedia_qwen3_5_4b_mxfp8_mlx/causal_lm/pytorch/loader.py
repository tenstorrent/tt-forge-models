...
"""
nightmedia/Qwen3.5-4B-mxfp8-mlx model loader for causal language modeling.
"""
import os
...
class ModelVariant(StrEnum):
    """Available nightmedia Qwen3.5-4B mxfp8 MLX model variants."""

    NIGHTMEDIA_QWEN3_5_4B_MXFP8_MLX = "4B_mxfp8_mlx"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.NIGHTMEDIA_QWEN3_5_4B_MXFP8_MLX: LLMModelConfig(
            pretrained_model_name="nightmedia/Qwen3.5-4B-mxfp8-mlx",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.NIGHTMEDIA_QWEN3_5_4B_MXFP8_MLX
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="nightmedia Qwen3.5-4B mxfp8 MLX",
            variant=variant,
