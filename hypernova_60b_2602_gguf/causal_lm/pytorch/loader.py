...
"""
Hypernova 60B 2602 GGUF model loader implementation for causal language modeling.
"""
import torch
...
def _patch_gpt_oss_support():
    ...
    Hypernova-60B-2602 is derived from GPT-OSS-120B (OpenAI) and uses the
    same Qwen3-MoE architecture. The GGUF file declares architecture as
    'gpt-oss' which transformers 5.x does not recognise natively.
    """
...
class ModelVariant(StrEnum):
    """Available Hypernova 60B 2602 GGUF model variants for causal language modeling."""

    HYPERNOVA_60B_2602_Q4_K_M = "Hypernova_60B_2602_Q4_K_M"


class ModelLoader(ForgeModel):
    """Hypernova 60B 2602 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.HYPERNOVA_60B_2602_Q4_K_M: LLMModelConfig(
            pretrained_model_name="mradermacher/Hypernova-60B-2602-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.HYPERNOVA_60B_2602_Q4_K_M

    GGUF_FILE = "Hypernova-60B-2602.Q4_K_M.gguf"
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        # Qwen3Moe: use batched_mm path to avoid histc-on-Int failure on XLA device.
