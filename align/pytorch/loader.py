...
class ModelVariant(StrEnum):
    """Available ALIGN model variants for image-text similarity."""

    BASE = "Base"


class ModelLoader(ForgeModel):
    """ALIGN model loader implementation for image-text similarity tasks."""
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the ALIGN model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The ALIGN model instance for image-text similarity.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the ALIGN model with this instance's variant settings.
    ...
    def post_process(self, outputs):
        """Post-process ALIGN model outputs to extract similarity scores.
    ...
    def unpack_forward_output(self, fwd_output):
        ...
        The ALIGN model (with return_dict=False) returns a tuple containing:
