...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.L2_R384_IN1K: EfficientViTConfig(
            pretrained_model_name="hf_hub:timm/efficientvit_l2.r384_in1k",
            source=ModelSource.TIMM,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.L2_R384_IN1K
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load pretrained EfficientViT model for this instance's variant.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The EfficientViT model instance.
        """
        ...
        if source == ModelSource.TIMM:
            ...
            raise ValueError(f"Unsupported source for EfficientViT: {source}")
