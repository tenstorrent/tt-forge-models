...
vantagewithai/Qwen-Image-Edit-2511-GGUF. Uses the upstream Qwen/Qwen-Image-Edit-2511
...
class ModelVariant(StrEnum):
    """Available VantageWithAI Qwen-Image-Edit-2511 GGUF quantization variants."""
...
class ModelLoader(ForgeModel):
    """VantageWithAI Qwen-Image-Edit-2511 GGUF loader for the diffusion transformer."""
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="VANTAGEWITHAI_QWEN_IMAGE_EDIT_2511_GGUF",
            variant=variant,
