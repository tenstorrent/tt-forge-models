...
"""Guanaco 13b Merged model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="timdettmers/guanaco-13b-merged",
            max_length=128,
        ),
    }
