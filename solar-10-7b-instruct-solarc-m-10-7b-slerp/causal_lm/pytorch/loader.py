...
"""Solar 10 7b Instruct Solarc M 10 7b Slerp model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="invalid-coder/SOLAR-10.7B-Instruct-SOLARC-M-10.7B-slerp",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Solar 10 7b Instruct Solarc M 10 7b Slerp",
