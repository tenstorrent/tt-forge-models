...
"""Gemma2 Snowflakes 9b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="yamatazen/Gemma2-Snowflakes-9B",
            max_length=128,
        ),
    }
