...
"""Relik Reader Deberta V3 Large Nyt model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="sapienzanlp/relik-reader-deberta-v3-large-nyt",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Relik Reader Deberta V3 Large Nyt",
