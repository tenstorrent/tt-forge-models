...
class ModelVariant(StrEnum):
    """Available InternLM-XComposer2d5 CLIP model variants."""

    VIT_LARGE_PATCH14_560 = "ViT_Large_Patch14_560"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.VIT_LARGE_PATCH14_560: ModelConfig(
            pretrained_model_name="internlm/internlm-xcomposer2d5-clip",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.VIT_LARGE_PATCH14_560
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="INTERNLM_XCOMPOSER2D5_CLIP",
            variant=variant,
