...
"""Configurablebeagle 11b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="vicgalle/ConfigurableBeagle-11B",
            max_length=128,
        ),
    }
