...
"""Vicuna Class Shishya Ac Hal 7b Ep3 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="luffycodes/vicuna-class-shishya-ac-hal-7b-ep3",
            max_length=128,
        ),
    }
