...
class ModelLoader(ForgeModel):
    ...
    def wrapper_model(self, f):
        ...
        VisionTextDualEncoder models output both image and text embeddings. This wrapper
        extracts the text model pooler output for compatibility with the testing framework.
        ...
        def model(args, kwargs):
            out = f(*args, **kwargs)
            # Extract text model pooler output from the dual encoder output
