...
class ModelVariant(StrEnum):
    """Available Attention-Only 2L model variants."""

    ATTN_ONLY_2L = "Attn_Only_2L512W_C4_Code"


class ModelLoader(ForgeModel):
    """Attention-Only 2-Layer Transformer model loader."""

    _VARIANTS = {
        ModelVariant.ATTN_ONLY_2L: ModelConfig(
            pretrained_model_name="NeelNanda/Attn_Only_2L512W_C4_Code",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.ATTN_ONLY_2L
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Attention-Only 2L model via TransformerLens."""
