...
"""
MARTHA-GPT-OSS-120B model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available MARTHA-GPT-OSS-120B model variants for causal language modeling."""

    MARTHA_GPT_OSS_120B = "120B"


class ModelLoader(ForgeModel):
    """MARTHA-GPT-OSS-120B model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MARTHA_GPT_OSS_120B: LLMModelConfig(
            pretrained_model_name="ZERO-POINT-INTELLIGENCE-LTD/MARTHA-GPT-OSS-120B",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MARTHA_GPT_OSS_120B
    ...
    def get_mesh_config(self, num_devices: int):
        if num_devices == 32:  # Galaxy
            ...
            raise ValueError(
                "MARTHA-GPT-OSS-120B is only supported on llmbox and galaxy"
            )
