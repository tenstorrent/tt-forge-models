...
Supports LiquidAI's LFM2 Mixture-of-Experts models.
"""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.LFM2_2_6B: LLMModelConfig(
            pretrained_model_name="LiquidAI/LFM2-2.6B",
            max_length=128,
        ),
        ModelVariant.LFM2_2_6B_EXP: LLMModelConfig(
            pretrained_model_name="LiquidAI/LFM2-2.6B-Exp",
            max_length=128,
        ),
