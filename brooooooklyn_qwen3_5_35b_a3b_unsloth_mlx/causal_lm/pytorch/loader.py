...
"""
Brooooooklyn/Qwen3.5-35B-A3B-unsloth-mlx model loader for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Brooooooklyn Qwen3.5-35B-A3B unsloth MLX model variants."""

    QWEN_3_5_35B_A3B_UNSLOTH_MLX = "35B_A3B_unsloth_mlx"
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.QWEN_3_5_35B_A3B_UNSLOTH_MLX
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Brooooooklyn Qwen3.5-35B-A3B unsloth MLX",
            variant=variant,
