...
"""Legal Htm Fpdm Roberta model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="AnonymousSub/Legal_HTM_FPDM_roberta",
        ),
    }
