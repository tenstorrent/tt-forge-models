...
"""
UI-Venus model loader implementation for image to text.
"""
...
class ModelLoader(ForgeModel):
    """UI-Venus model loader implementation for image to text tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.UI_VENUS_1_5_8B
