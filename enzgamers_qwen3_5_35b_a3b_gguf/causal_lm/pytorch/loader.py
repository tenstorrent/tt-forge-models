...
def _patch_transformers_qwen35moe_gguf():
    ...
    # 6. Patch get_gguf_hf_weights_map to use qwen3_moe for tensor name lookup.
    # The qwen35moe tensor name map expects fused ffn_gate_up_exps but actual GGUF
    # files store separate ffn_gate_exps / ffn_up_exps. The qwen3_moe map returns
    # None for gate_up_proj, triggering perform_fallback_tensor_mapping which
    # correctly adds both entries to tensor_key_mapping.
