...
"""
RepViT model loader implementation
"""
...
@dataclass
class RepViTConfig(ModelConfig):
    """Configuration specific to RepViT models"""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.REPVIT_M1_5_DIST_450E_IN1K
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load pretrained RepViT model for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The RepViT model instance.
        """
