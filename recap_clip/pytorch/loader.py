...
class ModelVariant(StrEnum):
    """Available Recap CLIP model variants."""

    VIT_L_16 = "ViT_L_16"


class ModelLoader(ForgeModel):
    """Recap CLIP model loader using OpenCLIP for image-text similarity tasks."""

    _VARIANTS = {
        ModelVariant.VIT_L_16: ModelConfig(
            pretrained_model_name="hf-hub:UCSC-VLAA/ViT-L-16-HTxt-Recap-CLIP",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.VIT_L_16
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The Recap CLIP model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the Recap CLIP model.
        ...
        # Tokenize text — call the underlying HF tokenizer directly since
        # open_clip's HFTokenizer uses batch_encode_plus which was removed in transformers v5.
    ...
    def post_process(self, outputs):
        """Post-process Recap CLIP model outputs to extract similarity scores.
