...
"""
LLaDA 2.0 model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available LLaDA 2.0 model variants for causal language modeling."""

    LLADA_2_0_MINI = "llada_2_0_mini"


class ModelLoader(ForgeModel):
    """LLaDA 2.0 model loader implementation for causal language modeling tasks."""
