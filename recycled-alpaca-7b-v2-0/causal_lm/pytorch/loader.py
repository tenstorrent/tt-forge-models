...
"""Recycled Alpaca 7b V2 0 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="umd-zhou-lab/recycled-alpaca-7b-v2.0",
            max_length=128,
        ),
    }
