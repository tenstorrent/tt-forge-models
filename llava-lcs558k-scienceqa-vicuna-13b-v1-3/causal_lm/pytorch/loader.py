...
"""Llava Lcs558k Scienceqa Vicuna 13b V1 3 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="liuhaotian/llava-lcs558k-scienceqa-vicuna-13b-v1.3",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Llava Lcs558k Scienceqa Vicuna 13b V1 3",
