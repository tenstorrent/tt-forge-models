...
"""
mradermacher GPT-OSS 20B Derestricted GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available mradermacher GPT-OSS 20B Derestricted GGUF model variants for causal language modeling."""

    GPT_OSS_20B_DERESTRICTED_Q4_K_M_GGUF = "GPT_OSS_20B_DERESTRICTED_Q4_K_M_GGUF"


class ModelLoader(ForgeModel):
    """mradermacher GPT-OSS 20B Derestricted GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GPT_OSS_20B_DERESTRICTED_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/gpt-oss-20b-Derestricted-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GPT_OSS_20B_DERESTRICTED_Q4_K_M_GGUF

    GGUF_FILE = "gpt-oss-20b-Derestricted.Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher GPT-OSS 20B Derestricted GGUF",
            variant=variant,
