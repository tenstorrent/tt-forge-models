...
"""Whisper Tiny Audio Captioning model loader implementation for automatic speech recognition."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="MU-NLPC/whisper-tiny-audio-captioning",
            max_length=30,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Whisper Tiny Audio Captioning",
