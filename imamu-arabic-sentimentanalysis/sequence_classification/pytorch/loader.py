...
"""Imamu Arabic Sentimentanalysis model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="ALANZI/imamu_arabic_sentimentAnalysis",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Imamu Arabic Sentimentanalysis",
