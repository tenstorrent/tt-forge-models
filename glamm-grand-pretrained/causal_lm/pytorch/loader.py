...
"""Glamm Grand Pretrained model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="MBZUAI/GLaMM-GranD-Pretrained",
            max_length=128,
        ),
    }
