...
"""Distilrubert Small Cased Conversational model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="DeepPavlov/distilrubert-small-cased-conversational",
            max_length=128,
        ),
    }
