...
"""Speechless Orca Platypus Coig Lite 4k 0 5e 13b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="uukuguy/speechless-orca-platypus-coig-lite-4k-0.5e-13b",
            max_length=128,
        ),
    }
