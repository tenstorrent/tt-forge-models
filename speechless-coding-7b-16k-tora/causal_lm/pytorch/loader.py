...
"""Speechless Coding 7b 16k Tora model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="speechlessai/speechless-coding-7b-16k-tora",
            max_length=128,
        ),
    }
