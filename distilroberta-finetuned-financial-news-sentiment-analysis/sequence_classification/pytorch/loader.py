...
"""Distilroberta Finetuned Financial News Sentiment Analysis model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="mrm8488/distilroberta-finetuned-financial-news-sentiment-analysis",
        ),
    }
