...
"""Msmarco Roberta Base V3 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="sentence-transformers/msmarco-roberta-base-v3",
        ),
    }
