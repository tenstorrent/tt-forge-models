...
class ModelVariant(StrEnum):
    """Available Unsloth DeepSeek-R1-Distill-Llama-70B BnB 4-bit model variants."""

    UNSLOTH_DEEPSEEK_R1_DISTILL_LLAMA_70B_BNB_4BIT = (
        "unsloth_deepseek_r1_distill_llama_70b_bnb_4bit"
    )


class ModelLoader(ForgeModel):
    """Unsloth DeepSeek-R1-Distill-Llama-70B BnB 4-bit model loader for causal language modeling."""

    _VARIANTS = {
        ModelVariant.UNSLOTH_DEEPSEEK_R1_DISTILL_LLAMA_70B_BNB_4BIT: LLMModelConfig(
            pretrained_model_name="unsloth/DeepSeek-R1-Distill-Llama-70B-bnb-4bit",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.UNSLOTH_DEEPSEEK_R1_DISTILL_LLAMA_70B_BNB_4BIT
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Unsloth DeepSeek-R1-Distill-Llama-70B BnB 4-bit",
            variant=variant,
