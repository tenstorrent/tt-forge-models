...
"""Acegpt V2 8b Chat model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="FreedomIntelligence/AceGPT-v2-8B-Chat",
            max_length=128,
        ),
    }
