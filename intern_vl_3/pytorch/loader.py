...
def build_transform(input_size):
    """Build image transform pipeline for InternVL3."""
    return T.Compose(
        [
...
def load_image(image_path, input_size=448, max_num=12):
    """Load and preprocess an image for InternVL3."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.INTERN_VL3_9B: ModelConfig(
            pretrained_model_name="OpenGVLab/InternVL3-9B",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.INTERN_VL3_1B_INSTRUCT
