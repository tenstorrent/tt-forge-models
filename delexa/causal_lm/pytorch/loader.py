...
"""
Delexa model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available Delexa model variants."""

    DELEXA_7B = "7B"


class ModelLoader(ForgeModel):
    """Delexa model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.DELEXA_7B: ModelConfig(
            pretrained_model_name="lex-hue/Delexa-7b",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.DELEXA_7B
