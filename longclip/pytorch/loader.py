...
"""
LongCLIP-GmP model loader implementation for image-text similarity.
"""
import torch
...
class ModelLoader(ForgeModel):
    """LongCLIP-GmP model loader implementation for image-text similarity tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.GMP_VIT_L_14
