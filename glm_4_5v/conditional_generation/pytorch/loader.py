...
class ModelVariant(StrEnum):
    """Available GLM-4.5V model variants for multimodal conditional generation."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.GLM_4_5V: LLMModelConfig(
            pretrained_model_name="zai-org/GLM-4.5V",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GLM_4_5V
