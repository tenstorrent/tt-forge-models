...
"""
Latent Consistency Model loader implementation
"""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.BASE: ModelConfig(
            pretrained_model_name="echarlaix/tiny-random-latent-consistency",
        )
    }
    ...
    def __init__(self, variant: Optional[ModelVariant] = None):
        ...
        self.pipeline: Optional[LatentConsistencyModelPipeline] = None
