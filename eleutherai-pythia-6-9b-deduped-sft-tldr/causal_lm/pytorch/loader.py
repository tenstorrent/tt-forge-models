...
"""Eleutherai Pythia 6 9b Deduped Sft Tldr model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="cleanrl/EleutherAI_pythia-6.9b-deduped__sft__tldr",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Eleutherai Pythia 6 9b Deduped Sft Tldr",
