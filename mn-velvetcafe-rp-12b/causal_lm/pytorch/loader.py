...
"""Mn Velvetcafe Rp 12b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="IggyLux/MN-VelvetCafe-RP-12B",
            max_length=128,
        ),
    }
