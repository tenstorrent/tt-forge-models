...
class ModelVariant(StrEnum):
    """Available ChemLLM model variants for causal language modeling."""

    CHEMLLM_7B_CHAT_1_5_DPO = "7B-Chat-1.5-DPO"


class ModelLoader(ForgeModel):
    """ChemLLM model loader implementation for causal language modeling tasks."""

    # Dictionary of available model variants using structured configs
    _VARIANTS = {
        ModelVariant.CHEMLLM_7B_CHAT_1_5_DPO: LLMModelConfig(
            pretrained_model_name="AI4Chem/ChemLLM-7B-Chat-1_5-DPO",
            max_length=128,
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.CHEMLLM_7B_CHAT_1_5_DPO

    # Shared configuration parameters
    sample_text = "What is the molecular formula for water?"
    chat_messages = [
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The ChemLLM model instance for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the ChemLLM model with this instance's variant settings.
