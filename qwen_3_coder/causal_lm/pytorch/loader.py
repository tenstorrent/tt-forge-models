...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Qwen 3 Coder model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The Qwen 3 Coder model instance for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the Qwen 3 Coder model.
    ...
    def load_config(self):
        """Load and return the configuration for the Qwen 3 Coder model variant.

        Returns:
            The configuration object for the Qwen 3 Coder model.
        """
