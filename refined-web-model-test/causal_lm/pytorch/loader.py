...
"""Refined Web Model Test model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="explosion-testing/refined-web-model-test",
            max_length=128,
        ),
    }
