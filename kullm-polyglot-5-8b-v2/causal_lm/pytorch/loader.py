...
"""Kullm Polyglot 5 8b V2 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="nlpai-lab/kullm-polyglot-5.8b-v2",
            max_length=128,
        ),
    }
