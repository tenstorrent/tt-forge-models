...
# Small test dimensions for the transformer forward pass.
# Must be divisible by the transformer's patch_size (1, 2, 2).
...
class ModelLoader(ForgeModel):
    ...
    def load_model(
        ...
        **kwargs,
        ...
        """Load the single-file Wan 2.2 T2V transformer module."""
