...
"""St Nli Ca Paraphrase Multilingual Mpnet Base model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="projecte-aina/ST-NLI-ca_paraphrase-multilingual-mpnet-base",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="St Nli Ca Paraphrase Multilingual Mpnet Base",
