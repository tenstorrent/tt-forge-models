...
"""
Granite 3.0 8B Instruct i1 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Granite 3.0 8B Instruct i1 GGUF model variants for causal language modeling."""
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Granite 3.0 8B Instruct i1 GGUF",
            variant=variant,
