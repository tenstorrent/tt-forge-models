...
"""Pythia 160m Attndropout model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="EleutherAI/pythia-160m-attndropout",
            max_length=128,
        ),
    }
