...
class ModelVariant(StrEnum):
    """Available OpenCUA model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.OPENCUA_7B: LLMModelConfig(
            pretrained_model_name="xlangai/OpenCUA-7B",
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.OPENCUA_7B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the OpenCUA model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The Wrapped OpenCUA model instance.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the OpenCUA model.
