...
def _patched_load_gguf_checkpoint(gguf_path, return_tensors=False, **kwargs):
    ...
    Also refreshes transformers' package-distribution mapping so that gguf
    (installed dynamically via requirements.txt) is visible to is_gguf_available().
    """
    import importlib.metadata
    import transformers.utils.import_utils as _import_utils

    # gguf is installed at test-setup time, after transformers was imported and
    # cached its PACKAGE_DISTRIBUTION_MAPPING.  Refresh so is_gguf_available()
    # finds the correct version instead of falling back to 'N/A'.
