...
"""Vicuna 7b Vanilla 1 1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Ejafa/vicuna_7B_vanilla_1.1",
            max_length=128,
        ),
    }
