...
"""Gpt2 Small Indonesian model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="flax-community/gpt2-small-indonesian",
            max_length=128,
        ),
    }
