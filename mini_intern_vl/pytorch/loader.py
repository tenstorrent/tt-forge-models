...
"""
Mini-InternVL-Chat model loader implementation for multimodal visual question answering.
"""
...
def build_transform(input_size):
    """Build image transform pipeline for Mini-InternVL-Chat."""
    return T.Compose(
        [
...
def load_image(image_path, input_size=448, max_num=12):
    """Load and preprocess an image for Mini-InternVL-Chat."""
...
class ModelVariant(StrEnum):
    """Available Mini-InternVL-Chat model variants."""

    MINI_INTERN_VL_CHAT_2B_V1_5 = "2B-V1-5"


class ModelLoader(ForgeModel):
    """Mini-InternVL-Chat model loader implementation for multimodal visual question answering tasks."""

    _VARIANTS = {
        ModelVariant.MINI_INTERN_VL_CHAT_2B_V1_5: ModelConfig(
            pretrained_model_name="OpenGVLab/Mini-InternVL-Chat-2B-V1-5",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MINI_INTERN_VL_CHAT_2B_V1_5
