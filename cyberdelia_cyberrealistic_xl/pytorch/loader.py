...
"""
CyberRealisticXL (John6666/cyberrealistic-xl-v4-sdxl) model loader implementation.
...
Available variants:
- CYBERREALISTIC_XL: John6666/cyberrealistic-xl-v4-sdxl text-to-image generation
"""
...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the UNet from the CyberRealisticXL pipeline.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the CyberRealisticXL UNet model.
