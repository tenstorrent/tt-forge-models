...
class ModelVariant(StrEnum):
    """Available CLIP ViT-Base/32 DTD model variants."""

    BASE_PATCH32_DTD = "Base_Patch32_DTD"


class ModelLoader(ForgeModel):
    """CLIP ViT-Base/32 DTD model loader for image feature extraction."""

    _VARIANTS = {
        ModelVariant.BASE_PATCH32_DTD: ModelConfig(
            pretrained_model_name="tanganke/clip-vit-base-patch32_dtd",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BASE_PATCH32_DTD
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="CLIP_ViT_Base_Patch32_DTD",
            variant=variant,
