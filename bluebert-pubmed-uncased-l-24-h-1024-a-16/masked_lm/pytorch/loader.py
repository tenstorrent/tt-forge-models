...
"""Bluebert Pubmed Uncased L 24 H 1024 A 16 model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="bionlp/bluebert_pubmed_uncased_L-24_H-1024_A-16",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bluebert Pubmed Uncased L 24 H 1024 A 16",
