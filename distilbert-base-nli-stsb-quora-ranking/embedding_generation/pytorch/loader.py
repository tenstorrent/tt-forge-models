...
"""Distilbert Base Nli Stsb Quora Ranking model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="sentence-transformers/distilbert-base-nli-stsb-quora-ranking",
        ),
    }
