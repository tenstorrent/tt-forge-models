...
"""Instructlm 500m model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="instruction-pretrain/InstructLM-500M",
            max_length=128,
        ),
    }
