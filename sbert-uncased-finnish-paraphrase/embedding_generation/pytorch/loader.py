...
"""Sbert Uncased Finnish Paraphrase model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="TurkuNLP/sbert-uncased-finnish-paraphrase",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sbert Uncased Finnish Paraphrase",
