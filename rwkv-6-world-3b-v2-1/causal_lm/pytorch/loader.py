...
"""Rwkv 6 World 3b V2 1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="RWKV/rwkv-6-world-3b-v2.1",
            max_length=128,
        ),
    }
