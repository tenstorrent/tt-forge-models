...
"""
Yi-1.5 Chat causal LM model loader implementation.
"""
...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Yi-1.5 model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The Yi-1.5 model for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the Yi-1.5 model with this instance's variant settings.
    ...
    def get_mesh_config(self, num_devices: int):
        ...
        if self.model.config.num_attention_heads % num_devices == 0:
    ...
    def load_shard_spec(self, model):
        """Tensor-parallel sharding spec for Yi-1.5.

        Yi-1.5 uses the standard Llama decoder layout:
          - `self_attn.{q,k,v,o}_proj`        : separate Q/K/V + output projection
          - `mlp.{gate,up,down}_proj`         : gated MLP
