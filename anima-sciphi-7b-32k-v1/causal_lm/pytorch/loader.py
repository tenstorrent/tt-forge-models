...
"""Anima Sciphi 7b 32k V1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Severian/ANIMA-SciPhi-7B-32k-v1",
            max_length=128,
        ),
    }
