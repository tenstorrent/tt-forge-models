...
"""
SMP MiT-B2 (Mix Transformer B2) model loader implementation using segmentation-models-pytorch.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available SMP MiT-B2 model variants."""

    MIT_B2_IMAGENET = "Mit_B2_Imagenet"


class ModelLoader(ForgeModel):
    """SMP MiT-B2 model loader implementation for semantic segmentation."""

    _VARIANTS = {
        ModelVariant.MIT_B2_IMAGENET: ModelConfig(
            pretrained_model_name="smp-hub/mit_b2.imagenet",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MIT_B2_IMAGENET
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the SMP MiT-B2 U-Net model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The SMP U-Net model with MiT-B2 encoder.
        """
        import segmentation_models_pytorch as smp

        model = smp.Unet("mit_b2", encoder_weights="imagenet")
        model.eval()
