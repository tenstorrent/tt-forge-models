...
class ModelVariant(StrEnum):
    """Available mradermacher AgenticQwen-8B i1 GGUF model variants for causal language modeling."""

    AGENTICQWEN_8B_I1_GGUF = "8B_i1_GGUF"


class ModelLoader(ForgeModel):
    """mradermacher AgenticQwen-8B i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.AGENTICQWEN_8B_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/AgenticQwen-8B-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.AGENTICQWEN_8B_I1_GGUF

    GGUF_FILE = "AgenticQwen-8B.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher AgenticQwen-8B i1 GGUF",
            variant=variant,
