...
"""
Huihui Qwen3.5-35B-A3B abliterated MXFP4 MoE GGUF model loader implementation for causal language modeling.
"""
import torch
...
def _patch_transformers_qwen35moe_gguf():
    ...
    # 3. Custom tensor processor for qwen35moe that handles the separate
    # ffn_gate_exps / ffn_up_exps tensors stored in the GGUF file.
    import re as _re
    from transformers.modeling_gguf_pytorch_utils import (
        GGUFTensor,
    ...
    # and add the unfused gate/up expert tensor entries the GGUF file stores separately.
...
class ModelVariant(StrEnum):
    """Available Huihui Qwen3.5-35B-A3B GGUF model variants for causal language modeling."""

    QWEN_3_5_35B_A3B_MXFP4_MOE_GGUF = "35B_A3B_MXFP4_MOE_GGUF"


class ModelLoader(ForgeModel):
    """Huihui Qwen3.5-35B-A3B abliterated MXFP4 MoE GGUF model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_5_35B_A3B_MXFP4_MOE_GGUF: LLMModelConfig(
            pretrained_model_name="noctrex/Huihui-Qwen3.5-35B-A3B-abliterated-MXFP4_MOE-GGUF",
            max_length=128,
        ),
    }
    ...
    GGUF_FILE = "Huihui-Qwen3.5-35B-A3B-abliterated-MXFP4_MOE.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Huihui Qwen3.5-35B-A3B MXFP4 MoE GGUF",
            variant=variant,
