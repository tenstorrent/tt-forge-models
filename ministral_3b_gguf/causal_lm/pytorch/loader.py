...
"""
Ministral 3B GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Ministral 3B GGUF model variants for causal language modeling."""

    MINISTRAL_3B_INSTRUCT_2512_GGUF = "3B_Instruct_2512_GGUF"


class ModelLoader(ForgeModel):
    """Ministral 3B GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MINISTRAL_3B_INSTRUCT_2512_GGUF: LLMModelConfig(
            pretrained_model_name="mistralai/Ministral-3-3B-Instruct-2512-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MINISTRAL_3B_INSTRUCT_2512_GGUF
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        # Disable sliding window attention to avoid compiler out-of-range errors
        # with large negative slice indices from the SWA cache update.
