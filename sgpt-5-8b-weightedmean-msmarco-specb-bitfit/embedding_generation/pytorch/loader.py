...
"""Sgpt 5 8b Weightedmean Msmarco Specb Bitfit model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Muennighoff/SGPT-5.8B-weightedmean-msmarco-specb-bitfit",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sgpt 5 8b Weightedmean Msmarco Specb Bitfit",
