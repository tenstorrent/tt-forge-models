...
"""
Granite 3.1 1B A400M Instruct model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Granite 3.1 1B A400M Instruct model variants for causal language modeling."""

    GRANITE_3_1_1B_A400M_INSTRUCT = "3.1_1B_A400M_Instruct"


class ModelLoader(ForgeModel):
    """Granite 3.1 1B A400M Instruct model loader implementation for causal language modeling tasks."""
