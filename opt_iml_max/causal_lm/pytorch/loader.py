...
"""
OPT-IML-Max model loader implementation for causal language modeling.
"""
...
class ModelLoader(ForgeModel):
    """OPT-IML-Max model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.OPT_IML_MAX_1_3B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the OPT-IML-Max model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The OPT-IML-Max model instance for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the OPT-IML-Max model with this instance's variant settings.
