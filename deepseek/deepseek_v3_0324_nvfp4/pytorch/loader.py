...
"""
NVIDIA DeepSeek-V3-0324-NVFP4 model loader implementation for causal language modeling.

This is an FP4-quantized variant of DeepSeek-V3-0324 by NVIDIA, optimized for
TensorRT-LLM inference. Uses reduced MoE configuration for testing since the
full 397B parameter model requires 8x B200 GPUs with TensorRT-LLM.
"""
...
class ModelLoader(ForgeModel):
    """NVIDIA DeepSeek-V3-0324-NVFP4 model loader for causal language modeling."""
