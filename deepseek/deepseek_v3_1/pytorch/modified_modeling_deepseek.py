...
# Modified: removed for tt-xla compilation
...
class DeepseekV3Model(DeepseekV3PreTrainedModel):
    ...
    def forward(
        ...
        if self._use_flash_attention_2:
            ...
            # Modified: use MLACache to get attention_mask only when caller did
            # not pass one in. Tests pre-build a padding-aware mask of shape
            # (B, 1, q_len, max_cache_len); honor it instead of overwriting.
            ...
            # Modified: caller already supplied a 4-D additive mask; pass through.
            pass
        else:
