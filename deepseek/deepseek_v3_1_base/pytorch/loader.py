...
"""
DeepSeek V3.1 Base model loader implementation for causal language modeling.
...
class ModelLoader(ForgeModel):
    """DeepSeek V3.1 Base model loader for causal language modeling."""

    def __init__(self, variant=None, num_layers: Optional[int] = None):
        super().__init__(variant)
        self.model_name = "unsloth/DeepSeek-V3.1-Base-BF16"
        self.tokenizer = None
