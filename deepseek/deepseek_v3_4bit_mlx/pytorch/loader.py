...
"""
DeepSeek V3 4-bit MLX model loader implementation for causal language modeling.
...
class ModelLoader(ForgeModel):
    """DeepSeek V3 4-bit MLX model loader for causal language modeling."""

    def __init__(self, variant=None, num_layers: Optional[int] = None):
        super().__init__(variant)
        self.model_name = "mlx-community/DeepSeek-V3-4bit"
        self.tokenizer = None
