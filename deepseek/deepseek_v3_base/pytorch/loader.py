...
"""
DeepSeek V3 Base model loader implementation for causal language modeling.
...
class ModelLoader(ForgeModel):
    """DeepSeek V3 Base model loader for causal language modeling."""

    def __init__(self, variant=None, num_layers: Optional[int] = None):
        super().__init__(variant)
        self.model_name = "deepseek-ai/DeepSeek-V3-Base"
        self.tokenizer = None
