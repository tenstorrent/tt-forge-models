...
"""
DeepSeek V2.5 1210 FP8 model loader implementation for causal language modeling.
...
# Shim for transformers 5.x: DynamicCache.get_usable_length was renamed to get_seq_length
...
class ModelLoader(ForgeModel):
    """DeepSeek V2.5 1210 FP8 model loader for causal language modeling."""

    def __init__(self, variant=None, num_layers: Optional[int] = None):
        super().__init__(variant)
        self.model_name = "RedHatAI/DeepSeek-V2.5-1210-FP8"
        self.tokenizer = None
