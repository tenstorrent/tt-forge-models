...
"""
DeepSeek Llama Instruct causal LM model loader implementation.
"""
...
class ModelVariant(StrEnum):
    """Available DeepSeek Llama model variants for causal language modeling."""

    DEEPSEEK_LLAMA_70B = "DeepSeek-R1-Distill-Llama-70B"


class ModelLoader(ForgeModel):
    """DeepSeek Llama model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.DEEPSEEK_LLAMA_70B: LLMModelConfig(
            pretrained_model_name="deepseek-ai/DeepSeek-R1-Distill-Llama-70B",
            max_length=256,
        )
    }

    DEFAULT_VARIANT = ModelVariant.DEEPSEEK_LLAMA_70B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the DeepSeek Llama model instance for this instance's variant.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the DeepSeek Llama model with this instance's variant settings.
