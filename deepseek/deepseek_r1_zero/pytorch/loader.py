...
"""
DeepSeek R1 Zero model loader implementation for causal language modeling.
...
class ModelLoader(ForgeModel):
    """DeepSeek R1 Zero model loader for causal language modeling."""

    def __init__(self, variant=None, num_layers: Optional[int] = None):
        super().__init__(variant)
        self.model_name = "deepseek-ai/DeepSeek-R1-Zero"
        self.tokenizer = None
