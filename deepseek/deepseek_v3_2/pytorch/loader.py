...
"""
DeepSeek V3.2 NVFP4 model loader implementation for causal language modeling.

Uses reduced MoE configuration for testing since the full 394B parameter
...
if not hasattr(DynamicCache, "get_usable_length"):
    # get_usable_length was removed in transformers 4.54; patch it back for
    # model remote code written against older transformers.
