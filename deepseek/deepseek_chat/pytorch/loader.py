...
"""
DeepSeek Chat model loader implementation.
"""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.DEEPSEEK_CHAT_67B: LLMModelConfig(
            pretrained_model_name="deepseek-ai/deepseek-llm-67b-chat",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.DEEPSEEK_CHAT_67B
