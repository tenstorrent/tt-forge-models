...
"""Llm Detector Small Zh model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="QiYuan-tech/LLM-Detector-Small-zh",
        ),
    }
