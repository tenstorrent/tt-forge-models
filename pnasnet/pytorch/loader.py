...
"""
PNASNet model loader implementation
"""
...
@dataclass
class PNASNetConfig(ModelConfig):
    """Configuration specific to PNASNet models"""
...
class ModelVariant(StrEnum):
    """Available PNASNet model variants."""

    PNASNET5LARGE_TF_IN1K = "pnasnet5large.tf_in1k"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.PNASNET5LARGE_TF_IN1K: PNASNetConfig(
            pretrained_model_name="pnasnet5large.tf_in1k",
            source=ModelSource.TIMM,
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.PNASNET5LARGE_TF_IN1K
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load pretrained PNASNet model for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The PNASNet model instance.
        """
        ...
        if source == ModelSource.TIMM:
            ...
            raise ValueError(f"Unsupported source for PNASNet: {source}")
        ...
        # Update postprocessor with model instance
