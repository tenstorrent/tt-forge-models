...
"""
Llama 3.2 3B Instruct Uncensored GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Llama 3.2 3B Instruct Uncensored GGUF model variants for causal language modeling."""
...
class ModelLoader(ForgeModel):
    """Llama 3.2 3B Instruct Uncensored GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MRADERMACHER_LLAMA_3_2_3B_INSTRUCT_UNCENSORED: LLMModelConfig(
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Llama 3.2 3B Instruct Uncensored GGUF",
            variant=variant,
