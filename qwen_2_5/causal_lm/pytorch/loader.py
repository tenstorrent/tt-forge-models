...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.QWEN_2_5_7B_INSTRUCT_GPTQ_INT4: LLMModelConfig(
            pretrained_model_name="Qwen/Qwen2.5-7B-Instruct-GPTQ-Int4",
            max_length=128,
        ),
        ModelVariant.QWEN_2_5_7B_INSTRUCT_GPTQ_INT8: LLMModelConfig(
        ...
        ModelVariant.QWEN_2_5_0_5B_INSTRUCT_AWQ: LLMModelConfig(
