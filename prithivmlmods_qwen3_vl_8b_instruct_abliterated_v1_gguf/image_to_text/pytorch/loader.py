...
class ModelVariant(StrEnum):
    """Available prithivMLmods Qwen3 VL 8B Instruct abliterated v1 GGUF model variants for image to text."""

    PRITHIVMLMODS_QWEN3_VL_8B_INSTRUCT_ABLITERATED_V1_GGUF = (
        "qwen3_vl_8b_instruct_abliterated_v1_gguf"
    )
...
class ModelLoader(ForgeModel):
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="prithivMLmods Qwen3 VL 8B Instruct abliterated v1 GGUF",
            variant=variant,
