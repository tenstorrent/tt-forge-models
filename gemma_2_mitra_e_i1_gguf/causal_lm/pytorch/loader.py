...
class ModelVariant(StrEnum):
    """Available Gemma 2 Mitra E i1 GGUF model variants for causal language modeling."""

    GEMMA_2_MITRA_E_I1_GGUF = "Mitra_E_i1_GGUF"


class ModelLoader(ForgeModel):
    """Gemma 2 Mitra E i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GEMMA_2_MITRA_E_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/gemma-2-mitra-e-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GEMMA_2_MITRA_E_I1_GGUF

    GGUF_FILE = "gemma-2-mitra-e.i1-Q4_K_M.gguf"
