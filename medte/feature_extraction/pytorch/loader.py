...
"""
MedTE model loader for medical text feature extraction.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available model variants for MedTE."""

    MEDTE_CL15_STEP_8000 = "MohammadKhodadad/MedTE-cl15-step-8000"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.MEDTE_CL15_STEP_8000: LLMModelConfig(
            pretrained_model_name="MohammadKhodadad/MedTE-cl15-step-8000",
            max_length=512,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MEDTE_CL15_STEP_8000
    ...
    def output_postprocess(self, output, inputs=None):
        ...
        # MedTE uses [CLS] token embedding as the sentence representation
