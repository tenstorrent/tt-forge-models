...
"""
Helper functions for Garage Mix Noob V-Pred Eps v1.0 V-Pred SDXL model loading and processing.
"""
...
def load_pipe(pretrained_model_name):
    """Load Garage Mix Noob V-Pred Eps v1.0 V-Pred SDXL pipeline.
