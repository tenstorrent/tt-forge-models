...
"""
RoGPT2 Base model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available RoGPT2 Base model variants."""

    BASE = "Default"


class ModelLoader(ForgeModel):
    """RoGPT2 Base model loader for causal language modeling."""

    _VARIANTS = {
        ModelVariant.BASE: LLMModelConfig(
            pretrained_model_name="readerbench/RoGPT2-base",
            max_length=256,
        ),
    }
