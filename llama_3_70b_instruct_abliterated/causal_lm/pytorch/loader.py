...
"""
Llama 3 70B Instruct Abliterated model loader implementation for causal language modeling.
"""
import torch
...
class ModelLoader(ForgeModel):
    """Llama 3 70B Instruct Abliterated model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.LLAMA_3_70B_INSTRUCT_ABLITERATED
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Llama 3 70B Instruct Abliterated",
            variant=variant,
