...
"""Roberta Fine Tuned Sentiment Newsmtsc model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="RogerKam/roberta_fine_tuned_sentiment_newsmtsc",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Roberta Fine Tuned Sentiment Newsmtsc",
