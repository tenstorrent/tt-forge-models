...
"""Airoboros 33b Gpt4 1 4 Superhot 8k Fp16 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="TheBloke/airoboros-33B-gpt4-1-4-SuperHOT-8K-fp16",
            max_length=128,
        ),
    }
