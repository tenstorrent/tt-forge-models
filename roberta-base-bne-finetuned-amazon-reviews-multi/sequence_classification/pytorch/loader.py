...
"""Roberta Base Bne Finetuned Amazon Reviews Multi model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Eugenia/roberta-base-bne-finetuned-amazon_reviews_multi",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Roberta Base Bne Finetuned Amazon Reviews Multi",
