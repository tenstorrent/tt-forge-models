...
"""Sql Millennials 7b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="budecosystem/sql-millennials-7b",
            max_length=128,
        ),
    }
