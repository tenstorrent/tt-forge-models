...
"""
Time Series Transformer model loader implementation for time series forecasting.
"""
...
class ModelVariant(StrEnum):
    """Available Time Series Transformer model variants."""

    TOURISM_MONTHLY = "Tourism_Monthly"


class ModelLoader(ForgeModel):
    """Time Series Transformer model loader for time series forecasting."""

    _VARIANTS = {
        ModelVariant.TOURISM_MONTHLY: ModelConfig(
            pretrained_model_name="huggingface/time-series-transformer-tourism-monthly",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Time Series Transformer model."""
        model_kwargs = {}
    ...
    def load_inputs(self, dtype_override=None):
        """Load sample time series inputs for the Time Series Transformer model.
        ...
        config = TimeSeriesTransformerConfig.from_pretrained(
