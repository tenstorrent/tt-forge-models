...
"""
Pygmalion-6B model loader implementation
"""
import torch
from typing import Optional

from transformers import GPTJForCausalLM, AutoTokenizer, GenerationConfig, AutoConfig
from ....config import (
    LLMModelConfig,
    ModelInfo,
    ModelGroup,
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.PYGMALION_6B
    ...
    def _load_tokenizer(self, dtype_override=None):
        ...
        # Set pad token to eos token for GPT-J based models
        self.tokenizer.pad_token = self.tokenizer.eos_token

        return self.tokenizer

    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Pygmalion-6B model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The Pygmalion-6B model instance.
        """
        ...
        model = GPTJForCausalLM.from_pretrained(pretrained_model_name, **model_kwargs)
        model.eval()
        return model

    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the Pygmalion-6B model with this instance's variant settings.
