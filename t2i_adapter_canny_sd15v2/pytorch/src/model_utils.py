...
"""
Helper functions for T2I-Adapter Canny SD1.5v2 model loading and processing.
"""
...
def load_t2i_adapter_canny_sd15v2_pipe(adapter_model_name, base_model_name):
    """Load T2I-Adapter Canny SD1.5v2 pipeline.
...
def t2i_adapter_canny_sd15v2_preprocessing(
    ...
    """Preprocess inputs for T2I-Adapter Canny SD1.5v2 model.
