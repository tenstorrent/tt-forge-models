...
"""
mlx-community/MiniMax-M2.5-6bit model loader implementation for causal language modeling.
...
Note: The mlx-community/MiniMax-M2.5-6bit model is an MLX-quantized variant
of MiniMaxAI/MiniMax-M2.5. Since MLX models cannot be loaded directly with
transformers, this loader uses the base MiniMaxAI/MiniMax-M2.5 model.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available mlx-community/MiniMax-M2.5-6bit model variants for causal language modeling."""

    MINIMAX_M2_5_6BIT = "M2.5-6bit"


class ModelLoader(ForgeModel):
    """mlx-community/MiniMax-M2.5-6bit model loader implementation for causal language modeling tasks."""

    # Dictionary of available model variants using structured configs
    _VARIANTS = {
        ModelVariant.MINIMAX_M2_5_6BIT: LLMModelConfig(
    ...
    DEFAULT_VARIANT = ModelVariant.MINIMAX_M2_5_6BIT
