...
"""Code Millenials 13b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="budecosystem/code-millenials-13b",
            max_length=128,
        ),
    }
