...
"""
MiniLM model loader implementation for embedding generation.
"""
import torch
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.ALL_MINILM_L6_V2
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the MiniLM model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The MiniLM model instance for embedding generation.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the MiniLM model with this instance's variant settings.
