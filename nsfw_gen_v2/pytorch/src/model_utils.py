...
"""
Helper functions for NSFW-gen-v2 model loading and processing.
"""
...
def load_pipe(pretrained_model_name):
    """Load NSFW-gen-v2 pipeline.

    Args:
        pretrained_model_name: HuggingFace model identifier

    Returns:
        AutoPipelineForText2Image: Loaded pipeline with components set to eval mode
    """
...
def stable_diffusion_preprocessing_xl(
    ...
    """Preprocess inputs for NSFW-gen-v2 SDXL UNet forward pass.

    Args:
        pipe: AutoPipelineForText2Image instance
