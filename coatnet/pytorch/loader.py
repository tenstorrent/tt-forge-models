...
class CoAtNetConfig(ModelConfig):
    """Configuration specific to CoAtNet models"""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.COATNET_2_RW_224: CoAtNetConfig(
            pretrained_model_name="hf_hub:timm/coatnet_2_rw_224.sw_in12k_ft_in1k",
            source=ModelSource.TIMM,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.COATNET_1_RW_224
