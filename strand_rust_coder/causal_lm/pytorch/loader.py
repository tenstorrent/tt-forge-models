...
"""
Fortytwo-Network/Strand-Rust-Coder-14B-v1 model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Strand Rust Coder model variants for causal language modeling."""

    STRAND_RUST_CODER_14B_V1 = "14B_V1"


class ModelLoader(ForgeModel):
    """Fortytwo-Network/Strand-Rust-Coder-14B-v1 model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.STRAND_RUST_CODER_14B_V1: LLMModelConfig(
            pretrained_model_name="Fortytwo-Network/Strand-Rust-Coder-14B-v1",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.STRAND_RUST_CODER_14B_V1
