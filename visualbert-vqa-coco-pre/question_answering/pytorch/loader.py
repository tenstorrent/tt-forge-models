...
"""Visualbert Vqa Coco Pre model loader implementation for question answering."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="uclanlp/visualbert-vqa-coco-pre",
            max_length=384,
        ),
    }
