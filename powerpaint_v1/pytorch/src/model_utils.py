...
"""
Helper functions for PowerPaint V1 Inpainting model loading and processing.
"""
...
def load_inpainting_pipe(model_name):
    """Load PowerPaint V1 Stable Diffusion Inpainting pipeline.
...
def inpainting_preprocessing(
    ...
    """Preprocess inputs for PowerPaint V1 Stable Diffusion Inpainting model.
