...
"""
PIXIE-Rune-v1.0 model loader for embedding generation.

Uses the XLM-RoBERTa architecture via AutoModel for Korean and English
...
class ModelVariant(StrEnum):
    """Available PIXIE-Rune-v1.0 model variants."""

    PIXIE_RUNE_V1_0 = "telepix/PIXIE-Rune-v1.0"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.PIXIE_RUNE_V1_0: LLMModelConfig(
            pretrained_model_name="telepix/PIXIE-Rune-v1.0",
            max_length=512,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.PIXIE_RUNE_V1_0
    ...
    def load_inputs(self, dtype_override=None, sentence=None):
        ...
        if sentence is None:
            sentence = "텔레픽스는 어떤 산업 분야에서 위성 데이터를 활용하나요?"
