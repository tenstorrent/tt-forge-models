...
"""Snorkel Mistral Pairrm Dpo Openchat 3 5 0106 Laser model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Eric111/Snorkel-Mistral-PairRM-DPO-openchat-3.5-0106-laser",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Snorkel Mistral Pairrm Dpo Openchat 3 5 0106 Laser",
