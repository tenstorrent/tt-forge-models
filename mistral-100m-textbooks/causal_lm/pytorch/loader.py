...
"""Mistral 100m Textbooks model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="openaccess-ai-collective/mistral-100m-textbooks",
            max_length=128,
        ),
    }
