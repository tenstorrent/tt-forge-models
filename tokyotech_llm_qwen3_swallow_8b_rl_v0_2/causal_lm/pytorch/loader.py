...
"""
tokyotech-llm/Qwen3-Swallow-8B-RL-v0.2 model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available tokyotech-llm/Qwen3-Swallow-8B-RL-v0.2 model variants for causal LM."""

    QWEN3_SWALLOW_8B_RL_V0_2 = "Qwen3_Swallow_8B_RL_v0.2"


class ModelLoader(ForgeModel):
    """tokyotech-llm/Qwen3-Swallow-8B-RL-v0.2 model loader for causal language modeling."""
