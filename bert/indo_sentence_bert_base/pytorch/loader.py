...
"""
Indo Sentence BERT Base model loader for sentence embedding generation.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available model variants for Indo Sentence BERT Base."""

    INDO_SENTENCE_BERT_BASE = "firqaaa/indo-sentence-bert-base"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.INDO_SENTENCE_BERT_BASE: LLMModelConfig(
            pretrained_model_name="firqaaa/indo-sentence-bert-base",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.INDO_SENTENCE_BERT_BASE
    ...
    def load_inputs(self, dtype_override=None, sentence=None):
        ...
        if sentence is None:
            sentence = "Ini adalah contoh kalimat dalam bahasa Indonesia."
