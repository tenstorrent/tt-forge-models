...
"""Japanese Large Lm 3 6b Instruction Sft model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="line-corporation/japanese-large-lm-3.6b-instruction-sft",
            max_length=128,
        ),
    }
