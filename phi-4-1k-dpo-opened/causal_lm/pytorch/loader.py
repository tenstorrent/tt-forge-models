...
"""Phi 4 1k Dpo Opened model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="FinaPolat/phi-4_1K_dpo_openED",
            max_length=128,
        ),
    }
