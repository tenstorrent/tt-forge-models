...
"""Contra Bottleneck T5 Large Wikipedia model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="thesephist/contra-bottleneck-t5-large-wikipedia",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Contra Bottleneck T5 Large Wikipedia",
