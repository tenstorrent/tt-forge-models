...
"""
Helper functions for Noob SDXL ControlNet Tile model loading and processing.
"""
...
def load_controlnet_tile_sdxl_pipe(controlnet_model_name, base_model_name):
    """Load ControlNet Tile SDXL pipeline.
...
def controlnet_tile_sdxl_preprocessing(
    ...
    """Preprocess inputs for ControlNet Tile SDXL model.

    Args:
        pipe: StableDiffusionXLControlNetPipeline
        prompt: Text prompt for generation
        control_image: Tile conditioning image
