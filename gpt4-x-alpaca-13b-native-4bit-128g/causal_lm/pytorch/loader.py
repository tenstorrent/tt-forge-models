...
"""Gpt4 X Alpaca 13b Native 4bit 128g model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="anon8231489123/gpt4-x-alpaca-13b-native-4bit-128g",
            max_length=128,
        ),
    }
