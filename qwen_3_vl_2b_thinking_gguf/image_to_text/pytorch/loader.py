...
"""
Qwen 3 VL 2B Thinking GGUF model loader implementation for image to text.
"""
...
class ModelVariant(StrEnum):
    """Available Qwen 3 VL 2B Thinking GGUF model variants for image to text."""

    QWEN_3_VL_2B_THINKING_GGUF = "2b_thinking_gguf"


class ModelLoader(ForgeModel):
    """Qwen 3 VL 2B Thinking GGUF model loader implementation for image to text tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_VL_2B_THINKING_GGUF: LLMModelConfig(
            pretrained_model_name="Qwen/Qwen3-VL-2B-Thinking-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN_3_VL_2B_THINKING_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Qwen 3 VL 2B Thinking GGUF",
            variant=variant,
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        try:
            ...
            inputs = self.processor(
                text="Describe an image of a dog.",
                return_tensors="pt",
            )
        return inputs
