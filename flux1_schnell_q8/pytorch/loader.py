...
"""
FLUX.1-schnell Q8 (Quanto) model loader implementation for text-to-image generation.

Loads a Quanto Q8-quantized FLUX.1-schnell transformer from
cocktailpeanut/flux1-schnell-q8. The checkpoint is a FluxTransformer2DModel
saved directly at the repository root (no ``transformer`` subfolder) as sharded
safetensors alongside a ``quanto_qmap.json`` quantization map.
"""
...
class ModelVariant(StrEnum):
    """Available FLUX.1-schnell Q8 (Quanto) model variants."""

    Q8 = "q8"


class ModelLoader(ForgeModel):
    """FLUX.1-schnell Q8 (Quanto) model loader for text-to-image generation."""

    _VARIANTS = {
        ModelVariant.Q8: ModelConfig(
            pretrained_model_name="cocktailpeanut/flux1-schnell-q8",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.Q8
