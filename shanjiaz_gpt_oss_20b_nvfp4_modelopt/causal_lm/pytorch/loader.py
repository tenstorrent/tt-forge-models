...
"""
shanjiaz/gpt-oss-20b-nvfp4-modelopt model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available shanjiaz GPT-OSS 20B NVFP4 ModelOpt model variants."""

    GPT_OSS_20B_NVFP4_MODELOPT = "Default"


class ModelLoader(ForgeModel):
    """shanjiaz GPT-OSS 20B NVFP4 ModelOpt model loader for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GPT_OSS_20B_NVFP4_MODELOPT: LLMModelConfig(
            pretrained_model_name="shanjiaz/gpt-oss-20b-nvfp4-modelopt",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GPT_OSS_20B_NVFP4_MODELOPT
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="shanjiaz-GPT-OSS-20B-NVFP4-ModelOpt",
            variant=variant,
    ...
    def get_mesh_config(self, num_devices: int):
        if num_devices == 32:  # Galaxy
            ...
            raise ValueError(
                "shanjiaz GPT-OSS 20B NVFP4 ModelOpt is only supported on llmbox and galaxy"
            )
