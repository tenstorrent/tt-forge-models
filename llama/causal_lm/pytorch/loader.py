...
class ModelVariant(StrEnum):
    ...
    # NVIDIA FP8 quantized variants
    LLAMA_3_1_70B_INSTRUCT_FP8_NVIDIA = "3.1_70B_Instruct_FP8_Nvidia"
    ...
    LLAMA_3_2_1B_INSTRUCT_FP8_KV = "3.2_1B_Instruct_FP8_KV"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        # AMD FP8 quantized variants
        ModelVariant.LLAMA_3_2_1B_INSTRUCT_FP8_KV: LLMModelConfig(
            pretrained_model_name="amd/Llama-3.2-1B-Instruct-FP8-KV",
            max_length=128,
        ),
        # RedHatAI NVFP4 quantized variants
        ...
        # NVIDIA FP8 quantized variants
        ModelVariant.LLAMA_3_1_70B_INSTRUCT_FP8_NVIDIA: LLMModelConfig(
            pretrained_model_name="nvidia/Llama-3.1-70B-Instruct-FP8",
            max_length=128,
        ),
        # Llama 2 variants
