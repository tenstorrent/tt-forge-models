...
"""Gams 9b Sft Translator model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="GaMS-Beta/GaMS-9B-SFT-Translator",
            max_length=128,
        ),
    }
