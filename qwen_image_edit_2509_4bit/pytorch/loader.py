...
"""
ovedrive/Qwen-Image-Edit-2509-4bit model loader implementation.

Loads the NF4-quantized diffusion transformer from ovedrive/Qwen-Image-Edit-2509-4bit,
a bitsandbytes 4-bit quantized version of Qwen/Qwen-Image-Edit-2509 for image editing.
...
class ModelVariant(StrEnum):
    """Available ovedrive/Qwen-Image-Edit-2509-4bit model variants."""

    QWEN_IMAGE_EDIT_2509_4BIT = "Edit_2509_4bit"


class ModelLoader(ForgeModel):
    """ovedrive/Qwen-Image-Edit-2509-4bit model loader for the NF4-quantized diffusion transformer."""

    _VARIANTS = {
        ModelVariant.QWEN_IMAGE_EDIT_2509_4BIT: ModelConfig(
            pretrained_model_name=REPO_ID,
        ),
    }
    DEFAULT_VARIANT = ModelVariant.QWEN_IMAGE_EDIT_2509_4BIT
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="QWEN_IMAGE_EDIT_2509_4BIT",
            variant=variant,
    ...
    def load_model(self, *, dtype_override: Optional[torch.dtype] = None, **kwargs):
        """Load and return the NF4-quantized Qwen-Image-Edit-2509 diffusion transformer.
