...
"""
alexliap Qwen3-VL-Embedding-2B FP8 dynamic quantized model loader implementation for multimodal embedding tasks.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available alexliap Qwen3-VL-Embedding-2B FP8 dynamic model variants."""

    QWEN_3_VL_EMBEDDING_2B_FP8_DYNAMIC = "Embedding_2B_FP8_Dynamic"


class ModelLoader(ForgeModel):
    """alexliap Qwen3-VL-Embedding-2B FP8 dynamic model loader for multimodal embedding tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_VL_EMBEDDING_2B_FP8_DYNAMIC: ModelConfig(
            pretrained_model_name="alexliap/Qwen3-VL-Embedding-2B-FP8-DYNAMIC",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN_3_VL_EMBEDDING_2B_FP8_DYNAMIC
