...
"""
huihui-ai/Qwen2.5-14B-Instruct-abliterated-v2 model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available model variants for huihui-ai Qwen2.5-14B-Instruct-abliterated-v2."""

    QWEN_2_5_14B_INSTRUCT_ABLITERATED_V2 = "14B_Instruct_abliterated_v2"


class ModelLoader(ForgeModel):
    """huihui-ai/Qwen2.5-14B-Instruct-abliterated-v2 model loader for causal language modeling tasks."""

    # Dictionary of available model variants using structured configs
    _VARIANTS = {
        ModelVariant.QWEN_2_5_14B_INSTRUCT_ABLITERATED_V2: LLMModelConfig(
            pretrained_model_name="huihui-ai/Qwen2.5-14B-Instruct-abliterated-v2",
            max_length=128,
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.QWEN_2_5_14B_INSTRUCT_ABLITERATED_V2
