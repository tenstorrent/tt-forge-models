...
"""Phi 3 Mini 4k Instruct Bnb 4bit Ita model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="walid-iguider/Phi-3-mini-4k-instruct-bnb-4bit-Ita",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Phi 3 Mini 4k Instruct Bnb 4bit Ita",
