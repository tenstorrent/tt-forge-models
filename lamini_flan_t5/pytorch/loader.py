...
"""
LaMini-Flan-T5 model loader implementation
"""
...
class ModelLoader(ForgeModel):
    """LaMini-Flan-T5 model loader implementation for text-to-text generation tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.LAMINI_FLAN_T5_77M
