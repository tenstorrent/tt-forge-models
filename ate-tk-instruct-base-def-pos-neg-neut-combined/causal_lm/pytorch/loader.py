...
"""Ate Tk Instruct Base Def Pos Neg Neut Combined model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="kevinscaria/ate_tk-instruct-base-def-pos-neg-neut-combined",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Ate Tk Instruct Base Def Pos Neg Neut Combined",
