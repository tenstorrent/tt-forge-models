...
class GoogleNetConfig(ModelConfig):
    """Configuration specific to GoogleNet models"""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.GOOGLENET: GoogleNetConfig(
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        if source == ModelSource.TORCHVISION:
            ...
            # Get the weights class name (e.g., "googlenet" -> "GoogLeNet_Weights")
            weight_class_name = "GoogLeNet_Weights"
            ...
            raise ValueError(f"Unsupported GoogleNet source: {source}")
    ...
    def print_cls_results(self, compiled_model_out):
        """Print classification results (backward compatibility wrapper).
