...
"""Sr Rule Based Roberta Only Classfn Epochs 1 Shard 1 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="AnonymousSub/SR_rule_based_roberta_only_classfn_epochs_1_shard_1",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sr Rule Based Roberta Only Classfn Epochs 1 Shard 1",
