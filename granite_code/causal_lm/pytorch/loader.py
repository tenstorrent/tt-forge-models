...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.GRANITE_3B_CODE_BASE_2K
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Granite Code model instance for this instance's variant.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The Granite Code model instance for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the Granite Code model.
