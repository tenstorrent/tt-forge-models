...
"""Marbertv2 Arabic Written Dialect Classifier model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="IbrahimAmin/marbertv2-arabic-written-dialect-classifier",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Marbertv2 Arabic Written Dialect Classifier",
