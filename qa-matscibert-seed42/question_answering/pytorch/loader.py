...
"""Qa Matscibert Seed42 model loader implementation for question answering."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="MaterialsInformaticsLaboratory/QA-MatSciBERT-seed42",
            max_length=384,
        ),
    }
