...
"""Roberta Targeted Sentiment Analysis model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="pysentimiento/roberta-targeted-sentiment-analysis",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Roberta Targeted Sentiment Analysis",
