...
"""Solar 10 7b Instruct V1 0 Uncensored model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="w4r10ck/SOLAR-10.7B-Instruct-v1.0-uncensored",
            max_length=128,
        ),
    }
