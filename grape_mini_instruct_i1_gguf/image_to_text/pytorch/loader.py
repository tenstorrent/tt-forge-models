...
"""
GRaPE-Mini-Instruct i1 GGUF model loader implementation for image to text.
"""
...
class ModelVariant(StrEnum):
    """Available GRaPE-Mini-Instruct i1 GGUF model variants for image to text."""

    GRAPE_MINI_INSTRUCT_I1_Q4_K_M_GGUF = "GRAPE_MINI_INSTRUCT_I1_Q4_K_M_GGUF"


class ModelLoader(ForgeModel):
    """GRaPE-Mini-Instruct i1 GGUF model loader implementation for image to text tasks."""

    _VARIANTS = {
        ModelVariant.GRAPE_MINI_INSTRUCT_I1_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/GRaPE-Mini-Instruct-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GRAPE_MINI_INSTRUCT_I1_Q4_K_M_GGUF

    _GGUF_FILES = {
        ModelVariant.GRAPE_MINI_INSTRUCT_I1_Q4_K_M_GGUF: "GRaPE-Mini-Instruct.i1-Q4_K_M.gguf",
    }

    # Base model provides the processor and correct config for from_pretrained
    BASE_MODEL = "SL-AI/GRaPE-Mini-Instruct"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="GRaPE-Mini-Instruct i1 GGUF",
            variant=variant,
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        # Register qwen3vl GGUF architecture and fix model_to_load forwarding
        # before calling from_pretrained so that load_gguf_checkpoint handles
        # both config parsing and weight loading correctly.
