...
"""Algolia Large Multilang Generic V2410 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="algolia/algolia-large-multilang-generic-v2410",
        ),
    }
