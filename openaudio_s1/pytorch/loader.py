...
"""
OpenAudio S1 model loader implementation for text-to-speech tasks.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available OpenAudio S1 model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.OA: ModelConfig(
            pretrained_model_name="cocktailpeanut/oa",
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.OA
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the OpenAudio S1 model."""
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the OpenAudio S1 model."""
