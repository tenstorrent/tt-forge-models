...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.NORMISTRAL_11B_WARM

    sample_text = "Hva er hovedstaden i Norge?"
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the NorMistral model instance for this instance's variant.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The NorMistral model instance for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the NorMistral model.
