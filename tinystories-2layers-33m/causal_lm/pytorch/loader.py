...
"""Tinystories 2layers 33m model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="roneneldan/TinyStories-2Layers-33M",
            max_length=128,
        ),
    }
