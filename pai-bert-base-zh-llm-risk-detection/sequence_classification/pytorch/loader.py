...
"""Pai Bert Base Zh Llm Risk Detection model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="alibaba-pai/pai-bert-base-zh-llm-risk-detection",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Pai Bert Base Zh Llm Risk Detection",
