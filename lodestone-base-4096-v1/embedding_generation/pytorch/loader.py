...
"""Lodestone Base 4096 V1 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Hum-Works/lodestone-base-4096-v1",
        ),
    }
