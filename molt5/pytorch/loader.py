...
"""
MolT5 model loader implementation
"""
...
class ModelLoader(ForgeModel):
    """MolT5 model loader implementation for SMILES to caption generation tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.BASE_SMILES2CAPTION

    sample_text = "C1=CC2=C(C(=C1)[O-])NC(=CC2=O)C(=O)O"
