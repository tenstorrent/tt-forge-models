...
"""Koalpaca Polyglot 12 8b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="beomi/KoAlpaca-Polyglot-12.8B",
            max_length=128,
        ),
    }
