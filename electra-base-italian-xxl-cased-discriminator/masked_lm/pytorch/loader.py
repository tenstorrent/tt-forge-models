...
"""Electra Base Italian Xxl Cased Discriminator model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="dbmdz/electra-base-italian-xxl-cased-discriminator",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Electra Base Italian Xxl Cased Discriminator",
