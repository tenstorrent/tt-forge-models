...
"""Bloomz 3b Retriever V2 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="cmarkea/bloomz-3b-retriever-v2",
        ),
    }
