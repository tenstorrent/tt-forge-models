...
"""
LAION CLIP XLM-RoBERTa model loader for multilingual image-text similarity using OpenCLIP.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available LAION CLIP XLM-RoBERTa model variants."""

    VIT_H_14_FROZEN_XLM_ROBERTA_LARGE = "ViT_H_14_frozen_xlm_roberta_large"


class ModelLoader(ForgeModel):
    """LAION CLIP XLM-RoBERTa model loader using OpenCLIP for multilingual image-text similarity."""
    ...
    DEFAULT_VARIANT = ModelVariant.VIT_H_14_FROZEN_XLM_ROBERTA_LARGE
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the LAION CLIP XLM-RoBERTa model instance.
