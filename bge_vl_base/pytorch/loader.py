...
class ModelVariant(StrEnum):
    """Available BAAI/BGE-VL-base model variants."""

    BGE_VL_BASE = "bge-vl-base"


class ModelLoader(ForgeModel):
    """BAAI/BGE-VL-base model loader for multimodal image-text similarity tasks."""

    _VARIANTS = {
        ModelVariant.BGE_VL_BASE: ModelConfig(
            pretrained_model_name="BAAI/BGE-VL-base",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BGE_VL_BASE
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the BGE-VL-base model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The BGE-VL-base model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the BGE-VL-base model.
