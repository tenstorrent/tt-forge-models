...
"""
GLM-4.7-PRISM GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    ...
    GLM_4_7_PRISM_GGUF = "4.7_PRISM_GGUF"


class ModelLoader(ForgeModel):
    """GLM-4.7-PRISM GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GLM_4_7_PRISM_GGUF: LLMModelConfig(
            pretrained_model_name="AliceThirty/GLM-4.7-PRISM-Unsloth-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.GLM_4_7_PRISM_GGUF

    GGUF_FILE = "UD-TQ1_0/GLM-4.7-PRISM-UD-TQ1_0.gguf"
