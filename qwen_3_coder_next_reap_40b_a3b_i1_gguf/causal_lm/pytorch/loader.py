...
def _patch_qwen3next_support():
    ...
    Qwen3-Coder-Next GGUF files declare architecture as 'qwen3next' which
    transformers 5.x does not yet recognise in its GGUF loading path.
    """
...
def _patched_get_gguf_hf_weights_map(
    ...
    """Map qwen3_next (HF) -> qwen3next (gguf-py) for tensor name lookup."""
