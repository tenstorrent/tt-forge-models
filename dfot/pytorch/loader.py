...
class ModelLoader(ForgeModel):
    ...
    # DiT-XL configuration for RE10K (standard VAE: 4ch, patch_size=2).
    _RE10K_CFG = DiT3DConfig(
        in_channels=4,
        patch_size=2,
        hidden_size=1152,
        depth=28,
    ...
    # DiT-XL configuration for K600/MCRAFT (Cosmos tokenizer: 16ch, patch_size=1).
    _COSMOS_CFG = DiT3DConfig(
        in_channels=16,
        patch_size=1,
        hidden_size=1152,
        depth=28,
    ...
    _VARIANT_CFGS = {
        ModelVariant.DFOT_RE10K: _RE10K_CFG,
        ModelVariant.DFOT_K600: _COSMOS_CFG,
        ModelVariant.DFOT_MCRAFT: _COSMOS_CFG,
    }
