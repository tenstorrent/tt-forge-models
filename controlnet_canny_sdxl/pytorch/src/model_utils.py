...
"""
Helper functions for ControlNet Canny SDXL model loading and processing.
"""
...
def load_controlnet_canny_sdxl_pipe(controlnet_model_name, base_model_name):
    """Load ControlNet Canny SDXL pipeline.
...
def create_canny_conditioning_image(height=1024, width=1024):
    """Create a dummy Canny edge conditioning image.

    Creates a simple synthetic edge map image suitable for ControlNet Canny conditioning.
...
def controlnet_canny_sdxl_preprocessing(
    pipe,
    prompt,
    control_image,
    device="cpu",
    ...
    """Preprocess inputs for ControlNet Canny SDXL model.

    Args:
        pipe: StableDiffusionXLControlNetPipeline
        prompt: Text prompt for generation
        control_image: Canny edge conditioning image
