...
"""Distilbert Base Uncased Finetuned Mnli model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="huggingface/distilbert-base-uncased-finetuned-mnli",
        ),
    }
