...
"""
MobileCLIP-B model loader implementation for image-text similarity using OpenCLIP.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available MobileCLIP-B model variants."""

    B = "B"


class ModelLoader(ForgeModel):
    """MobileCLIP-B model loader using OpenCLIP for image-text similarity tasks."""

    _VARIANTS = {
        ModelVariant.B: ModelConfig(
            pretrained_model_name="hf-hub:apple/MobileCLIP-B-OpenCLIP",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the MobileCLIP-B model instance.

        Args:
            dtype_override: Optional torch.dtype to override the model's default dtype.

        Returns:
            torch.nn.Module: The MobileCLIP-B model instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the MobileCLIP-B model.
    ...
    def post_process(self, outputs):
        """Post-process MobileCLIP-B model outputs to extract similarity scores.
