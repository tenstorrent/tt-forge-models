...
"""
T5 Small QG HL (Answer-Aware Question Generation) model loader implementation
"""
...
class ModelVariant(StrEnum):
    """Available T5 Small QG HL model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.SMALL: LLMModelConfig(
            pretrained_model_name="valhalla/t5-small-qg-hl",
            max_length=512,
        ),
    }
