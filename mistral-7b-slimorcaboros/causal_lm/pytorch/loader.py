...
"""Mistral 7b Slimorcaboros model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="openaccess-ai-collective/mistral-7b-slimorcaboros",
            max_length=128,
        ),
    }
