...
class ModelVariant(StrEnum):
    """Available Maya1 GGUF model variants."""

    MAYA1_Q4_K_M_GGUF = "Q4_K_M_GGUF"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.MAYA1_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/maya1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MAYA1_Q4_K_M_GGUF

    GGUF_FILE = "maya1.Q4_K_M.gguf"

    sample_text = '<description="A 30-year-old female with a warm, calm voice"> Hello, this is a test of the Maya text to speech model.'
