...
"""Beren Gpt2 Medium X49 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="stanford-crfm/beren-gpt2-medium-x49",
            max_length=128,
        ),
    }
