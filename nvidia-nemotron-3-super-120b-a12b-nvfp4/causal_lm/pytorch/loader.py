...
"""Nvidia Nemotron 3 Super 120b A12b Nvfp4 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="eightttttt/NVIDIA-Nemotron-3-Super-120B-A12B-NVFP4",
            max_length=128,
        ),
    }
