...
"""
Ministral 3 8B Instruct 2512 Tainted Heresy i1 GGUF model loader implementation for causal language modeling.
"""
import torch
...
def _patch_mistral3_support():
    ...
    Ministral GGUF files declare architecture as 'mistral3', which
    ...
    if "llama" in GGUF_TO_FAST_CONVERTERS:
        ...
        GGUF_TO_FAST_CONVERTERS.setdefault(
            "mistral3", GGUF_TO_FAST_CONVERTERS["llama"]
        )
...
class ModelVariant(StrEnum):
    ...
    MINISTRAL_3_8B_INSTRUCT_2512_TAINTED_HERESY_I1_Q4_K_M_GGUF = (
        "ministral_3_8b_instruct_2512_tainted_heresy_i1_Q4_K_M_GGUF"
    )
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.MINISTRAL_3_8B_INSTRUCT_2512_TAINTED_HERESY_I1_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Ministral-3-8B-Instruct-2512-tainted-heresy-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = (
        ModelVariant.MINISTRAL_3_8B_INSTRUCT_2512_TAINTED_HERESY_I1_Q4_K_M_GGUF
    )

    GGUF_FILE = "Ministral-3-8B-Instruct-2512-tainted-heresy.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Ministral 3 8B Instruct 2512 Tainted Heresy i1 GGUF",
            variant=variant,
