...
"""Unicoil Msmarco Passage model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="castorini/unicoil-msmarco-passage",
        ),
    }
