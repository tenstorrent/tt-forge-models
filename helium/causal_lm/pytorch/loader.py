...
"""
Helium model loader implementation for causal language modeling (PyTorch).
"""
...
class ModelLoader(ForgeModel):
    """Helium model loader implementation for causal language modeling."""
    ...
    DEFAULT_VARIANT = ModelVariant._1_2B
