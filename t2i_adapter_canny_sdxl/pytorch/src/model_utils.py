...
"""
Helper functions for T2I-Adapter Canny SDXL model loading and processing.
"""
...
def load_t2i_adapter_canny_sdxl_pipe(adapter_model_name, base_model_name):
    """Load T2I-Adapter Canny SDXL pipeline.
...
def t2i_adapter_canny_sdxl_preprocessing(
    pipe,
    prompt,
    adapter_image,
    device="cpu",
    ...
    """Preprocess inputs for T2I-Adapter Canny SDXL model.

    Args:
        pipe: StableDiffusionXLAdapterPipeline
        prompt: Text prompt for generation
        adapter_image: Canny edge conditioning image
