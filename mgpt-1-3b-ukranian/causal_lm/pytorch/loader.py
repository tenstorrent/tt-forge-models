...
"""Mgpt 1 3b Ukranian model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="ai-forever/mGPT-1.3B-ukranian",
            max_length=128,
        ),
    }
