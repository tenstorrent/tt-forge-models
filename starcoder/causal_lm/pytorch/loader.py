...
class ModelVariant(StrEnum):
    """Available StarCoder model variants for causal LM."""

    STARCODERBASE_1B = "1b"


class ModelLoader(ForgeModel):
    """StarCoder model loader for causal language modeling tasks."""
    ...
    def decode_output(self, outputs, inputs=None):
        ...
        return [self.tokenizer.decode([t.item()]) for t in next_tokens]
