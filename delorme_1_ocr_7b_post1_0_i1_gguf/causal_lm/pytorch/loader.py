...
"""
mradermacher/Delorme_1-OCR-7B-Post1.0-i1-GGUF model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    """Available Delorme_1-OCR-7B-Post1.0-i1-GGUF model variants for causal language modeling."""

    DELORME_1_OCR_7B_POST1_0_I1_GGUF = "Delorme_1-OCR-7B-Post1.0-i1-GGUF"


class ModelLoader(ForgeModel):
    """Delorme_1-OCR-7B-Post1.0-i1-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.DELORME_1_OCR_7B_POST1_0_I1_GGUF: LLMModelConfig(
            pretrained_model_name="prithivMLmods/Delorme_1-OCR-7B-Post1.0",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.DELORME_1_OCR_7B_POST1_0_I1_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher Delorme_1-OCR-7B-Post1.0-i1-GGUF",
            variant=variant,
