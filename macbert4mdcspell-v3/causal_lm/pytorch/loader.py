...
"""Macbert4mdcspell V3 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Macropodus/macbert4mdcspell_v3",
            max_length=128,
        ),
    }
