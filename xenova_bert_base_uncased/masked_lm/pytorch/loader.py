...
"""Xenova/bert-base-uncased model loader implementation for masked language modeling."""
...
class ModelVariant(StrEnum):
    """Available Xenova/bert-base-uncased model variants."""
...
class ModelLoader(ForgeModel):
    ...
    sample_text = "The goal of life is [MASK]."
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Xenova/bert-base-uncased model instance."""
