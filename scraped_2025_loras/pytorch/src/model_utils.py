...
"""
Helper functions for Scraped 2025 LoRAs SDXL model loading and preprocessing.
"""
...
def load_pipe(base_model: str, lora_repo: str, lora_file: str):
    """Load an SDXL-family pipeline and apply a LoRA adapter.

    Args:
        base_model: HuggingFace repo ID for the base model
        lora_repo: HuggingFace repo ID for the LoRA weights
        lora_file: Filename of the LoRA safetensors weights

    Returns:
        AutoPipelineForText2Image: Pipeline with LoRA fused and components in eval mode
    """
