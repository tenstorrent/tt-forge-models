...
"""
Helper functions for Scraped 2025 LoRAs SDXL model loading and processing.
"""
...
def load_pipe(pretrained_model_name, lora_repo, lora_weight_name):
    """Load an SDXL-family pipeline and apply a LoRA adapter.

    Args:
        pretrained_model_name: HuggingFace base model identifier
        lora_repo: HuggingFace repo containing the LoRA weights
        lora_weight_name: Filename of the LoRA safetensors file

    Returns:
        AutoPipelineForText2Image with LoRA weights loaded and components in eval mode
    """
