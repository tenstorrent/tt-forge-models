...
"""Solar 10 7b Instruct V1 0 128k model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="CallComply/SOLAR-10.7B-Instruct-v1.0-128k",
            max_length=128,
        ),
    }
