...
"""Bert Base German Cased Hatespeech Germeval18coarse model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="deepset/bert-base-german-cased-hatespeech-GermEval18Coarse",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert Base German Cased Hatespeech Germeval18coarse",
