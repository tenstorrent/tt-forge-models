...
class ModelVariant(StrEnum):
    ...
    UMUTEAM_W2V_BERT_BETO_CONCAT_EMOTION_EN = "UMUTeam/w2v-bert-beto-concat-emotion-en"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.UMUTEAM_W2V_BERT_BETO_CONCAT_EMOTION_EN: ModelConfig(
            pretrained_model_name="UMUTeam/w2v-bert-beto-concat-emotion-en",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.UMUTEAM_W2V_BERT_BETO_CONCAT_EMOTION_EN
