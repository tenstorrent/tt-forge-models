...
"""
Qwen 3.5 27B Claude 4.6 Opus Reasoning Distilled GGUF model loader implementation for causal language modeling.
"""
import numpy as np
import torch
...
def _patch_transformers_qwen35_gguf():
    ...
    # Always ensure the qwen3_5_text tokenizer converter is registered,
    # even if another model already patched the qwen35 architecture.
...
class ModelVariant(StrEnum):
    """Available Qwen 3.5 27B Claude 4.6 Opus Reasoning Distilled GGUF model variants for causal language modeling."""

    QWEN_3_5_27B_CLAUDE_4_6_OPUS_REASONING_DISTILLED_GGUF = (
        "27B_Claude_4_6_Opus_Reasoning_Distilled_GGUF"
    )


class ModelLoader(ForgeModel):
    """Qwen 3.5 27B Claude 4.6 Opus Reasoning Distilled GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN_3_5_27B_CLAUDE_4_6_OPUS_REASONING_DISTILLED_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Qwen3.5-27B-Claude-4.6-Opus-Reasoning-Distilled-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN_3_5_27B_CLAUDE_4_6_OPUS_REASONING_DISTILLED_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Qwen 3.5 27B Claude 4.6 Opus Reasoning Distilled GGUF",
            variant=variant,
