...
class ModelVariant(StrEnum):
    """Available Qwen3.5 4B Heretic i1 GGUF model variants for causal language modeling."""

    QWEN3_5_4B_HERETIC_I1_GGUF = "4B_I1_GGUF"
    QWEN3_5_4B_HERETIC_V2_GGUF = "4B_heretic_v2_GGUF"


class ModelLoader(ForgeModel):
    """Qwen3.5 4B Heretic i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.QWEN3_5_4B_HERETIC_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Qwen3.5-4B-heretic-i1-GGUF",
            max_length=128,
        ),
        ModelVariant.QWEN3_5_4B_HERETIC_V2_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Qwen3.5-4B-heretic-v2-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.QWEN3_5_4B_HERETIC_I1_GGUF

    _GGUF_FILES = {
        ModelVariant.QWEN3_5_4B_HERETIC_I1_GGUF: "Qwen3.5-4B-heretic.i1-Q4_K_M.gguf",
        ModelVariant.QWEN3_5_4B_HERETIC_V2_GGUF: "Qwen3.5-4B-heretic-v2.Q4_K_M.gguf",
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Qwen3.5 4B Heretic i1 GGUF",
            variant=variant,
