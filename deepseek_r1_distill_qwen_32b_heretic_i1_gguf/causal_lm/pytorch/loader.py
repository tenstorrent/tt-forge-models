...
class ModelVariant(StrEnum):
    """Available DeepSeek R1 Distill Qwen 32B Heretic i1 GGUF model variants."""

    HF_Q4_K_M = "HF_Q4_K_M"


class ModelLoader(ForgeModel):
    """DeepSeek R1 Distill Qwen 32B Heretic i1 GGUF model loader for causal language modeling."""

    _VARIANTS = {
        ModelVariant.HF_Q4_K_M: LLMModelConfig(
            pretrained_model_name="mradermacher/DeepSeek-R1-Distill-Qwen-32B-heretic-i1-GGUF",
            max_length=128,
        ),
    }
    ...
    GGUF_FILE = "DeepSeek-R1-Distill-Qwen-32B-heretic.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="DeepSeek R1 Distill Qwen 32B Heretic i1 GGUF",
            variant=variant,
