...
"""Japanese Gpt Neox Small model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="rinna/japanese-gpt-neox-small",
            max_length=128,
        ),
    }
