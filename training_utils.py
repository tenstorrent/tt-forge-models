...
_register_attr("DetrObjectDetectionOutput", "logits")
_register_attr("DetrSegmentationOutput", "pred_masks")
_register_attr("DFineObjectDetectionOutput", "logits")
_register_attr("DPRContextEncoderOutput", "pooler_output")
_register_attr("DPRQuestionEncoderOutput", "pooler_output")
...
# MgpstrModelOutput.logits is a 3-tuple (char/bpe/wp predictions); concat along
# last dim to expose all three classification heads to backward.
_register_handler(
    "MgpstrModelOutput", lambda x: torch.cat(x.logits, dim=-1)
)
...
_register_attr("SamImageSegmentationOutput", "pred_masks")
_register_attr("SegFormerImageClassifierOutput", "logits")
_register_attr("SemanticSegmenterOutput", "logits")
...
_register_attr("SwinImageClassifierOutput", "logits")
_register_attr("Swinv2ImageClassifierOutput", "logits")
_register_attr("Swinv2MaskedImageModelingOutput", "reconstruction")
_register_attr("TokenClassifierOutput", "logits")
_register_attr("UNet2DConditionOutput", "sample")
_register_attr("YolosObjectDetectionOutput", "logits")
