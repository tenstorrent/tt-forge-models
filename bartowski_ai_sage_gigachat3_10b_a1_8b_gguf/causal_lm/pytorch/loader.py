...
def _patched_load_gguf_checkpoint(gguf_path, return_tensors=False, **kwargs):
    """Refresh PACKAGE_DISTRIBUTION_MAPPING before loading so that gguf,
    installed at test time via requirements.txt, is visible to
    is_gguf_available() inside load_gguf_checkpoint."""
