...
"""Bert Review Model model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="pavansai-research/bert-review-model",
            max_length=128,
        ),
    }
