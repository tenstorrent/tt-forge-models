...
class ModelVariant(StrEnum):
    """Available Jina Embeddings v5 Text Nano Retrieval GGUF model variants."""

    JINA_EMBEDDINGS_V5_TEXT_NANO_RETRIEVAL_GGUF = (
        "jina-embeddings-v5-text-nano-retrieval-GGUF"
    )


class ModelLoader(ForgeModel):
    """Jina Embeddings v5 Text Nano Retrieval GGUF model loader for embedding generation."""

    _VARIANTS = {
        ModelVariant.JINA_EMBEDDINGS_V5_TEXT_NANO_RETRIEVAL_GGUF: ModelConfig(
            pretrained_model_name="jinaai/jina-embeddings-v5-text-nano-retrieval-GGUF",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.JINA_EMBEDDINGS_V5_TEXT_NANO_RETRIEVAL_GGUF

    GGUF_FILE = "v5-nano-retrieval-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Jina-Embeddings-v5-Text-Nano-Retrieval-GGUF",
            variant=variant,
