...
"""Deberta V3 Base Mnli Fever Docnli Ling 2c model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="MoritzLaurer/DeBERTa-v3-base-mnli-fever-docnli-ling-2c",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Deberta V3 Base Mnli Fever Docnli Ling 2c",
