...
"""Wikibert Base Parsinlu Multiple Choice model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="persiannlp/wikibert-base-parsinlu-multiple-choice",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Wikibert Base Parsinlu Multiple Choice",
