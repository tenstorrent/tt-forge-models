...
"""Qa Bert Seed30 model loader implementation for question answering."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="MaterialsInformaticsLaboratory/QA-BERT-seed30",
            max_length=384,
        ),
    }
