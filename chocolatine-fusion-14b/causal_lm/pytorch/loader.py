...
"""Chocolatine Fusion 14b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="FINGU-AI/Chocolatine-Fusion-14B",
            max_length=128,
        ),
    }
