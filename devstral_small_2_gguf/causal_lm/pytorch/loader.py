...
"""
Devstral Small 2 GGUF model loader implementation for causal language modeling.
"""
import torch
...
def _patch_mistral3_support():
    ...
    Devstral Small 2 uses the mistral3 architecture identifier in its GGUF
    metadata, which transformers 5.x does not yet recognise. The underlying
    model is compatible with the existing mistral config and model classes.
    """
...
class ModelVariant(StrEnum):
    """Available Devstral Small 2 GGUF model variants for causal language modeling."""

    DEVSTRAL_SMALL_2_24B_INSTRUCT_GGUF = "24B_Instruct_GGUF"


class ModelLoader(ForgeModel):
    """Devstral Small 2 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.DEVSTRAL_SMALL_2_24B_INSTRUCT_GGUF: LLMModelConfig(
            pretrained_model_name="lmstudio-community/Devstral-Small-2-24B-Instruct-2512-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.DEVSTRAL_SMALL_2_24B_INSTRUCT_GGUF
