...
"""Gml Mistral Merged V1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="mlabonne/GML-Mistral-merged-v1",
            max_length=128,
        ),
    }
