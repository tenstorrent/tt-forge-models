...
"""Deberta V3 Base Korean model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="team-lucid/deberta-v3-base-korean",
            max_length=128,
        ),
    }
