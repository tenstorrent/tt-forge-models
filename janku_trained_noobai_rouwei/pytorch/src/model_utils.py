...
"""
Helper functions for JANKU Trained NoobAI RouWei Illustrious XL SDXL model loading and processing.
"""
...
def load_pipe(variant):
    """Load JANKU Trained NoobAI RouWei SDXL pipeline.
...
def stable_diffusion_preprocessing_xl(
    ...
    **kwargs,
    ...
    """Preprocess inputs for JANKU Trained NoobAI RouWei SDXL model.
