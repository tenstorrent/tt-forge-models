...
try:
    ...
    # Stubs for CPU-only environments; KimiDeltaAttention layers must be disabled
    # via empty kda_layers in linear_attn_config before these are instantiated.
    ...
    chunk_kda = fused_recurrent_kda = fused_kda_gate = None
    prepare_cu_seqlens_from_mask = prepare_lens_from_mask = None
    tensor_cache = lambda fn: fn
