...
"""
Qwen 3 Coder Next GGUF model loader implementation for causal language modeling.
"""
import torch
...
def _patch_qwen3next_support():
    ...
    Qwen 3 Coder Next uses the same model architecture as Qwen 3 but the GGUF
