...
"""Bert Large Portuguese Cased Legal Tsdae Gpl Nli Sts Metakd V1 model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="stjiris/bert-large-portuguese-cased-legal-tsdae-gpl-nli-sts-MetaKD-v1",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert Large Portuguese Cased Legal Tsdae Gpl Nli Sts Metakd V1",
