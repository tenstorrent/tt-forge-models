...
def _patch_transformers_gemma3n_gguf():
    ...
    the gemma3n architecture. We bridge the gap by registering the config mapping
    and remapping model_type to gemma3n_text (matching the gemma3/gemma3_text pattern).
    """
