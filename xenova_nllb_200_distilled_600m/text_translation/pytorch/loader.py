...
"""
Xenova NLLB-200 distilled 600M model loader implementation for text translation.
"""
...
class ModelVariant(StrEnum):
    """Available Xenova NLLB-200 distilled 600M model variants."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.DISTILLED_600M: LLMModelConfig(
            pretrained_model_name="Xenova/nllb-200-distilled-600M",
        ),
    }
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Xenova NLLB-200 model instance for this instance's variant.
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the Xenova NLLB-200 model with this instance's variant settings.
