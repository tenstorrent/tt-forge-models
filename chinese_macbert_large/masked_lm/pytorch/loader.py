...
"""
Chinese MacBERT Large (hfl/chinese-macbert-large) model loader implementation for masked language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available Chinese MacBERT Large model variants for masked language modeling."""

    CHINESE_MACBERT_LARGE = "hfl/chinese-macbert-large"


class ModelLoader(ForgeModel):
    """Chinese MacBERT Large model loader implementation for masked language modeling."""
    ...
    DEFAULT_VARIANT = ModelVariant.CHINESE_MACBERT_LARGE

    def __init__(self, variant=None):
        super().__init__(variant)
        self.model_name = self._variant_config.pretrained_model_name
        self.sample_text = "北京是中国的[MASK]都。"
        self.max_length = 128
        self.tokenizer = None
