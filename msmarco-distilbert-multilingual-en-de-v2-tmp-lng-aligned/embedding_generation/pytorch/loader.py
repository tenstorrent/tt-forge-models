...
"""Msmarco Distilbert Multilingual En De V2 Tmp Lng Aligned model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="sentence-transformers/msmarco-distilbert-multilingual-en-de-v2-tmp-lng-aligned",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Msmarco Distilbert Multilingual En De V2 Tmp Lng Aligned",
