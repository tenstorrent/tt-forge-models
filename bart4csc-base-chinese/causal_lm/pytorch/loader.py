...
"""Bart4csc Base Chinese model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="shibing624/bart4csc-base-chinese",
            max_length=128,
        ),
    }
