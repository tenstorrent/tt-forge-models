...
from .src.model_utils import load_flux_controlnet_inpainting_beta_pipe


class ModelVariant(StrEnum):
    """Available FLUX ControlNet Inpainting Beta model variants."""

    FLUX_1_DEV_CONTROLNET_INPAINTING_BETA = "FLUX.1-dev-Controlnet-Inpainting-Beta"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.FLUX_1_DEV_CONTROLNET_INPAINTING_BETA: ModelConfig(
            pretrained_model_name="alimama-creative/FLUX.1-dev-Controlnet-Inpainting-Beta",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="FLUX ControlNet Inpainting Beta",
            variant=variant,
    ...
    def _load_pipeline(self, dtype_override=None):
        """Load the FLUX ControlNet Inpainting Beta pipeline.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the FLUX ControlNet Inpainting Beta model.
