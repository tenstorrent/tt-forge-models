...
"""Pubmedbert Base Uncased Sts Combined model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="bcwarner/PubMedBERT-base-uncased-sts-combined",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Pubmedbert Base Uncased Sts Combined",
