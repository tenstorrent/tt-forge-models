...
"""Pythia 12b Sft V8 Rlhf 2k Steps model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="OpenAssistant/pythia-12b-sft-v8-rlhf-2k-steps",
            max_length=128,
        ),
    }
