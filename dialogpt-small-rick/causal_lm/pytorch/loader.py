...
"""Dialogpt Small Rick model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="iamhariraj/DialoGPT-small-Rick",
            max_length=128,
        ),
    }
