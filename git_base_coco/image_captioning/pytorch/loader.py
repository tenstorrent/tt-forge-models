...
"""
GIT (GenerativeImage2Text) Base-COCO image captioning model loader implementation (PyTorch).
"""
...
class ModelVariant(StrEnum):
    """Available GIT Base-COCO image captioning model variants."""

    BASE_COCO = "Base-COCO"


class ModelLoader(ForgeModel):
    """GIT Base-COCO image captioning model loader implementation."""

    _VARIANTS = {
        ModelVariant.BASE_COCO: ModelConfig(
            pretrained_model_name="microsoft/git-base-coco",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BASE_COCO
