...
"""Lamini Docs Finetuned model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="lamini/lamini_docs_finetuned",
            max_length=128,
        ),
    }
