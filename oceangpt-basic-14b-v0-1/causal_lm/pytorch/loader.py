...
"""Oceangpt Basic 14b V0 1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="zjunlp/OceanGPT-basic-14B-v0.1",
            max_length=128,
        ),
    }
