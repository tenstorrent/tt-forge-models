...
"""Claire Mistral 7b 0 1 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="OpenLLM-France/Claire-Mistral-7B-0.1",
            max_length=128,
        ),
    }
