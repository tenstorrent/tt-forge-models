...
"""
Tele-FLM model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Tele-FLM model variants for causal language modeling."""

    TELE_FLM_52B = "52B"


class ModelLoader(ForgeModel):
    """Tele-FLM model loader implementation."""

    _VARIANTS = {
        ModelVariant.TELE_FLM_52B: LLMModelConfig(
            pretrained_model_name="CofeAI/Tele-FLM",
            max_length=256,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.TELE_FLM_52B
