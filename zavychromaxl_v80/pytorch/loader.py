...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the ZavyChromaXL v80 pipeline.

        Returns:
            StableDiffusionXLPipeline: The ZavyChromaXL v80 pipeline instance.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample text prompts for the ZavyChromaXL v80 model.
