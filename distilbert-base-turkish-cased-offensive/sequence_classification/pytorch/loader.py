...
"""Distilbert Base Turkish Cased Offensive model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Overfit-GM/distilbert-base-turkish-cased-offensive",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Distilbert Base Turkish Cased Offensive",
