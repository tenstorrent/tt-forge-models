...
class ModelVariant(StrEnum):
    """Available Qwen 3.5 imatrix GGUF model variants for causal language modeling."""

    IFORLOUYOU_QWEN_3_5_4B_IMATRIX_GGUF = "iforlouyou_4B_imatrix"


class ModelLoader(ForgeModel):
    """Qwen 3.5 imatrix GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.IFORLOUYOU_QWEN_3_5_4B_IMATRIX_GGUF: LLMModelConfig(
            pretrained_model_name="iforlouyou/Qwen3.5-4B-imatrix-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.IFORLOUYOU_QWEN_3_5_4B_IMATRIX_GGUF

    _GGUF_FILES = {
        ModelVariant.IFORLOUYOU_QWEN_3_5_4B_IMATRIX_GGUF: "Qwen3.5-4B-imatrix-Q4_K_M.gguf",
    }
