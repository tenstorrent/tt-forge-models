...
"""Acemath Rl Nemotron 7b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="nvidia/AceMath-RL-Nemotron-7B",
            max_length=128,
        ),
    }
