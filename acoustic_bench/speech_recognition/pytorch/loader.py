...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        cfg = {
            "pretrained_llm": self._variant_config.pretrained_model_name,
    ...
    def load_inputs(self, dtype_override=None):
        # SALM.forward() takes pre-combined audio+text embeddings.
        # Sequence length: ~13 audio tokens/s (16kHz, 10ms frames, 8x subsampling)
        # plus a short text prompt.
        batch_size = 1
        seq_len = 32
