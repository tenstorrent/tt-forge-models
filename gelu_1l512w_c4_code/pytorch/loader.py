...
class ModelVariant(StrEnum):
    """Available GELU 1L512W C4 Code model variants."""

    DEFAULT = "default"


class ModelLoader(ForgeModel):
    """GELU 1L512W C4 Code model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="NeelNanda/GELU_1L512W_C4_Code",
            max_length=256,
        ),
    }
