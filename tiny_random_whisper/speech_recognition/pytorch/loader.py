...
"""
Tiny Random Whisper model loader implementation for speech recognition (ASR).
"""
...
class ModelLoader(ForgeModel):
    """Tiny Random Whisper model loader for speech recognition (ASR) tasks."""
