...
class ModelVariant(StrEnum):
    ...
    MRADERMACHER_PHI_4_Q4_K_M = "mradermacher_Phi_4_Q4_K_M"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.MRADERMACHER_PHI_4_Q4_K_M: LLMModelConfig(
            pretrained_model_name="mradermacher/phi-4-GGUF",
            max_length=128,
        ),
    }
    ...
    _GGUF_FILES = {
        ModelVariant.PHI_4_GGUF: "phi-4-Q4_K_M.gguf",
        ModelVariant.MRADERMACHER_PHI_4_Q4_K_M: "phi-4.Q4_K_M.gguf",
    }
