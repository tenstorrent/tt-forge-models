...
class ModelVariant(StrEnum):
    """Available CLIP ViT-Base/32 SVHN model variants."""

    BASE_PATCH32_SVHN = "Base_Patch32_SVHN"


class ModelLoader(ForgeModel):
    """CLIP ViT-Base/32 SVHN model loader for image feature extraction."""

    _VARIANTS = {
        ModelVariant.BASE_PATCH32_SVHN: ModelConfig(
            pretrained_model_name="tanganke/clip-vit-base-patch32_svhn",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BASE_PATCH32_SVHN
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="CLIP_ViT_Base_Patch32_SVHN",
            variant=variant,
