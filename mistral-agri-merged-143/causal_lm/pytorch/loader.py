...
"""Mistral Agri Merged 143 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="chanystrange/mistral-agri-merged_143",
            max_length=128,
        ),
    }
