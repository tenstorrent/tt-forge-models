...
"""Sentence Transformers Multilingual E5 Large model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="smart-tribune/sentence-transformers-multilingual-e5-large",
        ),
    }
