...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.QWEN_1_5_7B_CHAT: LLMModelConfig(
            pretrained_model_name="Qwen/Qwen1.5-7B-Chat",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        variant_groups = {
            ...
            ModelVariant.QWEN_1_5_7B_CHAT: ModelGroup.VULCAN,
        }
