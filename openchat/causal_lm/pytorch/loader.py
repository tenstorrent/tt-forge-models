...
"""
OpenChat model loader implementation for causal language modeling.
"""
import torch
...
class ModelLoader(ForgeModel):
    """OpenChat model loader implementation for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.OPENCHAT_3_6_8B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the OpenChat model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The OpenChat model instance for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the OpenChat model.
