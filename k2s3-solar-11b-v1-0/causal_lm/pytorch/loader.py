...
"""K2s3 Solar 11b V1 0 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Changgil/K2S3-SOLAR-11b-v1.0",
            max_length=128,
        ),
    }
