...
"""
FLUX.2 Klein 9B Models LoRA loader implementation.

Loads the FLUX.2 Klein base pipeline and applies a likeness LoRA weight
file from pmczip/FLUX.2-klein-9B_Models, a collection of LoRA adapters
trained on top of FLUX.2-klein-base-9B for text-to-image generation.

Available variants:
- ALEX_KINGSTON: Alex Kingston PMv1a LoRA applied to FLUX.2 Klein
"""
...
LORA_REPO = "pmczip/FLUX.2-klein-9B_Models"
LORA_WEIGHT_NAME = "Alex_Kingston_PMv1a_F2KleinB.safetensors"


class ModelVariant(StrEnum):
    """Available FLUX.2 Klein 9B Models LoRA variants."""

    ALEX_KINGSTON = "AlexKingston"


class ModelLoader(ForgeModel):
    """FLUX.2 Klein 9B Models LoRA loader."""

    _VARIANTS = {
        ModelVariant.ALEX_KINGSTON: ModelConfig(
            pretrained_model_name=BASE_MODEL,
        ),
    }
    DEFAULT_VARIANT = ModelVariant.ALEX_KINGSTON
    ...
    def load_model(
        ...
        **kwargs,
        ...
        """Load the FLUX.2 Klein pipeline with the selected LoRA weights applied.
