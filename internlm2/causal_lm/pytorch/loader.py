...
class ModelLoader(ForgeModel):
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        # Load config first and fix rope_scaling for compatibility with the
        # custom modeling code which expects rope_scaling["type"] (legacy key).
        # Newer transformers versions emit {"rope_type": "default", ...} which
        # triggers a KeyError in the vendored InternLM2 attention init.
