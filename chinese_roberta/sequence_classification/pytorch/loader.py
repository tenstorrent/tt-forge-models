...
class ModelLoader(ForgeModel):
    """Chinese RoBERTa model loader for sequence classification."""

    _VARIANTS = {
        ModelVariant.JD_BINARY: LLMModelConfig(
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load Chinese RoBERTa model for sequence classification from Hugging Face."""
    ...
    def load_inputs(self, dtype_override=None):
        """Prepare sample input for Chinese RoBERTa sequence classification."""
