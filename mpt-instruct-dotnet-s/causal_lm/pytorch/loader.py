...
"""Mpt Instruct Dotnet S model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="Nethermind/Mpt-Instruct-DotNet-S",
            max_length=128,
        ),
    }
