...
"""Xuyuan Trial Sentiment Bert Chinese model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="touch20032003/xuyuan-trial-sentiment-bert-chinese",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Xuyuan Trial Sentiment Bert Chinese",
