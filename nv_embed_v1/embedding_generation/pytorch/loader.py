...
"""
NV-Embed-v1 model loader implementation for sentence embedding generation.
"""
...
class ModelVariant(StrEnum):
    """Available NV-Embed-v1 model variants for embedding generation."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.NV_EMBED_V1: ModelConfig(
            pretrained_model_name="nvidia/NV-Embed-v1",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.NV_EMBED_V1
