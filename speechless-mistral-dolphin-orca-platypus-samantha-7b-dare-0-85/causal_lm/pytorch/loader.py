...
"""Speechless Mistral Dolphin Orca Platypus Samantha 7b Dare 0 85 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="uukuguy/speechless-mistral-dolphin-orca-platypus-samantha-7b-dare-0.85",
            max_length=128,
        ),
    }
