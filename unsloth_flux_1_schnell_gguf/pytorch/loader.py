...
Repository:
- https://huggingface.co/unsloth/FLUX.1-schnell-GGUF
"""
import torch
...
GGUF_BASE_URL = "https://huggingface.co/unsloth/FLUX.1-schnell-GGUF/blob/main"


class ModelVariant(StrEnum):
    """Available Unsloth FLUX.1-schnell GGUF model variants."""
...
class ModelLoader(ForgeModel):
    """Unsloth FLUX.1-schnell GGUF model loader implementation for text-to-image tasks."""

    _VARIANTS = {
        ModelVariant.Q4_K_M: ModelConfig(
            pretrained_model_name="unsloth/FLUX.1-schnell-GGUF",
        ),
