...
"""Plantl Gob Es Roberta Base Bne Copy model loader implementation for masked language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="PeterPanecillo/PlanTL-GOB-ES-roberta-base-bne-copy",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Plantl Gob Es Roberta Base Bne Copy",
