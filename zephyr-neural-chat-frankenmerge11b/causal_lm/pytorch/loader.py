...
"""Zephyr Neural Chat Frankenmerge11b model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="S4sch/zephyr-neural-chat-frankenmerge11b",
            max_length=128,
        ),
    }
