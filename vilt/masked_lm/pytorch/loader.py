...
class ModelLoader(ForgeModel):
    """ViLT model loader implementation for masked language modeling tasks."""

    # Dictionary of available model variants using structured configs
    _VARIANTS = {
        ModelVariant.MLM: ModelConfig(
            pretrained_model_name="dandelin/vilt-b32-mlm",
        ),
    }

    # Default variant to use
    DEFAULT_VARIANT = ModelVariant.MLM

    # Shared configuration parameters
    text = "a bunch of cats laying on a [MASK]."
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        ...
        Returns:
            torch.nn.Module: The ViLT model instance for masked language modeling.
        """
