...
"""Sentence T5 Base Nlpl Code Search Net model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="krlvi/sentence-t5-base-nlpl-code_search_net",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Sentence T5 Base Nlpl Code Search Net",
