...
class ModelVariant(StrEnum):
    """Available FLUX.2 Klein FP8 model variants."""

    KLEIN_9B_KV_FP8 = "Klein_9B_KV_FP8"


class ModelLoader(ForgeModel):
    """FLUX.2 Klein 9B KV FP8 model loader for text-to-image generation."""

    _VARIANTS = {
        ModelVariant.KLEIN_9B_KV_FP8: ModelConfig(
            pretrained_model_name="black-forest-labs/FLUX.2-klein-9b-kv-fp8",
        ),
    }
