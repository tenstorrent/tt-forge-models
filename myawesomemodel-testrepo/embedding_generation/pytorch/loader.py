...
"""Myawesomemodel Testrepo model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="3006-sa-toolathlon/MyAwesomeModel-TestRepo",
        ),
    }
