...
"""Dionysus Mistral M3 V6 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="decem/Dionysus-Mistral-m3-v6",
            max_length=128,
        ),
    }
