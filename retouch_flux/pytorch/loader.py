...
"""
TDN-M/RetouchFLux model loader implementation.

Loads the FLUX.1-dev base pipeline and applies the RetouchFLux LoRA
from TDN-M/RetouchFLux for enhanced text-to-image generation with
improved color consistency, noise reduction, sharpness and vibrancy.

Repository: https://huggingface.co/TDN-M/RetouchFLux
"""
...
LORA_FILENAME = "TDNM_Retouch.safetensors"


class ModelVariant(StrEnum):
    """Available TDN-M/RetouchFLux model variants."""

    RETOUCH_FLUX = "RetouchFLux"


class ModelLoader(ForgeModel):
    """TDN-M/RetouchFLux model loader for text-to-image generation."""

    _VARIANTS = {
        ModelVariant.RETOUCH_FLUX: ModelConfig(
            pretrained_model_name=BASE_MODEL,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.RETOUCH_FLUX
    ...
    def _load_pipeline(self, dtype_override=None):
        """Load FLUX.1-dev pipeline and apply RetouchFLux LoRA."""
        ...
        # Apply RetouchFLux LoRA for enhanced image quality
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the FLUX transformer with RetouchFLux LoRA applied.
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        prompt = "A young woman with a bright smile, enhance, hdr"
