...
"""
Sapphira L3.3 70B model loader implementation for causal language modeling.
"""
...
class ModelLoader(ForgeModel):
    """Sapphira L3.3 70B model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.SAPPHIRA_L3_3_70B_0_2: LLMModelConfig(
