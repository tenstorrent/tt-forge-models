...
"""Xlm R Finetuned Toxic Political Tweets Es model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Newtral/xlm-r-finetuned-toxic-political-tweets-es",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Xlm R Finetuned Toxic Political Tweets Es",
