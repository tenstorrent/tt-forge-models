...
"""Minicpm 2b Sft Fp32 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="openbmb/MiniCPM-2B-sft-fp32",
            max_length=128,
        ),
    }
