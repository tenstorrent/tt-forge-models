...
"""Simcse Dist Mpnet Paracrawl Cs En model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="Seznam/simcse-dist-mpnet-paracrawl-cs-en",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Simcse Dist Mpnet Paracrawl Cs En",
