...
"""
Megamind v2 VL high i1 GGUF model loader implementation for image to text.
"""
...
def _find_real_load_gguf():
    ...
    in transformers 5.2.0. We BFS both global and closure paths to find the
...
class ModelVariant(StrEnum):
    """Available Megamind v2 VL high i1 GGUF model variants for image to text."""

    MEGAMIND_V2_VL_HIGH_I1_GGUF = "v2_vl_high_i1_gguf"


class ModelLoader(ForgeModel):
    """Megamind v2 VL high i1 GGUF model loader implementation for image to text tasks."""

    _VARIANTS = {
        ModelVariant.MEGAMIND_V2_VL_HIGH_I1_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/Megamind-v2-VL-high-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MEGAMIND_V2_VL_HIGH_I1_GGUF

    GGUF_FILE = "Megamind-v2-VL-high.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        ...
        return ModelInfo(
            model="Megamind v2 VL high i1 GGUF",
            variant=variant,
