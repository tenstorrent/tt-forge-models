...
class ModelVariant(StrEnum):
    """Available LatentDream Exp Delta 8B GGUF model variants for causal language modeling."""

    LATENTDREAM_EXP_DELTA_8B_GGUF = "LatentDream_Exp_Delta_8B_GGUF"


class ModelLoader(ForgeModel):
    """LatentDream Exp Delta 8B GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.LATENTDREAM_EXP_DELTA_8B_GGUF: LLMModelConfig(
            pretrained_model_name="mradermacher/LatentDream-exp-delta-8b-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.LATENTDREAM_EXP_DELTA_8B_GGUF

    GGUF_FILE = "LatentDream-exp-delta-8b.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="LatentDream Exp Delta 8B GGUF",
            variant=variant,
