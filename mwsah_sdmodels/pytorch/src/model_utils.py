...
def load_sdmodels_gguf_pipe(repo_id: str, gguf_filename: str, base_model: str):
    """Load a FLUX pipeline with a GGUF-quantized transformer.
    ...
    Returns:
        FluxPipeline: Loaded pipeline with GGUF-quantized transformer.
    """
...
def sdmodels_preprocessing(
    ...
    """Preprocess inputs for the HyperFlux Dedistilled transformer model.
