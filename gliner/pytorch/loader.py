...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.GLINER_SMALL_PII: ModelConfig(
            pretrained_model_name="vicgalle/gliner-small-pii"
        ),
    }
    ...
    def load_model(self, **kwargs):
        ...
        # packed sequence lengths at trace time, failing on XLA lazy tensors and
        # triggering an LLVM ArrayRef bounds assertion in the CPU-fallback partitioner.
        #
        ...
        # processed from zero hidden state, matching packed-sequence behavior.
        ...
        for i, output in enumerate(outputs):
            ...
            for start_token_idx, end_token_idx, ent_type, ent_score in output:
                ...
                ent_details = {
                    ...
                    "end": end_text_idx,
                    "text": self.texts[i][start_text_idx:end_text_idx],
                    "label": ent_type,
                    "score": ent_score,
                }
