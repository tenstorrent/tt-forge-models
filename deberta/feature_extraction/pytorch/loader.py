...
"""
DeBERTa V2 model loader implementation for feature extraction.
"""
...
class ModelVariant(StrEnum):
    """Available DeBERTa V2 model variants for feature extraction."""
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ModelVariant.TINY_RANDOM: LLMModelConfig(
            pretrained_model_name="peft-internal-testing/tiny-random-DebertaV2Model",
            max_length=128,
        ),
    }
