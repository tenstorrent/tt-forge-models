...
class ModelVariant(StrEnum):
    """Available LongCat-Flash-Lite GGUF model variants for causal language modeling."""

    LONGCAT_FLASH_LITE_GGUF = "LongCat_Flash_Lite_GGUF"


class ModelLoader(ForgeModel):
    """LongCat-Flash-Lite GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.LONGCAT_FLASH_LITE_GGUF: LLMModelConfig(
            pretrained_model_name="InquiringMinds-AI/LongCat-Flash-Lite-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.LONGCAT_FLASH_LITE_GGUF

    GGUF_FILE = "LongCat-Flash-Lite-Q4_K_M.gguf"
