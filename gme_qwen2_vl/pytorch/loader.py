...
"""
GME Qwen2-VL model loader implementation for multimodal embedding tasks.
"""
import torch
...
class ModelLoader(ForgeModel):
    """GME Qwen2-VL model loader for multimodal embedding tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.GME_QWEN2_VL_2B_INSTRUCT
