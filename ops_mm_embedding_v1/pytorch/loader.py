...
"""
Ops-MM-embedding-v1 model loader implementation for multimodal embedding tasks.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Ops-MM-embedding-v1 model variants."""

    OPS_MM_EMBEDDING_V1_2B = "2B"


class ModelLoader(ForgeModel):
    """Ops-MM-embedding-v1 model loader for multimodal embedding tasks."""

    _VARIANTS = {
        ModelVariant.OPS_MM_EMBEDDING_V1_2B: ModelConfig(
            pretrained_model_name="OpenSearch-AI/Ops-MM-embedding-v1-2B",
        ),
    }

    DEFAULT_VARIANT = ModelVariant.OPS_MM_EMBEDDING_V1_2B
