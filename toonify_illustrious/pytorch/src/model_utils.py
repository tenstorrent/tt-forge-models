...
"""
Helper functions for Toonify Illustrious SDXL model loading and processing.
"""
...
def load_pipe(variant):
    """Load Toonify Illustrious SDXL pipeline.
...
def stable_diffusion_preprocessing_xl(
    ...
    **kwargs,
    ...
    """Preprocess inputs for Toonify Illustrious SDXL model.
