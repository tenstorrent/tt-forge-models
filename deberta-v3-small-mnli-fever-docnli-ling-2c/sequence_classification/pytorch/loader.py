...
"""Deberta V3 Small Mnli Fever Docnli Ling 2c model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="MoritzLaurer/DeBERTa-v3-small-mnli-fever-docnli-ling-2c",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Deberta V3 Small Mnli Fever Docnli Ling 2c",
