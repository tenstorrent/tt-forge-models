...
"""
AaryanK Mistral Small 4 119B 2603 GGUF model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available AaryanK Mistral Small 4 119B 2603 GGUF model variants for causal language modeling."""

    MISTRAL_SMALL_4_119B_Q4_K_M_GGUF = "119B_Q4_K_M_GGUF"


class ModelLoader(ForgeModel):
    """AaryanK Mistral Small 4 119B 2603 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MISTRAL_SMALL_4_119B_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="AaryanK/Mistral-Small-4-119B-2603-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MISTRAL_SMALL_4_119B_Q4_K_M_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="AaryanK Mistral Small 4 119B 2603 GGUF",
            variant=variant,
