...
"""Dfm Sentence Encoder Large Exp2 No Lang Align model loader implementation for embedding generation."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="KennethEnevoldsen/dfm-sentence-encoder-large-exp2-no-lang-align",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Dfm Sentence Encoder Large Exp2 No Lang Align",
