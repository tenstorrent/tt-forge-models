...
"""
ResNeSt model loader implementation
"""
...
class ResNeStConfig(ModelConfig):
    """Configuration specific to ResNeSt models"""
...
class ModelVariant(StrEnum):
    ...
    RESNEST_26D_GLUON_IN1K = "ResNeSt26d_Gluon_IN1K"
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.RESNEST_26D_GLUON_IN1K: ResNeStConfig(
            pretrained_model_name="hf_hub:timm/resnest26d.gluon_in1k",
            source=ModelSource.TIMM,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.RESNEST_50D_IN1K
