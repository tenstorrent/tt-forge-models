...
"""Llm Jp 13b Instruct Full Jaster Dolly Oasst V1 0 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="llm-jp/llm-jp-13b-instruct-full-jaster-dolly-oasst-v1.0",
            max_length=128,
        ),
    }
