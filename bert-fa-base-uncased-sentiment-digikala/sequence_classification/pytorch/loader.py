...
"""Bert Fa Base Uncased Sentiment Digikala model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="HooshvareLab/bert-fa-base-uncased-sentiment-digikala",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Bert Fa Base Uncased Sentiment Digikala",
