...
"""
mradermacher/MetaphorStar-32B-i1-GGUF model loader implementation for causal language modeling.
...
class ModelVariant(StrEnum):
    """Available MetaphorStar-32B-i1-GGUF model variants for causal language modeling."""

    METAPHOR_STAR_32B_I1_GGUF = "32B_i1_GGUF"


class ModelLoader(ForgeModel):
    """MetaphorStar-32B-i1-GGUF model loader implementation for causal language modeling tasks.
    ...
    _VARIANTS = {
        ModelVariant.METAPHOR_STAR_32B_I1_GGUF: LLMModelConfig(
            pretrained_model_name="MING-ZCH/MetaphorStar-32B",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.METAPHOR_STAR_32B_I1_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="mradermacher MetaphorStar-32B-i1-GGUF",
            variant=variant,
