...
"""Small Language Model Mha 53m Pretrained model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="NamrataThakur/Small_Language_Model_MHA_53M_Pretrained",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Small Language Model Mha 53m Pretrained",
