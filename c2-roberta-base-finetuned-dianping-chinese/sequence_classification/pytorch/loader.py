...
"""C2 Roberta Base Finetuned Dianping Chinese model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="liam168/c2-roberta-base-finetuned-dianping-chinese",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="C2 Roberta Base Finetuned Dianping Chinese",
