...
"""Distilroberta Finetuned Financial Text Classification model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="nickmuchi/distilroberta-finetuned-financial-text-classification",
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Distilroberta Finetuned Financial Text Classification",
