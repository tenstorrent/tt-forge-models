...
"""Deutsch A2 Transformer model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="kengurukleo/deutsch_a2_transformer",
            max_length=128,
        ),
    }
