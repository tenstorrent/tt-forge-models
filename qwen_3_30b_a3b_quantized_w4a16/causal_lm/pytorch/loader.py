...
"""
RedHatAI Qwen3-30B-A3B quantized W4A16 model loader implementation for causal language modeling.
"""
import torch
...
class ModelLoader(ForgeModel):
    """RedHatAI Qwen3-30B-A3B quantized W4A16 model loader for causal language modeling tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.QWEN_3_30B_A3B_QUANTIZED_W4A16
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Qwen3-30B-A3B Quantized W4A16",
            variant=variant,
