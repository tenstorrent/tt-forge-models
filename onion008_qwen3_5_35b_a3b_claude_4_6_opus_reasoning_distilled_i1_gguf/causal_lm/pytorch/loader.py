...
"""
Onion008 Qwen3.5 35B-A3B Claude 4.6 Opus Reasoning Distilled i1 GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available Onion008 Qwen3.5 35B-A3B Claude 4.6 Opus Reasoning Distilled i1 GGUF model variants for causal language modeling."""

    ONION008_QWEN3_5_35B_A3B_CLAUDE_4_6_OPUS_REASONING_DISTILLED_I1_Q4_K_M_GGUF = (
        "35B_A3B_CLAUDE_4_6_OPUS_REASONING_DISTILLED_I1_Q4_K_M_GGUF"
    )


class ModelLoader(ForgeModel):
    """Onion008 Qwen3.5 35B-A3B Claude 4.6 Opus Reasoning Distilled i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.ONION008_QWEN3_5_35B_A3B_CLAUDE_4_6_OPUS_REASONING_DISTILLED_I1_Q4_K_M_GGUF: LLMModelConfig(
            pretrained_model_name="Onion008/Qwen3.5-35B-A3B-Claude-4.6-Opus-Reasoning-Distilled-i1-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = (
        ModelVariant.ONION008_QWEN3_5_35B_A3B_CLAUDE_4_6_OPUS_REASONING_DISTILLED_I1_Q4_K_M_GGUF
    )

    GGUF_FILE = "Qwen3.5-35B-A3B-Claude-4.6-Opus-Reasoning-Distilled.i1-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Onion008 Qwen3.5 35B-A3B Claude 4.6 Opus Reasoning Distilled i1 GGUF",
            variant=variant,
