...
"""Messier Opus 14b Elite7 model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="prithivMLmods/Messier-Opus-14B-Elite7",
            max_length=128,
        ),
    }
