...
def _fix_gguf_patch():
    ...
    get_gguf_hf_weights_map so that loaders patching that function (e.g.
    onion008) receive a valid model instead of None.
    """
...
class ModelVariant(StrEnum):
    """Available Mistral-Nemo-Gutenberg-Vitus-12B imatrix GGUF model variants for causal language modeling."""

    MISTRAL_NEMO_GUTENBERG_VITUS_12B_Q4_K_M = "12B_Q4_K_M"


class ModelLoader(ForgeModel):
    """Mistral-Nemo-Gutenberg-Vitus-12B imatrix GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.MISTRAL_NEMO_GUTENBERG_VITUS_12B_Q4_K_M: LLMModelConfig(
            pretrained_model_name="duyntnet/Mistral-Nemo-Gutenberg-Vitus-12B-imatrix-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MISTRAL_NEMO_GUTENBERG_VITUS_12B_Q4_K_M

    GGUF_FILE = "Mistral-Nemo-Gutenberg-Vitus-12B-Q4_K_M.gguf"
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Mistral-Nemo-Gutenberg-Vitus-12B imatrix GGUF",
            variant=variant,
