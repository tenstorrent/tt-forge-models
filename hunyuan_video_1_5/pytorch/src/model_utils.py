...
"""
Component loaders and wrappers for HunyuanVideo 1.5 (480p t2v, non-distilled base).

Model: hunyuanvideo-community/HunyuanVideo-1.5-Diffusers-480p_t2v
       (diffusers conversion of tencent/HunyuanVideo-1.5, 480p text-to-video)
Components:
...
This is the full (non-distilled) base checkpoint. It is architecturally
identical to the distilled sibling in `hunyuan_1_5` (same diffusers classes,
same tensor shapes); the difference is the trained weights and the recommended
number of denoising steps (the base model uses ~50 steps with CFG, the distilled
sibling 8-12). The wrappers and SPMD shard specs are therefore shared verbatim.
"""
