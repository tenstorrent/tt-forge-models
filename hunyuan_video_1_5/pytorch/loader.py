...
"""
HunyuanVideo 1.5 (480p t2v, non-distilled base) component loader.
...
This is the full (non-distilled) base checkpoint of tencent/HunyuanVideo-1.5,
the text-to-video sibling of the distilled `hunyuan_1_5` loader. The
architecture, tensor shapes and SPMD shard layout are identical; only the
trained weights (REPO_ID) and recommended denoising-step count differ.
"""
...
_REPO_ID = "hunyuanvideo-community/HunyuanVideo-1.5-Diffusers-480p_t2v"


class ModelVariant(StrEnum):
    """Loadable components of the HunyuanVideo 1.5 (base) pipeline."""
...
class ModelLoader(ForgeModel):
    """Load individual HunyuanVideo 1.5 (base) components without pulling the full pipeline."""
