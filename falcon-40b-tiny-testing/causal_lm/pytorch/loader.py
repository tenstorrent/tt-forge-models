...
"""Falcon 40b Tiny Testing model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="BlackSamorez/falcon-40b-tiny-testing",
            max_length=128,
        ),
    }
