...
"""
BERT Base Cantonese model loader implementation for masked language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available BERT Base Cantonese model variants for masked language modeling."""
...
class ModelLoader(ForgeModel):
    ...
    DEFAULT_VARIANT = ModelVariant.BERT_BASE_CANTONESE

    def __init__(self, variant=None):
        super().__init__(variant)
        self.model_name = self._variant_config.pretrained_model_name
        self.sample_text = "香港原本[MASK]一個人煙稀少嘅漁港。"
        self.max_length = 128
        self.tokenizer = None
