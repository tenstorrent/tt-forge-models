...
"""Ogno 7b Dpo Truthful model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="eren23/OGNO-7b-dpo-truthful",
            max_length=128,
        ),
    }
