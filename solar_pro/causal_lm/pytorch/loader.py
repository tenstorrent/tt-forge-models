...
"""
Solar Pro Preview Instruct causal LM model loader implementation.
"""
...
class ModelVariant(StrEnum):
    """Available Solar Pro model variants for causal language modeling."""

    SOLAR_PRO_PREVIEW_INSTRUCT = "pro_preview_instruct"


class ModelLoader(ForgeModel):
    """Solar Pro model loader implementation for causal language modeling tasks."""
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Solar Pro model instance for this instance's variant.
        ...
        Returns:
            torch.nn.Module: The Solar Pro model for causal language modeling.
        """
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        """Load and return sample inputs for the Solar Pro model with this instance's variant settings.
