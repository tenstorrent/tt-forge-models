...
"""Japanese Gpt2 Medium model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="rinna/japanese-gpt2-medium",
            max_length=128,
        ),
    }
