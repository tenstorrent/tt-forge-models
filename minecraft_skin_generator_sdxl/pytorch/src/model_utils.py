...
"""
Helper functions for Minecraft Skin Generator SDXL model loading and processing.
"""
...
def load_pipe(variant):
    """Load Minecraft Skin Generator SDXL pipeline.
    ...
    # Ensure all modules are float32 and on CPU
...
def stable_diffusion_preprocessing_xl(
    ...
    **kwargs,
    ...
    """Preprocess inputs for Minecraft Skin Generator SDXL model.
    ...
    Args:
        ...
        height: Image height (optional, defaults to 768)
    ...
    """
    # Default to 768x768 for Minecraft skin generation
