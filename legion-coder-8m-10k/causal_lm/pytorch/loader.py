...
"""Legion Coder 8m 10k model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="dineth554/legion-coder-8m-10k",
            max_length=128,
        ),
    }
