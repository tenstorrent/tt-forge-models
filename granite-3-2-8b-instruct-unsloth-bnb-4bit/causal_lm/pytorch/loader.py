...
"""Granite 3 2 8b Instruct Unsloth Bnb 4bit model loader implementation for causal language modeling."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: LLMModelConfig(
            pretrained_model_name="unsloth/granite-3.2-8b-instruct-unsloth-bnb-4bit",
            max_length=128,
        ),
    }
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Granite 3 2 8b Instruct Unsloth Bnb 4bit",
