...
"""
Benasd/Qwen3.5-4B-Instruct GGUF model loader implementation for causal language modeling.
"""
...
class ModelVariant(StrEnum):
    """Available Benasd/Qwen3.5-4B-Instruct GGUF model variants for causal language modeling."""

    BENASD_QWEN3_5_4B_INSTRUCT_GGUF = "4B_Instruct_GGUF"


class ModelLoader(ForgeModel):
    """Benasd/Qwen3.5-4B-Instruct GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.BENASD_QWEN3_5_4B_INSTRUCT_GGUF: LLMModelConfig(
            pretrained_model_name="Benasd/Qwen3.5-4B-Instruct-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.BENASD_QWEN3_5_4B_INSTRUCT_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Benasd Qwen3.5-4B-Instruct GGUF",
            variant=variant,
