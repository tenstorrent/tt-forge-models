...
"""
HY-MT1.5 GGUF model loader implementation for causal language modeling.
"""
import torch
...
def _patch_transformers_hunyuan_dense_gguf():
    ...
    for name in ("hunyuan-dense", "hunyuan_v1_dense"):
...
class ModelVariant(StrEnum):
    """Available HY-MT1.5 GGUF model variants for causal language modeling."""

    HY_MT1_5_1_8B_Q4_K_M = "1.8B_Q4_K_M"


class ModelLoader(ForgeModel):
    """HY-MT1.5 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.HY_MT1_5_1_8B_Q4_K_M: LLMModelConfig(
            pretrained_model_name="tencent/HY-MT1.5-1.8B-GGUF",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.HY_MT1_5_1_8B_Q4_K_M

    GGUF_FILE = "HY-MT1.5-1.8B-Q4_K_M.gguf"
