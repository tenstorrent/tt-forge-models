...
"""
frankjoshua/FLUX.1-dev model loader implementation for text-to-image generation.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available frankjoshua/FLUX.1-dev model variants."""

    DEFAULT = "Default"


class ModelLoader(ForgeModel):
    """frankjoshua/FLUX.1-dev model loader for text-to-image generation tasks."""

    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="frankjoshua/FLUX.1-dev",
        ),
    }
