...
class ModelLoader(ForgeModel):
    """Qwen 2.5 Omni Thinker model loader implementation for multimodal tasks."""
    ...
    DEFAULT_VARIANT = ModelVariant.QWEN_2_5_OMNI_7B
    ...
    def load_model(self, *, dtype_override=None, **kwargs):
        """Load and return the Qwen 2.5 Omni Thinker model instance."""
    ...
    def load_inputs(self, dtype_override=None):
        """Load and return sample inputs for the Qwen 2.5 Omni model."""
