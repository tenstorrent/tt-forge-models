...
"""
CamemBERT masked language model loader.
CamemBERT is a RoBERTa-based French language model trained on the OSCAR corpus.
"""
import torch
...
class ModelLoader(ForgeModel):
    ...
    _VARIANTS = {
        ...
        ModelVariant.CAMEMBERT_BASE_LEGACY: ModelConfig(
            pretrained_model_name="almanach/camembert-base-legacy",
        ),
    ...
    DEFAULT_VARIANT = ModelVariant.CAMEMBERT_BASE
    ...
    def load_inputs(self, dtype_override=None, batch_size=1):
        ...
        test_input = "Le camembert est un fromage de <mask>."
