...
"""Distilbert Base Uncased Finetuned Emotion model loader implementation for sequence classification."""
...
class ModelLoader(ForgeModel):
    _VARIANTS = {
        ModelVariant.DEFAULT: ModelConfig(
            pretrained_model_name="esuriddick/distilbert-base-uncased-finetuned-emotion",
        ),
    }
