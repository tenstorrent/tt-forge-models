...
"""
Gemma 3 27B IT VL Heretic GGUF model loader implementation for causal language modeling.
"""
import torch
...
class ModelLoader(ForgeModel):
    """Gemma 3 27B IT VL Heretic GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.GEMMA_3_27B_IT_VL_HERETIC_GGUF: LLMModelConfig(
    ...
    DEFAULT_VARIANT = ModelVariant.GEMMA_3_27B_IT_VL_HERETIC_GGUF
    ...
    def _get_model_info(cls, variant: Optional[ModelVariant] = None) -> ModelInfo:
        return ModelInfo(
            model="Gemma 3 27B IT VL Heretic GGUF",
            variant=variant,
