...
"""
openNemo-9B i1 GGUF model loader implementation for causal language modeling.

Note: The nemotron_h architecture is not supported in GGUF format by transformers,
so this loader uses the base safetensors model from empero-ai instead.
...
class ModelVariant(StrEnum):
    """Available openNemo-9B i1 GGUF model variants for causal language modeling."""

    OPEN_NEMO_9B_I1_GGUF = "9B_i1_GGUF"


class ModelLoader(ForgeModel):
    """openNemo-9B i1 GGUF model loader implementation for causal language modeling tasks."""

    _VARIANTS = {
        ModelVariant.OPEN_NEMO_9B_I1_GGUF: LLMModelConfig(
            pretrained_model_name="empero-ai/openNemo-9B",
            max_length=128,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.OPEN_NEMO_9B_I1_GGUF
