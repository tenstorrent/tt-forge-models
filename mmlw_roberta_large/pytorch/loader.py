...
"""
sdadas/mmlw-roberta-large model loader for Polish sentence embedding generation.
"""
import torch
...
class ModelVariant(StrEnum):
    """Available model variants for mmlw-roberta-large."""

    MMLW_ROBERTA_LARGE = "sdadas/mmlw-roberta-large"


class ModelLoader(ForgeModel):
    """sdadas/mmlw-roberta-large Polish sentence embedding model loader."""

    _VARIANTS = {
        ModelVariant.MMLW_ROBERTA_LARGE: LLMModelConfig(
            pretrained_model_name="sdadas/mmlw-roberta-large",
            max_length=512,
        ),
    }

    DEFAULT_VARIANT = ModelVariant.MMLW_ROBERTA_LARGE
    ...
    def load_inputs(self, dtype_override=None, sentence=None):
        ...
        if sentence is None:
            # Model expects "zapytanie: " prefix for queries.
            sentence = "zapytanie: Jak dożyć 100 lat?"
